import{n as e}from"./rolldown-runtime-hePW80VL.js";import{$ as t,B as n,F as r,G as i,I as a,Kt as o,L as s,O as c,P as l,Q as u,R as d,T as f,U as p,V as m,Wt as h,_ as g,bt as _,d as v,dt as y,et as b,f as x,g as S,i as C,j as w,l as T,lt as E,nt as D,ot as O,p as k,qt as A,tt as j,u as M,v as N,z as P}from"./runtime-core.esm-bundler-kkMznkCl.js";import{a as F,c as I,d as L,l as R,o as z,s as B,u as V}from"./runtime-dom.esm-bundler-CHanmBTQ.js";import{n as H,r as U}from"./pinia-Cmt0qqyQ.js";import{t as W}from"./message-Ri3ptyqj.js";import{t as ee}from"./message-box-CV2dSrpA.js";import{h as te,m as ne}from"./useApi-CROJJdhE-BZRBkDcY.js";import{i as G,n as re,r as ie}from"./curriculum-S4hSaKIm.js";import{t as K}from"./_plugin-vue_export-helper-BDNMzG2s.js";import{t as ae}from"./axios-DhiQ7QLW.js";import{n as oe,r as q,t as se}from"./CodeWindow-Dv9EOwfb.js";var ce={class:`snippet`},le=[`innerHTML`],ue={key:0,class:`parts`},de={key:1,class:`returns`},fe={key:2},pe=K({__name:`CodeSnippet`,props:{code:{type:String,required:!0},desc:{type:String,default:``},parts:{type:Array,default:()=>[]},returns:{type:String,default:``}},setup(e){let t=e,n=T(()=>oe(t.code));return(t,r)=>(s(),k(`figure`,ce,[M(`pre`,null,[M(`code`,{innerHTML:n.value},null,8,le)]),e.parts.length?(s(),k(`dl`,ue,[(s(!0),k(C,null,P(e.parts,e=>(s(),k(C,{key:e.token},[M(`dt`,null,A(e.token),1),M(`dd`,null,A(e.role),1)],64))),128))])):x(``,!0),e.returns?(s(),k(`p`,de,[r[0]||=M(`span`,{class:`returns-label`},`돌려주는 값`,-1),g(A(e.returns),1)])):x(``,!0),e.desc?(s(),k(`figcaption`,fe,A(e.desc),1)):x(``,!0)]))}},[[`__scopeId`,`data-v-264d774b`]]),me=[`aria-expanded`],he={key:0,class:`range`},ge={class:`chevron`},_e={class:`lecture-body`},ve={key:0,class:`intro`},ye=[`innerHTML`],be=[`innerHTML`],xe={key:1,class:`points`},Se=[`innerHTML`],Ce={key:2,class:`syntax`},we=K({__name:`LectureBrief`,props:{lecture:{type:Object,required:!0},studyRange:{type:String,default:``},open:{type:Boolean,default:!1}},setup(e){let t=y(e.open);return(n,r)=>(s(),k(`section`,{class:h([`lecture`,{closed:!t.value}])},[M(`button`,{class:`lecture-toggle`,type:`button`,"aria-expanded":t.value,onClick:r[0]||=e=>t.value=!t.value},[r[1]||=M(`span`,{class:`marker`},`📖`,-1),r[2]||=M(`span`,{class:`toggle-title`},`관련 강의 내용`,-1),e.studyRange?(s(),k(`span`,he,`교안 `+A(e.studyRange),1)):x(``,!0),M(`span`,ge,A(t.value?`−`:`+`),1)],8,me),j(M(`div`,_e,[e.lecture.intro?(s(),k(`p`,ve,[r[3]||=M(`span`,{class:`intro-label`},`쉽게 말하면`,-1),M(`span`,{innerHTML:_(q)(e.lecture.intro)},null,8,ye)])):x(``,!0),M(`p`,{class:`lead`,innerHTML:_(q)(e.lecture.summary)},null,8,be),e.lecture.points?.length?(s(),k(`ul`,xe,[(s(!0),k(C,null,P(e.lecture.points,e=>(s(),k(`li`,{key:e,innerHTML:_(q)(e)},null,8,Se))),128))])):x(``,!0),e.lecture.syntax?.length?(s(),k(`div`,Ce,[r[4]||=M(`p`,{class:`syntax-label`},`문법 정리`,-1),(s(!0),k(C,null,P(e.lecture.syntax,e=>(s(),v(pe,{key:e.code,code:e.code,desc:e.desc,parts:e.parts??[],returns:e.returns??``},null,8,[`code`,`desc`,`parts`,`returns`]))),128))])):x(``,!0)],512),[[R,t.value]])],2))}},[[`__scopeId`,`data-v-dd03eb2e`]]),Te=[`aria-expanded`,`aria-label`,`title`],Ee={key:0,class:`icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2.2`,"stroke-linecap":`round`,"aria-hidden":`true`},De={key:1,class:`icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`,"aria-hidden":`true`},Oe={class:`help-popover`,role:`note`},ke={class:`help-text`},J=K({__name:`ConceptHelp`,props:{text:{type:String,required:!0}},setup(e){let t=y(!1),n=y(null),r=e=>{t.value&&n.value&&!n.value.contains(e.target)&&(t.value=!1)},i=e=>{e.key===`Escape`&&(t.value=!1)};return l(()=>{document.addEventListener(`mousedown`,r),document.addEventListener(`keydown`,i)}),w(()=>{document.removeEventListener(`mousedown`,r),document.removeEventListener(`keydown`,i)}),(r,i)=>(s(),k(`span`,{ref_key:`root`,ref:n,class:`concept-help`},[M(`button`,{class:h([`help-button`,{open:t.value}]),type:`button`,"aria-expanded":t.value,"aria-label":t.value?`개념 설명 닫기`:`개념 설명 보기`,title:t.value?`닫기`:`개념 설명 보기`,onClick:i[0]||=e=>t.value=!t.value},[t.value?(s(),k(`svg`,Ee,[...i[1]||=[M(`path`,{d:`M18 6 6 18M6 6l12 12`},null,-1)]])):(s(),k(`svg`,De,[...i[2]||=[M(`circle`,{cx:`12`,cy:`12`,r:`9.5`},null,-1),M(`path`,{d:`M12 16.5v-5`},null,-1),M(`circle`,{cx:`12`,cy:`8`,r:`1.15`,fill:`currentColor`,stroke:`none`},null,-1)]]))],10,Te),j(M(`span`,Oe,[i[3]||=M(`span`,{class:`help-arrow`,"aria-hidden":`true`},null,-1),i[4]||=M(`span`,{class:`help-label`},`개념 설명`,-1),M(`span`,ke,A(e.text),1)],512),[[R,t.value]])],512))}},[[`__scopeId`,`data-v-46feb191`]]),Ae=e({default:()=>Ue}),je={class:`practice-card`},Me={class:`practice-area`},Ne=[`disabled`],Pe={class:`practice-area`},Fe={class:`practice-area`},Ie={class:`input-group`},Le={class:`practice-area`},Re={class:`practice-area`},ze=`https://vuejs.org`,Be=`https://vuejs.org/images/logo.png`,Ve=`user-profile-card`,He=`https://vuejs.org/images/logo.png`,Ue=K({__name:`BindPractice`,setup(e){let t=y(!0),n=y(!1),r=y(`dark-box`),i=y(`purple`),a=y(200),c={height:`80px`,color:`white`,backgroundColor:`#42b883`,transition:`all 0.3s ease`};return(e,l)=>(s(),k(`section`,je,[M(`div`,Me,[M(`h2`,null,[l[4]||=g(` v-bind 디렉티브 기본 (축약형: 콜론) `,-1),N(J,{text:`v-bind는 href, src, disabled 같은 HTML 속성에 JavaScript 데이터를 연결합니다. 축약형은 : 입니다.`})]),M(`a`,{href:ze,target:`_blank`},`Vue 공식 사이트`),M(`img`,{src:Be,alt:`Vue 로고`,width:`80`}),M(`button`,{disabled:t.value},`잠기는 버튼`,8,Ne),M(`button`,{onClick:l[0]||=e=>t.value=!t.value},` 잠금 상태 변경 `)]),M(`div`,Pe,[M(`h2`,null,[l[5]||=g(` v-bind 디렉티브 고급 (클래스 바인딩) `,-1),N(J,{text:`:class는 조건에 따라 CSS 클래스를 추가하거나 제거합니다. 객체와 배열 형식을 사용할 수 있습니다.`})]),M(`p`,{class:h({danger:n.value})},` 현재 경고 상태: `+A(n.value),3),M(`button`,{onClick:l[1]||=e=>n.value=!n.value},`경고 상태 변경`),M(`div`,{class:h([r.value,n.value?`red-border`:`gray-border`])},` 배열로 클래스를 조합한 상자 `,2)]),M(`div`,Fe,[M(`h2`,null,[l[6]||=g(` v-bind 디렉티브 고급 (스타일 바인딩) `,-1),N(J,{text:`:style은 색상이나 크기 같은 인라인 CSS 값을 데이터와 직접 연결합니다. 객체와 배열 형식을 지원합니다.`})]),M(`p`,{style:o({color:i.value,fontWeight:`bold`})},` 동적 스타일이 적용된 글자 `,4),M(`button`,{onClick:l[2]||=e=>i.value=i.value===`purple`?`blue`:`purple`},` 글자색 변경 `),M(`div`,Ie,[l[7]||=M(`label`,{for:`box-width`},`박스 너비: `,-1),j(M(`input`,{id:`box-width`,"onUpdate:modelValue":l[3]||=e=>a.value=e,type:`number`,step:`50`},null,512),[[I,a.value,void 0,{number:!0}]])]),M(`div`,{class:`size-box`,style:o([c,{width:a.value+`px`}])},A(a.value)+`px `,5)]),M(`div`,Le,[M(`h2`,null,[l[8]||=g(` Class Binding vs. Style Binding `,-1),N(J,{text:`미리 만든 디자인을 바꿀 때는 :class, 너비처럼 값 자체를 실시간으로 바꿀 때는 :style이 적합합니다.`})]),l[9]||=M(`p`,null,[g(` 미리 만든 디자인을 상태에 따라 바꿀 때는 `),M(`strong`,null,`:class`),g(`를 사용합니다. `)],-1),l[10]||=M(`p`,null,[g(` 너비나 색상 값을 실시간으로 직접 바꿀 때는 `),M(`strong`,null,`:style`),g(`을 사용합니다. `)],-1)]),M(`div`,Re,[M(`h2`,null,[l[11]||=g(` v-bind 디렉티브 고급 (단축 문법) `,-1),N(J,{text:`HTML 속성명과 JavaScript 변수명이 같으면 :src='src'를 :src처럼 줄일 수 있는 Vue 3.4 이상의 문법입니다.`})]),M(`div`,{id:Ve},[M(`img`,{src:He,alt:`Vue 로고`,width:`50`})])])]))}},[[`__scopeId`,`data-v-e7a49731`]]),We=e({default:()=>et}),Ge={class:`practice-card`},Ke={key:0},qe={key:1},Je={key:2,style:{color:`green`,"font-weight":`bold`}},Ye={key:3,style:{color:`blue`}},Xe={key:4,style:{color:`orange`}},Ze={key:5,style:{color:`red`,"font-weight":`bold`}},Qe={class:`box`},$e={class:`practice-area comparison-area`},et=K({__name:`ConditionalPractice`,setup(e){let t=y(!1),n=y(85),r=y(!0);return(e,i)=>(s(),k(`section`,Ge,[M(`h2`,null,[i[3]||=g(` v-if, v-else-if, v-else 디렉티브 학습 `,-1),N(J,{text:`조건에 따라 DOM 요소를 생성하거나 제거합니다. 여러 조건은 v-else-if와 v-else로 이어서 표현합니다.`})]),i[8]||=M(`h3`,null,`1) 기본 로그인 상태 스위치`,-1),t.value?(s(),k(`p`,Ke,`환영합니다! 회원 전용 화면입니다.`)):(s(),k(`p`,qe,`로그인이 필요합니다. 먼저 로그인해 주세요.`)),M(`button`,{onClick:i[0]||=e=>t.value=!t.value},A(t.value?`로그아웃 하기`:`로그인 하기`),1),i[9]||=M(`br`,null,null,-1),i[10]||=M(`h3`,null,`2) 성적별 학점 등급 측정 (다중 조건문)`,-1),i[11]||=M(`label`,null,`현재 점수 입력: `,-1),j(M(`input`,{"onUpdate:modelValue":i[1]||=e=>n.value=e,type:`number`,min:`0`,max:`100`,step:`5`},null,512),[[I,n.value]]),i[12]||=M(`br`,null,null,-1),n.value>=90?(s(),k(`div`,Je,` 합격 등급: A 학점 (훌륭합니다!) `)):n.value>=80?(s(),k(`div`,Ye,` 합격 등급: B 학점 (양호합니다.) `)):n.value>=70?(s(),k(`div`,Xe,` 합격 등급: C 학점 (조금 더 분발하세요.) `)):(s(),k(`div`,Ze,` 합격 등급: F 학점 (재시험 대상입니다.) `)),M(`h2`,null,[i[4]||=g(` v-show 디렉티브 학습 `,-1),N(J,{text:`v-show는 요소를 DOM에 유지하면서 CSS display 속성으로 보이거나 숨깁니다.`})]),M(`button`,{onClick:i[2]||=e=>r.value=!r.value},` 화면 토글하기 `),i[13]||=M(`br`,null,null,-1),j(M(`div`,Qe,[...i[5]||=[M(`p`,null,`v-show 상자`,-1),M(`p`,null,` 조건이 false가 되면 CSS display: none이 붙습니다. `,-1)]],512),[[R,r.value]]),M(`div`,$e,[M(`h2`,null,[i[6]||=g(` v-if vs. v-show `,-1),N(J,{text:`전환이 드물면 DOM을 생성·제거하는 v-if, 자주 열고 닫으면 display만 바꾸는 v-show가 적합합니다.`})]),i[7]||=M(`p`,null,` v-if는 DOM을 생성·제거하고, v-show는 DOM을 유지한 채 CSS display 속성으로 표시 여부를 바꿉니다. `,-1)])]))}},[[`__scopeId`,`data-v-e3392bd5`]]),tt=e({default:()=>ft}),nt={class:`practice-card`},rt={class:`practice-area`},it={class:`practice-area`},at={class:`practice-area`},ot=[`disabled`],st=[`disabled`],ct={class:`practice-area`},lt={class:`practice-area`},ut={class:`modifier-stop-area`},dt={class:`modifier-chain-area`},ft=K({__name:`EventPractice`,setup(e){let t=y(0),n=y(``),i=y(!1),a=y(``),c=y(``),l=y(`transparent`),u=y(0),d=y(!1),f=y(0),p=y(0),m=y(0),h=()=>{window.alert(`함수가 성공적으로 호출되었습니다!`)},_=e=>{n.value=`창 좌표: X=${e.clientX}, Y=${e.clientY} / 문서 좌표: X=${e.pageX}, Y=${e.pageY}`},v=()=>{i.value||(window.addEventListener(`click`,_),i.value=!0,n.value=`좌표 확인 중: 브라우저 창 안을 클릭해 보세요.`)},b=()=>{window.removeEventListener(`click`,_),i.value=!1},x=(e,t)=>{a.value=`대상: ${e} / 클릭된 태그: ${t.target.tagName}`},S=e=>{let t=e.currentTarget.getBoundingClientRect(),n=Math.min(1,Math.max(0,(e.clientX-t.left)/t.width)),r=Math.round(n*360);u.value=n*100,l.value=`hsl(${r}, 100%, 50%)`,c.value=`무지개 바 선택 / HSL 값: hsl(${r}, 100%, 50%)`},C=e=>{d.value=!0,e.currentTarget.setPointerCapture(e.pointerId),S(e)},w=e=>{d.value&&S(e)},T=e=>{d.value&&(S(e),d.value=!1,e.currentTarget.hasPointerCapture(e.pointerId)&&e.currentTarget.releasePointerCapture(e.pointerId))},E=()=>{window.alert(`수식어 덕분에 네이버로 이동하지 않고 함수만 실행됩니다!`)},D=()=>{window.alert(`부모 박스가 클릭되었습니다!`)},O=()=>{window.alert(`1번 자식 클릭!`)},j=()=>{window.alert(`2번 자식(나만 켜짐) 클릭!`)},P=()=>{f.value++},F=()=>{p.value++},I=()=>{f.value=0,p.value=0,m.value++};return r(()=>{window.removeEventListener(`click`,_)}),(e,r)=>(s(),k(`section`,nt,[M(`h2`,null,[r[2]||=g(` v-on 이벤트 핸들링 기초 `,-1),N(J,{text:`v-on은 클릭이나 키보드 입력 같은 이벤트를 감지해 코드를 실행합니다. 축약형은 @입니다.`})]),M(`div`,rt,[M(`h3`,null,[r[3]||=g(` 1) 인라인 연산 처리 `,-1),N(J,{text:`Inline Handler는 count++처럼 간단한 JavaScript 표현식을 템플릿 안에서 바로 실행하는 방식입니다.`})]),M(`p`,null,`현재 카운트: `+A(t.value),1),M(`button`,{onClick:r[0]||=e=>t.value++},`1씩 증가`)]),M(`div`,it,[M(`h3`,null,[r[4]||=g(` 2) 스크립트 함수 호출 `,-1),N(J,{text:`Method Handler는 script에 함수를 정의하고 이벤트에는 함수 이름을 연결하는 방식입니다.`})]),M(`button`,{onClick:h},`알림창 띄우기`)]),M(`div`,at,[M(`h2`,null,[r[5]||=g(` v-on 이벤트 객체($event) 활용 `,-1),N(J,{text:`함수 이름만 전달하면 이벤트 객체가 자동으로 전달됩니다. 다른 값과 이벤트 객체를 함께 넘길 때는 $event를 명시합니다.`})]),M(`p`,null,A(n.value||`좌표 확인 시작 버튼을 눌러주세요.`),1),M(`p`,null,` 현재 상태: `+A(i.value?`좌표 확인 중`:`좌표 확인 중지`),1),M(`p`,null,A(a.value||`태그: 버튼을 클릭해 보세요.`),1),M(`button`,{disabled:i.value,onClick:L(v,[`stop`])},` 좌표 확인 시작 `,8,ot),M(`button`,{disabled:!i.value,onClick:L(b,[`stop`])},` 좌표 그만 확인하기 `,8,st),M(`button`,{onClick:r[1]||=e=>x(`회원A`,e)},` 회원 정보와 태그 확인 `)]),M(`div`,ct,[M(`h2`,null,[r[6]||=g(` 클릭한 색상 알아내기 `,-1),N(J,{text:`색상 이름은 함수 인자로 전달하고, 실제 CSS 배경색은 $event의 currentTarget에서 읽습니다.`})]),M(`div`,{class:`rainbow-bar`,role:`button`,tabindex:`0`,"aria-label":`무지개 색상 선택`,onPointerdown:C,onPointermove:w,onPointerup:T,onPointercancel:T},[M(`span`,{class:`rainbow-marker`,style:o({left:u.value+`%`})},null,4)],32),M(`p`,null,A(c.value||`무지개 바나 색상 버튼을 클릭해 보세요.`),1),M(`div`,{class:`selected-color`,style:o({backgroundColor:l.value})},null,4)]),M(`div`,lt,[M(`h2`,null,[r[7]||=g(` 이벤트 수식어(Modifiers) 학습 `,-1),N(J,{text:`이벤트 수식어는 이벤트의 기본 동작이나 전파 방식을 간단한 접미어로 제어합니다.`})]),M(`h3`,null,[r[8]||=g(` 1) .prevent (기본 동작 막기) `,-1),N(J,{text:`.prevent는 preventDefault()와 같으며 링크 이동이나 폼 제출 후 새로고침 같은 기본 동작을 막습니다.`})]),M(`a`,{href:`https://www.naver.com`,onClick:L(E,[`prevent`])},` 네이버 링크 `),M(`div`,ut,[M(`h3`,null,[r[9]||=g(` 2) .stop (이벤트 버블링 막기) `,-1),N(J,{text:`.stop은 stopPropagation()과 같으며 자식에서 발생한 이벤트가 부모로 올라가는 것을 막습니다.`})]),M(`div`,{class:`modifier-box`,onClick:D},[r[10]||=M(`p`,null,`부모 영역 (클릭 시 alert 발동)`,-1),M(`button`,{onClick:O},` 버블링 발생 버튼 `),M(`button`,{onClick:L(j,[`stop`])},` 버블링 차단 버튼 `)])]),M(`div`,dt,[M(`h3`,null,[r[11]||=g(` 3) .prevent.stop.once 연결하기 `,-1),N(J,{text:`첫 클릭에는 기본 동작 방지, 버블링 차단, 한 번만 실행이 함께 적용됩니다. once로 리스너가 제거된 뒤에는 나머지 수식어도 더 이상 실행되지 않습니다.`})]),M(`div`,{class:`modifier-box`,onClick:F},[M(`p`,null,`부모 클릭 횟수: `+A(p.value),1),M(`p`,null,`자식 함수 실행 횟수: `+A(f.value),1),(s(),k(`input`,{key:m.value,type:`checkbox`,onClickOnce:L(P,[`prevent`,`stop`])},null,32)),r[12]||=g(` 체크박스를 클릭해 보세요. `,-1)]),r[13]||=M(`p`,{class:`modifier-guide`},` 첫 클릭은 체크되지 않고 부모 클릭도 발생하지 않으며, 자식 함수만 한 번 실행됩니다. 두 번째 클릭부터는 once로 리스너가 제거되어 체크와 부모 클릭이 다시 동작합니다. `,-1),M(`button`,{onClick:L(I,[`stop`])},` 연결 수식어 실습 초기화 `)])])]))}},[[`__scopeId`,`data-v-dd838579`]]),pt=e({default:()=>gt}),mt={class:`practice-card`},ht={class:`practice-area lists`},gt=K({__name:`ForPractice`,setup(e){let t=y([`사과`,`바나나`,`딸기`]),n=y({name:`홍길동`,age:25,role:`개발자`}),r=y([{id:`prod-101`,name:`아이폰`},{id:`prod-102`,name:`갤럭시`}]);return(e,i)=>(s(),k(`section`,mt,[M(`h2`,null,[i[0]||=g(` v-for 디렉티브 학습 `,-1),N(J,{text:`v-for는 배열이나 객체의 항목을 반복해서 화면에 출력합니다. 각 항목에는 가능한 한 고유한 :key를 지정합니다.`})]),M(`div`,ht,[M(`div`,null,[i[1]||=M(`h3`,null,`배열 반복`,-1),M(`ul`,null,[(s(!0),k(C,null,P(t.value,(e,t)=>(s(),k(`li`,{key:e},A(t+1)+`번 과일: `+A(e),1))),128))])]),M(`div`,null,[i[2]||=M(`h3`,null,`객체 반복`,-1),M(`ul`,null,[(s(!0),k(C,null,P(n.value,(e,t,n)=>(s(),k(`li`,{key:t},` [`+A(n)+`] `+A(t)+`: `+A(e),1))),128))])]),M(`div`,null,[i[3]||=M(`h3`,null,`객체 배열 반복`,-1),M(`ul`,null,[(s(!0),k(C,null,P(r.value,e=>(s(),k(`li`,{key:e.id},A(e.name),1))),128))])])])]))}},[[`__scopeId`,`data-v-e533b99b`]]),_t=e({default:()=>Ct}),vt={class:`practice-card`},yt={class:`practice-area`},bt={class:`practice-area`},xt=[`innerHTML`],St={class:`practice-area`},Y=`이 글자는 <span style="color: red; font-weight: bold;">빨간색 굵은 글자</span>이다.`,Ct=K({__name:`HtmlTextPractice`,setup(e){let t=y(``),n=y(``);function r(){n.value=t.value}return(e,i)=>(s(),k(`section`,vt,[M(`div`,yt,[M(`h2`,null,[i[1]||=g(` v-html 디렉티브 학습 `,-1),N(J,{text:`v-html은 문자열에 들어 있는 HTML 태그를 실제 HTML 요소로 해석해 출력합니다.`})]),i[2]||=M(`h3`,null,`일반 보간법 {{ }} 사용 결과:`,-1),M(`p`,null,A(Y)),i[3]||=M(`br`,null,null,-1),i[4]||=M(`h3`,null,`v-html 디렉티브 사용 결과:`,-1),M(`p`,{innerHTML:Y})]),M(`div`,bt,[M(`h2`,null,[i[5]||=g(` v-html XSS 학습 `,-1),N(J,{text:`XSS는 악성 스크립트가 다른 사용자의 브라우저에서 실행되는 공격입니다. 사용자 입력을 v-html에 직접 연결하면 위험합니다.`})]),j(M(`input`,{"onUpdate:modelValue":i[0]||=e=>t.value=e,placeholder:`내용을 입력하세요`},null,512),[[I,t.value]]),M(`button`,{onClick:r},`확인`),M(`div`,{innerHTML:n.value},null,8,xt)]),i[7]||=M(`p`,{class:`warning`},` 위 코드는 XSS 위험을 확인하기 위한 학습용 예제입니다. 실제 서비스에서는 사용자 입력을 v-html로 직접 출력하지 않습니다. `,-1),M(`div`,St,[M(`h2`,null,[i[6]||=g(` v-text 디렉티브 학습 `,-1),N(J,{text:`v-text는 값을 일반 텍스트로 출력합니다. HTML 태그가 포함되어 있어도 실제 태그로 해석하지 않습니다.`})]),M(`p`,{textContent:Y})])]))}},[[`__scopeId`,`data-v-860fa86e`]]),wt=e({default:()=>Ut}),Tt={class:`practice-card`},Et={class:`practice-area`},Dt={class:`form-item`},Ot={class:`form-item`},kt=[`value`],At={class:`practice-area`},jt={class:`form-item`},Mt={class:`form-item`},Nt={class:`form-item`},Pt={class:`option-group`},Ft={class:`form-item`},It={class:`option-group`},Lt={class:`form-item`},Rt={class:`practice-area`},zt={class:`form-item`},Bt={class:`form-item`},Vt={class:`form-item`},Ht={class:`form-item`},Ut=K({__name:`ModelPractice`,setup(e){let t=y(``),n=y(``),r=y(``),i=y(!1),a=y([]),o=y(``),c=y(``),l=y(``),u=y(``),d=y(``),f=y(``);return(e,p)=>(s(),k(`section`,Tt,[M(`div`,Et,[M(`h2`,null,[p[14]||=g(` v-model 양방향 데이터 바인딩 `,-1),N(J,{text:`v-model은 입력 요소의 값과 Vue 데이터를 연결해 한쪽이 바뀌면 다른 쪽도 자동으로 반영되게 합니다.`})]),M(`div`,Dt,[p[16]||=M(`h3`,null,`1) v-model 축약 문법 (양방향)`,-1),j(M(`input`,{"onUpdate:modelValue":p[0]||=e=>t.value=e,type:`text`,placeholder:`여기에 입력하세요`},null,512),[[I,t.value]]),M(`p`,null,[p[15]||=g(` 입력된 값: `,-1),M(`strong`,null,A(t.value),1)])]),M(`div`,Ot,[p[18]||=M(`h3`,null,`2) v-model의 내부 작동 원리 (단방향 + 이벤트)`,-1),M(`input`,{value:n.value,type:`text`,placeholder:`원리 파악용 입력창`,onInput:p[1]||=e=>n.value=e.target.value},null,40,kt),M(`p`,null,[p[17]||=g(` 입력된 값: `,-1),M(`strong`,null,A(n.value),1)])])]),M(`div`,At,[M(`h2`,null,[p[19]||=g(` 모든 HTML Form 요소와 v-model 매핑 `,-1),N(J,{text:`Form 요소마다 v-model이 저장하는 값의 형태가 다릅니다. 단일 체크박스는 Boolean, 다중 체크박스는 Array로 시작합니다.`})]),M(`div`,jt,[p[20]||=M(`h3`,null,`1) Textarea (장문 텍스트)`,-1),j(M(`textarea`,{"onUpdate:modelValue":p[2]||=e=>r.value=e,placeholder:`의견을 남겨주세요`},null,512),[[I,r.value]]),M(`p`,null,`데이터 상태: `+A(r.value),1)]),M(`div`,Mt,[p[22]||=M(`h3`,null,`2) 단일 Checkbox (동의 여부)`,-1),M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":p[3]||=e=>i.value=e,type:`checkbox`},null,512),[[F,i.value]]),p[21]||=g(` 약관에 동의합니다. `,-1)]),M(`p`,null,`데이터 상태: `+A(i.value),1)]),M(`div`,Nt,[p[26]||=M(`h3`,null,`3) 다중 Checkbox (복수 선택 → 배열에 저장)`,-1),M(`div`,Pt,[M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":p[4]||=e=>a.value=e,type:`checkbox`,value:`사과`},null,512),[[F,a.value]]),p[23]||=g(` 사과 `,-1)]),M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":p[5]||=e=>a.value=e,type:`checkbox`,value:`바나나`},null,512),[[F,a.value]]),p[24]||=g(` 바나나 `,-1)]),M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":p[6]||=e=>a.value=e,type:`checkbox`,value:`딸기`},null,512),[[F,a.value]]),p[25]||=g(` 딸기 `,-1)])]),M(`p`,null,`데이터 상태 (배열): `+A(a.value),1)]),M(`div`,Ft,[p[29]||=M(`h3`,null,`4) Radio (단일 선택)`,-1),M(`div`,It,[M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":p[7]||=e=>o.value=e,type:`radio`,value:`남성`},null,512),[[z,o.value]]),p[27]||=g(` 남성 `,-1)]),M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":p[8]||=e=>o.value=e,type:`radio`,value:`여성`},null,512),[[z,o.value]]),p[28]||=g(` 여성 `,-1)])]),M(`p`,null,`데이터 상태: `+A(o.value),1)]),M(`div`,Lt,[p[31]||=M(`h3`,null,`5) Select (드롭다운 선택)`,-1),j(M(`select`,{"onUpdate:modelValue":p[9]||=e=>c.value=e},[...p[30]||=[M(`option`,{value:``},`-- 선택하세요 --`,-1),M(`option`,{value:`tesla`},`테슬라`,-1),M(`option`,{value:`hyundai`},`현대자동차`,-1),M(`option`,{value:`bmw`},`BMW`,-1)]],512),[[B,c.value]]),M(`p`,null,`데이터 상태: `+A(c.value),1)])]),M(`div`,Rt,[M(`h2`,null,[p[32]||=g(` v-model 수식어(Modifiers) 활용 `,-1),N(J,{text:`v-model 수식어는 값의 반영 시점이나 저장 형태를 간단히 제어합니다. .lazy, .number, .trim을 단독 또는 연결해서 사용할 수 있습니다.`})]),M(`div`,zt,[p[34]||=M(`h3`,null,`1) .lazy 수식어 (change 이벤트 시점 반영)`,-1),j(M(`input`,{"onUpdate:modelValue":p[10]||=e=>l.value=e,type:`text`,placeholder:`입력 후 Enter 또는 외부 클릭`},null,512),[[I,l.value,void 0,{lazy:!0}]]),M(`p`,null,[p[33]||=g(` 실시간이 아닌 확정된 값: `,-1),M(`strong`,null,A(l.value),1)])]),M(`div`,Bt,[p[37]||=M(`h3`,null,`2) .number 수식어 (Number 타입 자동 형변환)`,-1),j(M(`input`,{"onUpdate:modelValue":p[11]||=e=>u.value=e,type:`text`,placeholder:`나이를 입력하세요`},null,512),[[I,u.value,void 0,{number:!0}]]),M(`p`,null,[p[35]||=g(` 입력된 값: `,-1),M(`strong`,null,A(u.value),1)]),M(`p`,null,[p[36]||=g(` 데이터 타입: `,-1),M(`strong`,null,A(typeof u.value),1)])]),M(`div`,Vt,[p[40]||=M(`h3`,null,`3) .trim 수식어 (양끝 공백 자동 제거)`,-1),j(M(`input`,{"onUpdate:modelValue":p[12]||=e=>d.value=e,type:`text`,placeholder:`앞뒤 공백을 포함해 입력해 보세요`},null,512),[[I,d.value,void 0,{trim:!0}]]),M(`p`,null,[p[38]||=g(` 공백 제거된 값: `,-1),M(`strong`,null,`"`+A(d.value)+`"`,1)]),M(`p`,null,[p[39]||=g(` 문자열 길이: `,-1),M(`strong`,null,A(d.value.length),1)])]),M(`div`,Ht,[p[43]||=M(`h3`,null,`4) Chaining (수식어 체이닝: .trim.number)`,-1),j(M(`input`,{"onUpdate:modelValue":p[13]||=e=>f.value=e,type:`text`,placeholder:`공백과 숫자를 섞어 입력해 보세요`},null,512),[[I,f.value,void 0,{trim:!0,number:!0}]]),M(`p`,null,[p[41]||=g(` 처리된 값: `,-1),M(`strong`,null,`"`+A(f.value)+`"`,1)]),M(`p`,null,[p[42]||=g(` 데이터 타입: `,-1),M(`strong`,null,A(typeof f.value),1)])])])]))}},[[`__scopeId`,`data-v-208c25e3`]]),Wt=e({default:()=>Kt}),Gt={class:`practice-card`},Kt={__name:`ReactivityPractice`,setup(e){let t=0,n=y(0),r=y(`hello vue`);return(e,i)=>(s(),k(`section`,Gt,[M(`h2`,null,[i[2]||=g(` 실습 1 — Reactivity와 보간법 `,-1),N(J,{text:`Reactivity는 데이터가 바뀌면 화면도 자동으로 갱신되는 특성이고, 보간법은 {{ }} 안의 값이나 표현식을 화면에 출력하는 문법입니다.`})]),M(`div`,null,[M(`p`,null,`일반 변수: `+A(_(t)),1),M(`button`,{onClick:i[0]||=e=>O(t)?t.value++:t++},`일반 변수 증가`),M(`p`,null,`반응형 변수: `+A(n.value),1),M(`button`,{onClick:i[1]||=e=>n.value++},`반응형 변수 증가`)]),M(`div`,null,[M(`p`,null,`원래 문자열: `+A(r.value),1),M(`p`,null,`대문자 변환: `+A(r.value.toUpperCase()),1),M(`p`,null,A(`Random number: `+Math.ceil(Math.random()*100)),1)])]))}},qt=e({default:()=>en}),Jt={class:`practice-card`},Yt={class:`practice-area`},Xt={class:`practice-area`},Zt={class:`practice-area`},Qt={class:`practice-area`},$t={class:`button-group`},en=K({__name:`SpecialDirectivePractice`,setup(e){let t=y(`안녕하세요!`),n=y(1),r=y(`홍길동`),a=y(20);return(e,o)=>(s(),k(`section`,Jt,[M(`div`,Yt,[M(`h2`,null,[o[5]||=g(` v-pre 디렉티브 학습 `,-1),N(J,{text:`v-pre는 해당 요소와 자식의 Vue 문법을 해석하지 않고 작성된 내용을 그대로 표시합니다.`})]),M(`p`,null,`일반 출력: `+A(t.value),1),o[6]||=M(`p`,null,`v-pre 출력: {{ message }}`,-1)]),M(`div`,Xt,[M(`h2`,null,[o[7]||=g(` v-cloak 디렉티브 학습 `,-1),N(J,{text:`v-cloak은 Vue가 준비되기 전에 {{ message }} 같은 템플릿 원문이 잠깐 보이는 것을 CSS와 함께 방지합니다.`})]),M(`p`,null,`Vue가 준비되면 표시: `+A(t.value),1)]),M(`div`,Zt,[M(`h2`,null,[o[8]||=g(` v-once 디렉티브 학습 `,-1),N(J,{text:`v-once는 최초 한 번만 렌더링하고 이후 데이터가 변경되어도 해당 화면을 갱신하지 않습니다.`})]),M(`p`,null,`일반 값: `+A(n.value),1),o[0]||(i(-1,!0),(o[0]=M(`p`,null,[g(`최초 값으로 고정: `+A(n.value),1)])).cacheIndex=0,i(1),o[0]),M(`button`,{onClick:o[1]||=e=>n.value++},`숫자 증가`)]),M(`div`,Qt,[M(`h2`,null,[o[9]||=g(` v-memo 디렉티브 학습 `,-1),N(J,{text:`v-memo는 지정한 의존성이 바뀔 때만 영역을 다시 렌더링합니다. 큰 목록 등 실제 성능 문제가 있는 경우에 제한적으로 사용합니다.`})]),D([r.value,a.value],()=>(s(),k(`div`,{class:`memo-box`},[M(`p`,null,`이름: `+A(r.value),1),M(`p`,null,`나이: `+A(a.value),1)])),o,2),M(`div`,$t,[M(`button`,{onClick:o[3]||=e=>r.value=r.value===`홍길동`?`이순신`:`홍길동`},` 이름 변경 `),M(`button`,{onClick:o[4]||=e=>a.value++},`나이 증가`)])])]))}},[[`__scopeId`,`data-v-0ad0fb48`]]),tn={type:`button`,class:`base-button`},nn=K({__name:`BaseButton`,props:{label:{type:String,default:`기본 버튼`}},setup(e){return(t,n)=>(s(),k(`button`,tn,A(e.label),1))}},[[`__scopeId`,`data-v-2e39ae80`]]),rn=e({default:()=>un}),an={class:`practice-card`},on={class:`practice-area`},sn={class:`row`},cn={class:`practice-area`},ln={class:`row`},un=K({__name:`ComponentRegistrationPractice`,setup(e){return(e,t)=>{let n=m(`GlobalBadge`);return s(),k(`section`,an,[M(`h2`,null,[t[0]||=g(` Component 등록 — 지역 vs 전역 `,-1),N(J,{text:`지역 등록은 쓰는 파일에서 import 하는 방식이라 어디서 쓰는지 코드로 드러납니다. 전역 등록은 main.js에서 app.component()로 한 번만 해두면 어디서든 import 없이 쓸 수 있지만, 안 쓰는 컴포넌트까지 번들에 들어갑니다.`})]),M(`div`,on,[t[1]||=M(`h3`,null,`1) 지역(Local) 등록 — import 한 줄이 등록`,-1),t[2]||=M(`p`,{class:`explain`},[g(` 아래 두 버튼은 `),M(`b`,null,`같은 컴포넌트`),g(`입니다. 등록한 컴포넌트는 PascalCase와 kebab-case 두 가지로 부를 수 있습니다. `)],-1),M(`div`,sn,[N(nn,{label:`PascalCase 호출`}),N(nn,{label:`kebab-case 호출`})]),t[3]||=M(`pre`,{class:`code`},`import BaseButton from './BaseButton.vue'

<BaseButton />
<base-button></base-button>`,-1)]),M(`div`,cn,[t[4]||=M(`h3`,null,`2) 전역(Global) 등록 — import가 없다`,-1),t[5]||=M(`p`,{class:`explain`},[g(` 아래 배지는 이 파일에서 `),M(`b`,null,`import 하지 않았습니다.`),g(` main.js에서 한 번 등록해 둔 덕분에 바로 쓸 수 있습니다. `)],-1),M(`div`,ln,[N(n),N(n,{text:`어디서든 사용 가능`})]),t[6]||=M(`pre`,{class:`code`},`// main.js
app.component('GlobalBadge', GlobalBadge)

// 이 파일 — import 없이 바로
<GlobalBadge />`,-1)]),t[7]||=S(`<div class="practice-area" data-v-369125df><h3 data-v-369125df>3) 언제 무엇을 쓸까</h3><table class="compare" data-v-369125df><thead data-v-369125df><tr data-v-369125df><th data-v-369125df></th><th data-v-369125df>지역 등록</th><th data-v-369125df>전역 등록</th></tr></thead><tbody data-v-369125df><tr data-v-369125df><td data-v-369125df>등록 위치</td><td data-v-369125df>쓰는 파일에서 import</td><td data-v-369125df>main.js 한 곳</td></tr><tr data-v-369125df><td data-v-369125df>사용 범위</td><td data-v-369125df>그 파일 안에서만</td><td data-v-369125df>앱 전체</td></tr><tr data-v-369125df><td data-v-369125df>의존 관계</td><td data-v-369125df>코드에 드러남</td><td data-v-369125df>어디서 왔는지 안 보임</td></tr><tr data-v-369125df><td data-v-369125df>번들 크기</td><td data-v-369125df>쓰는 것만 포함</td><td data-v-369125df>안 써도 포함</td></tr><tr data-v-369125df><td data-v-369125df>적합한 경우</td><td data-v-369125df><b data-v-369125df>대부분의 컴포넌트</b></td><td data-v-369125df>앱 전반에서 반복되는 소수</td></tr></tbody></table></div>`,1)])}}},[[`__scopeId`,`data-v-369125df`]]),dn={class:`counter-display`},fn=K({__name:`LifecycleChild`,setup(e){let t=y(0),n=null;return console.log(`1. [setup] 컴포넌트가 메모리에 생성되었습니다. (DOM 접근 불가능)`),l(()=>{console.log(`2. [onMounted] 화면에 완벽히 부착되었습니다! (API 호출/DOM 조작 적기)`),n=setInterval(()=>{t.value++},3e3)}),a(()=>{console.log(`3. [onUpdated] 데이터가 변경되어 화면을 새로 그렸습니다. (현재 count: ${t.value})`)}),r(()=>{clearInterval(n),console.log(`4. [onUnmounted] 컴포넌트가 소멸했습니다. 타이머 청소 완료!`)}),(e,n)=>(s(),k(C,null,[n[1]||=M(`h3`,null,`⏱️ 라이프사이클 훅 흐름 탐색기`,-1),M(`div`,dn,[M(`p`,null,`실시간 타이머 카운트: `+A(t.value),1),M(`button`,{onClick:n[0]||=e=>t.value++},`수동으로 숫자 올리기`)])],64))}},[[`__scopeId`,`data-v-4c2f5f04`]]),pn=e({default:()=>gn}),mn={class:`practice-card`},hn={key:1,class:`gone`},gn=K({__name:`LifecyclePractice`,setup(e){let t=y(!0);return(e,n)=>(s(),k(`section`,mn,[M(`h2`,null,[n[1]||=g(` Lifecycle Hook — 생성부터 소멸까지 `,-1),N(J,{text:`컴포넌트는 생성 → 부착(mount) → 갱신(update) → 소멸(unmount)의 생애를 거칩니다. 각 시점에 Vue가 불러주는 함수가 Lifecycle Hook입니다. 브라우저 콘솔(F12)을 열고 아래 버튼으로 컴포넌트를 껐다 켜면 네 단계가 순서대로 찍힙니다.`})]),n[2]||=M(`p`,{class:`hint`},`브라우저 콘솔(F12)을 열어두고 버튼을 눌러 보세요.`,-1),M(`button`,{class:`toggle-btn`,onClick:n[0]||=e=>t.value=!t.value},A(t.value?`🛑 실습 컴포넌트 파괴하기 (v-if="false")`:`🟢 실습 컴포넌트 다시 살리기`),1),n[3]||=M(`hr`,null,null,-1),t.value?(s(),v(fn,{key:0})):(s(),k(`p`,hn,`컴포넌트가 소멸했습니다. 콘솔에서 타이머 정리 로그를 확인해 보세요.`))]))}},[[`__scopeId`,`data-v-d955f165`]]),_n={class:`child-container`},vn=K({__name:`PropsEmitsChild`,props:{parentData:{type:String,required:!0}},emits:[`update-request`],setup(e,{emit:t}){let n=t,r=()=>{n(`update-request`,`Child에서 가공한 새로운 데이터`)};return(t,n)=>(s(),k(`div`,_n,[n[1]||=M(`p`,{class:`role`},`하위 컴포넌트 (Child)`,-1),M(`p`,null,[n[0]||=g(` 수신된 Props 데이터: `,-1),M(`strong`,null,A(e.parentData),1)]),M(`button`,{onClick:r},`상위 컴포넌트로 갱신 요청 (Emit)`)]))}},[[`__scopeId`,`data-v-e98cd097`]]),yn=e({default:()=>Cn}),bn={class:`practice-card`},xn={class:`parent-container`},Sn={class:`state`},Cn=K({__name:`PropsEmitsPractice`,setup(e){let t=y(`Parent 초기 메시지`),n=e=>{t.value=e};return(e,r)=>(s(),k(`section`,bn,[M(`h2`,null,[r[0]||=g(` Props & Emits — 부모와 자식의 대화 `,-1),N(J,{text:`데이터는 부모 → 자식 한 방향으로만 흐릅니다(Props). 자식이 값을 바꾸고 싶으면 직접 고치지 않고 부모에게 '바꿔 달라'고 신호를 보냅니다(Emits). 실제로 값을 바꾸는 주체는 언제나 데이터를 가진 부모입니다.`})]),M(`div`,xn,[r[2]||=M(`p`,{class:`role`},`상위 컴포넌트 (Parent)`,-1),M(`p`,Sn,[r[1]||=g(` 현재 로컬 데이터(State): `,-1),M(`strong`,null,A(t.value),1)]),N(vn,{"parent-data":t.value,onUpdateRequest:n},null,8,[`parent-data`])])]))}},[[`__scopeId`,`data-v-cfac9a78`]]),wn={class:`node child`},Tn={class:`field`},En={class:`val`},Dn=K({__name:`FlowChild`,props:{message:{type:String,required:!0}},emits:[`reply`],setup(e,{emit:t}){let n=t;return(t,r)=>(s(),k(`div`,wn,[r[2]||=M(`p`,{class:`node-role`},`자식 (Child)`,-1),M(`p`,Tn,[r[1]||=M(`span`,{class:`key`},`props.message`,-1),M(`span`,En,A(e.message||`(빈 값)`),1)]),M(`button`,{onClick:r[0]||=e=>n(`reply`,`자식이 보낸 인사 👋`)},` 부모에게 신호 보내기 (emit) `)]))}},[[`__scopeId`,`data-v-8ceed664`]]),On=e({default:()=>Bn}),kn={class:`practice-card`},An={class:`flow`},jn={class:`node parent`},Mn={class:`field`},Nn=[`value`],Pn={class:`field`},Fn={class:`val`},In={class:`arrows`},Ln={class:`log`},Rn={key:0,class:`log-empty`},zn={class:`log-dir`},Bn=K({__name:`PropsFlowPractice`,setup(e){let t=y(`안녕하세요`),n=y(`아직 없음`),r=y(null),i=y([]),a=e=>{r.value=e,setTimeout(()=>{r.value===e&&(r.value=null)},700)},o=(e,t)=>{i.value.unshift({dir:e,text:t}),i.value.length>6&&i.value.pop()},c=e=>{t.value=e.target.value,a(`down`),o(`down`,`props.message = "${t.value}"`)},l=e=>{n.value=e,a(`up`),o(`up`,`emit('reply', "${e}")`)};return(e,a)=>(s(),k(`section`,kn,[M(`h2`,null,[a[0]||=g(` 데이터는 어느 쪽으로 흐르나 — Props ↓ / Emits ↑ `,-1),N(J,{text:`Props는 부모에서 자식으로 내려가고(↓), Emits는 자식에서 부모로 올라갑니다(↑). 반대 방향은 없습니다. 아래에서 입력하거나 버튼을 누르면 그 순간 어느 화살표가 켜지는지 확인해 보세요.`})]),M(`div`,An,[M(`div`,jn,[a[3]||=M(`p`,{class:`node-role`},`부모 (Parent)`,-1),M(`label`,Mn,[a[1]||=M(`span`,{class:`key`},`message`,-1),M(`input`,{value:t.value,type:`text`,onInput:c},null,40,Nn)]),M(`p`,Pn,[a[2]||=M(`span`,{class:`key`},`받은 신호`,-1),M(`span`,Fn,A(n.value),1)])]),M(`div`,In,[M(`div`,{class:h([`arrow down`,{on:r.value===`down`}])},[...a[4]||=[M(`span`,{class:`head`},`↓`,-1),M(`span`,{class:`tag`},`props`,-1)]],2),M(`div`,{class:h([`arrow up`,{on:r.value===`up`}])},[...a[5]||=[M(`span`,{class:`head`},`↑`,-1),M(`span`,{class:`tag`},`emits`,-1)]],2)]),N(Dn,{message:t.value,onReply:l},null,8,[`message`])]),M(`div`,Ln,[a[6]||=M(`p`,{class:`log-title`},`주고받은 기록`,-1),i.value.length?x(``,!0):(s(),k(`p`,Rn,`입력하거나 버튼을 눌러 보세요.`)),(s(!0),k(C,null,P(i.value,(e,t)=>(s(),k(`p`,{key:t,class:h([`log-row`,e.dir])},[M(`span`,zn,A(e.dir===`down`?`↓ 내려감`:`↑ 올라감`),1),M(`code`,null,A(e.text),1)],2))),128))])]))}},[[`__scopeId`,`data-v-f9dc9376`]]),Vn={class:`child`},Hn={class:`field`},Un={class:`val`},Wn=K({__name:`ReadonlyChild`,props:{count:{type:Number,required:!0}},emits:[`increase`],setup(e,{emit:t}){let n=e,r=t,i=y(``),a=()=>{let e=n.count;try{n.count=e+1}catch{}i.value=n.count===e?`실패 — 값은 그대로 ${n.count} 입니다. (콘솔 경고 확인)`:`어라, 바뀌었습니다: ${n.count}`},o=()=>{r(`increase`),i.value=`성공 — 부모가 값을 바꿔 주었습니다.`};return(t,n)=>(s(),k(`div`,Vn,[n[1]||=M(`p`,{class:`node-role`},`자식 (Child)`,-1),M(`p`,Hn,[n[0]||=M(`span`,{class:`key`},`props.count`,-1),M(`span`,Un,A(e.count),1)]),M(`div`,{class:`buttons`},[M(`button`,{class:`bad`,onClick:a},`❌ 직접 바꾸기 (props.count++)`),M(`button`,{class:`good`,onClick:o},`✅ 부모에게 요청 (emit)`)]),i.value?(s(),k(`p`,{key:0,class:h([`result`,{fail:i.value.startsWith(`실패`)}])},A(i.value),3)):x(``,!0)]))}},[[`__scopeId`,`data-v-d711a9c2`]]),Gn=e({default:()=>Xn}),Kn={class:`practice-card`},qn={class:`parent`},Jn={class:`field`},Yn={class:`val`},Xn=K({__name:`PropsReadonlyPractice`,setup(e){let t=y(0),n=()=>{t.value++};return(e,r)=>(s(),k(`section`,Kn,[M(`h2`,null,[r[0]||=g(` Props는 읽기 전용 — 값의 주인은 부모다 `,-1),N(J,{text:`자식이 받은 Props를 직접 바꾸면 Vue가 막습니다. 값이 어디서 바뀌었는지 추적할 수 없게 되기 때문입니다. 자식은 '바꿔 달라'고 요청(emit)하고, 실제로 바꾸는 것은 값을 가진 부모입니다.`})]),M(`div`,qn,[r[2]||=M(`p`,{class:`node-role`},`부모 (Parent) — 값의 주인`,-1),M(`p`,Jn,[r[1]||=M(`span`,{class:`key`},`count`,-1),M(`span`,Yn,A(t.value),1)]),N(Wn,{count:t.value,onIncrease:n},null,8,[`count`])]),r[3]||=M(`p`,{class:`hint`},[g(` 브라우저 콘솔(F12)을 열고 ❌ 버튼을 누르면 `),M(`code`,null,`Set operation on key "count" failed: target is readonly`),g(` 경고가 찍힙니다. `)],-1)]))}},[[`__scopeId`,`data-v-24c24705`]]),Zn={class:`named`},Qn={class:`value`},$n=K({__name:`DrillLeaf`,props:{theme:{type:String,required:!0}},setup(e){return(t,n)=>(s(),k(`div`,{class:h([`level`,e.theme])},[n[1]||=M(`p`,{class:`role`},`자식 (Child)`,-1),M(`p`,Zn,[n[0]||=M(`span`,{class:`name`},`props.theme :`,-1),M(`span`,Qn,A(e.theme),1)])],2))}},[[`__scopeId`,`data-v-54c3d013`]]),er={class:`data`},tr=K({__name:`DrillMid`,props:{theme:{type:String,required:!0}},setup(e){let t=e,n=y(!1);return u(()=>t.theme,()=>{n.value=!0,setTimeout(()=>n.value=!1,900)}),(t,r)=>(s(),k(`div`,{class:h([`level`,{passing:n.value}])},[r[1]||=M(`p`,{class:`role`},`부모 (Parent)`,-1),M(`p`,{class:h([`hold`,{passing:n.value}])},[r[0]||=M(`span`,{class:`name`},`props.theme :`,-1),M(`span`,er,A(e.theme),1)],2),r[2]||=M(`p`,{class:`desc`},`😩 쓰지도 않는 값을 받아서 아래로 넘긴다`,-1),N($n,{theme:e.theme},null,8,[`theme`])],2))}},[[`__scopeId`,`data-v-803c609f`]]),nr={class:`named`},rr={class:`value`},ir=K({__name:`InjectLeaf`,setup(e){let t=f(`globalTheme`,`(주입된 값 없음)`);return(e,n)=>(s(),k(`div`,{class:h([`level`,_(t)])},[n[1]||=M(`p`,{class:`role`},`자식 (Child)`,-1),M(`p`,nr,[n[0]||=M(`span`,{class:`name`},`inject('globalTheme') :`,-1),M(`span`,rr,A(_(t)),1)])],2))}},[[`__scopeId`,`data-v-79d6cd3e`]]),ar={class:`level`},or=K({__name:`InjectMid`,setup(e){return(e,t)=>(s(),k(`div`,ar,[t[0]||=S(`<p class="role" data-v-c476208c>부모 (Parent)</p><p class="hold" data-v-c476208c><span class="name" data-v-c476208c>props :</span><span class="none" data-v-c476208c>없음 (0개)</span></p><p class="desc" data-v-c476208c>😌 값이 지나가는지도 모른다. 조용하다.</p>`,3),N(ir)]))}},[[`__scopeId`,`data-v-c476208c`]]),sr=e({default:()=>hr}),cr={class:`practice-card`},lr={class:`root`},ur={class:`field`},dr={class:`val`},fr={class:`compare`},pr={class:`col`},mr={class:`col`},hr=K({__name:`ProvideInjectPractice`,setup(e){let t=y(`dark-mode`);d(`globalTheme`,t);let n=()=>{t.value=t.value===`dark-mode`?`light-mode`:`dark-mode`};return(e,r)=>(s(),k(`section`,cr,[M(`h2`,null,[r[0]||=g(` Provide & Inject — 중간을 건너뛰고 전달하기 `,-1),N(J,{text:`계층이 깊어지면 중간 컴포넌트들이 자기는 쓰지도 않는 값을 받아서 아래로 넘기기만 하는 일이 생깁니다(Props Drilling). provide/inject는 그 중간을 건너뛰고 조상이 선언한 값을 후손이 직접 꺼내 쓰게 해 줍니다.`})]),M(`div`,lr,[r[6]||=M(`p`,{class:`root-role`},`조부모 (GrandParent) — 값의 주인`,-1),M(`p`,ur,[r[1]||=M(`span`,{class:`key`},`themeColor :`,-1),M(`span`,dr,A(t.value),1),M(`button`,{onClick:n},`테마 바꾸기`)]),M(`div`,fr,[M(`div`,pr,[r[2]||=M(`p`,{class:`col-title bad`},`A · Props Drilling`,-1),r[3]||=M(`p`,{class:`col-desc`},[g(`값이 `),M(`b`,null,`중간을 통과해`),g(` 내려갑니다.`)],-1),N(tr,{theme:t.value},null,8,[`theme`])]),M(`div`,mr,[r[4]||=M(`p`,{class:`col-title good`},`B · Provide / Inject`,-1),r[5]||=M(`p`,{class:`col-desc`},[g(`값이 `),M(`b`,null,`중간을 건너뛰고`),g(` 바로 갑니다.`)],-1),N(or)])])]),r[7]||=M(`p`,{class:`footnote`},[g(` 버튼을 누를 때 `),M(`b`,null,`A의 중간 카드만 번쩍이는지`),g(` 보세요. 값이 그곳을 지나간다는 뜻입니다. 여기는 조부모 → 부모 → 자식 3단계라 차이가 작아 보이지만, 10단계쯤 되면 A는 중간 8곳을 전부 고쳐야 합니다. `)],-1)]))}},[[`__scopeId`,`data-v-8bf7e4c2`]]),gr={class:`sibling`},_r={class:`buttons`},vr=[`onClick`],yr=K({__name:`SiblingA`,emits:[`send`],setup(e,{emit:t}){let n=t,r=[`안녕!`,`점심 먹었어?`,`과제 다 했어?`];return(e,t)=>(s(),k(`div`,gr,[t[0]||=M(`p`,{class:`node-role`},`형제 A (보내는 쪽)`,-1),t[1]||=M(`p`,{class:`desc`},`누르면 부모에게 올려보냅니다(emit).`,-1),M(`div`,_r,[(s(),k(C,null,P(r,e=>M(`button`,{key:e,onClick:t=>n(`send`,e)},A(e),9,vr)),64))])]))}},[[`__scopeId`,`data-v-6a5f088d`]]),br={class:`sibling`},xr=K({__name:`SiblingB`,props:{received:{type:String,default:``}},setup(e){return(t,n)=>(s(),k(`div`,br,[n[0]||=M(`p`,{class:`node-role`},`형제 B (받는 쪽)`,-1),n[1]||=M(`p`,{class:`desc`},`부모가 내려준 값(props)만 볼 수 있습니다.`,-1),M(`p`,{class:h([`bubble`,{empty:!e.received}])},A(e.received||`아직 받은 말이 없습니다`),3)]))}},[[`__scopeId`,`data-v-c96b2e77`]]),Sr=e({default:()=>Dr}),Cr={class:`practice-card`},wr={class:`parent`},Tr={class:`route`},Er={class:`siblings`},Dr=K({__name:`SiblingTalkPractice`,setup(e){let t=y(``),n=y(0),r=e=>{n.value=1,setTimeout(()=>{t.value=e,n.value=2,setTimeout(()=>n.value=0,900)},450)};return(e,i)=>(s(),k(`section`,Cr,[M(`h2`,null,[i[0]||=g(` 형제끼리는 부모를 거쳐야 한다 `,-1),N(J,{text:`같은 부모 아래 나란히 있는 컴포넌트끼리는 직접 연결된 선이 없습니다. A가 B에게 말하려면 반드시 부모에게 올렸다가(emit) 부모가 다시 B에게 내려줘야(props) 합니다. 부모를 거치는 이 경로가 눈에 보이도록 만들었습니다.`})]),M(`div`,wr,[i[2]||=M(`p`,{class:`node-role`},`부모 (Parent) — 중계자`,-1),M(`div`,Tr,[M(`span`,{class:h([`leg up`,{on:n.value>=1}])},`① A → 부모 \xA0emit`,2),M(`span`,{class:h([`leg down`,{on:n.value>=2}])},`② 부모 → B \xA0props`,2)]),M(`div`,Er,[N(yr,{onSend:r}),i[1]||=M(`span`,{class:`cut`,"aria-hidden":`true`},`✕ 직접 연결 없음`,-1),N(xr,{received:t.value},null,8,[`received`])])])]))}},[[`__scopeId`,`data-v-9ac8d55d`]]),Or={class:`base-card`},kr={class:`slot-zone head`},Ar={class:`slot-zone body`},jr={class:`slot-zone foot`},X=K({__name:`SlotBaseCard`,setup(e){return(e,t)=>(s(),k(`div`,Or,[M(`div`,kr,[n(e.$slots,`header`,{},()=>[t[0]||=M(`span`,{class:`fallback`},`header 구멍 (비어 있음)`,-1)],!0)]),M(`div`,Ar,[n(e.$slots,`default`,{},()=>[t[1]||=M(`span`,{class:`fallback`},`기본 구멍 (비어 있음)`,-1)],!0)]),M(`div`,jr,[n(e.$slots,`footer`,{},()=>[t[2]||=M(`span`,{class:`fallback`},`footer 구멍 (비어 있음)`,-1)],!0)])]))}},[[`__scopeId`,`data-v-fa66589e`]]),Mr=e({default:()=>Rr}),Nr={class:`practice-card`},Pr={class:`deck`},Fr={class:`case`},Ir={class:`case`},Lr={class:`case`},Rr=K({__name:`SlotBaseCardPractice`,setup(e){return(e,t)=>(s(),k(`section`,Nr,[M(`h2`,null,[t[0]||=g(` 더해보기 ① BaseCard 하나로 화면 3개 `,-1),N(J,{text:`아래 세 카드는 전부 같은 SlotBaseCard.vue 파일입니다. 테두리·모서리·구분선이 똑같은 이유죠. 다른 것은 부모가 header·body·footer 세 구멍에 무엇을 넣었는지뿐입니다. 껍데기를 한 번만 만들어 두고 화면마다 알맹이만 갈아 끼우는 것이 Slot의 목적입니다.`})]),t[9]||=M(`p`,{class:`explain`},[g(` 세 카드 모두 `),M(`b`,null,`같은 파일`),g(`입니다. 껍데기를 고치고 싶으면 `),M(`code`,null,`SlotBaseCard.vue`),g(` 한 곳만 고치면 세 개가 동시에 바뀝니다. `)],-1),M(`div`,Pr,[M(`div`,Fr,[t[4]||=M(`p`,{class:`case-label`},`구멍 3개 모두 채움`,-1),N(X,null,{header:b(()=>[...t[1]||=[M(`b`,null,`주간 리포트`,-1)]]),footer:b(()=>[...t[2]||=[M(`button`,{type:`button`},`자세히`,-1)]]),default:b(()=>[t[3]||=M(`p`,{class:`line`},`이번 주 방문자가 12% 늘었습니다.`,-1)]),_:1})]),M(`div`,Ir,[t[7]||=M(`p`,{class:`case-label`},`footer만 비움`,-1),N(X,null,{header:b(()=>[...t[5]||=[M(`b`,null,`공지`,-1)]]),default:b(()=>[t[6]||=M(`p`,{class:`line`},`금요일 18시에 배포가 있습니다.`,-1)]),_:1})]),M(`div`,Lr,[t[8]||=M(`p`,{class:`case-label`},`아무것도 안 채움`,-1),N(X)])]),t[10]||=S(`<div class="verdict" data-v-1f455799><p class="verdict-title" data-v-1f455799>그럼 Props로 하면 안 되나?</p><div class="verdict-grid" data-v-1f455799><div class="side bad" data-v-1f455799><p class="side-head" data-v-1f455799>❌ Props로 시도</p><pre data-v-1f455799><code data-v-1f455799>&lt;BaseCard title=&quot;주간 리포트&quot; /&gt;</code></pre><p class="side-why" data-v-1f455799> 제목 <b data-v-1f455799>글자</b>는 넘길 수 있습니다. 그런데 위 첫 카드의 footer에는 <b data-v-1f455799>&lt;button&gt; 태그</b>가 들어 있습니다. Props로 버튼을 넘기려면 문자열로 <code data-v-1f455799>&quot;&lt;button&gt;&quot;</code>을 보내야 하는데, 그건 화면이 아니라 그냥 글자입니다. </p></div><div class="side good" data-v-1f455799><p class="side-head" data-v-1f455799>✅ Slot이어야만 하는 이유</p><pre data-v-1f455799><code data-v-1f455799>&lt;template #footer&gt;
  &lt;button @click=&quot;...&quot;&gt;자세히&lt;/button&gt;
&lt;/template&gt;</code></pre><p class="side-why" data-v-1f455799><b data-v-1f455799>태그·이벤트·컴포넌트</b>가 통째로 들어갑니다. 넘기는 것이 값이 아니라 화면 조각이기 때문입니다. <b data-v-1f455799>버튼 하나만 들어가도 Props로는 안 됩니다.</b></p></div></div></div>`,1)]))}},[[`__scopeId`,`data-v-1f455799`]]),zr={class:`list`},Br={class:`fallback`},Z=K({__name:`SlotItemList`,setup(e){let t=y([{id:1,name:`노트북 거치대`,price:32e3,stock:12},{id:2,name:`기계식 키보드`,price:89e3,stock:0},{id:3,name:`USB-C 허브`,price:45e3,stock:3}]);return(e,r)=>(s(),k(`ul`,zr,[(s(!0),k(C,null,P(t.value,t=>(s(),k(`li`,{key:t.id},[n(e.$slots,`default`,{item:t},()=>[M(`span`,Br,A(t.name)+` (부모가 그리는 방법을 정하지 않음)`,1)],!0)]))),128))]))}},[[`__scopeId`,`data-v-5164d7f2`]]),Vr=e({default:()=>ei}),Hr={class:`practice-card`},Ur={class:`views`},Wr={class:`view`},Gr={class:`plain`},Kr={class:`view`},qr={class:`row`},Jr={class:`price`},Yr={class:`view`},Xr={class:`row`},Zr={key:0,class:`badge sold`},Qr={key:1,class:`badge low`},$r={key:2,class:`badge ok`},ei=K({__name:`SlotListPractice`,setup(e){let t=e=>e.toLocaleString(`ko-KR`)+`원`;return(e,n)=>(s(),k(`section`,Hr,[M(`h2`,null,[n[0]||=g(` 더해보기 ② 같은 목록, 부모가 정하는 세 가지 모습 `,-1),N(J,{text:`목록 컴포넌트는 '무엇을 반복할지'(데이터와 v-for)만 책임지고, '각 항목을 어떻게 그릴지'는 부모에게 맡깁니다. 아래 세 목록은 전부 같은 SlotItemList.vue이고 데이터도 완전히 같습니다. 부모가 v-slot으로 받은 item을 다르게 그렸을 뿐입니다.`})]),n[4]||=M(`p`,{class:`explain`},[g(` 세 목록 모두 `),M(`b`,null,`같은 컴포넌트 · 같은 데이터`),g(`입니다. 데이터는 `),M(`code`,null,`SlotItemList.vue`),g(` 안에만 있고, 부모는 그리는 방법만 정합니다. `)],-1),M(`div`,Ur,[M(`div`,Wr,[n[1]||=M(`p`,{class:`view-label`},`A · 이름만`,-1),N(Z,null,{default:b(({item:e})=>[M(`span`,Gr,A(e.name),1)]),_:1})]),M(`div`,Kr,[n[2]||=M(`p`,{class:`view-label`},`B · 가격 강조`,-1),N(Z,null,{default:b(({item:e})=>[M(`div`,qr,[M(`span`,null,A(e.name),1),M(`b`,Jr,A(t(e.price)),1)])]),_:1})]),M(`div`,Yr,[n[3]||=M(`p`,{class:`view-label`},`C · 재고 상태`,-1),N(Z,null,{default:b(({item:e})=>[M(`div`,Xr,[M(`span`,{class:h({out:e.stock===0})},A(e.name),3),e.stock===0?(s(),k(`span`,Zr,`품절`)):e.stock<5?(s(),k(`span`,Qr,A(e.stock)+`개 남음`,1)):(s(),k(`span`,$r,`재고 충분`))])]),_:1})])]),n[5]||=M(`p`,{class:`note`},[g(` C의 `),M(`b`,null,`품절 · 임박`),g(` 판단은 목록 컴포넌트가 아니라 `),M(`b`,null,`부모`),g(`가 했습니다. 목록은 `),M(`code`,null,`stock`),g(`이 무슨 뜻인지조차 모릅니다. 그래서 같은 목록을 쇼핑몰에도, 관리자 페이지에도 쓸 수 있습니다. `)],-1)]))}},[[`__scopeId`,`data-v-94406ce4`]]),ti={class:`modal`,role:`dialog`,"aria-modal":`true`},ni={class:`modal-head`},ri={class:`modal-body`},ii={class:`modal-foot`},ai=K({__name:`SlotModal`,props:{open:{type:Boolean,default:!1}},emits:[`close`],setup(e,{emit:t}){let r=t;return(t,i)=>e.open?(s(),k(`div`,{key:0,class:`backdrop`,onClick:i[2]||=L(e=>r(`close`),[`self`])},[M(`div`,ti,[M(`header`,ni,[n(t.$slots,`title`,{},()=>[i[3]||=M(`b`,null,`제목 없음`,-1)],!0),M(`button`,{type:`button`,class:`close`,"aria-label":`닫기`,onClick:i[0]||=e=>r(`close`)},`✕`)]),M(`div`,ri,[n(t.$slots,`default`,{},()=>[i[4]||=M(`p`,{class:`fallback`},`본문 구멍 (비어 있음)`,-1)],!0)]),M(`footer`,ii,[n(t.$slots,`actions`,{},()=>[M(`button`,{type:`button`,onClick:i[1]||=e=>r(`close`)},`닫기`)],!0)])])])):x(``,!0)}},[[`__scopeId`,`data-v-4b2f4b14`]]),oi=e({default:()=>fi}),si={class:`practice-card`},ci={class:`stage`},li={class:`buttons`},ui={key:0,class:`result`},di={key:1,class:`hint`},fi=K({__name:`SlotModalPractice`,setup(e){let t=y(!1),n=y(!1),r=y(``),i=()=>{r.value=`삭제했습니다.`,t.value=!1};return(e,a)=>(s(),k(`section`,si,[M(`h2`,null,[a[5]||=g(` 더해보기 ③ 모달 하나로 창 두 개 `,-1),N(J,{text:`모달 껍데기(어둡게 덮기·가운데 띄우기·닫기)는 어느 창이든 똑같습니다. 다른 건 제목·내용·버튼뿐이죠. 그래서 그 세 곳만 Named Slot으로 열어 두면, 모달 파일 하나로 확인창·안내창·입력창을 전부 만들 수 있습니다.`})]),a[11]||=M(`p`,{class:`explain`},[g(` 아래 두 버튼은 `),M(`b`,null,`같은 SlotModal.vue`),g(`를 엽니다. 껍데기는 같고 `),M(`code`,null,`#title`),g(` · 본문 · `),M(`code`,null,`#actions`),g(` 세 구멍만 다릅니다. `)],-1),M(`div`,ci,[M(`div`,li,[M(`button`,{type:`button`,onClick:a[0]||=e=>t.value=!0},`삭제 확인창 열기`),M(`button`,{type:`button`,onClick:a[1]||=e=>n.value=!0},`안내창 열기`)]),r.value?(s(),k(`p`,ui,A(r.value),1)):x(``,!0),!t.value&&!n.value?(s(),k(`p`,di,[...a[6]||=[g(` 위 버튼을 눌러 보세요. 모달은 `,-1),M(`b`,null,`이 점선 안에서만`,-1),g(` 열립니다. `,-1)]])):x(``,!0),N(ai,{open:t.value,onClose:a[3]||=e=>t.value=!1},{title:b(()=>[...a[7]||=[M(`b`,null,`정말 삭제할까요?`,-1)]]),actions:b(()=>[M(`button`,{type:`button`,onClick:a[2]||=e=>t.value=!1},`취소`),M(`button`,{type:`button`,class:`danger`,onClick:i},`삭제`)]),default:b(()=>[a[8]||=M(`p`,null,`삭제한 항목은 되돌릴 수 없습니다.`,-1)]),_:1},8,[`open`]),N(ai,{open:n.value,onClose:a[4]||=e=>n.value=!1},{title:b(()=>[...a[9]||=[M(`b`,null,`배포 안내`,-1)]]),default:b(()=>[a[10]||=M(`p`,null,`금요일 18시에 서비스가 잠시 중단됩니다.`,-1)]),_:1},8,[`open`])]),a[12]||=M(`p`,{class:`note`},[g(` 안내창은 `),M(`code`,null,`#actions`),g(`를 `),M(`b`,null,`채우지 않았습니다`),g(`. 그래서 SlotModal이 준비해 둔 기본 `),M(`b`,null,`닫기`),g(` 버튼 하나만 나옵니다. 구멍마다 기본값을 넣어 두면 부모가 매번 다 채우지 않아도 됩니다. `)],-1)]))}},[[`__scopeId`,`data-v-c7612aa2`]]),pi={},mi={class:`base-card`};function hi(e,t){return s(),k(`div`,mi,[n(e.$slots,`default`,{},()=>[t[0]||=M(`p`,null,`기본 콘텐츠 영역입니다.`,-1)],!0)])}var Q=K(pi,[[`render`,hi],[`__scopeId`,`data-v-187523ed`]]),gi={},_i={class:`base-card`};function vi(e,t){return s(),k(`div`,_i,[M(`header`,null,[n(e.$slots,`header`,{},void 0,!0)]),M(`main`,null,[n(e.$slots,`default`,{},void 0,!0)])])}var yi=K(gi,[[`render`,vi],[`__scopeId`,`data-v-f11484c5`]]),bi={class:`base-card`},xi=K({__name:`SlotScopedChild`,setup(e){let t=y(`현재 서버 상태 정상`),r=y(150);return(e,i)=>(s(),k(`div`,bi,[i[1]||=M(`p`,{class:`role`},`하위 컴포넌트 (Child)`,-1),n(e.$slots,`default`,{text:t.value,count:r.value},()=>[i[0]||=M(`p`,null,`부모가 마크업을 주입하지 않았을 때의 디폴트 화면`,-1)],!0)]))}},[[`__scopeId`,`data-v-54665344`]]),Si=e({default:()=>Oi}),Ci={class:`practice-card`},wi={class:`practice-area`},Ti={class:`practice-area`},Ei={class:`practice-area`},Di={class:`display-panel`},Oi=K({__name:`SlotPractice`,setup(e){return(e,t)=>(s(),k(`section`,Ci,[M(`h2`,null,[t[0]||=g(` Slot — 껍데기는 두고 알맹이만 갈아 끼우기 `,-1),N(J,{text:`Props가 '값'을 넘기는 것이라면 Slot은 '화면 조각(HTML)'을 통째로 넘기는 것입니다. 액자를 하나 만들어 두고 사진만 바꿔 끼우는 셈이라, 카드·모달·레이아웃처럼 껍데기는 같고 안쪽만 다른 UI에 씁니다.`})]),M(`div`,wi,[t[3]||=M(`h3`,null,`1) Default Slot — 이름 없는 구멍 하나`,-1),t[4]||=M(`p`,{class:`explain`},[g(` 같은 `),M(`b`,null,`SlotDefaultChild`),g(` 카드에 서로 다른 내용을 넣었습니다. 마지막 카드는 아무것도 안 넣어서 `),M(`b`,null,`기본값`),g(`이 나옵니다. `)],-1),N(Q,null,{default:b(()=>[...t[1]||=[M(`p`,null,`단순한 텍스트 문장을 주입합니다.`,-1)]]),_:1}),N(Q,null,{default:b(()=>[...t[2]||=[M(`h4`,{class:`warn`},`🔥 경고 상태`,-1),M(`button`,null,`확인`,-1)]]),_:1}),N(Q)]),M(`div`,Ti,[t[7]||=M(`h3`,null,`2) Named Slot — 구멍에 이름을 붙여 여러 개`,-1),t[8]||=M(`p`,{class:`explain`},[M(`b`,null,`#header`),g(` 자리와 이름 없는 `),M(`b`,null,`본문`),g(` 자리에 각각 다른 내용을 넣습니다. `)],-1),N(yi,null,{header:b(()=>[...t[5]||=[M(`h4`,null,`Child 주입 제목`,-1)]]),default:b(()=>[t[6]||=M(`p`,null,` "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt..." `,-1)]),_:1})]),M(`div`,Ei,[t[9]||=M(`h3`,null,`3) Scoped Slot — 자식의 데이터를 부모가 받아 쓴다`,-1),t[10]||=M(`p`,{class:`explain`},[g(` 아래 값은 `),M(`b`,null,`자식이 가진 데이터`),g(`인데, 화면에 어떻게 그릴지는 `),M(`b`,null,`부모가`),g(` 정합니다. `)],-1),N(xi,null,{default:b(e=>[M(`div`,Di,[M(`p`,null,`알림 메시지: `+A(e.text),1),M(`p`,null,`접속자 수: `+A(e.count)+`명`,1)])]),_:1}),N(xi)])]))}},[[`__scopeId`,`data-v-4d263364`]]),ki=e({default:()=>ji}),Ai={class:`practice-card`},ji=K({__name:`ComputedCachePractice`,setup(e){let t=y(0),n=y(0),r=()=>(console.log(`❌ 일반 함수 실행됨!`),t.value*2),i=T(()=>(console.log(`✅ Computed 연산 실행됨!`),t.value*2));return(e,a)=>(s(),k(`section`,Ai,[M(`h2`,null,[a[2]||=g(` computed() 캐싱 동작 비교 `,-1),N(J,{text:`computed는 의존하는 값이 바뀔 때만 다시 계산하고 결과를 캐싱합니다. 일반 함수는 화면이 다시 그려질 때마다 무조건 재실행됩니다. dummy 버튼을 눌러 콘솔 출력 차이를 확인해 보세요.`})]),M(`p`,null,`count: `+A(t.value)+` | dummy: `+A(n.value),1),M(`button`,{onClick:a[0]||=e=>t.value++},`count 증가 (의존성 변경)`),M(`button`,{onClick:a[1]||=e=>n.value++},`dummy 증가 (무관한 변경)`),M(`p`,null,`일반 함수 결과: `+A(r()),1),M(`p`,null,`Computed 결과: `+A(i.value),1),a[3]||=M(`p`,{class:`console-hint`},[g(` 브라우저 콘솔(F12)을 열고 `),M(`b`,null,`dummy 증가`),g(`를 눌러보세요. 일반 함수만 계속 실행되고 computed는 조용합니다. `)],-1)]))}},[[`__scopeId`,`data-v-5263d813`]]),Mi=e({default:()=>Li}),Ni={class:`practice-card`},Pi={class:`practice-area`},Fi={class:`monitor`},Ii={class:`monitor target`},Li=K({__name:`DeepWatchPractice`,setup(e){let t=y({name:`홍길동`,age:20}),n=y(`아직 반응 없음`),r=y(`아직 반응 없음`);return u(t,e=>{n.value=`[deep 감지] 누군가 변경됨! 현재 이름: ${e.name}, 나이: ${e.age}`},{deep:!0}),u(()=>t.value.age,(e,t)=>{r.value=`[타겟 감지] 나이가 ${t}세 ➡️ ${e}세로 변경됨!`}),(e,i)=>(s(),k(`section`,Ni,[M(`h2`,null,[i[2]||=g(` ref 객체 감시 — Deep Watch `,-1),N(J,{text:`ref에 객체를 담고 watch(user, ...)만 쓰면 속성 변경을 감지하지 못합니다. 객체 자체(참조)가 바뀐 게 아니기 때문입니다. deep: true로 내부 전체를 감시하거나, 화살표 함수로 특정 속성만 콕 집어 감시해야 합니다.`})]),M(`div`,Pi,[i[3]||=M(`h3`,null,`👨‍💻 회원 데이터 조작 panel`,-1),M(`p`,null,`이름: `+A(t.value.name)+` / 나이: `+A(t.value.age)+`세`,1),M(`button`,{onClick:i[0]||=e=>t.value.name=`이순신`},`이름만 변경`),M(`button`,{onClick:i[1]||=e=>t.value.age++},`나이만 변경 (age++)`)]),M(`div`,Fi,[i[4]||=M(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) deep: true 모니터 (전체 감시)`,-1),M(`p`,null,A(n.value),1)]),M(`div`,Ii,[i[5]||=M(`p`,{class:`monitor-title`},`🎯 2) 화살표 함수 모니터 (나이만 타겟 감시)`,-1),M(`p`,null,A(r.value),1)])]))}},[[`__scopeId`,`data-v-485827f2`]]),Ri=e({default:()=>qi}),zi={class:`practice-card`},Bi={class:`compare`},Vi={class:`side`},Hi={class:`check`},Ui={class:`side highlight`},Wi={class:`check`},Gi={class:`live`},Ki={key:0,class:`submitted`},qi=K({__name:`FormStatePractice`,setup(e){let t=y(``),n=y(``),r=y(``),i=y(!1),a=()=>{t.value=``,n.value=``,r.value=``,i.value=!1},o=()=>JSON.stringify({name:t.value,email:n.value,age:r.value,agree:i.value},null,1),c={name:``,email:``,age:``,agree:!1},l=E({...c}),u=()=>{Object.assign(l,c)},d=()=>JSON.stringify(l,null,1),f=y(``),p=()=>{f.value=`[ref 방식] ${o()}`},m=()=>{f.value=`[reactive 방식] ${d()}`};return(e,c)=>(s(),k(`section`,zi,[M(`h2`,null,[c[8]||=g(` 폼 상태 관리 — ref 여러 개 vs reactive 하나 `,-1),N(J,{text:`reactive의 장점은 '관련 있는 값을 한 덩어리로 다룰 수 있다'는 점입니다. 초기화·전송·전달을 객체 단위로 처리할 수 있어 필드가 많아질수록 코드가 짧아집니다. 대신 통째로 재할당하면 반응성이 끊기고, 원시값에는 쓸 수 없습니다.`})]),M(`div`,Bi,[M(`div`,Vi,[c[13]||=M(`h3`,null,`A. ref 4개`,-1),M(`label`,null,[c[9]||=g(`이름 `,-1),j(M(`input`,{"onUpdate:modelValue":c[0]||=e=>t.value=e,type:`text`},null,512),[[I,t.value]])]),M(`label`,null,[c[10]||=g(`이메일 `,-1),j(M(`input`,{"onUpdate:modelValue":c[1]||=e=>n.value=e,type:`text`},null,512),[[I,n.value]])]),M(`label`,null,[c[11]||=g(`나이 `,-1),j(M(`input`,{"onUpdate:modelValue":c[2]||=e=>r.value=e,type:`number`},null,512),[[I,r.value,void 0,{number:!0}]])]),M(`label`,Hi,[j(M(`input`,{"onUpdate:modelValue":c[3]||=e=>i.value=e,type:`checkbox`},null,512),[[F,i.value]]),c[12]||=g(` 약관 동의`,-1)]),M(`div`,{class:`buttons`},[M(`button`,{onClick:p},`전송`),M(`button`,{onClick:a},`초기화`)]),c[14]||=M(`pre`,{class:`code`},`name.value = ''
email.value = ''
age.value = ''
agree.value = false`,-1),c[15]||=M(`p`,{class:`note`},`필드가 늘면 이 줄도 같이 늘어난다`,-1)]),M(`div`,Ui,[c[20]||=M(`h3`,null,`B. reactive 1개`,-1),M(`label`,null,[c[16]||=g(`이름 `,-1),j(M(`input`,{"onUpdate:modelValue":c[4]||=e=>l.name=e,type:`text`},null,512),[[I,l.name]])]),M(`label`,null,[c[17]||=g(`이메일 `,-1),j(M(`input`,{"onUpdate:modelValue":c[5]||=e=>l.email=e,type:`text`},null,512),[[I,l.email]])]),M(`label`,null,[c[18]||=g(`나이 `,-1),j(M(`input`,{"onUpdate:modelValue":c[6]||=e=>l.age=e,type:`number`},null,512),[[I,l.age,void 0,{number:!0}]])]),M(`label`,Wi,[j(M(`input`,{"onUpdate:modelValue":c[7]||=e=>l.agree=e,type:`checkbox`},null,512),[[F,l.agree]]),c[19]||=g(` 약관 동의`,-1)]),M(`div`,{class:`buttons`},[M(`button`,{onClick:m},`전송`),M(`button`,{onClick:u},`초기화`)]),c[21]||=M(`pre`,{class:`code`},`Object.assign(form, INITIAL_FORM)`,-1),c[22]||=M(`p`,{class:`note`},`필드가 몇 개든 한 줄로 끝난다`,-1)])]),M(`div`,Gi,[M(`div`,null,[c[23]||=M(`p`,{class:`live-label`},`A · ref 4개를 손으로 조립`,-1),M(`pre`,null,A(o()),1)]),M(`div`,null,[c[24]||=M(`p`,{class:`live-label`},`B · reactive 객체를 그대로 사용`,-1),M(`pre`,null,A(d()),1)])]),f.value?(s(),k(`p`,Ki,A(f.value),1)):x(``,!0)]))}},[[`__scopeId`,`data-v-be254916`]]),Ji=e({default:()=>Qi}),Yi={class:`practice-card`},Xi={class:`practice-area`},Zi={class:`monitor`},Qi=K({__name:`MultiWatchPractice`,setup(e){let t=y(`서울`),n=y(`오늘`),r=y(`대기 중...`);return u([t,n],([e,t],[n,i])=>{r.value=`[변경 감지] ${n}(${i}) ➡️ ${e}(${t})`,console.log(`🤖 [통합 API 호출] ${e}의 ${t} 날씨를 불러옵니다...`)}),(e,i)=>(s(),k(`section`,Yi,[M(`h2`,null,[i[4]||=g(` 여러 개의 변수 동시 감시 (Multi-Source Watch) `,-1),N(J,{text:`watch의 첫 번째 인자에 배열을 넘기면 여러 값을 한 번에 감시합니다. 콜백이 받는 새 값·이전 값도 배열이며, 감시 대상을 적은 순서 그대로 매핑됩니다. 둘 중 하나만 바뀌어도 콜백이 한 번 실행됩니다.`})]),M(`div`,Xi,[i[9]||=M(`h3`,null,`날씨 조건 설정`,-1),i[10]||=M(`label`,null,`도시: `,-1),j(M(`select`,{"onUpdate:modelValue":i[0]||=e=>t.value=e},[...i[5]||=[M(`option`,{value:`서울`},`서울`,-1),M(`option`,{value:`수원`},`수원`,-1),M(`option`,{value:`부산`},`부산`,-1)]],512),[[B,t.value]]),i[11]||=M(`p`,{class:`field-label`},`날짜:`,-1),M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":i[1]||=e=>n.value=e,type:`radio`,value:`오늘`},null,512),[[z,n.value]]),i[6]||=g(` 오늘`,-1)]),M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":i[2]||=e=>n.value=e,type:`radio`,value:`내일`},null,512),[[z,n.value]]),i[7]||=g(` 내일`,-1)]),M(`label`,null,[j(M(`input`,{"onUpdate:modelValue":i[3]||=e=>n.value=e,type:`radio`,value:`주간예보`},null,512),[[z,n.value]]),i[8]||=g(` 주간예보`,-1)])]),M(`div`,Zi,[i[12]||=M(`h3`,null,`통합 모니터링 로그`,-1),M(`p`,null,`현재 상태: `+A(r.value),1)])]))}},[[`__scopeId`,`data-v-25d6c99a`]]),$i=e({default:()=>ia}),ea={class:`practice-card`},ta={class:`practice-area`},na={class:`monitor auto`},ra={class:`monitor target`},ia=K({__name:`ReactiveArrayWatchPractice`,setup(e){let t=E([`서울`,`수원`]),n=y(`대기 중...`),r=y(`대기 중...`);return u(t,(e,t)=>{n.value=`[자동 감시] 배열 변동 발생! 옛날길이인척하는:${t.length} / 현재길이:${e.length}`}),u(()=>[...t],(e,t)=>{r.value=`[스냅샷 감시] 진짜 과거 길이:${t.length} (데이터: ${t}) ➡️ 바뀐 길이:${e.length}`}),(e,i)=>(s(),k(`section`,ea,[M(`h2`,null,[i[2]||=g(` reactive() 배열 감시 — 스냅샷 기법 `,-1),N(J,{text:`배열도 객체와 같은 함정이 있습니다. 변수명을 그대로 넘기면 이전 배열과 현재 배열이 같은 것을 가리켜 비교가 불가능합니다. 스프레드로 복사본을 만들어([...cityList]) 감시하면 과거 상태가 그대로 보존됩니다.`})]),M(`div`,ta,[i[4]||=M(`h3`,null,`즐겨찾기 도시 목록 (reactive 배열)`,-1),M(`p`,null,[i[3]||=g(` 현재 등록된 도시: `,-1),M(`strong`,null,A(t),1)]),M(`button`,{onClick:i[0]||=e=>t.push(`부산`)},`부산 추가 (push)`),M(`button`,{onClick:i[1]||=e=>t.pop()},`최근 도시 삭제 (pop)`)]),M(`div`,na,[i[5]||=M(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) cityList 변수명 쌩으로 감시`,-1),M(`p`,null,A(n.value),1),i[6]||=M(`small`,null,`※ 주의: 이전 배열과 현재 배열의 내용물·길이가 똑같이 동기화되어 버립니다.`,-1)]),M(`div`,ra,[i[7]||=M(`p`,{class:`monitor-title`},`🎯 2) () => [...cityList] 복사본 감시`,-1),M(`p`,null,A(r.value),1),i[8]||=M(`small`,null,`※ 성공: 과거 배열에 들어있던 내용물이 지워지지 않고 정상 대조됩니다.`,-1)])]))}},[[`__scopeId`,`data-v-e62c5023`]]),aa=e({default:()=>ua}),oa={class:`practice-card`},sa={class:`practice-area`},ca={class:`practice-area`},la=[`onClick`],ua=K({__name:`ReactiveStatePractice`,setup(e){let t=E({name:`이순신`,age:30}),n=()=>{t.age++},r=E([`사과`,`바나나`]),i=()=>{r.push(`과일 ${r.length+1}`)},a=e=>{r.splice(e,1)};return(e,o)=>(s(),k(`section`,oa,[M(`h2`,null,[o[0]||=g(` 반응형 상태 reactive() 특징 및 주의점 `,-1),N(J,{text:`reactive()는 객체·배열 전용이며 .value 없이 바로 접근합니다. 다만 객체를 통째로 재할당(userReactive = { ... })하면 반응성이 끊기고, 원시값에는 쓸 수 없습니다. 그래서 실무는 ref()로 통일하는 추세입니다.`})]),M(`div`,sa,[o[1]||=M(`h3`,null,`1) 객체(Object) reactive`,-1),M(`p`,null,`이름: `+A(t.name)+` / 나이: `+A(t.age)+`세`,1),M(`button`,{onClick:n},`reactive 나이 한 살 추가`)]),M(`div`,ca,[o[2]||=M(`h3`,null,`2) 배열(Array) reactive`,-1),M(`ul`,null,[(s(!0),k(C,null,P(r,(e,t)=>(s(),k(`li`,{key:t},[g(A(e)+` `,1),M(`button`,{style:{"margin-left":`8px`,padding:`2px 8px`},onClick:e=>a(t)},` 삭제 `,8,la)]))),128))]),M(`button`,{onClick:i},`과일 항목 추가`)])]))}},[[`__scopeId`,`data-v-524a2c66`]]),da=e({default:()=>ga}),fa={class:`practice-card`},pa={class:`practice-area`},ma={class:`monitor auto`},ha={class:`monitor target`},ga=K({__name:`ReactiveWatchPractice`,setup(e){let t=E({productName:`노트북`,price:1e3}),n=y(`대기 중...`),r=y(`대기 중...`);return u(t,(e,t)=>{n.value=`[자동 deep] 가격 변동! 이전가격인척하는:${t.price}원 ➡️ 현재가격:${e.price}원`}),u(()=>t.price,(e,t)=>{r.value=`[타겟 조준] 가격이 진짜 올랐음! 옛날값:${t}원 ➡️ 바뀐값:${e}원`}),(e,i)=>(s(),k(`section`,fa,[M(`h2`,null,[i[1]||=g(` reactive() 데이터 watch 감시 규칙 `,-1),N(J,{text:`reactive 객체는 변수명을 그대로 넘기면 deep이 자동으로 켜져 내부 속성 변경까지 잡아냅니다. 다만 이전 값과 현재 값이 같은 객체를 가리켜서 oldVal이 쓸모없어집니다. 이전 값이 필요하면 화살표 함수로 특정 속성만 콕 집어야 합니다.`})]),M(`div`,pa,[i[2]||=M(`h3`,null,`🛒 상품 정보 관리 (reactive)`,-1),M(`p`,null,`상품명: `+A(t.productName)+` / 가격: `+A(t.price)+`원`,1),M(`button`,{onClick:i[0]||=e=>t.price+=500},`가격 500원 인상`)]),M(`div`,ma,[i[3]||=M(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) state 변수 통째로 감시 (deep 자동화)`,-1),M(`p`,null,A(n.value),1),i[4]||=M(`small`,null,`※ 주의: 이전 값과 현재 값이 똑같이 찍힌다.`,-1)]),M(`div`,ha,[i[5]||=M(`p`,{class:`monitor-title`},`🎯 2) () => state.price 콕 집어 감시 (과거 추적)`,-1),M(`p`,null,A(r.value),1),i[6]||=M(`small`,null,`※ 성공: 과거의 원본 가격이 칼같이 보존된다.`,-1)])]))}},[[`__scopeId`,`data-v-50148cb5`]]),_a=e({default:()=>Ca}),va={class:`practice-card`},ya={class:`practice-area`},ba={class:`log text`},xa={class:`practice-area`},Sa={class:`log object`},Ca=K({__name:`RefArrayWatchPractice`,setup(e){let t=y([`홍길동`,`이순신`,`강감찬`]),n=y(`대기 중...`),r=y([{name:`서울`,temp:25},{name:`수원`,temp:22}]),i=y(`대기 중...`);return u(()=>t.value[0],(e,t)=>{n.value=`[방출/영입] 0번 선수 교체: ${t} ➡️ ${e}`}),u(()=>r.value[0],e=>{i.value=`[날씨 변동] 서울의 온도가 현재 ${e.temp}°C 로 변경되었습니다.`},{deep:!0}),(e,a)=>(s(),k(`section`,va,[M(`h2`,null,[a[2]||=g(` ref 배열의 특정 인덱스 감시하기 `,-1),N(J,{text:`배열의 특정 요소만 감시하려면 화살표 함수로 콕 집어야 합니다. 다만 그 요소가 문자열이면 그대로 동작하지만, 객체라면 { deep: true }가 없으면 내부 속성 변경을 감지하지 못합니다. 가리키는 대상의 타입에 따라 규칙이 달라집니다.`})]),M(`div`,ya,[M(`h3`,null,`🏃‍♂️ 1) 문자열 배열: 현재 0번 멤버 [ `+A(t.value[0])+` ]`,1),M(`button`,{onClick:a[0]||=e=>t.value[0]=`손흥민`},`0번 멤버를 손흥민으로 교체`),M(`p`,ba,`로그: `+A(n.value),1)]),M(`div`,xa,[M(`h3`,null,`⛅ 2) 객체형 배열: 현재 `+A(r.value[0].name)+` 기온 [ `+A(r.value[0].temp)+`°C ]`,1),M(`button`,{onClick:a[1]||=e=>r.value[0].temp++},`서울 기온 1도 올리기 (temp++)`),M(`p`,Sa,`로그: `+A(i.value),1)])]))}},[[`__scopeId`,`data-v-b0ee05f5`]]),wa=e({default:()=>Ea}),Ta={class:`practice-card`},Ea={__name:`RefStatePractice`,setup(e){let t=y(0),n=y(`홍길동`),r=y(!0),i=y([`사과`,`배`]),a=y({name:`이순신`,age:30}),o=()=>{t.value++},c=()=>{a.value.name=`장보고`};return(e,l)=>(s(),k(`section`,Ta,[M(`h2`,null,[l[3]||=g(` 반응형 상태 ref() 기초 `,-1),N(J,{text:`ref()는 값을 반응형 상자에 담습니다. script에서는 .value로 상자를 열어야 하고, template에서는 자동 언래핑되어 .value 없이 씁니다. 객체나 배열을 담아도 내부 속성 변경까지 감지됩니다.`})]),M(`p`,null,[l[4]||=g(` Ref 카운트: `,-1),M(`strong`,null,A(t.value),1)]),M(`p`,null,[l[5]||=g(`이름: `,-1),j(M(`input`,{"onUpdate:modelValue":l[0]||=e=>n.value=e},null,512),[[I,n.value]]),g(A(n.value),1)]),M(`p`,null,`활성 상태: `+A(r.value?`활성`:`비활성`),1),M(`p`,null,`과일 목록: `+A(i.value.join(`, `)),1),M(`p`,null,`사용자 정보: 이름 - `+A(a.value.name)+`, 나이 - `+A(a.value.age),1),M(`button`,{onClick:o},`Ref 변수 증가`),M(`button`,{onClick:l[1]||=e=>r.value=!r.value},`토글`),M(`button`,{onClick:l[2]||=e=>i.value.push(`귤`)},`과일 추가`),M(`button`,{onClick:c},`사용자 이름 변경`)]))}},Da=e({default:()=>Ba}),Oa={class:`practice-card`},ka={class:`todo-input`},Aa=[`disabled`],ja={class:`filter`},Ma={key:0,class:`todo-list`},Na=[`checked`,`onChange`],Pa=[`onKeyup`,`onBlur`],Fa=[`onClick`],Ia=[`onClick`],La={key:1,class:`empty`},Ra={key:2,class:`empty`},za={key:3,class:`todo-foot`},Ba=K({__name:`TodoAdvancedPractice`,setup(e){let t=y([{id:1,title:`장보기`,done:!1},{id:2,title:`Vue 복습하기`,done:!0}]),n=y(``),r=3,i=()=>{let e=n.value.trim();e&&(t.value.push({id:r,title:e,done:!1}),r++,n.value=``)},a=e=>{e.done=!e.done},o=e=>{t.value=t.value.filter(t=>t.id!==e)},l=y(null),u=y(``),d=y(null),f=async e=>{l.value=e.id,u.value=e.title,await c(),d.value?.focus()},p=e=>{if(l.value===null)return;let t=u.value.trim();t&&(e.title=t),l.value=null},m=()=>{l.value=null},_=y(!1),v=T(()=>_.value?t.value.filter(e=>!e.done):t.value),b=T(()=>t.value.filter(e=>!e.done).length),S=T(()=>t.value.length-b.value);return(e,r)=>(s(),k(`section`,Oa,[M(`h2`,null,[r[3]||=g(` 할 일 목록 응용 2 — 잠금 · 수정 · 필터 `,-1),N(J,{text:`세 가지를 얹었습니다. ① :disabled로 빈 입력일 때 버튼 잠그기 ② 제목을 클릭해 인라인 수정(수정 중 상태를 ref로 관리) ③ computed로 필터와 집계를 옮기기. computed는 CC06에서 정식으로 배우지만 여기서 미리 써 봅니다.`})]),M(`div`,ka,[j(M(`input`,{"onUpdate:modelValue":r[0]||=e=>n.value=e,type:`text`,placeholder:`할 일을 입력하고 Enter`,onKeyup:V(i,[`enter`])},null,544),[[I,n.value]]),M(`button`,{disabled:!n.value.trim(),onClick:i},`추가`,8,Aa)]),M(`label`,ja,[j(M(`input`,{"onUpdate:modelValue":r[1]||=e=>_.value=e,type:`checkbox`},null,512),[[F,_.value]]),r[4]||=g(` 남은 일만 보기 `,-1)]),v.value.length?(s(),k(`ul`,Ma,[(s(!0),k(C,null,P(v.value,e=>(s(),k(`li`,{key:e.id,class:h({done:e.done})},[M(`input`,{type:`checkbox`,checked:e.done,onChange:t=>a(e)},null,40,Na),l.value===e.id?j((s(),k(`input`,{key:0,ref_for:!0,ref:e=>e&&(d.value=e),"onUpdate:modelValue":r[2]||=e=>u.value=e,class:`edit-input`,onKeyup:[V(t=>p(e),[`enter`]),V(m,[`esc`])],onBlur:t=>p(e)},null,40,Pa)),[[I,u.value]]):(s(),k(`span`,{key:1,class:`title`,title:`클릭하면 제목을 고칠 수 있습니다`,onClick:t=>f(e)},A(e.title),9,Fa)),M(`button`,{onClick:t=>o(e.id)},`삭제`,8,Ia)],2))),128))])):t.value.length?(s(),k(`p`,La,` 🎉 남은 일이 없습니다. 필터를 끄면 완료한 항목을 볼 수 있어요. `)):(s(),k(`p`,Ra,`아직 할 일이 없습니다. 위에서 하나 추가해 보세요.`)),t.value.length?(s(),k(`div`,za,[M(`span`,null,[r[5]||=g(` 전체 `,-1),M(`b`,null,A(t.value.length),1),r[6]||=g(` · 남은 일 `,-1),M(`b`,null,A(b.value),1),r[7]||=g(` · 완료 `,-1),M(`b`,null,A(S.value),1)]),r[8]||=M(`span`,{class:`hint`},`제목을 클릭 → 수정 · Enter 확정 · Esc 취소`,-1)])):x(``,!0)]))}},[[`__scopeId`,`data-v-f5c37e4e`]]),Va=e({default:()=>Xa}),Ha={class:`practice-card`},Ua={class:`todo-input`},Wa={key:0,class:`todo-list`},Ga=[`checked`,`onChange`],Ka={class:`title`},qa=[`onClick`],Ja={key:1,class:`empty`},Ya={key:2,class:`todo-foot`},Xa=K({__name:`TodoListPractice`,setup(e){let t=y([]),n=y(``),r=1,i=()=>{let e=n.value.trim();e&&(t.value.push({id:r,title:e,done:!1}),r++,n.value=``)},a=e=>{e.done=!e.done},o=e=>{t.value=t.value.filter(t=>t.id!==e)},c=()=>{t.value=t.value.filter(e=>!e.done)};return(e,r)=>(s(),k(`section`,Ha,[M(`h2`,null,[r[1]||=g(` 할 일 목록 — ref 배열 응용 `,-1),N(J,{text:`ref([])에 객체를 담아 목록을 관리하는 연습입니다. 추가는 push, 삭제는 filter로 새 배열을 만들어 교체합니다. 배열 안 객체의 속성(done)을 직접 바꿔도 ref가 변화를 감지해 화면이 갱신됩니다.`})]),M(`div`,Ua,[j(M(`input`,{"onUpdate:modelValue":r[0]||=e=>n.value=e,type:`text`,placeholder:`할 일을 입력하고 Enter`,onKeyup:V(i,[`enter`])},null,544),[[I,n.value]]),M(`button`,{onClick:i},`추가`)]),t.value.length?(s(),k(`ul`,Wa,[(s(!0),k(C,null,P(t.value,e=>(s(),k(`li`,{key:e.id,class:h({done:e.done})},[M(`input`,{type:`checkbox`,checked:e.done,onChange:t=>a(e)},null,40,Ga),M(`span`,Ka,A(e.title),1),M(`button`,{class:`remove`,onClick:t=>o(e.id)},`삭제`,8,qa)],2))),128))])):(s(),k(`p`,Ja,`아직 할 일이 없습니다. 위에서 하나 추가해 보세요.`)),t.value.length?(s(),k(`div`,Ya,[M(`span`,null,[r[2]||=g(` 전체 `,-1),M(`b`,null,A(t.value.length),1),r[3]||=g(` · 남은 일 `,-1),M(`b`,null,A(t.value.filter(e=>!e.done).length),1),r[4]||=g(` · 완료 `,-1),M(`b`,null,A(t.value.filter(e=>e.done).length),1)]),M(`button`,{onClick:c},`완료한 항목 지우기`)])):x(``,!0)]))}},[[`__scopeId`,`data-v-db2e98ce`]]),Za=e({default:()=>to}),Qa={class:`practice-card`},$a={class:`practice-area`},eo={class:`monitor`},to=K({__name:`WatchEffectPractice`,setup(e){let n=y(`홍길동`),r=y(20),i=y(`대기 중...`);return t(()=>{i.value=`[자동 감지] 이름: ${n.value} / 나이: ${r.value}세`,console.log(`🤖 watchEffect가 내부 변수 변경을 감지하여 실행되었습니다.`)}),(e,t)=>(s(),k(`section`,Qa,[M(`h2`,null,[t[2]||=g(` 자동 감시자 watchEffect() `,-1),N(J,{text:`watchEffect는 감시 대상을 적지 않습니다. 함수 안에서 읽은 반응형 값이 자동으로 의존성이 됩니다. 그리고 등록되는 즉시 한 번 실행되는 점이 watch와 가장 큰 차이입니다. 대신 이전 값은 받을 수 없습니다.`})]),M(`div`,$a,[M(`p`,null,`이름: `+A(n.value)+` / 나이: `+A(r.value)+`세`,1),M(`button`,{onClick:t[0]||=e=>n.value=`이순신`},`이름을 '이순신'으로 변경`),M(`button`,{onClick:t[1]||=e=>r.value++},`나이 한 살 추가 (age++)`)]),M(`div`,eo,[t[3]||=M(`h3`,null,`👁️‍🗨️ watchEffect 자동 모니터링 시스템`,-1),M(`p`,null,A(i.value),1),t[4]||=M(`small`,null,` ※ 새로고침하자마자 버튼을 안 눌러도 로그가 이미 찍혀있는 특징을 주목하세요! `,-1)])]))}},[[`__scopeId`,`data-v-542ebb87`]]),no=e({default:()=>oo}),ro={class:`practice-card`},io={class:`practice-area`},ao={class:`monitor`},oo=K({__name:`WatchPractice`,setup(e){let t=y(`서울`),n=y(`아직 감시 시스템이 작동하지 않았습니다.`);return u(t,(e,t)=>{n.value=`📍 감시자 발동! [${t}]에서 [${e}]로 변경됨.`,console.log(`🤖 [서버 요청 완료] 기상청 서버에서 ${e}의 날씨 API를 다시 조회합니다...`)}),(e,r)=>(s(),k(`section`,ro,[M(`h2`,null,[r[3]||=g(` 감시자 watch()의 원리와 실무 활용 `,-1),N(J,{text:`watch()는 값이 바뀌는 순간 무언가를 실행하는 감시자입니다. 콜백은 (새 값, 이전 값)을 받습니다. 화면에 보여줄 값은 computed로, API 호출·로그 같은 부수 효과는 watch로 처리합니다.`})]),M(`div`,io,[r[4]||=M(`h3`,null,`🏙️ 지역 선택 제어판`,-1),M(`p`,null,`현재 선택된 도시: `+A(t.value),1),M(`button`,{onClick:r[0]||=e=>t.value=`서울`},`서울 선택`),M(`button`,{onClick:r[1]||=e=>t.value=`수원`},`수원 선택`),M(`button`,{onClick:r[2]||=e=>t.value=`부산`},`부산 선택`)]),M(`div`,ao,[r[5]||=M(`h3`,null,`👁️‍🗨️ 파수꾼(watch) 모니터링 시스템`,-1),M(`p`,null,A(n.value),1),r[6]||=M(`small`,null,`(버튼을 누른 후 브라우저 콘솔창 F12를 확인해 보세요)`,-1)])]))}},[[`__scopeId`,`data-v-f25592fe`]]),so=e({default:()=>Do}),co={class:`practice-card`},lo={class:`area`},uo={class:`request`},fo={class:`modes`},po=[`onClick`],mo={class:`url`},ho=[`disabled`],go={class:`area`},_o={key:0,class:`panel loading`},vo={key:1,class:`panel error`},yo={class:`e-body`},bo={key:2,class:`panel ok`},xo={class:`w-city`},So={class:`w-temp`},Co={class:`w-desc`},wo={key:3,class:`panel idle`},To={key:0,class:`area`},Eo={class:`logs`},Do=K({__name:`AxiosWeatherPractice`,setup(e){let t=e=>new Promise(t=>setTimeout(t,e)),n={Seoul:{name:`서울`,temp:27.3,humidity:62,desc:`구름 조금`},Busan:{name:`부산`,temp:24.8,humidity:78,desc:`흐림`},Jeju:{name:`제주`,temp:26.1,humidity:71,desc:`가끔 비`}},r=y(`ok`),i=[{value:`ok`,label:`정상 응답`,hint:`200`},{value:`slow`,label:`느린 응답`,hint:`2.5초`},{value:`notfound`,label:`없는 도시`,hint:`404`},{value:`server`,label:`서버 오류`,hint:`500`},{value:`timeout`,label:`응답 없음`,hint:`timeout`}],a=ae.create({baseURL:`https://api.example.com/data/2.5`,timeout:2e3});a.defaults.adapter=async e=>{let i=e.params?.q??``;if(r.value===`slow`?await t(2500):await t(600),r.value===`timeout`&&await t(1e4),r.value===`server`)return Promise.reject(Object.assign(Error(`Request failed with status code 500`),{response:{status:500,data:{message:`internal server error`}},config:e}));let a=n[i];return r.value===`notfound`||!a?Promise.reject(Object.assign(Error(`Request failed with status code 404`),{response:{status:404,data:{cod:`404`,message:`city not found`}},config:e})):{status:200,statusText:`OK`,headers:{},config:e,data:{name:a.name,main:{temp:a.temp,humidity:a.humidity},weather:[{description:a.desc}]}}};let o=y(`Seoul`),c=y(null),l=y(``),u=y(!1),d=y(0),f=y([]),p=(e,t=`plain`)=>f.value.push({id:f.value.length,text:e,tone:t}),m=async()=>{u.value=!0,c.value=null,l.value=``,f.value=[],d.value=0;let e=performance.now();p(`GET /weather?q=${o.value} — 보냈다. 응답을 기다린다`,`wait`);try{let e=await a.get(`/weather`,{params:{q:o.value,units:`metric`,appid:`<API_KEY>`}});c.value={city:e.data.name,temp:e.data.main.temp,humidity:e.data.main.humidity,desc:e.data.weather[0].description},p(`${e.status} ${e.statusText} — response.data 도착`,`ok`)}catch(e){e.response?(l.value=`서버가 ${e.response.status} 로 거절했습니다.`,p(`error.response.status = ${e.response.status}`,`fail`),p(`error.response.data = ${JSON.stringify(e.response.data)}`,`fail`)):(l.value=`서버가 응답하지 않습니다. 네트워크를 확인해 주세요.`,p(`error.response 가 없다 — ${e.code??e.message}`,`fail`))}finally{u.value=!1,d.value=Math.round(performance.now()-e),p(`finally — 로딩 종료 (${d.value}ms)`,`done`)}};return(e,t)=>(s(),k(`section`,co,[M(`h2`,null,[t[1]||=g(` Axios — 서버에서 날씨 받아오기 `,-1),N(J,{text:`Axios는 브라우저에서 서버에 HTTP 요청을 보내는 라이브러리입니다. axios.get()은 Promise를 돌려주므로 await로 기다립니다. 서버가 준 값은 response가 아니라 response.data에 들어 있습니다. 2xx가 아니면 catch로 떨어지고, 서버가 답을 준 실패는 error.response에 담깁니다.`})]),t[13]||=M(`p`,{class:`lead`},[g(` 실제 OpenWeather 대신 `),M(`b`,null,`가짜 서버`),g(`를 붙였습니다. 키도 네트워크도 필요 없고, 대신 실패를 마음대로 일으켜 볼 수 있습니다. 호출하는 쪽 코드는 진짜 API 와 똑같습니다. `)],-1),M(`div`,lo,[t[5]||=M(`h3`,null,`요청`,-1),M(`div`,uo,[M(`label`,null,[t[3]||=M(`span`,{class:`lb`},`도시 (params.q)`,-1),j(M(`select`,{"onUpdate:modelValue":t[0]||=e=>o.value=e},[...t[2]||=[M(`option`,{value:`Seoul`},`Seoul`,-1),M(`option`,{value:`Busan`},`Busan`,-1),M(`option`,{value:`Jeju`},`Jeju`,-1),M(`option`,{value:`Atlantis`},`Atlantis (DB에 없음)`,-1)]],512),[[B,o.value]])]),M(`label`,null,[t[4]||=M(`span`,{class:`lb`},`서버가 이렇게 굴게`,-1),M(`div`,fo,[(s(),k(C,null,P(i,e=>M(`button`,{key:e.value,type:`button`,class:h([`mode`,{on:r.value===e.value}]),onClick:t=>r.value=e.value},[g(A(e.label)+` `,1),M(`small`,null,A(e.hint),1)],10,po)),64))])])]),M(`pre`,mo,`GET https://api.example.com/data/2.5/weather?q=`+A(o.value)+`&units=metric`,1),M(`button`,{type:`button`,class:`go`,disabled:u.value,onClick:m},A(u.value?`불러오는 중…`:`axios.get() 보내기`),9,ho)]),M(`div`,go,[t[10]||=M(`h3`,null,[g(`화면 `),M(`small`,null,`로딩 · 성공 · 실패 세 갈래를 모두 그려야 한다`)],-1),u.value?(s(),k(`div`,_o,[...t[6]||=[M(`span`,{class:`spinner`,"aria-hidden":`true`},null,-1),M(`p`,null,`불러오는 중입니다…`,-1)]])):l.value?(s(),k(`div`,vo,[t[7]||=M(`p`,{class:`e-title`},`불러오지 못했습니다`,-1),M(`p`,yo,A(l.value),1),M(`button`,{type:`button`,class:`retry`,onClick:m},`다시 시도`)])):c.value?(s(),k(`div`,bo,[M(`p`,xo,A(c.value.city),1),M(`p`,So,[g(A(c.value.temp),1),t[8]||=M(`span`,null,`℃`,-1)]),M(`p`,Co,A(c.value.desc)+` · 습도 `+A(c.value.humidity)+`%`,1)])):(s(),k(`div`,wo,[...t[9]||=[M(`p`,null,`아직 요청하지 않았습니다. 위 버튼을 눌러 보세요.`,-1)]]))]),f.value.length?(s(),k(`div`,To,[t[12]||=M(`h3`,null,`통신 기록`,-1),M(`ul`,Eo,[(s(!0),k(C,null,P(f.value,e=>(s(),k(`li`,{key:e.id,class:h(e.tone)},[t[11]||=M(`span`,{class:`dot`,"aria-hidden":`true`},null,-1),M(`span`,null,A(e.text),1)],2))),128))])])):x(``,!0)]))}},[[`__scopeId`,`data-v-038d0ac1`]]),Oo=e({default:()=>Ro}),ko={class:`practice-card`},Ao={class:`area`},jo={key:0,class:`files`},Mo={class:`f-name`},No={key:1,class:`all-gone`},Po={class:`area`},Fo={class:`dl-actions`},Io={key:0,class:`area`},Lo={class:`logs`},Ro=K({__name:`ElementConfirmPractice`,setup(e){let t=y([`월간 보고서.pdf`,`회의록.docx`,`예산안.xlsx`]),n=y(0),r=y(!1),i=null,a=y([]),o=(e,t=`plain`)=>a.value.push({id:a.value.length,text:e,tone:t}),c=e=>{ee.confirm(`'${e}' 을(를) 정말 삭제하시겠습니까?`,`삭제 확인`,{confirmButtonText:`삭제`,cancelButtonText:`취소`,type:`warning`}).then(()=>{t.value=t.value.filter(t=>t!==e),W.success(`삭제되었습니다.`),o(`then — '${e}' 삭제됨`,`ok`)}).catch(()=>{W.info(`삭제를 취소했습니다.`),o(`catch — 취소를 눌렀다`,`plain`)})},l=()=>{r.value||(r.value=!0,n.value=0,o(`setInterval 시작 — 300ms 마다 20씩`,`wait`),i=setInterval(()=>{n.value+=20,n.value>=100&&(n.value=100,clearInterval(i),i=null,r.value=!1,W.success(`다운로드가 완료되었습니다.`),o(`clearInterval — 100 도달, 타이머 정리`,`ok`))},300))},u=()=>{clearInterval(i),i=null,n.value=0,r.value=!1,t.value=[`월간 보고서.pdf`,`회의록.docx`,`예산안.xlsx`],a.value=[]};return w(()=>clearInterval(i)),(e,i)=>{let o=m(`el-button`),d=m(`el-card`),f=m(`el-progress`);return s(),k(`section`,ko,[M(`h2`,null,[i[0]||=g(` Element Plus — 삭제 확인과 진행률 `,-1),N(J,{text:`ElMessageBox.confirm()은 확인·취소 버튼이 있는 모달을 띄우고 Promise를 돌려줍니다. 확인을 누르면 then, 취소를 누르면 catch로 갑니다. el-progress는 percentage에 0~100 숫자를 주면 막대가 찹니다. setInterval로 값을 올릴 때는 100에서 clearInterval로 반드시 멈춰야 합니다.`})]),M(`div`,Ao,[i[2]||=M(`h3`,null,[g(`ElMessageBox `),M(`small`,null,`확인은 then, 취소는 catch`)],-1),N(d,{shadow:`never`},{default:b(()=>[t.value.length?(s(),k(`ul`,jo,[(s(!0),k(C,null,P(t.value,e=>(s(),k(`li`,{key:e},[M(`span`,Mo,A(e),1),N(o,{type:`danger`,size:`small`,plain:``,onClick:t=>c(e)},{default:b(()=>[...i[1]||=[g(` 삭제 `,-1)]]),_:1},8,[`onClick`])]))),128))])):(s(),k(`p`,No,`파일을 모두 지웠습니다. 아래 초기화로 되돌릴 수 있습니다.`))]),_:1}),i[3]||=M(`p`,{class:`hint-line`},[g(` 확인도 눌러 보고 `),M(`b`,null,`취소도 눌러 보세요.`),g(` 취소 쪽이 catch 로 간다는 것이 이 문법의 전부입니다. `)],-1)]),M(`div`,Po,[i[5]||=M(`h3`,null,[g(`el-progress `),M(`small`,null,`setInterval 은 반드시 멈춰야 한다`)],-1),N(d,{shadow:`never`},{default:b(()=>[N(f,{percentage:n.value,status:n.value===100?`success`:void 0,"stroke-width":14},null,8,[`percentage`,`status`]),M(`div`,Fo,[N(o,{type:`primary`,loading:r.value,onClick:l},{default:b(()=>[g(A(r.value?`다운로드 중…`:`다운로드 시작`),1)]),_:1},8,[`loading`]),N(o,{onClick:u},{default:b(()=>[...i[4]||=[g(`초기화`,-1)]]),_:1})])]),_:1})]),a.value.length?(s(),k(`div`,Io,[i[7]||=M(`h3`,null,`기록`,-1),M(`ul`,Lo,[(s(!0),k(C,null,P(a.value,e=>(s(),k(`li`,{key:e.id,class:h(e.tone)},[i[6]||=M(`span`,{class:`dot`,"aria-hidden":`true`},null,-1),M(`span`,null,A(e.text),1)],2))),128))])])):x(``,!0),i[8]||=M(`p`,{class:`note`},[M(`b`,null,`타이머는 스스로 멈추지 않습니다.`),g(` 100 에서 `),M(`code`,null,`clearInterval`),g(` 을 부르지 않으면 값이 120, 140 으로 계속 올라가고, 이 실습을 닫아도 뒤에서 계속 돕니다. 그래서 `),M(`code`,null,`onBeforeUnmount`),g(` 에서도 한 번 더 정리합니다. `)],-1)])}}},[[`__scopeId`,`data-v-80fcad8f`]]),zo=e({default:()=>Qo}),Bo={class:`practice-card`},Vo={class:`area`},Ho={class:`field`},Uo={class:`field row`},Wo={class:`state`},Go={class:`actions`},Ko={class:`area`},qo={class:`state-box`},Jo={class:`area`},Yo={key:0,class:`history`},Xo={class:`tag`},Zo={key:1,class:`hint`},Qo=K({__name:`ElementFormPractice`,setup(e){let t=E({email:``,agree:!1}),n=y([]),r=(e,t)=>n.value.unshift({id:n.value.length,type:e,text:t}),i=()=>{if(!t.email.includes(`@`)){W.error(`올바른 이메일 형식이 아닙니다.`),r(`error`,`ElMessage.error — @ 가 없다`);return}if(!t.agree){W.warning(`약관에 동의해야 가입할 수 있습니다.`),r(`warning`,`ElMessage.warning — 약관 미동의`);return}W.success(`${t.email} 님, 가입이 완료되었습니다.`),r(`success`,`ElMessage.success — 통과`)},a=()=>{t.email=``,t.agree=!1,n.value=[]};return(e,r)=>{let o=m(`el-input`),c=m(`el-switch`),l=m(`el-button`),u=m(`el-card`);return s(),k(`section`,Bo,[M(`h2`,null,[r[2]||=g(` Element Plus — 회원가입 폼 `,-1),N(J,{text:`el-input·el-switch는 템플릿에 태그로 쓰는 컴포넌트이고, ElMessage는 태그가 아니라 import해서 호출하는 함수입니다. 화면 오른쪽 위에 잠깐 떴다 사라지는 알림을 띄웁니다. success·warning·error·info 네 종류가 있습니다.`})]),M(`div`,Vo,[N(u,{shadow:`never`,class:`form-card`},{header:b(()=>[...r[3]||=[M(`span`,{class:`card-title`},`회원가입`,-1)]]),default:b(()=>[M(`div`,Ho,[r[4]||=M(`label`,{for:`ep-email`},`이메일`,-1),N(o,{id:`ep-email`,modelValue:t.email,"onUpdate:modelValue":r[0]||=e=>t.email=e,placeholder:`you@example.com`,clearable:``},null,8,[`modelValue`])]),M(`div`,Uo,[r[5]||=M(`label`,{for:`ep-agree`},`약관 동의`,-1),N(c,{id:`ep-agree`,modelValue:t.agree,"onUpdate:modelValue":r[1]||=e=>t.agree=e},null,8,[`modelValue`]),M(`span`,Wo,A(t.agree?`동의함`:`동의 안 함`),1)]),M(`div`,Go,[N(l,{type:`primary`,onClick:i},{default:b(()=>[...r[6]||=[g(`가입하기`,-1)]]),_:1}),N(l,{onClick:a},{default:b(()=>[...r[7]||=[g(`초기화`,-1)]]),_:1})])]),_:1})]),M(`div`,Ko,[r[8]||=M(`h3`,null,[g(`userForm `),M(`small`,null,`reactive 객체 안이 이렇게 바뀐다`)],-1),M(`pre`,qo,A({email:t.email,agree:t.agree}),1)]),M(`div`,Jo,[r[10]||=M(`h3`,null,[g(`알림 기록 `),M(`small`,null,`화면 알림은 3초면 사라지므로 여기 남긴다`)],-1),n.value.length?(s(),k(`ul`,Yo,[(s(!0),k(C,null,P(n.value,e=>(s(),k(`li`,{key:e.id,class:h(e.type)},[M(`span`,Xo,A(e.type),1),M(`span`,null,A(e.text),1)],2))),128))])):(s(),k(`p`,Zo,[...r[9]||=[g(` 빈 칸으로 한 번, `,-1),M(`code`,null,`@`,-1),g(` 없이 한 번, 약관을 끈 채로 한 번 — 세 갈래를 모두 눌러 보세요. `,-1)]]))]),r[11]||=M(`p`,{class:`note`},[M(`b`,null,`ElMessage 는 태그가 아닙니다.`),g(` 템플릿에 `),M(`code`,null,`<el-message />`),g(` 를 적는 것이 아니라 `),M(`code`,null,`import { ElMessage } from 'element-plus'`),g(` 로 가져와 함수처럼 호출합니다. `)],-1)])}}},[[`__scopeId`,`data-v-2fa4b6bf`]]),$o=e({default:()=>ls}),es={class:`practice-card`},ts={class:`area`},ns={class:`price`},rs={class:`field`},is={class:`field`},as={class:`total`},os={class:`area`},ss={class:`values`},cs=12500,ls=K({__name:`ElementProductPractice`,setup(e){let t=y(1),n=y(4),r=T(()=>(t.value*cs).toLocaleString()),i=[`별로예요`,`그저 그래요`,`괜찮아요`,`좋아요`,`최고예요`];return(e,a)=>{let o=m(`el-input-number`),c=m(`el-rate`),l=m(`el-card`);return s(),k(`section`,es,[M(`h2`,null,[a[2]||=g(` Element Plus — 상품 수량과 별점 `,-1),N(J,{text:`el-input-number는 숫자 전용 입력창으로 min·max·step으로 범위를 제한합니다. el-rate는 별점 컴포넌트로 show-text를 켜면 점수에 맞는 설명이 함께 나옵니다. 둘 다 v-model로 숫자를 주고받습니다.`})]),M(`div`,ts,[N(l,{shadow:`never`,class:`product-card`},{header:b(()=>[...a[3]||=[M(`span`,{class:`card-title`},`SKALA 텀블러`,-1)]]),default:b(()=>[M(`p`,ns,A(cs.toLocaleString())+`원`,1),M(`div`,rs,[a[4]||=M(`label`,null,`수량`,-1),N(o,{modelValue:t.value,"onUpdate:modelValue":a[0]||=e=>t.value=e,min:1,max:10,step:1},null,8,[`modelValue`]),a[5]||=M(`span`,{class:`limit`},`1 ~ 10개`,-1)]),M(`div`,is,[a[6]||=M(`label`,null,`별점`,-1),N(c,{modelValue:n.value,"onUpdate:modelValue":a[1]||=e=>n.value=e,"show-text":``,texts:i},null,8,[`modelValue`])]),M(`div`,as,[a[7]||=M(`span`,null,`합계`,-1),M(`b`,null,A(r.value)+`원`,1)])]),_:1})]),M(`div`,os,[a[10]||=M(`h3`,null,[g(`지금 값 `),M(`small`,null,`v-model 이 묶어 둔 반응형 상태`)],-1),M(`ul`,ss,[M(`li`,null,[a[8]||=M(`code`,null,`productQuantity`,-1),M(`b`,null,A(t.value),1)]),M(`li`,null,[a[9]||=M(`code`,null,`productRate`,-1),M(`b`,null,A(n.value),1)])])]),a[11]||=M(`p`,{class:`note`},[g(` 수량에서 `),M(`b`,null,`−`),g(` 를 계속 눌러 보세요. 1 에서 멈추고 버튼이 비활성화됩니다. `),M(`code`,null,`:min="1"`),g(` 한 줄이 하는 일입니다. 직접 만들었다면 입력값 검사·버튼 잠금·음수 방어를 전부 손으로 짜야 합니다. `)],-1)])}}},[[`__scopeId`,`data-v-6ea38ed4`]]),us=e({default:()=>Ss}),ds={class:`practice-card`},fs={class:`area`},ps={class:`run`},ms=[`disabled`],hs={class:`switch`},gs=[`disabled`],_s={class:`area`},vs={class:`pipe`},ys={key:0,class:`area`},bs={class:`logs`},xs={class:`area`},Ss=K({__name:`ModernAsyncPractice`,setup(e){let t=y(``),n=y([]),r=y(!1),i=y(!1),a=()=>new Promise(e=>setTimeout(()=>e({uid:777}),400)),o=e=>new Promise((t,n)=>setTimeout(()=>{i.value?n(Error(`프로필 서버 응답 없음`)):t({uid:e,nick:`Graves`})},400)),c=(e,t=`plain`)=>n.value.push({id:n.value.length,text:e,tone:t}),l=async()=>{r.value=!0,n.value=[],t.value=`데이터 동기화 중...`;try{c(`await fetchUserId() — 여기서 멈춰 기다린다`,`wait`);let{uid:e}=await a();c(`uid 도착: ${e}`,`ok`),c(`await fetchUserProfile(${e}) — 앞 결과를 인자로 넘겨 연쇄 호출`,`wait`);let{nick:n}=await o(e);c(`nick 도착: ${n}`,`ok`),t.value=`동기화 성공: ${n}님 환영합니다.`}catch(e){c(`catch 로 떨어짐 — ${e.message}`,`fail`),t.value=`통신 실패`}finally{r.value=!1}};return(e,a)=>(s(),k(`section`,ds,[M(`h2`,null,[a[1]||=g(` 과제 3 — 비동기 연쇄 파이프라인 (Async/Await) `,-1),N(J,{text:`async는 이 함수 안에서 비동기 처리를 하겠다는 선언이고, await는 그 작업이 끝날 때까지 다음 줄로 넘어가지 말라는 명령입니다. async 함수는 항상 Promise를 반환합니다. .then/.catch 대신 try/catch로 에러를 잡습니다.`})]),M(`div`,fs,[M(`div`,ps,[M(`button`,{type:`button`,class:`go`,disabled:r.value,onClick:l},A(r.value?`통신 중…`:`과제 3 가동`),9,ms),M(`label`,hs,[j(M(`input`,{"onUpdate:modelValue":a[0]||=e=>i.value=e,type:`checkbox`,disabled:r.value},null,8,gs),[[F,i.value]]),a[2]||=M(`span`,null,[g(`두 번째 호출을 실패시키기 `),M(`small`,null,`catch 로 가는 길 보기`)],-1)])])]),M(`div`,_s,[a[6]||=M(`h3`,null,[g(`두 번의 기다림 `),M(`small`,null,`각 400ms`)],-1),M(`div`,vs,[M(`div`,{class:h([`stage`,{done:n.value.some(e=>e.text.includes(`uid 도착`))}])},[...a[3]||=[M(`code`,null,`fetchUserId()`,-1),M(`span`,null,`{ uid: 777 }`,-1)]],2),a[5]||=M(`span`,{class:`link`,"aria-hidden":`true`},`→`,-1),M(`div`,{class:h([`stage`,{done:n.value.some(e=>e.text.includes(`nick 도착`))}])},[...a[4]||=[M(`code`,null,`fetchUserProfile(uid)`,-1),M(`span`,null,`{ uid, nick }`,-1)]],2)]),a[7]||=M(`p`,{class:`hint-line`},[g(` 앞 호출의 결과(`),M(`code`,null,`uid`),g(`)가 뒤 호출의 인자가 됩니다. 그래서 동시에 못 하고 순서대로 기다립니다. `)],-1)]),n.value.length?(s(),k(`div`,ys,[a[9]||=M(`h3`,null,`진행 기록`,-1),M(`ul`,bs,[(s(!0),k(C,null,P(n.value,e=>(s(),k(`li`,{key:e.id,class:h(e.tone)},[a[8]||=M(`span`,{class:`dot`,"aria-hidden":`true`},null,-1),M(`span`,null,A(e.text),1)],2))),128))])])):x(``,!0),M(`div`,xs,[a[10]||=M(`h3`,null,`결과창 3`,-1),M(`div`,{class:h([`console`,{empty:!t.value}])},A(t.value||`가동 버튼을 누르면 통신 결과가 여기 찍힙니다.`),3)])]))}},[[`__scopeId`,`data-v-d190aa58`]]),Cs=e({default:()=>Ls}),ws={class:`practice-card`},Ts={class:`area`},Es={class:`given`},Ds={class:`given-item`},Os={class:`chips`},ks={class:`area`},As={class:`run`},js={key:0,class:`area`},Ms={class:`steps`},Ns={class:`s-name`},Ps={class:`s-code`},Fs={class:`s-why`},Is={class:`area`},Ls=K({__name:`ModernExtractPractice`,setup(e){let t=y(``),n=y([]),r=[`김수원`,`이서울`,`박부산`,`최대전`],i={id:101,grade:`VIP`,details:{score:95}},a=()=>{let e=r.includes(`박부산`),{grade:a,details:{score:o}}=i;t.value=`부산 포함 여부: ${e} / 등급: ${a} / 점수: ${o}점`,n.value=[{label:`memberContainsPark`,code:`MEMBERS.includes('박부산')`,value:String(e),kind:`boolean`,why:`값 자체가 아니라 "있느냐"만 돌려준다. 그래서 true 다.`},{label:`grade`,code:`const { grade } = RAW_DATA`,value:`'${a}'`,kind:`string`,why:`키 이름과 변수 이름이 같아야 꺼내진다.`},{label:`score`,code:`const { details: { score } } = RAW_DATA`,value:String(o),kind:`number`,why:`콜론은 "이름 바꾸기"가 아니라 "한 겹 더 들어가기"다.`}]},o=()=>{t.value=``,n.value=[]};return(e,c)=>(s(),k(`section`,ws,[M(`h2`,null,[c[0]||=g(` 과제 1 — 데이터 추출 및 포맷팅 `,-1),N(J,{text:"구조 분해 할당은 객체나 배열에서 필요한 값만 골라 변수로 꺼내는 문법입니다. 중첩된 객체는 콜론(:)으로 한 겹 더 들어갑니다. 템플릿 리터럴은 백틱(`) 안에서 ${} 로 값을 끼워 넣어 문자열을 조립하는 문법입니다."})]),M(`div`,Ts,[c[3]||=M(`h3`,null,`주어진 재료`,-1),M(`div`,Es,[M(`div`,Ds,[c[1]||=M(`code`,{class:`g-name`},`members`,-1),M(`div`,Os,[(s(),k(C,null,P(r,e=>M(`span`,{key:e,class:h({hit:e===`박부산`})},A(e),3)),64))])]),M(`div`,{class:`given-item`},[c[2]||=M(`code`,{class:`g-name`},`rawData`,-1),M(`pre`,{class:`g-value`},A(i))])])]),M(`div`,ks,[M(`div`,As,[M(`button`,{type:`button`,class:`go`,onClick:a},`과제 1 가동`),t.value?(s(),k(`button`,{key:0,type:`button`,class:`ghost`,onClick:o},`지우기`)):x(``,!0)])]),n.value.length?(s(),k(`div`,js,[c[4]||=M(`h3`,null,[g(`꺼낸 값 `),M(`small`,null,`결과창에 들어가기 전 모습`)],-1),M(`ul`,Ms,[(s(!0),k(C,null,P(n.value,e=>(s(),k(`li`,{key:e.label},[M(`code`,Ns,A(e.label),1),M(`code`,Ps,A(e.code),1),M(`span`,{class:h([`s-value`,e.kind])},A(e.value),3),M(`span`,Fs,A(e.why),1)]))),128))])])):x(``,!0),M(`div`,Is,[c[5]||=M(`h3`,null,`결과창 1`,-1),M(`div`,{class:h([`console`,{empty:!t.value}])},A(t.value||`가동 버튼을 누르면 조립된 문자열이 여기 찍힙니다.`),3)])]))}},[[`__scopeId`,`data-v-0ded5264`]]),Rs=e({default:()=>ac}),zs={class:`practice-card`},Bs={class:`area`},Vs={class:`given`},Hs={class:`given-item`},Us={class:`chips`},Ws={class:`area`},Gs={class:`run`},Ks={key:0,class:`area`},qs={class:`carts`},Js={class:`cart`},Ys={class:`chips`},Xs={class:`cart`},Zs={class:`chips`},Qs={key:1,class:`area`},$s={class:`compare`},ec={class:`cm-label`},tc={class:`cm-cell old`},nc={class:`cm-cell now`},rc={class:`cm-why`},ic={class:`area`},ac=K({__name:`ModernImmutablePractice`,setup(e){let t=y(``),n=y([]),r=y([]),i=y([]),a=[`Apple`,`Banana`],o={name:`Orange`,stock:0,preview:null},c=()=>{let e=[...a,o.name],s=o?.preview??`이미지 준비중`,c=o.stock??0;t.value=`카트: ${e} / 이미지: ${s} / 수량: ${c}개`,r.value=[...a],i.value=e,n.value=[{label:`stock (0)`,old:o.stock||99,oldCode:`stock || 99`,now:o.stock??99,nowCode:`stock ?? 99`,why:`0 은 Falsy 라서 || 는 없는 값으로 본다. ?? 는 null·undefined 만 없는 값으로 본다.`,broken:!0},{label:`preview (null)`,old:o.preview||`이미지 준비중`,oldCode:`preview || …`,now:o.preview??`이미지 준비중`,nowCode:`preview ?? …`,why:`null 은 둘 다 없는 값으로 본다. 여기서는 결과가 같다.`,broken:!1}]},l=()=>{t.value=``,n.value=[],r.value=[],i.value=[]},u=e=>e===``?`''`:String(e);return(e,d)=>(s(),k(`section`,zs,[M(`h2`,null,[d[0]||=g(` 과제 2 — 불변성 복사 및 데이터 방어 `,-1),N(J,{text:`스프레드 연산자(...)는 배열·객체를 펼쳐 새 것을 만들어 원본을 지킵니다. 널 병합 연산자(??)는 좌항이 null이나 undefined일 때만 우항의 기본값을 씁니다. 논리합(||)과 달리 숫자 0과 빈 문자열을 값으로 인정합니다.`})]),M(`div`,Bs,[d[3]||=M(`h3`,null,`주어진 재료`,-1),M(`div`,Vs,[M(`div`,Hs,[d[1]||=M(`code`,{class:`g-name`},`currentCart`,-1),M(`div`,Us,[(s(),k(C,null,P(a,e=>M(`span`,{key:e},A(e),1)),64))])]),M(`div`,{class:`given-item`},[d[2]||=M(`code`,{class:`g-name`},`newProduct`,-1),M(`pre`,{class:`g-value`},A(o))])]),d[4]||=M(`p`,{class:`hint-line`},[M(`b`,null,`stock 이 0`),g(`이고 `),M(`b`,null,`preview 가 null`),g(`인 것이 이 과제의 함정입니다. `)],-1)]),M(`div`,Ws,[M(`div`,Gs,[M(`button`,{type:`button`,class:`go`,onClick:c},`과제 2 가동`),t.value?(s(),k(`button`,{key:0,type:`button`,class:`ghost`,onClick:l},`지우기`)):x(``,!0)])]),i.value.length?(s(),k(`div`,Ks,[d[8]||=M(`h3`,null,[g(`원본은 그대로인가 `),M(`small`,null,`스프레드가 하는 일`)],-1),M(`div`,qs,[M(`div`,Js,[d[5]||=M(`p`,{class:`c-label`},[g(`currentCart `),M(`span`,{class:`tag keep`},`원본`)],-1),M(`div`,Ys,[(s(!0),k(C,null,P(r.value,e=>(s(),k(`span`,{key:e},A(e),1))),128))])]),d[7]||=M(`span`,{class:`arrow`,"aria-hidden":`true`},`→`,-1),M(`div`,Xs,[d[6]||=M(`p`,{class:`c-label`},[g(`updatedCart `),M(`span`,{class:`tag new`},`새 배열`)],-1),M(`div`,Zs,[(s(!0),k(C,null,P(i.value,e=>(s(),k(`span`,{key:e,class:h({added:e===`Orange`})},A(e),3))),128))])])]),d[9]||=M(`p`,{class:`hint-line`},[g(` 오른쪽에 Orange 가 늘었는데 왼쪽은 두 개 그대로입니다. `),M(`code`,null,`=`),g(` 로 대입했다면 왼쪽도 같이 늘었을 것입니다. `)],-1)])):x(``,!0),n.value.length?(s(),k(`div`,Qs,[d[10]||=M(`h3`,null,[g(`|| 였다면 `),M(`small`,null,`같은 값에 두 연산자를 각각 써 본 결과`)],-1),M(`ul`,$s,[(s(!0),k(C,null,P(n.value,e=>(s(),k(`li`,{key:e.label,class:h({broken:e.broken})},[M(`span`,ec,A(e.label),1),M(`span`,tc,[M(`code`,null,A(e.oldCode),1),M(`b`,null,A(u(e.old)),1)]),M(`span`,nc,[M(`code`,null,A(e.nowCode),1),M(`b`,null,A(u(e.now)),1)]),M(`span`,rc,A(e.why),1)],2))),128))])])):x(``,!0),M(`div`,ic,[d[11]||=M(`h3`,null,`결과창 2`,-1),M(`div`,{class:h([`console`,{empty:!t.value}])},A(t.value||`가동 버튼을 누르면 조립된 문자열이 여기 찍힙니다.`),3)])]))}},[[`__scopeId`,`data-v-ce0bc34a`]]),oc=H(`counter`,()=>{let e=y(0),t=T(()=>e.value*2);function n(){e.value++}return{count:e,doubleCount:t,increment:n}}),sc={class:`panel`},cc={class:`label`},lc={class:`count`},uc={class:`double`},dc=K({__name:`StoreCounterPanel`,props:{label:{type:String,required:!0}},setup(e){let t=oc(),{count:n,doubleCount:r}=U(t);return(i,a)=>(s(),k(`div`,sc,[M(`p`,cc,A(e.label),1),M(`p`,lc,A(_(n)),1),M(`p`,uc,`doubleCount · `+A(_(r)),1),M(`button`,{type:`button`,onClick:a[0]||=e=>_(t).increment()},`increment()`)]))}},[[`__scopeId`,`data-v-492b3aa9`]]),fc=e({default:()=>wc}),pc={class:`practice-card`},mc={class:`area`},hc={class:`panels`},gc={class:`area`},_c={key:0,class:`compare`},vc={class:`cell good`},yc={class:`cell-value`},bc={class:`cell bad`},xc={class:`cell-value`},Sc={key:1,class:`controls`},Cc={key:2,class:`note warn`},wc=K({__name:`StoreCounterPractice`,setup(e){let t=oc(),{count:n}=U(t),{count:r}=t,i=()=>{t.count=0},a=y(!1);return(e,o)=>(s(),k(`section`,pc,[M(`h2`,null,[o[3]||=g(` 한 사물함을 두 컴포넌트가 함께 본다 `,-1),N(J,{text:`아래 두 패널은 부모가 값을 내려 주지 않습니다. 각자 useCounterStore()를 불러 같은 사물함을 열 뿐입니다. 한쪽에서 increment()를 누르면 다른 쪽 숫자도 같이 바뀝니다 — 이것이 Props Drilling 없이 상태를 나누는 방법입니다.`})]),M(`div`,mc,[M(`div`,hc,[N(dc,{label:`COMPONENT A`}),N(dc,{label:`COMPONENT B`})]),o[4]||=M(`p`,{class:`note`},[g(` 두 패널 사이에는 `),M(`b`,null,`props 도 emits 도 없습니다`),g(`. 각자 `),M(`code`,null,`useCounterStore()`),g(` 로 같은 Store 를 열었을 뿐인데 숫자가 함께 움직입니다. `)],-1)]),M(`div`,gc,[M(`h3`,null,[o[5]||=g(` storeToRefs 를 빼면 어떻게 되나 `,-1),M(`button`,{type:`button`,class:`peek`,onClick:o[0]||=e=>a.value=!a.value},A(a.value?`닫기`:`직접 확인`),1)]),a.value?(s(),k(`div`,_c,[M(`div`,vc,[o[6]||=M(`p`,{class:`cell-head`},[M(`span`,{class:`tag ok`},`정상`),M(`code`,null,`const { count } = storeToRefs(store)`)],-1),M(`p`,yc,A(_(n)),1)]),M(`div`,bc,[o[7]||=M(`p`,{class:`cell-head`},[M(`span`,{class:`tag no`},`끊김`),M(`code`,null,`const { count } = store`)],-1),M(`p`,xc,A(_(r)),1)])])):x(``,!0),a.value?(s(),k(`div`,Sc,[M(`button`,{type:`button`,onClick:o[1]||=e=>_(t).increment()},`increment()`),M(`button`,{type:`button`,class:`ghost`,onClick:o[2]||=e=>i()},`0 으로 되돌리기`)])):x(``,!0),a.value?(s(),k(`p`,Cc,[...o[8]||=[g(` 오른쪽은 `,-1),M(`b`,null,`값이 복사된 순간`,-1),g(`에 멈춰 있습니다. Store 의 state 는 ref 인데 구조 분해하면 `,-1),M(`code`,null,`.value`,-1),g(` 만 꺼내져 연결이 끊기기 때문입니다. `,-1),M(`b`,null,`actions 는 함수라 그냥 꺼내 써도 됩니다`,-1),g(` — storeToRefs 는 state 와 getters 에만 씁니다. `,-1)]])):x(``,!0)])]))}},[[`__scopeId`,`data-v-4f9b28d2`]]),Tc=e({default:()=>Hc}),Ec={class:`practice-card`},Dc={class:`area`},Oc={class:`routes`},kc={class:`path`},Ac={class:`name`},jc={key:0,class:`hit`},Mc={class:`area`},Nc={class:`links`},Pc={class:`area`},Fc={class:`view-name`},Ic={class:`view-body`},Lc={key:0,class:`params`},Rc={class:`area`},zc={class:`ab`},Bc={class:`tick`},Vc={class:`ab-buttons`},Hc=K({__name:`RouterBasicPractice`,setup(e){let t=[{path:`/`,name:`home`,label:`홈`,body:`오늘의 날씨 목록이 여기 나옵니다.`},{path:`/about`,name:`about`,label:`소개`,body:`이 앱이 무엇인지 설명하는 화면입니다.`},{path:`/weather/:cityId`,name:`detail`,label:`도시 상세`,body:`한 도시의 시간별 날씨를 봅니다.`},{path:`/:pathMatch(.*)*`,name:`not-found`,label:`없는 페이지`,body:`404`}],n=y(`/`),r=y(`/`),i=T(()=>{for(let e of t){if(e.path===`/:pathMatch(.*)*`)continue;let t=`^`+e.path.replace(/:([\w]+)/g,`(?<$1>[^/]+)`)+`$`,r=n.value.match(new RegExp(t));if(r)return{route:e,params:r.groups??{}}}return{route:t[t.length-1],params:{}}}),a=e=>{n.value=e,r.value=e},o=y(0),c=y(!1),l=()=>{c.value=!0,o.value=0,setTimeout(()=>c.value=!1,1400)};return(e,n)=>(s(),k(`section`,Ec,[M(`h2`,null,[n[9]||=g(` 주소 → 화면, 라우터가 하는 일 `,-1),N(J,{text:`라우터는 주소표(routes)를 들고 있다가, 주소가 바뀌면 거기 맞는 컴포넌트를 골라 RouterView 자리에 끼워 넣습니다. 아래는 그 과정을 그대로 흉내 낸 미니 라우터입니다. 진짜 vue-router를 이 안에 또 띄우면 이 사이트의 주소까지 바뀌므로 원리만 재현했습니다.`})]),M(`div`,Dc,[n[11]||=M(`h3`,null,`① 주소표 (routes)`,-1),M(`ul`,Oc,[(s(),k(C,null,P(t,e=>M(`li`,{key:e.path,class:h({on:e===i.value.route})},[M(`code`,kc,A(e.path),1),n[10]||=M(`span`,{class:`arrow`,"aria-hidden":`true`},`→`,-1),M(`span`,Ac,A(e.label),1),e===i.value.route?(s(),k(`span`,jc,`지금 이것`)):x(``,!0)],2)),64))])]),M(`div`,Mc,[n[14]||=M(`h3`,null,`② 주소창`,-1),M(`form`,{class:`bar`,onSubmit:n[1]||=L(e=>a(r.value),[`prevent`])},[n[12]||=M(`span`,{class:`origin`},`myapp.com`,-1),j(M(`input`,{"onUpdate:modelValue":n[0]||=e=>r.value=e,spellcheck:`false`,"aria-label":`주소`,placeholder:`/about`},null,512),[[I,r.value]]),n[13]||=M(`button`,{type:`submit`,"aria-label":`이동`},[M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`M5 12h13M13 6l6 6-6 6`})])],-1)],32),M(`p`,Nc,[M(`button`,{type:`button`,class:`link`,onClick:n[2]||=e=>a(`/`)},`/`),M(`button`,{type:`button`,class:`link`,onClick:n[3]||=e=>a(`/about`)},`/about`),M(`button`,{type:`button`,class:`link`,onClick:n[4]||=e=>a(`/weather/seoul`)},`/weather/seoul`),M(`button`,{type:`button`,class:`link`,onClick:n[5]||=e=>a(`/weather/busan`)},`/weather/busan`),M(`button`,{type:`button`,class:`link`,onClick:n[6]||=e=>a(`/hello`)},`/hello (없는 주소)`)])]),M(`div`,Pc,[n[16]||=M(`h3`,null,`③ <RouterView /> — 화면이 갈아끼워지는 자리`,-1),M(`div`,{class:h([`viewport`,{missing:i.value.route.name===`not-found`}])},[M(`p`,Fc,A(i.value.route.label),1),M(`p`,Ic,A(i.value.route.body),1),Object.keys(i.value.params).length?(s(),k(`p`,Lc,[n[15]||=M(`span`,{class:`tag`},`route.params`,-1),M(`code`,null,A(i.value.params),1)])):x(``,!0)],2)]),M(`div`,Rc,[n[18]||=M(`h3`,null,`④ 왜 <a href> 를 쓰면 안 되나`,-1),n[19]||=M(`p`,{class:`explain`},[g(` 아래 숫자는 화면이 기억하고 있는 값입니다(`),M(`code`,null,`ref`),g(`). 두 버튼을 각각 눌러 보세요. `)],-1),M(`div`,zc,[M(`div`,{class:h([`counter`,{wiped:c.value}])},[M(`span`,Bc,A(o.value),1),M(`button`,{type:`button`,onClick:n[7]||=e=>o.value++},`+1 올리기`)],2),M(`div`,Vc,[M(`button`,{type:`button`,class:`good`,onClick:n[8]||=e=>a(`/about`)},` RouterLink 로 이동 `),M(`button`,{type:`button`,class:`bad`,onClick:l},` <a href> 로 이동 `)])]),M(`p`,{class:h([`verdict`,{show:c.value}])},[...n[17]||=[g(` 새로고침이 일어나 `,-1),M(`b`,null,`기억하던 값이 0으로 초기화`,-1),g(`되었습니다. `,-1)]],2)])]))}},[[`__scopeId`,`data-v-9a2bf107`]]),Uc=e({default:()=>al}),Wc={class:`practice-card`},Gc={class:`area`},Kc={class:`area`},qc={class:`links`},Jc=[`onClick`],Yc={key:0,class:`lock`,"aria-hidden":`true`},Xc={class:`area`},Zc={class:`view-name`},Qc={class:`view-path`},$c={class:`toggle`},el={class:`area`},tl={key:0,class:`logs`},nl={class:`hook`},rl={class:`text`},il={key:1,class:`hint`},al=K({__name:`RouterGuardPractice`,setup(e){let t=[{path:`/`,name:`Home`,label:`홈`,meta:{}},{path:`/about`,name:`About`,label:`소개`,meta:{}},{path:`/mypage`,name:`MyPage`,label:`마이페이지`,meta:{isAuth:!0}},{path:`/admin`,name:`Admin`,label:`관리자`,meta:{isAuth:!0}},{path:`/login`,name:`Login`,label:`로그인`,meta:{}}],n=y(!1),r=y(!0),i=y(`/`),a=y([]),o=T(()=>t.find(e=>e.path===i.value)??null),c=T(()=>o.value?{kind:`page`,route:o.value}:r.value?{kind:`not-found`}:{kind:`blank`}),l=(e,t,n=`plain`)=>a.value.unshift({id:a.value.length,hook:e,text:t,tone:n}),u=e=>{a.value=[];let r=t.find(t=>t.path===e)?.meta??{};if(l(`beforeEach`,`to: ${e} · from: ${i.value}`,`start`),r.isAuth&&!n.value){l(`beforeEach`,`to.meta.isAuth 인데 로그인 안 됨 → next('/login')`,`block`),i.value=`/login`,l(`afterEach`,`로그인 화면으로 이동 완료`,`done`);return}l(`beforeEach`,`next() — 통과 허가`,`pass`),l(`beforeResolve`,`컴포넌트까지 다 준비됨 (마지막 확인 지점)`,`plain`),i.value=e,l(`afterEach`,`화면 전환 완료 (분석 로그 보내기 좋은 곳)`,`done`)},d=()=>{n.value=!0,l(`상태`,`로그인했습니다. 이제 잠긴 주소도 들어갈 수 있습니다.`,`pass`)},f=()=>{n.value=!1,l(`상태`,`로그아웃했습니다.`,`block`)};return(e,i)=>(s(),k(`section`,Wc,[M(`h2`,null,[i[3]||=g(` Navigation Guard — 페이지 입장 전 검문소 `,-1),N(J,{text:`특정 주소로 들어가기 직전에 가로채서 권한을 검사하거나 다른 곳으로 보내는 장치입니다. 로그인해야 볼 수 있는 마이페이지·관리자 화면에 씁니다. beforeEach(시작 직전) → beforeResolve(컴포넌트까지 준비된 뒤) → afterEach(전환 완료 후) 순서로 불립니다.`})]),M(`div`,Gc,[M(`div`,{class:h([`auth`,{on:n.value}])},[i[4]||=M(`span`,{class:`dot`,"aria-hidden":`true`},null,-1),M(`b`,null,A(n.value?`로그인 상태`:`비로그인 상태`),1),M(`code`,null,`isAuthenticated = `+A(n.value),1),M(`button`,{type:`button`,onClick:i[0]||=e=>n.value?f():d()},A(n.value?`로그아웃`:`로그인하기`),1)],2)]),M(`div`,Kc,[i[5]||=M(`h3`,null,`어디로 갈까요`,-1),M(`div`,qc,[(s(),k(C,null,P(t,e=>M(`button`,{key:e.path,type:`button`,class:h([`link`,{locked:e.meta.isAuth}]),onClick:t=>u(e.path)},[g(A(e.path)+` `,1),e.meta.isAuth?(s(),k(`span`,Yc,`🔒`)):x(``,!0)],10,Jc)),64)),M(`button`,{type:`button`,class:`link ghost`,onClick:i[1]||=e=>u(`/unknown-page`)},` /unknown-page `)])]),M(`div`,Xc,[i[11]||=M(`h3`,null,`<RouterView />`,-1),M(`div`,{class:h([`viewport`,c.value.kind])},[c.value.kind===`page`?(s(),k(C,{key:0},[M(`p`,Zc,A(c.value.route.label),1),M(`code`,Qc,A(c.value.route.path),1)],64)):c.value.kind===`not-found`?(s(),k(C,{key:1},[i[6]||=M(`p`,{class:`view-name`},`404 — 그런 페이지는 없습니다`,-1),i[7]||=M(`code`,{class:`view-path`},`Catch-all Route 가 받아 냈습니다`,-1)],64)):(s(),k(C,{key:2},[i[8]||=M(`p`,{class:`view-name blank`},`(하얗게 비어 있음)`,-1),i[9]||=M(`code`,{class:`view-path`},`매칭되는 컴포넌트가 없어 아무것도 그려지지 않았습니다`,-1)],64))],2),M(`label`,$c,[j(M(`input`,{"onUpdate:modelValue":i[2]||=e=>r.value=e,type:`checkbox`},null,512),[[F,r.value]]),i[10]||=M(`span`,null,[g(` Catch-all Route 사용 — `),M(`code`,null,`{ path: '/:pathMatch(.*)*', component: NotFoundView }`)],-1)])]),M(`div`,el,[i[12]||=M(`h3`,null,[g(`검문 기록 `),M(`small`,null,`최근 이동이 위에`)],-1),a.value.length?(s(),k(`ul`,tl,[(s(!0),k(C,null,P(a.value,e=>(s(),k(`li`,{key:e.id,class:h(e.tone)},[M(`span`,nl,A(e.hook),1),M(`span`,rl,A(e.text),1)],2))),128))])):(s(),k(`p`,il,`위에서 주소를 눌러 보세요. 검문 순서가 여기 쌓입니다.`))])]))}},[[`__scopeId`,`data-v-0450e31b`]]),ol=e({default:()=>Tl}),sl={class:`practice-card`},cl={class:`area`},ll={class:`urlbar`},ul={class:`url`},dl={class:`area`},fl={class:`route`},pl={key:0},ml={key:0},hl={class:`area`},gl={class:`methods`},_l=[`onClick`],vl={class:`area`},yl={class:`stack`},bl={class:`no`},xl={key:0,class:`here-tag`},Sl={class:`nav`},Cl=[`disabled`],wl=[`disabled`],Tl=K({__name:`RouterNavigatePractice`,setup(e){let t=y([`/`]),n=y(0),r=T(()=>t.value[n.value]),i=T(()=>{let[e,t=``]=r.value.split(`?`),n={};for(let e of t.split(`&`).filter(Boolean)){let[t,r=``]=e.split(`=`);n[decodeURIComponent(t)]=decodeURIComponent(r)}for(let t of[{name:`WeatherHome`,path:`/`},{name:`WeatherDetail`,path:`/weather/:cityId`},{name:`UserPosts`,path:`/user/:userId/posts`},{name:`Search`,path:`/search`}]){let r=RegExp(`^`+t.path.replace(/:(\w+)/g,`(?<$1>[^/]+)`)+`$`),i=e.match(r);if(i)return{name:t.name,path:e,params:i.groups??{},query:n}}return{name:`NotFound`,path:e,params:{},query:n}}),a=e=>{t.value=[...t.value.slice(0,n.value+1),e],n.value=t.value.length-1},o=e=>{t.value=[...t.value.slice(0,n.value),e],n.value=t.value.length-1},c=e=>{let r=n.value+e;r>=0&&r<t.value.length&&(n.value=r)},l=T(()=>n.value>0),u=T(()=>n.value<t.value.length-1),d=[{label:`router.push('/about')`,run:()=>a(`/about`),note:`가장 단순한 형태`},{label:`router.push({ name: 'WeatherDetail', params: { cityId: 'seoul' } })`,run:()=>a(`/weather/seoul`),note:`이름 + 동적 세그먼트`},{label:`router.push({ name: 'Search', query: { q: 'vue' } })`,run:()=>a(`/search?q=vue`),note:`물음표 뒤 쿼리`},{label:`router.push({ name: 'UserPosts', params: { userId: 42 } })`,run:()=>a(`/user/42/posts`),note:`중간 위치 동적 세그먼트`},{label:`router.replace('/login')`,run:()=>o(`/login`),note:`기록을 덮어쓴다 — 뒤로가기로 못 돌아온다`,danger:!0}];return(e,a)=>(s(),k(`section`,sl,[M(`h2`,null,[a[2]||=g(` useRoute() 로 읽고, useRouter() 로 옮긴다 `,-1),N(J,{text:`이름이 한 글자 차이라 헷갈립니다. useRoute()는 '지금 이 페이지의 정보'를 읽는 것이고(읽기 전용), useRouter()는 '페이지를 옮기는 리모컨'입니다(동작). 아래에서 버튼을 눌러 주소를 옮기면 위쪽 route 객체가 어떻게 바뀌는지 보세요.`})]),M(`div`,cl,[M(`div`,ll,[a[3]||=M(`span`,{class:`origin`},`myapp.com`,-1),M(`span`,ul,A(r.value),1)])]),M(`div`,dl,[a[8]||=M(`h3`,null,[g(`useRoute() — 지금 페이지의 정보 `),M(`span`,{class:`tag read`},`읽기`)],-1),M(`dl`,fl,[a[4]||=M(`dt`,null,`route.path`,-1),M(`dd`,null,[M(`code`,null,A(i.value.path),1)]),a[5]||=M(`dt`,null,`route.name`,-1),M(`dd`,null,[M(`code`,null,A(i.value.name),1)]),a[6]||=M(`dt`,null,`route.params`,-1),M(`dd`,{class:h({empty:!Object.keys(i.value.params).length})},[M(`code`,null,A(i.value.params),1),Object.keys(i.value.params).length?x(``,!0):(s(),k(`small`,pl,`주소에 :빈칸이 없는 경로`))],2),a[7]||=M(`dt`,null,`route.query`,-1),M(`dd`,{class:h({empty:!Object.keys(i.value.query).length})},[M(`code`,null,A(i.value.query),1),Object.keys(i.value.query).length?x(``,!0):(s(),k(`small`,ml,`물음표 뒤가 비어 있음`))],2)])]),M(`div`,hl,[a[9]||=M(`h3`,null,[g(`useRouter() — 페이지를 옮기는 리모컨 `),M(`span`,{class:`tag write`},`동작`)],-1),M(`ul`,gl,[(s(),k(C,null,P(d,e=>M(`li`,{key:e.label},[M(`button`,{type:`button`,class:h({danger:e.danger}),onClick:t=>e.run()},[M(`code`,null,A(e.label),1),M(`small`,null,A(e.note),1)],10,_l)])),64))])]),M(`div`,vl,[a[10]||=M(`h3`,null,`히스토리 스택 — push 와 replace 의 차이`,-1),M(`ol`,yl,[(s(!0),k(C,null,P(t.value,(e,t)=>(s(),k(`li`,{key:t,class:h({here:t===n.value})},[M(`span`,bl,A(t),1),M(`code`,null,A(e),1),t===n.value?(s(),k(`span`,xl,`지금`)):x(``,!0)],2))),128))]),M(`div`,Sl,[M(`button`,{type:`button`,disabled:!l.value,onClick:a[0]||=e=>c(-1)},`← router.go(-1)`,8,Cl),M(`button`,{type:`button`,disabled:!u.value,onClick:a[1]||=e=>c(1)},`router.go(1) →`,8,wl)]),a[11]||=M(`p`,{class:`note`},[M(`b`,null,`push`),g(` 는 기록을 `),M(`b`,null,`쌓고`),g(`, `),M(`b`,null,`replace`),g(` 는 지금 기록을 `),M(`b`,null,`덮어씁니다`),g(`. 그래서 로그인 후 이동에는 replace를 씁니다 — 뒤로가기로 로그인 화면에 다시 돌아가면 곤란하니까요. `)],-1)])]))}},[[`__scopeId`,`data-v-1eefdd55`]]),El=`<script setup>
import { ref } from 'vue'
...
`,hu=Object.assign({"./basic/BindPractice.vue":Ae,"./basic/ConditionalPractice.vue":We,"./basic/EventPractice.vue":tt,"./basic/ForPractice.vue":pt,"./basic/HtmlTextPractice.vue":_t,"./basic/ModelPractice.vue":wt,"./basic/ReactivityPractice.vue":Wt,"./basic/SpecialDirectivePractice.vue":qt,"./component/ComponentRegistrationPractice.vue":rn,"./component/LifecyclePractice.vue":pn,"./component/PropsEmitsPractice.vue":yn,"./component/PropsFlowPractice.vue":On,"./component/PropsReadonlyPractice.vue":Gn,"./component/ProvideInjectPractice.vue":sr,"./component/SiblingTalkPractice.vue":Sr,"./component/SlotBaseCardPractice.vue":Mr,"./component/SlotListPractice.vue":Vr,"./component/SlotModalPractice.vue":oi,"./component/SlotPractice.vue":Si,"./composition/ComputedCachePractice.vue":ki,"./composition/DeepWatchPractice.vue":Mi,"./composition/FormStatePractice.vue":Ri,"./composition/MultiWatchPractice.vue":Ji,"./composition/ReactiveArrayWatchPractice.vue":$i,"./composition/ReactiveStatePractice.vue":aa,"./composition/ReactiveWatchPractice.vue":da,"./composition/RefArrayWatchPractice.vue":_a,"./composition/RefStatePractice.vue":wa,"./composition/TodoAdvancedPractice.vue":Da,"./composition/TodoListPractice.vue":Va,"./composition/WatchEffectPractice.vue":Za,"./composition/WatchPractice.vue":no,"./library/AxiosWeatherPractice.vue":so,"./library/ElementConfirmPractice.vue":Oo,"./library/ElementFormPractice.vue":zo,"./library/ElementProductPractice.vue":$o,"./library/ModernAsyncPractice.vue":us,"./library/ModernExtractPractice.vue":Cs,"./library/ModernImmutablePractice.vue":Rs,"./library/StoreCounterPractice.vue":fc,"./router/RouterBasicPractice.vue":Tc,"./router/RouterGuardPractice.vue":Uc,"./router/RouterNavigatePractice.vue":ol}),$=e=>e.split(`/`).pop().replace(`.vue`,``),gu=Object.fromEntries(Object.entries(hu).map(([e,t])=>[$(e),t.default])),_u=Object.fromEntries(Object.entries(hu).map(([e])=>[$(e),e.replace(`./`,`src/components/practices/`)]));Object.keys(gu).sort();var vu=e=>gu[e]??null,yu=e=>_u[e]??``,bu=Object.fromEntries(Object.entries(Object.assign({"./basic/BindPractice.vue":El,"./basic/ConditionalPractice.vue":Dl,"./basic/EventPractice.vue":Ol,"./basic/ForPractice.vue":kl,"./basic/HtmlTextPractice.vue":Al,"./basic/ModelPractice.vue":jl,"./basic/ReactivityPractice.vue":Ml,"./basic/SpecialDirectivePractice.vue":Nl,"./component/ComponentRegistrationPractice.vue":Pl,"./component/LifecyclePractice.vue":Fl,"./component/PropsEmitsPractice.vue":Il,"./component/PropsFlowPractice.vue":Ll,"./component/PropsReadonlyPractice.vue":Rl,"./component/ProvideInjectPractice.vue":zl,"./component/SiblingTalkPractice.vue":Bl,"./component/SlotBaseCardPractice.vue":Vl,"./component/SlotListPractice.vue":Hl,"./component/SlotModalPractice.vue":Ul,"./component/SlotPractice.vue":Wl,"./composition/ComputedCachePractice.vue":Gl,"./composition/DeepWatchPractice.vue":Kl,"./composition/FormStatePractice.vue":ql,"./composition/MultiWatchPractice.vue":Jl,"./composition/ReactiveArrayWatchPractice.vue":Yl,"./composition/ReactiveStatePractice.vue":Xl,"./composition/ReactiveWatchPractice.vue":Zl,"./composition/RefArrayWatchPractice.vue":Ql,"./composition/RefStatePractice.vue":$l,"./composition/TodoAdvancedPractice.vue":eu,"./composition/TodoListPractice.vue":tu,"./composition/WatchEffectPractice.vue":nu,"./composition/WatchPractice.vue":ru,"./library/AxiosWeatherPractice.vue":iu,"./library/ElementConfirmPractice.vue":au,"./library/ElementFormPractice.vue":ou,"./library/ElementProductPractice.vue":su,"./library/ModernAsyncPractice.vue":cu,"./library/ModernExtractPractice.vue":lu,"./library/ModernImmutablePractice.vue":uu,"./library/StoreCounterPractice.vue":du,"./router/RouterBasicPractice.vue":fu,"./router/RouterGuardPractice.vue":pu,"./router/RouterNavigatePractice.vue":mu})).map(([e,t])=>[$(e),t])),xu=e=>bu[e]??``,Su=[`id`],Cu=[`aria-expanded`,`title`],wu={class:`card-chevron`,"aria-hidden":`true`},Tu={class:`head-text`},Eu={class:`label`},Du={class:`slide`},Ou={key:0,class:`goal`},ku={key:1,class:`card-summary`},Au={class:`head-badges`},ju={key:0,class:`badge live`},Mu={key:1,class:`tasks`},Nu={key:2,class:`fold pitfalls`},Pu={class:`fold-body`},Fu={key:0,class:`compare`},Iu={key:0,class:`bad`},Lu={key:1,class:`good`},Ru={class:`why`},zu={key:3,class:`practice-note`},Bu={class:`practice-head`},Vu=[`aria-expanded`,`title`],Hu={class:`chevron`,"aria-hidden":`true`},Uu={key:0,class:`count`},Wu={class:`practice-hint`},Gu={class:`practice-main`},Ku={key:0,class:`practice-mounts`},qu={class:`slot-tools`},Ju=[`onClick`],Yu=[`onClick`],Xu={key:1,class:`practice-empty`},Zu={key:2,class:`practice-missing`},Qu=[`aria-expanded`,`title`],$u={class:`side-chevron`,"aria-hidden":`true`},ed={class:`side-body`},td={key:0,class:`side-block`},nd={class:`side-heading`},rd=[`onClick`],id={class:`guide`},ad=[`innerHTML`],od={class:`guide-see`},sd=[`innerHTML`],cd={key:0,class:`guide-why`},ld=[`innerHTML`],ud={key:1,class:`group-extras`},dd={key:1,class:`side-block fold extensions`},fd={class:`fold-body`},pd={key:5,class:`fold extensions`},md={class:`fold-body`},hd=K({__name:`ChallengeCard`,props:{challenge:{type:Object,required:!0}},setup(e){let t=e,n=T(()=>t.challenge.practices.map(e=>({name:e,component:vu(e)})).filter(e=>e.component)),r=T(()=>t.challenge.practices.filter(e=>!vu(e))),i=T(()=>n.value.length>0),a=T(()=>t.challenge.practiceGuide??[]),o=T(()=>{let e=[];for(let t of a.value)t.practice||e.length===0?e.push({label:t.practice??null,steps:[t]}):e[e.length-1].steps.push(t);return e.map(e=>({...e,extras:u.value.filter(t=>typeof t==`object`&&t.practice===e.label)}))}),c=T(()=>{let e=new Set(o.value.map(e=>e.label));return u.value.filter(t=>typeof t==`string`||!e.has(t.practice))}),l=e=>typeof e==`string`?e:e.text,u=T(()=>t.challenge.extensions??[]),d=T(()=>i.value&&(a.value.length>0||u.value.length>0)),f=y(!0),m=y(!0),b=y(!1),S=T(()=>{let e=[];return t.challenge.tasks?.length&&e.push(`연습 ${t.challenge.tasks.length}`),t.challenge.pitfalls?.length&&e.push(`주의 ${t.challenge.pitfalls.length}`),n.value.length&&e.push(`실습 ${n.value.length}`),e.join(` · `)}),w=T(()=>!d.value&&u.value.length>0),D=E({}),O=e=>`${e}-${D[e]??0}`,N=e=>{D[e]=(D[e]??0)+1},F=()=>{n.value.forEach(e=>N(e.name))},I=y(null),z=e=>{I.value=e},B=y(null),H=e=>e.replace(/\s+/g,` `).trim(),U=(e,t)=>{let n=B.value;if(!n)return;let r=[...n.querySelectorAll(`.practice-slot`)];if(!r.length)return;let i=r.find(t=>{let n=t.querySelector(`h2`);return n&&H(n.textContent)===H(e??``)})??r[t]??r[0];i.scrollIntoView({behavior:`smooth`,block:`center`}),i.classList.add(`is-target`),setTimeout(()=>i.classList.remove(`is-target`),1400)};return(t,y)=>(s(),k(`article`,{id:`challenge-${e.challenge.id}`,ref_key:`cardEl`,ref:B,class:h([`challenge`,[e.challenge.status,{collapsed:!b.value}]])},[M(`header`,{class:`challenge-head`,role:`button`,tabindex:`0`,"aria-expanded":b.value,title:b.value?`이 챌린지 접기`:`이 챌린지 펼치기`,onClick:y[0]||=e=>b.value=!b.value,onKeydown:[y[1]||=V(L(e=>b.value=!b.value,[`prevent`]),[`enter`]),y[2]||=V(L(e=>b.value=!b.value,[`prevent`]),[`space`])]},[M(`span`,wu,A(b.value?`▾`:`▸`),1),M(`div`,Tu,[M(`p`,Eu,[g(A(e.challenge.label)+` `,1),M(`span`,Du,`교안 `+A(e.challenge.slidePage),1)]),M(`h3`,null,A(e.challenge.title),1),b.value?(s(),k(`p`,Ou,A(e.challenge.goal),1)):S.value?(s(),k(`p`,ku,A(S.value),1)):x(``,!0)]),M(`div`,Au,[M(`span`,{class:h([`badge`,e.challenge.status])},A(e.challenge.status===`done`?`학습 완료`:`진행 예정`),3),i.value?(s(),k(`span`,ju,` 실습 `+A(n.value.length)+`개 `,1)):x(``,!0)])],40,Cu),b.value?(s(),k(C,{key:0},[e.challenge.lecture?(s(),v(we,{key:0,lecture:e.challenge.lecture,"study-range":e.challenge.studyRange},null,8,[`lecture`,`study-range`])):x(``,!0),e.challenge.tasks?.length?(s(),k(`section`,Mu,[y[6]||=M(`p`,{class:`section-label`},`✎ 연습 항목`,-1),M(`ul`,null,[(s(!0),k(C,null,P(e.challenge.tasks,e=>(s(),k(`li`,{key:e},A(e),1))),128))])])):x(``,!0),e.challenge.pitfalls?.length?(s(),k(`details`,Nu,[M(`summary`,null,[y[7]||=M(`span`,{"aria-hidden":`true`},`⚠`,-1),y[8]||=g(` 조심할 점 `,-1),M(`b`,null,A(e.challenge.pitfalls.length),1)]),M(`div`,Pu,[(s(!0),k(C,null,P(e.challenge.pitfalls,(e,t)=>(s(),k(`div`,{key:t,class:`pitfall`},[e.bad||e.good?(s(),k(`div`,Fu,[e.bad?(s(),k(`p`,Iu,[y[9]||=M(`span`,null,`❌`,-1),M(`code`,null,A(e.bad),1)])):x(``,!0),e.good?(s(),k(`p`,Lu,[y[10]||=M(`span`,null,`✅`,-1),M(`code`,null,A(e.good),1)])):x(``,!0)])):x(``,!0),M(`p`,Ru,A(e.why),1)]))),128))])])):x(``,!0),!i.value&&e.challenge.practiceNote?(s(),k(`p`,zu,[y[11]||=M(`span`,{"aria-hidden":`true`},`✓`,-1),g(` `+A(e.challenge.practiceNote),1)])):(s(),k(`section`,{key:4,class:h([`practice-zone`,{closed:!m.value}])},[M(`header`,Bu,[M(`button`,{type:`button`,class:`practice-toggle`,"aria-expanded":m.value,title:m.value?`실습 화면 접기`:`실습 화면 펼치기`,onClick:y[3]||=e=>m.value=!m.value},[M(`span`,Hu,A(m.value?`▾`:`▸`),1),y[12]||=M(`span`,{class:`practice-mark`,"aria-hidden":`true`},`🖥`,-1),y[13]||=M(`span`,{class:`practice-title`},`실습 화면`,-1),i.value?(s(),k(`span`,Uu,A(n.value.length),1)):x(``,!0)],8,Vu),M(`span`,Wu,A(m.value?`직접 눌러보며 동작을 확인하세요`:`접어 둠 · 제목을 눌러 펼치기`),1),n.value.length>1&&m.value?(s(),k(`button`,{key:0,type:`button`,class:`reset-button reset-all`,"aria-label":`실습 전체 초기화`,title:`이 챌린지의 실습을 모두 처음 상태로 되돌립니다`,onClick:F},[...y[14]||=[M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),M(`path`,{d:`M20 4v4.5h-4.5`})],-1)]])):x(``,!0)]),j(M(`div`,{class:h([`practice-body`,{"has-guide":d.value,"side-closed":d.value&&!f.value}])},[M(`div`,Gu,[i.value?(s(),k(`div`,Ku,[(s(!0),k(C,null,P(n.value,e=>(s(),k(`div`,{key:e.name,class:`practice-slot`},[M(`div`,qu,[M(`button`,{type:`button`,class:`icon-button`,"aria-label":`소스 코드 보기`,title:`소스 코드를 새 창으로 엽니다`,onClick:t=>z(e.name)},[...y[15]||=[M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`M9 7 4 12l5 5M15 7l5 5-5 5`})],-1)]],8,Ju),M(`button`,{type:`button`,class:`icon-button`,"aria-label":`이 실습 초기화`,title:`이 실습만 처음 상태로 되돌립니다 (페이지 새로고침 없음)`,onClick:t=>N(e.name)},[...y[16]||=[M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),M(`path`,{d:`M20 4v4.5h-4.5`})],-1)]],8,Yu)]),(s(),v(p(e.component),{key:O(e.name)}))]))),128))])):(s(),k(`p`,Xu,[...y[17]||=[g(` 아직 이 챌린지에 연결된 실습 화면이 없습니다. `,-1),M(`code`,null,`src/components/practices/`,-1),g(` 에 컴포넌트를 추가하고 `,-1),M(`code`,null,`curriculum.js`,-1),g(` 의 `,-1),M(`code`,null,`practices`,-1),g(` 에 이름을 넣으면 여기에 나타납니다. `,-1)]])),r.value.length?(s(),k(`p`,Zu,` ⚠ 파일을 찾지 못한 실습: `+A(r.value.join(`, `)),1)):x(``,!0)]),d.value?(s(),k(`aside`,{key:0,class:h([`guide-side`,{collapsed:!f.value}])},[M(`button`,{type:`button`,class:`side-toggle`,"aria-expanded":f.value,title:f.value?`접어서 실습 화면 넓히기`:`실습 도우미 펼치기`,onClick:y[4]||=e=>f.value=!f.value},[y[18]||=M(`span`,{class:`side-toggle-label`},[M(`span`,{"aria-hidden":`true`},`✓`),g(` 실습 도우미 `)],-1),M(`span`,$u,A(f.value?`›`:`‹`),1)],8,Qu),j(M(`div`,ed,[a.value.length?(s(),k(`section`,td,[M(`p`,nd,[y[19]||=g(` 확인 가이드 `,-1),M(`b`,null,A(a.value.length),1)]),(s(!0),k(C,null,P(o.value,(e,t)=>(s(),k(`div`,{key:t,class:`guide-group`},[e.label?(s(),k(`button`,{key:0,type:`button`,class:`guide-chip`,title:`이 실습으로 이동합니다`,onClick:n=>U(e.label,t)},[g(A(e.label)+` `,1),y[20]||=M(`span`,{class:`jump`,"aria-hidden":`true`},`↓`,-1)],8,rd)):x(``,!0),M(`ol`,id,[(s(!0),k(C,null,P(e.steps,(e,t)=>(s(),k(`li`,{key:t},[M(`p`,{class:`guide-do`,innerHTML:_(q)(e.do)},null,8,ad),M(`p`,od,[y[21]||=M(`b`,null,`확인`,-1),y[22]||=g(),M(`span`,{innerHTML:_(q)(e.see)},null,8,sd)]),e.why?(s(),k(`p`,cd,[y[23]||=M(`b`,null,`왜`,-1),y[24]||=g(),M(`span`,{innerHTML:_(q)(e.why)},null,8,ld)])):x(``,!0)]))),128))]),e.extras.length?(s(),k(`div`,ud,[y[25]||=M(`p`,{class:`extras-label`},[M(`span`,{"aria-hidden":`true`},`🚀`),g(` 더 해보기`)],-1),M(`ul`,null,[(s(!0),k(C,null,P(e.extras,(e,t)=>(s(),k(`li`,{key:t},A(l(e)),1))),128))])])):x(``,!0)]))),128))])):x(``,!0),c.value.length?(s(),k(`details`,dd,[M(`summary`,null,[y[26]||=M(`span`,{"aria-hidden":`true`},`🚀`,-1),y[27]||=g(` 더 해보기 (전체) `,-1),M(`b`,null,A(c.value.length),1)]),M(`div`,fd,[M(`ul`,null,[(s(!0),k(C,null,P(c.value,(e,t)=>(s(),k(`li`,{key:t},A(l(e)),1))),128))])])])):x(``,!0)],512),[[R,f.value]])],2)):x(``,!0)],2),[[R,m.value]])],2)),w.value?(s(),k(`details`,pd,[M(`summary`,null,[y[28]||=M(`span`,{"aria-hidden":`true`},`🚀`,-1),y[29]||=g(` 더 해보기 (심화 응용) `,-1),M(`b`,null,A(u.value.length),1)]),M(`div`,md,[M(`ul`,null,[(s(!0),k(C,null,P(u.value,(e,t)=>(s(),k(`li`,{key:t},A(l(e)),1))),128))])])])):x(``,!0)],64)):x(``,!0),I.value?(s(),v(se,{key:1,path:_(yu)(I.value),code:_(xu)(I.value),onClose:y[5]||=e=>I.value=null},null,8,[`path`,`code`])):x(``,!0)],10,Su))}},[[`__scopeId`,`data-v-6e637b45`]]),gd=[`aria-expanded`],_d={class:`toggle-title`},vd={class:`chevron`,"aria-hidden":`true`},yd={class:`notes-body`},bd={class:`lead`},xd=[`aria-expanded`,`onClick`],Sd={class:`no`},Cd={class:`section-title`},wd={key:0,class:`slide`},Td={class:`section-body`},Ed={key:1,class:`bullets`},Dd={key:2,class:`table-wrap`},Od={key:3,class:`code`},kd={key:4,class:`note-line`},Ad={key:0,class:`checklist`},jd={key:1,class:`quiz`},Md=K({__name:`ChapterNotes`,props:{notes:{type:Object,required:!0}},setup(e){let t=e,n=y(!1),r=y(0),i=e=>{r.value=r.value===e?-1:e},a=e=>Array.isArray(e)?e:[e],o=T(()=>t.notes.sections.length);return(t,c)=>(s(),k(`section`,{class:h([`notes`,{closed:!n.value}])},[M(`button`,{class:`notes-toggle`,type:`button`,"aria-expanded":n.value,onClick:c[0]||=e=>n.value=!n.value},[c[2]||=M(`span`,{class:`marker`,"aria-hidden":`true`},`📖`,-1),M(`span`,_d,[c[1]||=g(` 교안 정리 — 이 챕터를 여기서 복습합니다 `,-1),M(`small`,null,A(e.notes.range)+` · `+A(o.value)+`개 항목`,1)]),M(`span`,vd,A(n.value?`−`:`+`),1)],8,gd),j(M(`div`,yd,[M(`p`,bd,A(e.notes.lead),1),(s(!0),k(C,null,P(e.notes.sections,(e,t)=>(s(),k(`article`,{key:e.title,class:h([`note-section`,{open:r.value===t}])},[M(`button`,{class:`section-head`,type:`button`,"aria-expanded":r.value===t,onClick:e=>i(t)},[M(`span`,Sd,A(String(t+1).padStart(2,`0`)),1),M(`span`,Cd,A(e.title),1),e.slide?(s(),k(`span`,wd,A(e.slide),1)):x(``,!0)],8,xd),j(M(`div`,Td,[e.body?(s(!0),k(C,{key:0},P(a(e.body),(e,t)=>(s(),k(`p`,{key:t,class:`para`},A(e),1))),128)):x(``,!0),e.bullets?(s(),k(`ul`,Ed,[(s(!0),k(C,null,P(e.bullets,e=>(s(),k(`li`,{key:e},A(e),1))),128))])):x(``,!0),e.table?(s(),k(`div`,Dd,[M(`table`,null,[M(`thead`,null,[M(`tr`,null,[(s(!0),k(C,null,P(e.table.head,e=>(s(),k(`th`,{key:e},A(e),1))),128))])]),M(`tbody`,null,[(s(!0),k(C,null,P(e.table.rows,(e,t)=>(s(),k(`tr`,{key:t},[(s(!0),k(C,null,P(e,(e,t)=>(s(),k(`td`,{key:t},A(e),1))),128))]))),128))])])])):x(``,!0),e.code?(s(),k(`figure`,Od,[M(`figcaption`,null,A(e.code.caption),1),M(`pre`,null,[M(`code`,null,A(e.code.text),1)])])):x(``,!0),e.note?(s(),k(`p`,kd,[c[3]||=M(`span`,{"aria-hidden":`true`},`⚠`,-1),g(` `+A(e.note),1)])):x(``,!0)],512),[[R,r.value===t]])],2))),128)),e.notes.checklist?(s(),k(`section`,Ad,[c[4]||=M(`p`,{class:`block-label`},`이만큼 말할 수 있으면 이 챕터는 넘어가도 됩니다`,-1),M(`ul`,null,[(s(!0),k(C,null,P(e.notes.checklist,e=>(s(),k(`li`,{key:e},A(e),1))),128))])])):x(``,!0),e.notes.quiz?(s(),k(`section`,jd,[c[5]||=M(`p`,{class:`block-label`},`스스로 확인 — 답을 떠올린 뒤 펼쳐 보세요`,-1),(s(!0),k(C,null,P(e.notes.quiz,e=>(s(),k(`details`,{key:e.q},[M(`summary`,null,A(e.q),1),M(`p`,null,A(e.a),1)]))),128))])):x(``,!0)],512),[[R,n.value]])],2))}},[[`__scopeId`,`data-v-ec97fd99`]]),Nd=[`aria-expanded`],Pd={class:`chevron`,"aria-hidden":`true`},Fd={class:`orientation-body`},Id={class:`rule`},Ld={class:`lead`},Rd={class:`cargo`},zd={class:`name`},Bd={class:`payload`},Vd={"aria-hidden":`true`},Hd=[`innerHTML`],Ud={class:`priority`},Wd={class:`p-name`},Gd={class:`p-weight`},Kd={class:`p-when`},qd={class:`keep`},Jd=[`innerHTML`],Yd=K({__name:`ChapterOrientation`,props:{orientation:{type:Object,required:!0}},setup(e){let t=y(!0);return(n,r)=>(s(),k(`section`,{class:h([`orientation`,{closed:!t.value}])},[M(`button`,{class:`orientation-toggle`,type:`button`,"aria-expanded":t.value,onClick:r[0]||=e=>t.value=!t.value},[r[1]||=M(`span`,{class:`marker`,"aria-hidden":`true`},`🧭`,-1),r[2]||=M(`span`,{class:`toggle-title`},`시작하기 전에 — 규칙은 하나뿐입니다`,-1),M(`span`,Pd,A(t.value?`−`:`+`),1)],8,Nd),j(M(`div`,Fd,[M(`p`,Id,A(e.orientation.rule),1),M(`p`,Ld,A(e.orientation.lead),1),M(`ul`,Rd,[(s(!0),k(C,null,P(e.orientation.cargo,e=>(s(),k(`li`,{key:e.name},[M(`code`,zd,A(e.name),1),M(`span`,Bd,A(e.payload),1),M(`span`,{class:h([`dir`,e.dir===`위로`?`up`:`down`])},[M(`span`,Vd,A(e.dir===`위로`?`↑`:`↓`),1),g(` `+A(e.dir),1)],2)]))),128))]),M(`p`,{class:`why`,innerHTML:_(q)(e.orientation.why)},null,8,Hd),r[4]||=M(`p`,{class:`priority-label`},`실제로 쓰는 비중`,-1),M(`ul`,Ud,[(s(!0),k(C,null,P(e.orientation.priority,e=>(s(),k(`li`,{key:e.name,class:h(e.level)},[M(`span`,Wd,A(e.name),1),M(`span`,Gd,A(e.weight),1),M(`span`,Kd,A(e.when),1)],2))),128))]),M(`p`,qd,[r[3]||=M(`span`,{class:`keep-label`},`이것만은`,-1),M(`span`,{innerHTML:_(q)(e.orientation.keep)},null,8,Jd)])],512),[[R,t.value]])],2))}},[[`__scopeId`,`data-v-bfb97b66`]]),Xd={6:{range:`178~190쪽`,lead:`컴포넌트 계층을 타고 값을 넘기는 대신, 화면 밖 저장소 하나를 두고 모두가 거기를 본다. 이 챕터의 절반은 Store 만드는 법, 나머지 절반은 그것으로 로그인을 구현하는 사례연구다.`,sections:[{title:`Pinia란 무엇인가`,slide:`179쪽`,body:`Vue Application이 크고 복잡해질수록 Component 간 데이터를 전달하는 일이 어려워집니다. Pinia는 Component 계층 구조와 상관없이 별도의 전역 데이터 저장소(Store)를 개설해 반응형 데이터를 관리합니다.`,bullets:[`Pinia는 Vue 3의 상태(state) 관리 라이브러리다. Vue 2에서는 Vuex를 썼다.`,`상태(State)란 웹 애플리케이션을 렌더링하는 과정에 영향을 줄 수 있는 값을 말하고, 상태관리란 그 값을 다루는 방법을 말한다.`,`package.json 의 dependencies 에 pinia 가 들어 있어야 한다.`]},{title:`Store — 무엇을 한 파일에 담는가`,slide:`180쪽`,body:`Store는 여러 파일로 구성될 수 있으며, 일반적으로 의미가 있는 상태끼리 파일 하나로 작성합니다. 예를 들어 인증스토어(authStore.js), UI스토어(uiStore.js), 알림스토어(alertStore.js), 공통코드스토어(commonStore.js)처럼 나눕니다.`,table:{head:[`용어`,`기술적 본질`,`Vue 3 내장 문법 매핑`,`주요 역할`],rows:[[`state`,`반응형 데이터 변수`,`ref() / reactive()`,`전역으로 공유할 상태 데이터 객체를 정의한다`],[`getters`,`읽기 전용 계산된 변수`,`computed()`,`원본 state를 기반으로 실시간 가공한다`],[`actions`,`상태 변경 및 통신 함수`,`function()`,`state 값을 변경하는 핸들러 로직 / 서버 비동기 API 통신(axios 등) 수행`]]},note:`Pinia 를 새로 외우는 것이 아니다. 이미 아는 ref · computed · function 에 이름을 새로 붙인 것뿐이다.`},{title:`구축 3단계 ① Pinia 등록`,slide:`181쪽`,body:`src/main.js 에서 createPinia() 함수로 pinia 인스턴스를 생성하고, 애플리케이션 인스턴스의 use() 함수로 등록합니다.`,code:{caption:`src/main.js`,text:`import { createApp } from 'vue'
...
}`},note:`취소를 누르면 reject 되어 catch 로 간다. catch 를 빼먹으면 콘솔에 처리되지 않은 Promise 경고가 뜬다.`}],checklist:[`UI 라이브러리를 쓰면 무엇이 절감되는지 세 가지로 말할 수 있다`,`Element Plus 를 국내에서 많이 쓰는 이유를 비교표로 설명할 수 있다`,`main.js 에 라이브러리와 CSS 를 등록하는 두 줄을 외우지 않고도 찾아 쓸 수 있다`,`태그로 쓰는 컴포넌트와 JS 함수로 부르는 컴포넌트(ElMessage 등)를 구분할 수 있다`,`el-form 검증과 직접 if 로 검증하는 방식의 차이를 안다`,`ElMessageBox.confirm 이 Promise 를 돌려준다는 점과 취소가 catch 로 간다는 점을 안다`],quiz:[{q:`el-button 은 나오는데 스타일이 하나도 없다. 무엇을 빠뜨렸나?`,a:`import 'element-plus/dist/index.css' 다. 컴포넌트 등록과 CSS 로드는 별개다.`},{q:`ElMessage 를 쓰려면 템플릿에 어떤 태그를 적어야 하는가?`,a:`적지 않는다. 태그가 아니라 JS 함수라서 import 해서 호출만 하면 화면에 알아서 떠오른다.`},{q:`ElMessageBox.confirm 에서 사용자가 취소를 눌렀다. 코드의 어디로 가는가?`,a:`catch 로 간다. 확인은 then, 취소는 catch 다. catch 가 없으면 처리되지 않은 Promise 경고가 뜬다.`},{q:`데이터가 오기 전 화면이 텅 비어 보인다. 어떤 컴포넌트가 어울리나?`,a:`el-skeleton 이다. 회색 유령 레이아웃을 미리 깔아 체감 속도를 높인다. 결과가 없을 때는 el-empty 를 쓴다.`}]}},Zd=e=>Xd[e]??null,Qd={class:`chapter-nav`},$d={class:`nav-head`},ef={key:0,class:`nav-title`},tf=[`title`,`aria-label`],nf=[`title`,`onClick`],rf={class:`chapter-no`},af={key:0,class:`chapter-info`},of={key:1,class:`chapter-meta`},sf=[`title`],cf={key:0,class:`nav-legend`},lf={key:0},uf={id:`learning-content`,class:`learning-content`},df={class:`chapter-head`},ff={class:`eyebrow`},pf={class:`chapter-summary`},mf={class:`topic-chips`},hf={key:2,class:`challenge-stack`},gf={key:3,class:`empty-state`},_f={key:4,class:`linked-assignments`},vf={class:`step`},yf=2,bf=K({__name:`LearningView`,props:{chapterId:{type:String,default:``}},setup(e){ne();let t=te(),n=e,r=T(()=>{let e=Number(n.chapterId);return G.some(t=>t.id===e)?e:yf}),i=e=>{t.push({name:`learning`,params:{chapterId:String(e)}}),document.getElementById(`learning-content`)?.scrollIntoView({behavior:`smooth`,block:`start`})};u(()=>n.chapterId,e=>{e||t.replace({name:`learning`,params:{chapterId:String(yf)}})},{immediate:!0});let a=y(!1),o=T(()=>G.find(e=>e.id===r.value)),c=T(()=>Zd(r.value)),l=T(()=>ie(r.value)),d=T(()=>re(r.value)),f=T(()=>G.map(e=>{let t=ie(e.id),n=t.filter(e=>e.label.startsWith(`Code Challenge`));return{...e,total:n.length,live:t.filter(e=>e.practices.length>0).length,assignments:re(e.id).length}})),p=()=>{window.scrollTo({top:0,behavior:`smooth`})};return(e,t)=>{let n=m(`RouterLink`);return s(),k(C,null,[t[6]||=M(`section`,{class:`page-intro`},[M(`p`,{class:`eyebrow`},`LEARNING & CODE CHALLENGES`),M(`h1`,null,`학습 & 코드 챌린지`),M(`p`,null,[g(` 왼쪽에서 챕터를 고르면 해당 챕터의 `),M(`strong`,null,`코드 챌린지`),g(`가 열립니다. 각 챌린지는 `),M(`strong`,null,`관련 강의 내용 → 연습 항목 → 실습 화면`),g(` 순서로 이어집니다. `)])],-1),M(`section`,{class:h([`learning-layout`,{"nav-collapsed":a.value}])},[M(`aside`,Qd,[M(`div`,$d,[a.value?x(``,!0):(s(),k(`p`,ef,`학습 로드맵`)),M(`button`,{type:`button`,class:`nav-toggle`,title:a.value?`메뉴 펼치기`:`메뉴 접기`,"aria-label":a.value?`메뉴 펼치기`:`메뉴 접기`,onClick:t[0]||=e=>a.value=!a.value},A(a.value?`»`:`«`),9,tf)]),(s(!0),k(C,null,P(f.value,e=>(s(),k(`button`,{key:e.id,type:`button`,class:h([`chapter-item`,{active:e.id===r.value}]),title:a.value?`${e.title} · ${e.slides}`:``,onClick:t=>i(e.id)},[M(`span`,rf,A(String(e.id).padStart(2,`0`)),1),a.value?x(``,!0):(s(),k(`span`,af,[M(`b`,null,A(e.title),1),M(`small`,null,A(e.slides),1)])),a.value?x(``,!0):(s(),k(`span`,of,[M(`i`,{class:h([`dot`,{live:e.live,none:!e.total}]),title:e.total?`코드 챌린지 ${e.total}개${e.live?` · 실습 화면 ${e.live}개`:``}`:`코드 챌린지 없음`},A(e.total||`–`),11,sf)]))],10,nf))),128)),a.value?x(``,!0):(s(),k(`p`,cf,[...t[1]||=[g(` 숫자 = 코드 챌린지 수 \xA0·\xA0 `,-1),M(`i`,{class:`dot live`},`n`,-1),g(` 실습 화면 있음 `,-1)]])),M(`button`,{type:`button`,class:`to-top`,title:`맨 위로`,"aria-label":`맨 위로 가기`,onClick:p},[t[2]||=M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`m6 15 6-6 6 6`})],-1),a.value?x(``,!0):(s(),k(`span`,lf,`맨 위로`))])]),M(`div`,uf,[M(`header`,df,[M(`div`,null,[M(`p`,ff,A(o.value.code)+` · 교안 `+A(o.value.slides),1),M(`h2`,null,A(o.value.title),1),M(`p`,pf,A(o.value.summary),1),M(`div`,mf,[(s(!0),k(C,null,P(o.value.topics,e=>(s(),k(`span`,{key:e},A(e),1))),128))])])]),o.value.orientation?(s(),v(Yd,{key:0,orientation:o.value.orientation},null,8,[`orientation`])):x(``,!0),c.value?(s(),v(Md,{key:1,notes:c.value},null,8,[`notes`])):x(``,!0),l.value.length?(s(),k(`div`,hf,[(s(!0),k(C,null,P(l.value,e=>(s(),v(hd,{key:e.id,challenge:e},null,8,[`challenge`]))),128))])):(s(),k(`p`,gf,[...t[3]||=[g(` 교안 기준으로 이 챕터에는 코드 챌린지가 없습니다. 아래 `,-1),M(`b`,null,`제출 과제`,-1),g(`로 바로 진행합니다. `,-1)]])),d.value.length?(s(),k(`section`,_f,[t[5]||=M(`p`,{class:`section-label`},`이 챕터의 제출 과제`,-1),(s(!0),k(C,null,P(d.value,e=>(s(),v(n,{key:e.id,class:`assignment-link`,to:`/assignments`},{default:b(()=>[M(`span`,vf,A(String(e.id).padStart(2,`0`)),1),M(`span`,null,[M(`b`,null,A(e.title),1),M(`small`,null,A(e.goal),1)]),t[4]||=M(`span`,{class:`arrow`},`→`,-1)]),_:2},1024))),128))])):x(``,!0)])],2)],64)}}},[[`__scopeId`,`data-v-94fb5490`]]);export{bf as default};