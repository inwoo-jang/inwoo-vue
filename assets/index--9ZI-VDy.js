...
`,Cu=Object.fromEntries(Object.entries(Object.assign({"./WeatherComposition.vue":is,"./WeatherMockup.vue":gs,"./WeatherParent.vue":Bl})).map(([e,t])=>[e.replace(`./`,``).replace(`.vue`,``),t.default]));Object.keys(Cu).sort();var wu=e=>Cu[e]??null,Tu=Object.assign({"./WeatherComposition.vue":uu,"./WeatherMockup.vue":du,"./WeatherParent.vue":fu,"./weather/BaseDashboardCard.vue":pu,"./weather/HourlyDetail.vue":mu,"./weather/RegionTabs.vue":hu,"./weather/SearchBar.vue":gu,"./weather/UiIcon.vue":_u,"./weather/WeatherBackdrop.vue":vu,"./weather/WeatherByStatus.vue":yu,"./weather/WeatherCard.vue":bu,"./weather/WeatherIcon.vue":xu,"./weather/weatherApi.js":Su}),Eu=Object.fromEntries(Object.entries(Tu).map(([e,t])=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),t])),Du=Object.fromEntries(Object.keys(Tu).map(e=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),e.replace(`./`,`src/components/assignments/`)])),Ou=e=>Eu[e]===void 0?Object.keys(Eu).find(t=>t.endsWith(`/${e}`)):e,ku=e=>Eu[Ou(e)]??``,Au=e=>Du[Ou(e)]??``,ju={class:`progress-bar`},Mu={class:`track`},Nu={class:`assignment-timeline`},Pu={class:`step`},Fu={class:`assignment-body`},Iu={class:`topline`},Lu={class:`eyebrow`},Ru={class:`slide`},zu={class:`goal`},Bu={class:`scope`},Vu={class:`chapter-tag`},Hu={class:`range`},Uu=[`open`],Wu={key:0,class:`note`},Gu={key:1,class:`result`},Ku={key:0},qu={class:`result-stage`},Ju=Q({__name:`AssignmentsView`,setup(e){let t=e=>qo.find(t=>t.id===e)?.title??``,n={done:`완료`,todo:`진행 예정`,final:`최종`},r=X(()=>Yo.filter(e=>e.status===`done`).length);return(e,i)=>(H(),U(V,null,[i[3]||=G(`section`,{class:`page-intro`},[G(`p`,{class:`eyebrow`},`SUBMISSION ASSIGNMENTS`),G(`h1`,null,`제출 과제`),G(`p`,null,[q(` 각 과제는 이전 결과물에서 `),G(`strong`,null,`이어집니다`),q(`. 여기서 완성한 결과가 최종 날씨 서비스의 기반이 됩니다. `)])],-1),G(`section`,ju,[G(`div`,null,[i[0]||=G(`p`,{class:`label`},`전체 진행률`,-1),G(`strong`,null,O(r.value)+` / `+O(F(Yo).length),1)]),G(`div`,Mu,[G(`i`,{style:E({width:`${r.value/F(Yo).length*100}%`})},null,4)])]),G(`section`,Nu,[(H(!0),U(V,null,B(F(Yo),e=>(H(),U(`article`,{key:e.id,class:D([`assignment-card`,e.status])},[G(`div`,Pu,O(String(e.id).padStart(2,`0`)),1),G(`div`,Fu,[G(`div`,Iu,[G(`p`,Lu,[q(` ASSIGNMENT `+O(String(e.id).padStart(2,`0`))+` `,1),G(`span`,Ru,`교안 `+O(e.slidePage),1)]),G(`span`,{class:D([`status`,e.status])},O(n[e.status]),3)]),G(`h2`,null,O(e.title),1),G(`p`,zu,O(e.goal),1),G(`div`,Bu,[G(`span`,Vu,O(t(e.chapterId)),1),G(`span`,Hu,O(e.scope),1)]),G(`details`,{class:`requirements`,open:e.status!==`todo`},[G(`summary`,null,`요구사항 `+O(e.requirements.length)+`개`,1),G(`ul`,null,[(H(!0),U(V,null,B(e.requirements,e=>(H(),U(`li`,{key:e},O(e),1))),128))])],8,Uu),e.note?(H(),U(`p`,Wu,`⚠ `+O(e.note),1)):J(``,!0),F(wu)(e.result)?(H(),U(`details`,Gu,[G(`summary`,null,[i[1]||=G(`span`,{"aria-hidden":`true`},`▶`,-1),i[2]||=q(` 결과물 보기 `,-1),e.resultNote?(H(),U(`small`,Ku,O(e.resultNote),1)):J(``,!0)]),G(`div`,qu,[(H(),W(Er(F(wu)(e.result))))])])):J(``,!0)])],2))),128))])],64))}},[[`__scopeId`,`data-v-59c19f57`]]),Yu={class:`hero`},Xu={class:`progress-card`},Zu={class:`progress-track`},Qu={class:`section-block`},$u={class:`chapter-grid`},ed={class:`number`},td={class:`section-block`},nd={class:`project-strip`},rd={class:`mini-stats`},id=Q({__name:`HomeView`,setup(e){let t=Math.round(rs/Yo.length*100);return(e,n)=>(H(),U(V,null,[G(`section`,Yu,[n[3]||=oa(`<div data-v-9ae6c4f2><p class="eyebrow" data-v-9ae6c4f2>LEARN · PRACTICE · SUBMIT</p><h1 data-v-9ae6c4f2>Vue를 배우고,<br data-v-9ae6c4f2><span data-v-9ae6c4f2>하나의 결과물</span>로 완성하세요.</h1><p class="hero-copy" data-v-9ae6c4f2> 코드 챌린지로 개념을 익히고, 단계별 제출 과제로 날씨 웹 애플리케이션을 발전시킵니다. </p><div class="hero-actions" data-v-9ae6c4f2><a class="primary-button" href="#/learning" data-v-9ae6c4f2>학습 시작하기</a><a class="secondary-button" href="#/assignments" data-v-9ae6c4f2>제출 과제 보기</a></div></div>`,1),G(`div`,Xu,[n[0]||=G(`p`,{class:`card-label`},`MY LEARNING`,-1),G(`strong`,null,O(F(rs))+` / `+O(F(Yo).length),1),n[1]||=G(`span`,null,`제출 과제 진행률`,-1),G(`div`,Zu,[G(`i`,{style:E({width:`${F(t)}%`})},null,4)]),n[2]||=G(`a`,{href:`#/project`},`최종 결과물 확인 →`,-1)])]),G(`section`,Qu,[n[4]||=G(`div`,{class:`section-heading`},[G(`div`,null,[G(`p`,{class:`eyebrow`},`CURRICULUM`),G(`h2`,null,`학습 영역`)]),G(`a`,{href:`#/learning`},`전체 학습 보기 →`)],-1),G(`div`,$u,[(H(!0),U(V,null,B(F(qo).slice(0,4),e=>(H(),U(`article`,{key:e.id,class:`info-card`},[G(`span`,ed,O(String(e.id).padStart(2,`0`)),1),G(`h3`,null,O(e.title),1),G(`p`,null,O(e.subtitle),1),G(`small`,null,`교안 `+O(e.slides),1)]))),128))])]),G(`section`,td,[n[9]||=G(`div`,{class:`section-heading`},[G(`div`,null,[G(`p`,{class:`eyebrow`},`SUBMISSION PROJECT`),G(`h2`,null,`하나의 날씨 프로젝트`)]),G(`a`,{href:`#/assignments`},`과제 전체 보기 →`)],-1),G(`div`,nd,[n[8]||=G(`div`,null,[G(`span`,{class:`project-icon`},`☁`),G(`h3`,null,`Weather Dashboard`),G(`p`,null,`Mockup에서 API 연동과 배포까지, 과제 결과물이 순서대로 이어집니다.`)],-1),G(`div`,rd,[G(`strong`,null,O(F(ns)),1),n[5]||=G(`span`,null,`개 코드 챌린지`,-1),G(`strong`,null,O(F(ts)),1),n[6]||=G(`span`,null,`개 실습 화면 연결됨`,-1),G(`strong`,null,O(F(Yo).length),1),n[7]||=G(`span`,null,`단계별 제출 과제`,-1)])])])],64))}},[[`__scopeId`,`data-v-9ae6c4f2`]]),ad=new Set(`const.let.var.function.return.if.else.for.while.do.switch.case.default.break.continue.new.delete.typeof.instanceof.in.of.import.export.from.as.async.await.try.catch.finally.throw.class.extends.this.null.undefined.true.false.void.yield`.split(`.`)),od=new Set(`ref.reactive.computed.watch.watchEffect.toRefs.toRef.unref.isRef.shallowRef.readonly.nextTick.onMounted.onUnmounted.onBeforeMount.onBeforeUnmount.onUpdated.onBeforeUpdate.onErrorCaptured.defineProps.defineEmits.defineExpose.defineModel.createApp.defineStore.storeToRefs.provide.inject.useRoute.useRouter.createPinia.createRouter`.split(`.`)),sd=e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`),cd=e=>e?sd(String(e)).replace(/\*\*([^*]+)\*\*/g,`<mark>$1</mark>`).replace(/`([^`]+)`/g,`<code>$1</code>`):``,ld=(e,t)=>`<span class="tok-${e}">${sd(t)}</span>`,ud=new RegExp([`(<!--[\\s\\S]*?-->)`,`(/\\*[\\s\\S]*?\\*/)`,`(//[^\\n]*)`,"(`(?:\\\\[\\s\\S]|[^`\\\\])*`)",`('(?:\\\\[\\s\\S]|[^'\\\\\\n])*')`,`("(?:\\\\[\\s\\S]|[^"\\\\\\n])*")`,`(</?[A-Za-z][\\w.-]*)`,`(\\s(?:v-[\\w:.\\-\\[\\]]+|[@:#][\\w.\\-\\[\\]]+))`,`(\\b\\d+(?:\\.\\d+)?\\b)`,`([A-Za-z_$][\\w$]*)`].join(`|`),`g`),dd=e=>{if(!e)return``;let t=``,n=0;for(let r of e.matchAll(ud)){t+=sd(e.slice(n,r.index)),n=r.index+r[0].length;let[i,a,o,s,c,l,u,d,f,p,m]=r;a||o||s?t+=ld(`comment`,i):c||l||u?t+=ld(`string`,i):d?t+=ld(`tag`,i):f?t+=i.slice(0,1)+ld(`attr`,i.slice(1)):p?t+=ld(`number`,i):m?ad.has(m)?t+=ld(`keyword`,i):od.has(m)?t+=ld(`api`,i):t+=sd(i):t+=sd(i)}return t+sd(e.slice(n))},fd={class:`snippet`},pd=[`innerHTML`],md={key:0,class:`parts`},hd={key:1,class:`returns`},gd={key:2},_d=Q({__name:`CodeSnippet`,props:{code:{type:String,required:!0},desc:{type:String,default:``},parts:{type:Array,default:()=>[]},returns:{type:String,default:``}},setup(e){let t=e,n=X(()=>dd(t.code));return(t,r)=>(H(),U(`figure`,fd,[G(`pre`,null,[G(`code`,{innerHTML:n.value},null,8,pd)]),e.parts.length?(H(),U(`dl`,md,[(H(!0),U(V,null,B(e.parts,e=>(H(),U(V,{key:e.token},[G(`dt`,null,O(e.token),1),G(`dd`,null,O(e.role),1)],64))),128))])):J(``,!0),e.returns?(H(),U(`p`,hd,[r[0]||=G(`span`,{class:`returns-label`},`돌려주는 값`,-1),q(O(e.returns),1)])):J(``,!0),e.desc?(H(),U(`figcaption`,gd,O(e.desc),1)):J(``,!0)]))}},[[`__scopeId`,`data-v-264d774b`]]),vd=[`aria-expanded`],yd={key:0,class:`range`},bd={class:`chevron`},xd={class:`lecture-body`},Sd={key:0,class:`intro`},Cd=[`innerHTML`],wd=[`innerHTML`],Td={key:1,class:`points`},Ed=[`innerHTML`],Dd={key:2,class:`syntax`},Od=Q({__name:`LectureBrief`,props:{lecture:{type:Object,required:!0},studyRange:{type:String,default:``},open:{type:Boolean,default:!1}},setup(e){let t=P(e.open);return(n,r)=>(H(),U(`section`,{class:D([`lecture`,{closed:!t.value}])},[G(`button`,{class:`lecture-toggle`,type:`button`,"aria-expanded":t.value,onClick:r[0]||=e=>t.value=!t.value},[r[1]||=G(`span`,{class:`marker`},`📖`,-1),r[2]||=G(`span`,{class:`toggle-title`},`관련 강의 내용`,-1),e.studyRange?(H(),U(`span`,yd,`교안 `+O(e.studyRange),1)):J(``,!0),G(`span`,bd,O(t.value?`−`:`+`),1)],8,vd),R(G(`div`,xd,[e.lecture.intro?(H(),U(`p`,Sd,[r[3]||=G(`span`,{class:`intro-label`},`쉽게 말하면`,-1),G(`span`,{innerHTML:F(cd)(e.lecture.intro)},null,8,Cd)])):J(``,!0),G(`p`,{class:`lead`,innerHTML:F(cd)(e.lecture.summary)},null,8,wd),e.lecture.points?.length?(H(),U(`ul`,Td,[(H(!0),U(V,null,B(e.lecture.points,e=>(H(),U(`li`,{key:e,innerHTML:F(cd)(e)},null,8,Ed))),128))])):J(``,!0),e.lecture.syntax?.length?(H(),U(`div`,Dd,[r[4]||=G(`p`,{class:`syntax-label`},`문법 정리`,-1),(H(!0),U(V,null,B(e.lecture.syntax,e=>(H(),W(_d,{key:e.code,code:e.code,desc:e.desc,parts:e.parts??[],returns:e.returns??``},null,8,[`code`,`desc`,`parts`,`returns`]))),128))])):J(``,!0)],512),[[Ja,t.value]])],2))}},[[`__scopeId`,`data-v-dd03eb2e`]]),kd={class:`code-window`},Ad={class:`window-bar`},jd={class:`path`},Md={class:`meta`},Nd={class:`code-scroll`},Pd=[`innerHTML`],Fd=Q({__name:`CodeWindow`,props:{path:{type:String,required:!0},code:{type:String,required:!0}},emits:[`close`],setup(e,{emit:t}){let n=e,r=t,i=X(()=>dd(n.code)),a=X(()=>n.code.split(`
`).length),o=P(!1),s=async()=>{try{await navigator.clipboard.writeText(n.code),o.value=!0,setTimeout(()=>o.value=!1,1500)}catch{o.value=!1}},c=e=>{e.key===`Escape`&&r(`close`)};return mr(()=>{document.addEventListener(`keydown`,c),document.body.style.overflow=`hidden`}),_r(()=>{document.removeEventListener(`keydown`,c),document.body.style.overflow=``}),(t,n)=>(H(),W(Yn,{to:`body`},[G(`div`,{class:`code-backdrop`,role:`dialog`,"aria-modal":`true`,onClick:n[1]||=Ro(e=>r(`close`),[`self`])},[G(`div`,kd,[G(`header`,Ad,[n[3]||=G(`span`,{class:`dots`,"aria-hidden":`true`},[G(`i`),G(`i`),G(`i`)],-1),G(`code`,jd,O(e.path),1),G(`span`,Md,O(a.value)+`줄`,1),G(`button`,{type:`button`,class:`bar-button`,onClick:s},O(o.value?`복사됨`:`복사`),1),G(`button`,{type:`button`,class:`bar-button close`,"aria-label":`닫기`,onClick:n[0]||=e=>r(`close`)},[...n[2]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M18 6 6 18M6 6l12 12`})],-1)]])]),G(`div`,Nd,[G(`pre`,null,[G(`code`,{innerHTML:i.value},null,8,Pd)])]),n[4]||=G(`footer`,{class:`window-foot`},[G(`span`,null,[G(`kbd`,null,`Esc`),q(` 또는 바깥을 클릭하면 닫힙니다`)]),G(`span`,{class:`legend`},[G(`i`,{class:`tok-keyword`},`키워드`),G(`i`,{class:`tok-api`},`Vue 함수`),G(`i`,{class:`tok-tag`},`태그`),G(`i`,{class:`tok-attr`},`디렉티브`),G(`i`,{class:`tok-string`},`문자열`),G(`i`,{class:`tok-comment`},`주석`)])],-1)])])]))}},[[`__scopeId`,`data-v-fe776e53`]]),Id=[`aria-expanded`,`aria-label`,`title`],Ld={key:0,class:`icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2.2`,"stroke-linecap":`round`,"aria-hidden":`true`},Rd={key:1,class:`icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`,"aria-hidden":`true`},zd={class:`help-popover`,role:`note`},Bd={class:`help-text`},$=Q({__name:`ConceptHelp`,props:{text:{type:String,required:!0}},setup(e){let t=P(!1),n=P(null),r=e=>{t.value&&n.value&&!n.value.contains(e.target)&&(t.value=!1)},i=e=>{e.key===`Escape`&&(t.value=!1)};return mr(()=>{document.addEventListener(`mousedown`,r),document.addEventListener(`keydown`,i)}),_r(()=>{document.removeEventListener(`mousedown`,r),document.removeEventListener(`keydown`,i)}),(r,i)=>(H(),U(`span`,{ref_key:`root`,ref:n,class:`concept-help`},[G(`button`,{class:D([`help-button`,{open:t.value}]),type:`button`,"aria-expanded":t.value,"aria-label":t.value?`개념 설명 닫기`:`개념 설명 보기`,title:t.value?`닫기`:`개념 설명 보기`,onClick:i[0]||=e=>t.value=!t.value},[t.value?(H(),U(`svg`,Ld,[...i[1]||=[G(`path`,{d:`M18 6 6 18M6 6l12 12`},null,-1)]])):(H(),U(`svg`,Rd,[...i[2]||=[G(`circle`,{cx:`12`,cy:`12`,r:`9.5`},null,-1),G(`path`,{d:`M12 16.5v-5`},null,-1),G(`circle`,{cx:`12`,cy:`8`,r:`1.15`,fill:`currentColor`,stroke:`none`},null,-1)]]))],10,Id),R(G(`span`,zd,[i[3]||=G(`span`,{class:`help-arrow`,"aria-hidden":`true`},null,-1),i[4]||=G(`span`,{class:`help-label`},`개념 설명`,-1),G(`span`,Bd,O(e.text),1)],512),[[Ja,t.value]])],512))}},[[`__scopeId`,`data-v-46feb191`]]),Vd=t({default:()=>ef}),Hd={class:`practice-card`},Ud={class:`practice-area`},Wd=[`disabled`],Gd={class:`practice-area`},Kd={class:`practice-area`},qd={class:`input-group`},Jd={class:`practice-area`},Yd={class:`practice-area`},Xd=`https://vuejs.org`,Zd=`https://vuejs.org/images/logo.png`,Qd=`user-profile-card`,$d=`https://vuejs.org/images/logo.png`,ef=Q({__name:`BindPractice`,setup(e){let t=P(!0),n=P(!1),r=P(`dark-box`),i=P(`purple`),a=P(200),o={height:`80px`,color:`white`,backgroundColor:`#42b883`,transition:`all 0.3s ease`};return(e,s)=>(H(),U(`section`,Hd,[G(`div`,Ud,[G(`h2`,null,[s[4]||=q(` v-bind 디렉티브 기본 (축약형: 콜론) `,-1),K($,{text:`v-bind는 href, src, disabled 같은 HTML 속성에 JavaScript 데이터를 연결합니다. 축약형은 : 입니다.`})]),G(`a`,{href:Xd,target:`_blank`},`Vue 공식 사이트`),G(`img`,{src:Zd,alt:`Vue 로고`,width:`80`}),G(`button`,{disabled:t.value},`잠기는 버튼`,8,Wd),G(`button`,{onClick:s[0]||=e=>t.value=!t.value},` 잠금 상태 변경 `)]),G(`div`,Gd,[G(`h2`,null,[s[5]||=q(` v-bind 디렉티브 고급 (클래스 바인딩) `,-1),K($,{text:`:class는 조건에 따라 CSS 클래스를 추가하거나 제거합니다. 객체와 배열 형식을 사용할 수 있습니다.`})]),G(`p`,{class:D({danger:n.value})},` 현재 경고 상태: `+O(n.value),3),G(`button`,{onClick:s[1]||=e=>n.value=!n.value},`경고 상태 변경`),G(`div`,{class:D([r.value,n.value?`red-border`:`gray-border`])},` 배열로 클래스를 조합한 상자 `,2)]),G(`div`,Kd,[G(`h2`,null,[s[6]||=q(` v-bind 디렉티브 고급 (스타일 바인딩) `,-1),K($,{text:`:style은 색상이나 크기 같은 인라인 CSS 값을 데이터와 직접 연결합니다. 객체와 배열 형식을 지원합니다.`})]),G(`p`,{style:E({color:i.value,fontWeight:`bold`})},` 동적 스타일이 적용된 글자 `,4),G(`button`,{onClick:s[2]||=e=>i.value=i.value===`purple`?`blue`:`purple`},` 글자색 변경 `),G(`div`,qd,[s[7]||=G(`label`,{for:`box-width`},`박스 너비: `,-1),R(G(`input`,{id:`box-width`,"onUpdate:modelValue":s[3]||=e=>a.value=e,type:`number`,step:`50`},null,512),[[Z,a.value,void 0,{number:!0}]])]),G(`div`,{class:`size-box`,style:E([o,{width:a.value+`px`}])},O(a.value)+`px `,5)]),G(`div`,Jd,[G(`h2`,null,[s[8]||=q(` Class Binding vs. Style Binding `,-1),K($,{text:`미리 만든 디자인을 바꿀 때는 :class, 너비처럼 값 자체를 실시간으로 바꿀 때는 :style이 적합합니다.`})]),s[9]||=G(`p`,null,[q(` 미리 만든 디자인을 상태에 따라 바꿀 때는 `),G(`strong`,null,`:class`),q(`를 사용합니다. `)],-1),s[10]||=G(`p`,null,[q(` 너비나 색상 값을 실시간으로 직접 바꿀 때는 `),G(`strong`,null,`:style`),q(`을 사용합니다. `)],-1)]),G(`div`,Yd,[G(`h2`,null,[s[11]||=q(` v-bind 디렉티브 고급 (단축 문법) `,-1),K($,{text:`HTML 속성명과 JavaScript 변수명이 같으면 :src='src'를 :src처럼 줄일 수 있는 Vue 3.4 이상의 문법입니다.`})]),G(`div`,{id:Qd},[G(`img`,{src:$d,alt:`Vue 로고`,width:`50`})])])]))}},[[`__scopeId`,`data-v-e7a49731`]]),tf=t({default:()=>ff}),nf={class:`practice-card`},rf={key:0},af={key:1},of={key:2,style:{color:`green`,"font-weight":`bold`}},sf={key:3,style:{color:`blue`}},cf={key:4,style:{color:`orange`}},lf={key:5,style:{color:`red`,"font-weight":`bold`}},uf={class:`box`},df={class:`practice-area comparison-area`},ff=Q({__name:`ConditionalPractice`,setup(e){let t=P(!1),n=P(85),r=P(!0);return(e,i)=>(H(),U(`section`,nf,[G(`h2`,null,[i[3]||=q(` v-if, v-else-if, v-else 디렉티브 학습 `,-1),K($,{text:`조건에 따라 DOM 요소를 생성하거나 제거합니다. 여러 조건은 v-else-if와 v-else로 이어서 표현합니다.`})]),i[8]||=G(`h3`,null,`1) 기본 로그인 상태 스위치`,-1),t.value?(H(),U(`p`,rf,`환영합니다! 회원 전용 화면입니다.`)):(H(),U(`p`,af,`로그인이 필요합니다. 먼저 로그인해 주세요.`)),G(`button`,{onClick:i[0]||=e=>t.value=!t.value},O(t.value?`로그아웃 하기`:`로그인 하기`),1),i[9]||=G(`br`,null,null,-1),i[10]||=G(`h3`,null,`2) 성적별 학점 등급 측정 (다중 조건문)`,-1),i[11]||=G(`label`,null,`현재 점수 입력: `,-1),R(G(`input`,{"onUpdate:modelValue":i[1]||=e=>n.value=e,type:`number`,min:`0`,max:`100`,step:`5`},null,512),[[Z,n.value]]),i[12]||=G(`br`,null,null,-1),n.value>=90?(H(),U(`div`,of,` 합격 등급: A 학점 (훌륭합니다!) `)):n.value>=80?(H(),U(`div`,sf,` 합격 등급: B 학점 (양호합니다.) `)):n.value>=70?(H(),U(`div`,cf,` 합격 등급: C 학점 (조금 더 분발하세요.) `)):(H(),U(`div`,lf,` 합격 등급: F 학점 (재시험 대상입니다.) `)),G(`h2`,null,[i[4]||=q(` v-show 디렉티브 학습 `,-1),K($,{text:`v-show는 요소를 DOM에 유지하면서 CSS display 속성으로 보이거나 숨깁니다.`})]),G(`button`,{onClick:i[2]||=e=>r.value=!r.value},` 화면 토글하기 `),i[13]||=G(`br`,null,null,-1),R(G(`div`,uf,[...i[5]||=[G(`p`,null,`v-show 상자`,-1),G(`p`,null,` 조건이 false가 되면 CSS display: none이 붙습니다. `,-1)]],512),[[Ja,r.value]]),G(`div`,df,[G(`h2`,null,[i[6]||=q(` v-if vs. v-show `,-1),K($,{text:`전환이 드물면 DOM을 생성·제거하는 v-if, 자주 열고 닫으면 display만 바꾸는 v-show가 적합합니다.`})]),i[7]||=G(`p`,null,` v-if는 DOM을 생성·제거하고, v-show는 DOM을 유지한 채 CSS display 속성으로 표시 여부를 바꿉니다. `,-1)])]))}},[[`__scopeId`,`data-v-e3392bd5`]]),pf=t({default:()=>wf}),mf={class:`practice-card`},hf={class:`practice-area`},gf={class:`practice-area`},_f={class:`practice-area`},vf=[`disabled`],yf=[`disabled`],bf={class:`practice-area`},xf={class:`practice-area`},Sf={class:`modifier-stop-area`},Cf={class:`modifier-chain-area`},wf=Q({__name:`EventPractice`,setup(e){let t=P(0),n=P(``),r=P(!1),i=P(``),a=P(``),o=P(`transparent`),s=P(0),c=P(!1),l=P(0),u=P(0),d=P(0),f=()=>{window.alert(`함수가 성공적으로 호출되었습니다!`)},p=e=>{n.value=`창 좌표: X=${e.clientX}, Y=${e.clientY} / 문서 좌표: X=${e.pageX}, Y=${e.pageY}`},m=()=>{r.value||(window.addEventListener(`click`,p),r.value=!0,n.value=`좌표 확인 중: 브라우저 창 안을 클릭해 보세요.`)},h=()=>{window.removeEventListener(`click`,p),r.value=!1},g=(e,t)=>{i.value=`대상: ${e} / 클릭된 태그: ${t.target.tagName}`},_=e=>{let t=e.currentTarget.getBoundingClientRect(),n=Math.min(1,Math.max(0,(e.clientX-t.left)/t.width)),r=Math.round(n*360);s.value=n*100,o.value=`hsl(${r}, 100%, 50%)`,a.value=`무지개 바 선택 / HSL 값: hsl(${r}, 100%, 50%)`},v=e=>{c.value=!0,e.currentTarget.setPointerCapture(e.pointerId),_(e)},y=e=>{c.value&&_(e)},b=e=>{c.value&&(_(e),c.value=!1,e.currentTarget.hasPointerCapture(e.pointerId)&&e.currentTarget.releasePointerCapture(e.pointerId))},x=()=>{window.alert(`수식어 덕분에 네이버로 이동하지 않고 함수만 실행됩니다!`)},S=()=>{window.alert(`부모 박스가 클릭되었습니다!`)},C=()=>{window.alert(`1번 자식 클릭!`)},ee=()=>{window.alert(`2번 자식(나만 켜짐) 클릭!`)},te=()=>{l.value++},ne=()=>{u.value++},re=()=>{l.value=0,u.value=0,d.value++};return vr(()=>{window.removeEventListener(`click`,p)}),(e,c)=>(H(),U(`section`,mf,[G(`h2`,null,[c[2]||=q(` v-on 이벤트 핸들링 기초 `,-1),K($,{text:`v-on은 클릭이나 키보드 입력 같은 이벤트를 감지해 코드를 실행합니다. 축약형은 @입니다.`})]),G(`div`,hf,[G(`h3`,null,[c[3]||=q(` 1) 인라인 연산 처리 `,-1),K($,{text:`Inline Handler는 count++처럼 간단한 JavaScript 표현식을 템플릿 안에서 바로 실행하는 방식입니다.`})]),G(`p`,null,`현재 카운트: `+O(t.value),1),G(`button`,{onClick:c[0]||=e=>t.value++},`1씩 증가`)]),G(`div`,gf,[G(`h3`,null,[c[4]||=q(` 2) 스크립트 함수 호출 `,-1),K($,{text:`Method Handler는 script에 함수를 정의하고 이벤트에는 함수 이름을 연결하는 방식입니다.`})]),G(`button`,{onClick:f},`알림창 띄우기`)]),G(`div`,_f,[G(`h2`,null,[c[5]||=q(` v-on 이벤트 객체($event) 활용 `,-1),K($,{text:`함수 이름만 전달하면 이벤트 객체가 자동으로 전달됩니다. 다른 값과 이벤트 객체를 함께 넘길 때는 $event를 명시합니다.`})]),G(`p`,null,O(n.value||`좌표 확인 시작 버튼을 눌러주세요.`),1),G(`p`,null,` 현재 상태: `+O(r.value?`좌표 확인 중`:`좌표 확인 중지`),1),G(`p`,null,O(i.value||`태그: 버튼을 클릭해 보세요.`),1),G(`button`,{disabled:r.value,onClick:Ro(m,[`stop`])},` 좌표 확인 시작 `,8,vf),G(`button`,{disabled:!r.value,onClick:Ro(h,[`stop`])},` 좌표 그만 확인하기 `,8,yf),G(`button`,{onClick:c[1]||=e=>g(`회원A`,e)},` 회원 정보와 태그 확인 `)]),G(`div`,bf,[G(`h2`,null,[c[6]||=q(` 클릭한 색상 알아내기 `,-1),K($,{text:`색상 이름은 함수 인자로 전달하고, 실제 CSS 배경색은 $event의 currentTarget에서 읽습니다.`})]),G(`div`,{class:`rainbow-bar`,role:`button`,tabindex:`0`,"aria-label":`무지개 색상 선택`,onPointerdown:v,onPointermove:y,onPointerup:b,onPointercancel:b},[G(`span`,{class:`rainbow-marker`,style:E({left:s.value+`%`})},null,4)],32),G(`p`,null,O(a.value||`무지개 바나 색상 버튼을 클릭해 보세요.`),1),G(`div`,{class:`selected-color`,style:E({backgroundColor:o.value})},null,4)]),G(`div`,xf,[G(`h2`,null,[c[7]||=q(` 이벤트 수식어(Modifiers) 학습 `,-1),K($,{text:`이벤트 수식어는 이벤트의 기본 동작이나 전파 방식을 간단한 접미어로 제어합니다.`})]),G(`h3`,null,[c[8]||=q(` 1) .prevent (기본 동작 막기) `,-1),K($,{text:`.prevent는 preventDefault()와 같으며 링크 이동이나 폼 제출 후 새로고침 같은 기본 동작을 막습니다.`})]),G(`a`,{href:`https://www.naver.com`,onClick:Ro(x,[`prevent`])},` 네이버 링크 `),G(`div`,Sf,[G(`h3`,null,[c[9]||=q(` 2) .stop (이벤트 버블링 막기) `,-1),K($,{text:`.stop은 stopPropagation()과 같으며 자식에서 발생한 이벤트가 부모로 올라가는 것을 막습니다.`})]),G(`div`,{class:`modifier-box`,onClick:S},[c[10]||=G(`p`,null,`부모 영역 (클릭 시 alert 발동)`,-1),G(`button`,{onClick:C},` 버블링 발생 버튼 `),G(`button`,{onClick:Ro(ee,[`stop`])},` 버블링 차단 버튼 `)])]),G(`div`,Cf,[G(`h3`,null,[c[11]||=q(` 3) .prevent.stop.once 연결하기 `,-1),K($,{text:`첫 클릭에는 기본 동작 방지, 버블링 차단, 한 번만 실행이 함께 적용됩니다. once로 리스너가 제거된 뒤에는 나머지 수식어도 더 이상 실행되지 않습니다.`})]),G(`div`,{class:`modifier-box`,onClick:ne},[G(`p`,null,`부모 클릭 횟수: `+O(u.value),1),G(`p`,null,`자식 함수 실행 횟수: `+O(l.value),1),(H(),U(`input`,{key:d.value,type:`checkbox`,onClickOnce:Ro(te,[`prevent`,`stop`])},null,32)),c[12]||=q(` 체크박스를 클릭해 보세요. `,-1)]),c[13]||=G(`p`,{class:`modifier-guide`},` 첫 클릭은 체크되지 않고 부모 클릭도 발생하지 않으며, 자식 함수만 한 번 실행됩니다. 두 번째 클릭부터는 once로 리스너가 제거되어 체크와 부모 클릭이 다시 동작합니다. `,-1),G(`button`,{onClick:Ro(re,[`stop`])},` 연결 수식어 실습 초기화 `)])])]))}},[[`__scopeId`,`data-v-dd838579`]]),Tf=t({default:()=>Of}),Ef={class:`practice-card`},Df={class:`practice-area lists`},Of=Q({__name:`ForPractice`,setup(e){let t=P([`사과`,`바나나`,`딸기`]),n=P({name:`홍길동`,age:25,role:`개발자`}),r=P([{id:`prod-101`,name:`아이폰`},{id:`prod-102`,name:`갤럭시`}]);return(e,i)=>(H(),U(`section`,Ef,[G(`h2`,null,[i[0]||=q(` v-for 디렉티브 학습 `,-1),K($,{text:`v-for는 배열이나 객체의 항목을 반복해서 화면에 출력합니다. 각 항목에는 가능한 한 고유한 :key를 지정합니다.`})]),G(`div`,Df,[G(`div`,null,[i[1]||=G(`h3`,null,`배열 반복`,-1),G(`ul`,null,[(H(!0),U(V,null,B(t.value,(e,t)=>(H(),U(`li`,{key:e},O(t+1)+`번 과일: `+O(e),1))),128))])]),G(`div`,null,[i[2]||=G(`h3`,null,`객체 반복`,-1),G(`ul`,null,[(H(!0),U(V,null,B(n.value,(e,t,n)=>(H(),U(`li`,{key:t},` [`+O(n)+`] `+O(t)+`: `+O(e),1))),128))])]),G(`div`,null,[i[3]||=G(`h3`,null,`객체 배열 반복`,-1),G(`ul`,null,[(H(!0),U(V,null,B(r.value,e=>(H(),U(`li`,{key:e.id},O(e.name),1))),128))])])])]))}},[[`__scopeId`,`data-v-e533b99b`]]),kf=t({default:()=>If}),Af={class:`practice-card`},jf={class:`practice-area`},Mf={class:`practice-area`},Nf=[`innerHTML`],Pf={class:`practice-area`},Ff=`이 글자는 <span style="color: red; font-weight: bold;">빨간색 굵은 글자</span>이다.`,If=Q({__name:`HtmlTextPractice`,setup(e){let t=P(``),n=P(``);function r(){n.value=t.value}return(e,i)=>(H(),U(`section`,Af,[G(`div`,jf,[G(`h2`,null,[i[1]||=q(` v-html 디렉티브 학습 `,-1),K($,{text:`v-html은 문자열에 들어 있는 HTML 태그를 실제 HTML 요소로 해석해 출력합니다.`})]),i[2]||=G(`h3`,null,`일반 보간법 {{ }} 사용 결과:`,-1),G(`p`,null,O(Ff)),i[3]||=G(`br`,null,null,-1),i[4]||=G(`h3`,null,`v-html 디렉티브 사용 결과:`,-1),G(`p`,{innerHTML:Ff})]),G(`div`,Mf,[G(`h2`,null,[i[5]||=q(` v-html XSS 학습 `,-1),K($,{text:`XSS는 악성 스크립트가 다른 사용자의 브라우저에서 실행되는 공격입니다. 사용자 입력을 v-html에 직접 연결하면 위험합니다.`})]),R(G(`input`,{"onUpdate:modelValue":i[0]||=e=>t.value=e,placeholder:`내용을 입력하세요`},null,512),[[Z,t.value]]),G(`button`,{onClick:r},`확인`),G(`div`,{innerHTML:n.value},null,8,Nf)]),i[7]||=G(`p`,{class:`warning`},` 위 코드는 XSS 위험을 확인하기 위한 학습용 예제입니다. 실제 서비스에서는 사용자 입력을 v-html로 직접 출력하지 않습니다. `,-1),G(`div`,Pf,[G(`h2`,null,[i[6]||=q(` v-text 디렉티브 학습 `,-1),K($,{text:`v-text는 값을 일반 텍스트로 출력합니다. HTML 태그가 포함되어 있어도 실제 태그로 해석하지 않습니다.`})]),G(`p`,{textContent:Ff})])]))}},[[`__scopeId`,`data-v-860fa86e`]]),Lf=t({default:()=>np}),Rf={class:`practice-card`},zf={class:`practice-area`},Bf={class:`form-item`},Vf={class:`form-item`},Hf=[`value`],Uf={class:`practice-area`},Wf={class:`form-item`},Gf={class:`form-item`},Kf={class:`form-item`},qf={class:`option-group`},Jf={class:`form-item`},Yf={class:`option-group`},Xf={class:`form-item`},Zf={class:`practice-area`},Qf={class:`form-item`},$f={class:`form-item`},ep={class:`form-item`},tp={class:`form-item`},np=Q({__name:`ModelPractice`,setup(e){let t=P(``),n=P(``),r=P(``),i=P(!1),a=P([]),o=P(``),s=P(``),c=P(``),l=P(``),u=P(``),d=P(``);return(e,f)=>(H(),U(`section`,Rf,[G(`div`,zf,[G(`h2`,null,[f[14]||=q(` v-model 양방향 데이터 바인딩 `,-1),K($,{text:`v-model은 입력 요소의 값과 Vue 데이터를 연결해 한쪽이 바뀌면 다른 쪽도 자동으로 반영되게 합니다.`})]),G(`div`,Bf,[f[16]||=G(`h3`,null,`1) v-model 축약 문법 (양방향)`,-1),R(G(`input`,{"onUpdate:modelValue":f[0]||=e=>t.value=e,type:`text`,placeholder:`여기에 입력하세요`},null,512),[[Z,t.value]]),G(`p`,null,[f[15]||=q(` 입력된 값: `,-1),G(`strong`,null,O(t.value),1)])]),G(`div`,Vf,[f[18]||=G(`h3`,null,`2) v-model의 내부 작동 원리 (단방향 + 이벤트)`,-1),G(`input`,{value:n.value,type:`text`,placeholder:`원리 파악용 입력창`,onInput:f[1]||=e=>n.value=e.target.value},null,40,Hf),G(`p`,null,[f[17]||=q(` 입력된 값: `,-1),G(`strong`,null,O(n.value),1)])])]),G(`div`,Uf,[G(`h2`,null,[f[19]||=q(` 모든 HTML Form 요소와 v-model 매핑 `,-1),K($,{text:`Form 요소마다 v-model이 저장하는 값의 형태가 다릅니다. 단일 체크박스는 Boolean, 다중 체크박스는 Array로 시작합니다.`})]),G(`div`,Wf,[f[20]||=G(`h3`,null,`1) Textarea (장문 텍스트)`,-1),R(G(`textarea`,{"onUpdate:modelValue":f[2]||=e=>r.value=e,placeholder:`의견을 남겨주세요`},null,512),[[Z,r.value]]),G(`p`,null,`데이터 상태: `+O(r.value),1)]),G(`div`,Gf,[f[22]||=G(`h3`,null,`2) 단일 Checkbox (동의 여부)`,-1),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[3]||=e=>i.value=e,type:`checkbox`},null,512),[[ko,i.value]]),f[21]||=q(` 약관에 동의합니다. `,-1)]),G(`p`,null,`데이터 상태: `+O(i.value),1)]),G(`div`,Kf,[f[26]||=G(`h3`,null,`3) 다중 Checkbox (복수 선택 → 배열에 저장)`,-1),G(`div`,qf,[G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[4]||=e=>a.value=e,type:`checkbox`,value:`사과`},null,512),[[ko,a.value]]),f[23]||=q(` 사과 `,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[5]||=e=>a.value=e,type:`checkbox`,value:`바나나`},null,512),[[ko,a.value]]),f[24]||=q(` 바나나 `,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[6]||=e=>a.value=e,type:`checkbox`,value:`딸기`},null,512),[[ko,a.value]]),f[25]||=q(` 딸기 `,-1)])]),G(`p`,null,`데이터 상태 (배열): `+O(a.value),1)]),G(`div`,Jf,[f[29]||=G(`h3`,null,`4) Radio (단일 선택)`,-1),G(`div`,Yf,[G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[7]||=e=>o.value=e,type:`radio`,value:`남성`},null,512),[[jo,o.value]]),f[27]||=q(` 남성 `,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[8]||=e=>o.value=e,type:`radio`,value:`여성`},null,512),[[jo,o.value]]),f[28]||=q(` 여성 `,-1)])]),G(`p`,null,`데이터 상태: `+O(o.value),1)]),G(`div`,Xf,[f[31]||=G(`h3`,null,`5) Select (드롭다운 선택)`,-1),R(G(`select`,{"onUpdate:modelValue":f[9]||=e=>s.value=e},[...f[30]||=[G(`option`,{value:``},`-- 선택하세요 --`,-1),G(`option`,{value:`tesla`},`테슬라`,-1),G(`option`,{value:`hyundai`},`현대자동차`,-1),G(`option`,{value:`bmw`},`BMW`,-1)]],512),[[Mo,s.value]]),G(`p`,null,`데이터 상태: `+O(s.value),1)])]),G(`div`,Zf,[G(`h2`,null,[f[32]||=q(` v-model 수식어(Modifiers) 활용 `,-1),K($,{text:`v-model 수식어는 값의 반영 시점이나 저장 형태를 간단히 제어합니다. .lazy, .number, .trim을 단독 또는 연결해서 사용할 수 있습니다.`})]),G(`div`,Qf,[f[34]||=G(`h3`,null,`1) .lazy 수식어 (change 이벤트 시점 반영)`,-1),R(G(`input`,{"onUpdate:modelValue":f[10]||=e=>c.value=e,type:`text`,placeholder:`입력 후 Enter 또는 외부 클릭`},null,512),[[Z,c.value,void 0,{lazy:!0}]]),G(`p`,null,[f[33]||=q(` 실시간이 아닌 확정된 값: `,-1),G(`strong`,null,O(c.value),1)])]),G(`div`,$f,[f[37]||=G(`h3`,null,`2) .number 수식어 (Number 타입 자동 형변환)`,-1),R(G(`input`,{"onUpdate:modelValue":f[11]||=e=>l.value=e,type:`text`,placeholder:`나이를 입력하세요`},null,512),[[Z,l.value,void 0,{number:!0}]]),G(`p`,null,[f[35]||=q(` 입력된 값: `,-1),G(`strong`,null,O(l.value),1)]),G(`p`,null,[f[36]||=q(` 데이터 타입: `,-1),G(`strong`,null,O(typeof l.value),1)])]),G(`div`,ep,[f[40]||=G(`h3`,null,`3) .trim 수식어 (양끝 공백 자동 제거)`,-1),R(G(`input`,{"onUpdate:modelValue":f[12]||=e=>u.value=e,type:`text`,placeholder:`앞뒤 공백을 포함해 입력해 보세요`},null,512),[[Z,u.value,void 0,{trim:!0}]]),G(`p`,null,[f[38]||=q(` 공백 제거된 값: `,-1),G(`strong`,null,`"`+O(u.value)+`"`,1)]),G(`p`,null,[f[39]||=q(` 문자열 길이: `,-1),G(`strong`,null,O(u.value.length),1)])]),G(`div`,tp,[f[43]||=G(`h3`,null,`4) Chaining (수식어 체이닝: .trim.number)`,-1),R(G(`input`,{"onUpdate:modelValue":f[13]||=e=>d.value=e,type:`text`,placeholder:`공백과 숫자를 섞어 입력해 보세요`},null,512),[[Z,d.value,void 0,{trim:!0,number:!0}]]),G(`p`,null,[f[41]||=q(` 처리된 값: `,-1),G(`strong`,null,`"`+O(d.value)+`"`,1)]),G(`p`,null,[f[42]||=q(` 데이터 타입: `,-1),G(`strong`,null,O(typeof d.value),1)])])])]))}},[[`__scopeId`,`data-v-208c25e3`]]),rp=t({default:()=>ap}),ip={class:`practice-card`},ap={__name:`ReactivityPractice`,setup(e){let t=0,n=P(0),r=P(`hello vue`);return(e,i)=>(H(),U(`section`,ip,[G(`h2`,null,[i[2]||=q(` 실습 1 — Reactivity와 보간법 `,-1),K($,{text:`Reactivity는 데이터가 바뀌면 화면도 자동으로 갱신되는 특성이고, 보간법은 {{ }} 안의 값이나 표현식을 화면에 출력하는 문법입니다.`})]),G(`div`,null,[G(`p`,null,`일반 변수: `+O(F(t)),1),G(`button`,{onClick:i[0]||=e=>N(t)?t.value++:t++},`일반 변수 증가`),G(`p`,null,`반응형 변수: `+O(n.value),1),G(`button`,{onClick:i[1]||=e=>n.value++},`반응형 변수 증가`)]),G(`div`,null,[G(`p`,null,`원래 문자열: `+O(r.value),1),G(`p`,null,`대문자 변환: `+O(r.value.toUpperCase()),1),G(`p`,null,O(`Random number: `+Math.ceil(Math.random()*100)),1)])]))}},op=t({default:()=>pp}),sp={class:`practice-card`},cp={class:`practice-area`},lp={class:`practice-area`},up={class:`practice-area`},dp={class:`practice-area`},fp={class:`button-group`},pp=Q({__name:`SpecialDirectivePractice`,setup(e){let t=P(`안녕하세요!`),n=P(1),r=P(`홍길동`),i=P(20);return(e,a)=>(H(),U(`section`,sp,[G(`div`,cp,[G(`h2`,null,[a[5]||=q(` v-pre 디렉티브 학습 `,-1),K($,{text:`v-pre는 해당 요소와 자식의 Vue 문법을 해석하지 않고 작성된 내용을 그대로 표시합니다.`})]),G(`p`,null,`일반 출력: `+O(t.value),1),a[6]||=G(`p`,null,`v-pre 출력: {{ message }}`,-1)]),G(`div`,lp,[G(`h2`,null,[a[7]||=q(` v-cloak 디렉티브 학습 `,-1),K($,{text:`v-cloak은 Vue가 준비되기 전에 {{ message }} 같은 템플릿 원문이 잠깐 보이는 것을 CSS와 함께 방지합니다.`})]),G(`p`,null,`Vue가 준비되면 표시: `+O(t.value),1)]),G(`div`,up,[G(`h2`,null,[a[8]||=q(` v-once 디렉티브 학습 `,-1),K($,{text:`v-once는 최초 한 번만 렌더링하고 이후 데이터가 변경되어도 해당 화면을 갱신하지 않습니다.`})]),G(`p`,null,`일반 값: `+O(n.value),1),a[0]||(Zi(-1,!0),(a[0]=G(`p`,null,[q(`최초 값으로 고정: `+O(n.value),1)])).cacheIndex=0,Zi(1),a[0]),G(`button`,{onClick:a[1]||=e=>n.value++},`숫자 증가`)]),G(`div`,dp,[G(`h2`,null,[a[9]||=q(` v-memo 디렉티브 학습 `,-1),K($,{text:`v-memo는 지정한 의존성이 바뀔 때만 영역을 다시 렌더링합니다. 큰 목록 등 실제 성능 문제가 있는 경우에 제한적으로 사용합니다.`})]),Na([r.value,i.value],()=>(H(),U(`div`,{class:`memo-box`},[G(`p`,null,`이름: `+O(r.value),1),G(`p`,null,`나이: `+O(i.value),1)])),a,2),G(`div`,fp,[G(`button`,{onClick:a[3]||=e=>r.value=r.value===`홍길동`?`이순신`:`홍길동`},` 이름 변경 `),G(`button`,{onClick:a[4]||=e=>i.value++},`나이 증가`)])])]))}},[[`__scopeId`,`data-v-0ad0fb48`]]),mp={type:`button`,class:`base-button`},hp=Q({__name:`BaseButton`,props:{label:{type:String,default:`기본 버튼`}},setup(e){return(t,n)=>(H(),U(`button`,mp,O(e.label),1))}},[[`__scopeId`,`data-v-2e39ae80`]]),gp=t({default:()=>Sp}),_p={class:`practice-card`},vp={class:`practice-area`},yp={class:`row`},bp={class:`practice-area`},xp={class:`row`},Sp=Q({__name:`ComponentRegistrationPractice`,setup(e){return(e,t)=>{let n=wr(`GlobalBadge`);return H(),U(`section`,_p,[G(`h2`,null,[t[0]||=q(` Component 등록 — 지역 vs 전역 `,-1),K($,{text:`지역 등록은 쓰는 파일에서 import 하는 방식이라 어디서 쓰는지 코드로 드러납니다. 전역 등록은 main.js에서 app.component()로 한 번만 해두면 어디서든 import 없이 쓸 수 있지만, 안 쓰는 컴포넌트까지 번들에 들어갑니다.`})]),G(`div`,vp,[t[1]||=G(`h3`,null,`1) 지역(Local) 등록 — import 한 줄이 등록`,-1),t[2]||=G(`p`,{class:`explain`},[q(` 아래 두 버튼은 `),G(`b`,null,`같은 컴포넌트`),q(`입니다. 등록한 컴포넌트는 PascalCase와 kebab-case 두 가지로 부를 수 있습니다. `)],-1),G(`div`,yp,[K(hp,{label:`PascalCase 호출`}),K(hp,{label:`kebab-case 호출`})]),t[3]||=G(`pre`,{class:`code`},`import BaseButton from './BaseButton.vue'

<BaseButton />
<base-button></base-button>`,-1)]),G(`div`,bp,[t[4]||=G(`h3`,null,`2) 전역(Global) 등록 — import가 없다`,-1),t[5]||=G(`p`,{class:`explain`},[q(` 아래 배지는 이 파일에서 `),G(`b`,null,`import 하지 않았습니다.`),q(` main.js에서 한 번 등록해 둔 덕분에 바로 쓸 수 있습니다. `)],-1),G(`div`,xp,[K(n),K(n,{text:`어디서든 사용 가능`})]),t[6]||=G(`pre`,{class:`code`},`// main.js
app.component('GlobalBadge', GlobalBadge)

// 이 파일 — import 없이 바로
<GlobalBadge />`,-1)]),t[7]||=oa(`<div class="practice-area" data-v-369125df><h3 data-v-369125df>3) 언제 무엇을 쓸까</h3><table class="compare" data-v-369125df><thead data-v-369125df><tr data-v-369125df><th data-v-369125df></th><th data-v-369125df>지역 등록</th><th data-v-369125df>전역 등록</th></tr></thead><tbody data-v-369125df><tr data-v-369125df><td data-v-369125df>등록 위치</td><td data-v-369125df>쓰는 파일에서 import</td><td data-v-369125df>main.js 한 곳</td></tr><tr data-v-369125df><td data-v-369125df>사용 범위</td><td data-v-369125df>그 파일 안에서만</td><td data-v-369125df>앱 전체</td></tr><tr data-v-369125df><td data-v-369125df>의존 관계</td><td data-v-369125df>코드에 드러남</td><td data-v-369125df>어디서 왔는지 안 보임</td></tr><tr data-v-369125df><td data-v-369125df>번들 크기</td><td data-v-369125df>쓰는 것만 포함</td><td data-v-369125df>안 써도 포함</td></tr><tr data-v-369125df><td data-v-369125df>적합한 경우</td><td data-v-369125df><b data-v-369125df>대부분의 컴포넌트</b></td><td data-v-369125df>앱 전반에서 반복되는 소수</td></tr></tbody></table></div>`,1)])}}},[[`__scopeId`,`data-v-369125df`]]),Cp={class:`counter-display`},wp=Q({__name:`LifecycleChild`,setup(e){let t=P(0),n=null;return console.log(`1. [setup] 컴포넌트가 메모리에 생성되었습니다. (DOM 접근 불가능)`),mr(()=>{console.log(`2. [onMounted] 화면에 완벽히 부착되었습니다! (API 호출/DOM 조작 적기)`),n=setInterval(()=>{t.value++},3e3)}),gr(()=>{console.log(`3. [onUpdated] 데이터가 변경되어 화면을 새로 그렸습니다. (현재 count: ${t.value})`)}),vr(()=>{clearInterval(n),console.log(`4. [onUnmounted] 컴포넌트가 소멸했습니다. 타이머 청소 완료!`)}),(e,n)=>(H(),U(V,null,[n[1]||=G(`h3`,null,`⏱️ 라이프사이클 훅 흐름 탐색기`,-1),G(`div`,Cp,[G(`p`,null,`실시간 타이머 카운트: `+O(t.value),1),G(`button`,{onClick:n[0]||=e=>t.value++},`수동으로 숫자 올리기`)])],64))}},[[`__scopeId`,`data-v-4c2f5f04`]]),Tp=t({default:()=>Op}),Ep={class:`practice-card`},Dp={key:1,class:`gone`},Op=Q({__name:`LifecyclePractice`,setup(e){let t=P(!0);return(e,n)=>(H(),U(`section`,Ep,[G(`h2`,null,[n[1]||=q(` Lifecycle Hook — 생성부터 소멸까지 `,-1),K($,{text:`컴포넌트는 생성 → 부착(mount) → 갱신(update) → 소멸(unmount)의 생애를 거칩니다. 각 시점에 Vue가 불러주는 함수가 Lifecycle Hook입니다. 브라우저 콘솔(F12)을 열고 아래 버튼으로 컴포넌트를 껐다 켜면 네 단계가 순서대로 찍힙니다.`})]),n[2]||=G(`p`,{class:`hint`},`브라우저 콘솔(F12)을 열어두고 버튼을 눌러 보세요.`,-1),G(`button`,{class:`toggle-btn`,onClick:n[0]||=e=>t.value=!t.value},O(t.value?`🛑 실습 컴포넌트 파괴하기 (v-if="false")`:`🟢 실습 컴포넌트 다시 살리기`),1),n[3]||=G(`hr`,null,null,-1),t.value?(H(),W(wp,{key:0})):(H(),U(`p`,Dp,`컴포넌트가 소멸했습니다. 콘솔에서 타이머 정리 로그를 확인해 보세요.`))]))}},[[`__scopeId`,`data-v-d955f165`]]),kp={class:`child-container`},Ap=Q({__name:`PropsEmitsChild`,props:{parentData:{type:String,required:!0}},emits:[`update-request`],setup(e,{emit:t}){let n=t,r=()=>{n(`update-request`,`Child에서 가공한 새로운 데이터`)};return(t,n)=>(H(),U(`div`,kp,[n[1]||=G(`p`,{class:`role`},`하위 컴포넌트 (Child)`,-1),G(`p`,null,[n[0]||=q(` 수신된 Props 데이터: `,-1),G(`strong`,null,O(e.parentData),1)]),G(`button`,{onClick:r},`상위 컴포넌트로 갱신 요청 (Emit)`)]))}},[[`__scopeId`,`data-v-e98cd097`]]),jp=t({default:()=>Fp}),Mp={class:`practice-card`},Np={class:`parent-container`},Pp={class:`state`},Fp=Q({__name:`PropsEmitsPractice`,setup(e){let t=P(`Parent 초기 메시지`),n=e=>{t.value=e};return(e,r)=>(H(),U(`section`,Mp,[G(`h2`,null,[r[0]||=q(` Props & Emits — 부모와 자식의 대화 `,-1),K($,{text:`데이터는 부모 → 자식 한 방향으로만 흐릅니다(Props). 자식이 값을 바꾸고 싶으면 직접 고치지 않고 부모에게 '바꿔 달라'고 신호를 보냅니다(Emits). 실제로 값을 바꾸는 주체는 언제나 데이터를 가진 부모입니다.`})]),G(`div`,Np,[r[2]||=G(`p`,{class:`role`},`상위 컴포넌트 (Parent)`,-1),G(`p`,Pp,[r[1]||=q(` 현재 로컬 데이터(State): `,-1),G(`strong`,null,O(t.value),1)]),K(Ap,{"parent-data":t.value,onUpdateRequest:n},null,8,[`parent-data`])])]))}},[[`__scopeId`,`data-v-cfac9a78`]]),Ip={class:`node child`},Lp={class:`field`},Rp={class:`val`},zp=Q({__name:`FlowChild`,props:{message:{type:String,required:!0}},emits:[`reply`],setup(e,{emit:t}){let n=t;return(t,r)=>(H(),U(`div`,Ip,[r[2]||=G(`p`,{class:`node-role`},`자식 (Child)`,-1),G(`p`,Lp,[r[1]||=G(`span`,{class:`key`},`props.message`,-1),G(`span`,Rp,O(e.message||`(빈 값)`),1)]),G(`button`,{onClick:r[0]||=e=>n(`reply`,`자식이 보낸 인사 👋`)},` 부모에게 신호 보내기 (emit) `)]))}},[[`__scopeId`,`data-v-8ceed664`]]),Bp=t({default:()=>Qp}),Vp={class:`practice-card`},Hp={class:`flow`},Up={class:`node parent`},Wp={class:`field`},Gp=[`value`],Kp={class:`field`},qp={class:`val`},Jp={class:`arrows`},Yp={class:`log`},Xp={key:0,class:`log-empty`},Zp={class:`log-dir`},Qp=Q({__name:`PropsFlowPractice`,setup(e){let t=P(`안녕하세요`),n=P(`아직 없음`),r=P(null),i=P([]),a=e=>{r.value=e,setTimeout(()=>{r.value===e&&(r.value=null)},700)},o=(e,t)=>{i.value.unshift({dir:e,text:t}),i.value.length>6&&i.value.pop()},s=e=>{t.value=e.target.value,a(`down`),o(`down`,`props.message = "${t.value}"`)},c=e=>{n.value=e,a(`up`),o(`up`,`emit('reply', "${e}")`)};return(e,a)=>(H(),U(`section`,Vp,[G(`h2`,null,[a[0]||=q(` 데이터는 어느 쪽으로 흐르나 — Props ↓ / Emits ↑ `,-1),K($,{text:`Props는 부모에서 자식으로 내려가고(↓), Emits는 자식에서 부모로 올라갑니다(↑). 반대 방향은 없습니다. 아래에서 입력하거나 버튼을 누르면 그 순간 어느 화살표가 켜지는지 확인해 보세요.`})]),G(`div`,Hp,[G(`div`,Up,[a[3]||=G(`p`,{class:`node-role`},`부모 (Parent)`,-1),G(`label`,Wp,[a[1]||=G(`span`,{class:`key`},`message`,-1),G(`input`,{value:t.value,type:`text`,onInput:s},null,40,Gp)]),G(`p`,Kp,[a[2]||=G(`span`,{class:`key`},`받은 신호`,-1),G(`span`,qp,O(n.value),1)])]),G(`div`,Jp,[G(`div`,{class:D([`arrow down`,{on:r.value===`down`}])},[...a[4]||=[G(`span`,{class:`head`},`↓`,-1),G(`span`,{class:`tag`},`props`,-1)]],2),G(`div`,{class:D([`arrow up`,{on:r.value===`up`}])},[...a[5]||=[G(`span`,{class:`head`},`↑`,-1),G(`span`,{class:`tag`},`emits`,-1)]],2)]),K(zp,{message:t.value,onReply:c},null,8,[`message`])]),G(`div`,Yp,[a[6]||=G(`p`,{class:`log-title`},`주고받은 기록`,-1),i.value.length?J(``,!0):(H(),U(`p`,Xp,`입력하거나 버튼을 눌러 보세요.`)),(H(!0),U(V,null,B(i.value,(e,t)=>(H(),U(`p`,{key:t,class:D([`log-row`,e.dir])},[G(`span`,Zp,O(e.dir===`down`?`↓ 내려감`:`↑ 올라감`),1),G(`code`,null,O(e.text),1)],2))),128))])]))}},[[`__scopeId`,`data-v-f9dc9376`]]),$p={class:`child`},em={class:`field`},tm={class:`val`},nm=Q({__name:`ReadonlyChild`,props:{count:{type:Number,required:!0}},emits:[`increase`],setup(e,{emit:t}){let n=e,r=t,i=P(``),a=()=>{let e=n.count;try{n.count=e+1}catch{}i.value=n.count===e?`실패 — 값은 그대로 ${n.count} 입니다. (콘솔 경고 확인)`:`어라, 바뀌었습니다: ${n.count}`},o=()=>{r(`increase`),i.value=`성공 — 부모가 값을 바꿔 주었습니다.`};return(t,n)=>(H(),U(`div`,$p,[n[1]||=G(`p`,{class:`node-role`},`자식 (Child)`,-1),G(`p`,em,[n[0]||=G(`span`,{class:`key`},`props.count`,-1),G(`span`,tm,O(e.count),1)]),G(`div`,{class:`buttons`},[G(`button`,{class:`bad`,onClick:a},`❌ 직접 바꾸기 (props.count++)`),G(`button`,{class:`good`,onClick:o},`✅ 부모에게 요청 (emit)`)]),i.value?(H(),U(`p`,{key:0,class:D([`result`,{fail:i.value.startsWith(`실패`)}])},O(i.value),3)):J(``,!0)]))}},[[`__scopeId`,`data-v-d711a9c2`]]),rm=t({default:()=>cm}),im={class:`practice-card`},am={class:`parent`},om={class:`field`},sm={class:`val`},cm=Q({__name:`PropsReadonlyPractice`,setup(e){let t=P(0),n=()=>{t.value++};return(e,r)=>(H(),U(`section`,im,[G(`h2`,null,[r[0]||=q(` Props는 읽기 전용 — 값의 주인은 부모다 `,-1),K($,{text:`자식이 받은 Props를 직접 바꾸면 Vue가 막습니다. 값이 어디서 바뀌었는지 추적할 수 없게 되기 때문입니다. 자식은 '바꿔 달라'고 요청(emit)하고, 실제로 바꾸는 것은 값을 가진 부모입니다.`})]),G(`div`,am,[r[2]||=G(`p`,{class:`node-role`},`부모 (Parent) — 값의 주인`,-1),G(`p`,om,[r[1]||=G(`span`,{class:`key`},`count`,-1),G(`span`,sm,O(t.value),1)]),K(nm,{count:t.value,onIncrease:n},null,8,[`count`])]),r[3]||=G(`p`,{class:`hint`},[q(` 브라우저 콘솔(F12)을 열고 ❌ 버튼을 누르면 `),G(`code`,null,`Set operation on key "count" failed: target is readonly`),q(` 경고가 찍힙니다. `)],-1)]))}},[[`__scopeId`,`data-v-24c24705`]]),lm={class:`named`},um={class:`value`},dm=Q({__name:`DrillLeaf`,props:{theme:{type:String,required:!0}},setup(e){return(t,n)=>(H(),U(`div`,{class:D([`level`,e.theme])},[n[1]||=G(`p`,{class:`role`},`자식 (Child)`,-1),G(`p`,lm,[n[0]||=G(`span`,{class:`name`},`props.theme :`,-1),G(`span`,um,O(e.theme),1)])],2))}},[[`__scopeId`,`data-v-54c3d013`]]),fm={class:`data`},pm=Q({__name:`DrillMid`,props:{theme:{type:String,required:!0}},setup(e){let t=e,n=P(!1);return z(()=>t.theme,()=>{n.value=!0,setTimeout(()=>n.value=!1,900)}),(t,r)=>(H(),U(`div`,{class:D([`level`,{passing:n.value}])},[r[1]||=G(`p`,{class:`role`},`부모 (Parent)`,-1),G(`p`,{class:D([`hold`,{passing:n.value}])},[r[0]||=G(`span`,{class:`name`},`props.theme :`,-1),G(`span`,fm,O(e.theme),1)],2),r[2]||=G(`p`,{class:`desc`},`😩 쓰지도 않는 값을 받아서 아래로 넘긴다`,-1),K(dm,{theme:e.theme},null,8,[`theme`])],2))}},[[`__scopeId`,`data-v-803c609f`]]),mm={class:`named`},hm={class:`value`},gm=Q({__name:`InjectLeaf`,setup(e){let t=jn(`globalTheme`,`(주입된 값 없음)`);return(e,n)=>(H(),U(`div`,{class:D([`level`,F(t)])},[n[1]||=G(`p`,{class:`role`},`자식 (Child)`,-1),G(`p`,mm,[n[0]||=G(`span`,{class:`name`},`inject('globalTheme') :`,-1),G(`span`,hm,O(F(t)),1)])],2))}},[[`__scopeId`,`data-v-79d6cd3e`]]),_m={class:`level`},vm=Q({__name:`InjectMid`,setup(e){return(e,t)=>(H(),U(`div`,_m,[t[0]||=oa(`<p class="role" data-v-c476208c>부모 (Parent)</p><p class="hold" data-v-c476208c><span class="name" data-v-c476208c>props :</span><span class="none" data-v-c476208c>없음 (0개)</span></p><p class="desc" data-v-c476208c>😌 값이 지나가는지도 모른다. 조용하다.</p>`,3),K(gm)]))}},[[`__scopeId`,`data-v-c476208c`]]),ym=t({default:()=>Dm}),bm={class:`practice-card`},xm={class:`root`},Sm={class:`field`},Cm={class:`val`},wm={class:`compare`},Tm={class:`col`},Em={class:`col`},Dm=Q({__name:`ProvideInjectPractice`,setup(e){let t=P(`dark-mode`);An(`globalTheme`,t);let n=()=>{t.value=t.value===`dark-mode`?`light-mode`:`dark-mode`};return(e,r)=>(H(),U(`section`,bm,[G(`h2`,null,[r[0]||=q(` Provide & Inject — 중간을 건너뛰고 전달하기 `,-1),K($,{text:`계층이 깊어지면 중간 컴포넌트들이 자기는 쓰지도 않는 값을 받아서 아래로 넘기기만 하는 일이 생깁니다(Props Drilling). provide/inject는 그 중간을 건너뛰고 조상이 선언한 값을 후손이 직접 꺼내 쓰게 해 줍니다.`})]),G(`div`,xm,[r[6]||=G(`p`,{class:`root-role`},`조부모 (GrandParent) — 값의 주인`,-1),G(`p`,Sm,[r[1]||=G(`span`,{class:`key`},`themeColor :`,-1),G(`span`,Cm,O(t.value),1),G(`button`,{onClick:n},`테마 바꾸기`)]),G(`div`,wm,[G(`div`,Tm,[r[2]||=G(`p`,{class:`col-title bad`},`A · Props Drilling`,-1),r[3]||=G(`p`,{class:`col-desc`},[q(`값이 `),G(`b`,null,`중간을 통과해`),q(` 내려갑니다.`)],-1),K(pm,{theme:t.value},null,8,[`theme`])]),G(`div`,Em,[r[4]||=G(`p`,{class:`col-title good`},`B · Provide / Inject`,-1),r[5]||=G(`p`,{class:`col-desc`},[q(`값이 `),G(`b`,null,`중간을 건너뛰고`),q(` 바로 갑니다.`)],-1),K(vm)])])]),r[7]||=G(`p`,{class:`footnote`},[q(` 버튼을 누를 때 `),G(`b`,null,`A의 중간 카드만 번쩍이는지`),q(` 보세요. 값이 그곳을 지나간다는 뜻입니다. 여기는 조부모 → 부모 → 자식 3단계라 차이가 작아 보이지만, 10단계쯤 되면 A는 중간 8곳을 전부 고쳐야 합니다. `)],-1)]))}},[[`__scopeId`,`data-v-8bf7e4c2`]]),Om={class:`sibling`},km={class:`buttons`},Am=[`onClick`],jm=Q({__name:`SiblingA`,emits:[`send`],setup(e,{emit:t}){let n=t,r=[`안녕!`,`점심 먹었어?`,`과제 다 했어?`];return(e,t)=>(H(),U(`div`,Om,[t[0]||=G(`p`,{class:`node-role`},`형제 A (보내는 쪽)`,-1),t[1]||=G(`p`,{class:`desc`},`누르면 부모에게 올려보냅니다(emit).`,-1),G(`div`,km,[(H(),U(V,null,B(r,e=>G(`button`,{key:e,onClick:t=>n(`send`,e)},O(e),9,Am)),64))])]))}},[[`__scopeId`,`data-v-6a5f088d`]]),Mm={class:`sibling`},Nm=Q({__name:`SiblingB`,props:{received:{type:String,default:``}},setup(e){return(t,n)=>(H(),U(`div`,Mm,[n[0]||=G(`p`,{class:`node-role`},`형제 B (받는 쪽)`,-1),n[1]||=G(`p`,{class:`desc`},`부모가 내려준 값(props)만 볼 수 있습니다.`,-1),G(`p`,{class:D([`bubble`,{empty:!e.received}])},O(e.received||`아직 받은 말이 없습니다`),3)]))}},[[`__scopeId`,`data-v-c96b2e77`]]),Pm=t({default:()=>zm}),Fm={class:`practice-card`},Im={class:`parent`},Lm={class:`route`},Rm={class:`siblings`},zm=Q({__name:`SiblingTalkPractice`,setup(e){let t=P(``),n=P(0),r=e=>{n.value=1,setTimeout(()=>{t.value=e,n.value=2,setTimeout(()=>n.value=0,900)},450)};return(e,i)=>(H(),U(`section`,Fm,[G(`h2`,null,[i[0]||=q(` 형제끼리는 부모를 거쳐야 한다 `,-1),K($,{text:`같은 부모 아래 나란히 있는 컴포넌트끼리는 직접 연결된 선이 없습니다. A가 B에게 말하려면 반드시 부모에게 올렸다가(emit) 부모가 다시 B에게 내려줘야(props) 합니다. 부모를 거치는 이 경로가 눈에 보이도록 만들었습니다.`})]),G(`div`,Im,[i[2]||=G(`p`,{class:`node-role`},`부모 (Parent) — 중계자`,-1),G(`div`,Lm,[G(`span`,{class:D([`leg up`,{on:n.value>=1}])},`① A → 부모 \xA0emit`,2),G(`span`,{class:D([`leg down`,{on:n.value>=2}])},`② 부모 → B \xA0props`,2)]),G(`div`,Rm,[K(jm,{onSend:r}),i[1]||=G(`span`,{class:`cut`,"aria-hidden":`true`},`✕ 직접 연결 없음`,-1),K(Nm,{received:t.value},null,8,[`received`])])])]))}},[[`__scopeId`,`data-v-9ac8d55d`]]),Bm={class:`base-card`},Vm={class:`slot-zone head`},Hm={class:`slot-zone body`},Um={class:`slot-zone foot`},Wm=Q({__name:`SlotBaseCard`,setup(e){return(e,t)=>(H(),U(`div`,Bm,[G(`div`,Vm,[kr(e.$slots,`header`,{},()=>[t[0]||=G(`span`,{class:`fallback`},`header 구멍 (비어 있음)`,-1)],!0)]),G(`div`,Hm,[kr(e.$slots,`default`,{},()=>[t[1]||=G(`span`,{class:`fallback`},`기본 구멍 (비어 있음)`,-1)],!0)]),G(`div`,Um,[kr(e.$slots,`footer`,{},()=>[t[2]||=G(`span`,{class:`fallback`},`footer 구멍 (비어 있음)`,-1)],!0)])]))}},[[`__scopeId`,`data-v-fa66589e`]]),Gm=t({default:()=>Zm}),Km={class:`practice-card`},qm={class:`deck`},Jm={class:`case`},Ym={class:`case`},Xm={class:`case`},Zm=Q({__name:`SlotBaseCardPractice`,setup(e){return(e,t)=>(H(),U(`section`,Km,[G(`h2`,null,[t[0]||=q(` 더해보기 ① BaseCard 하나로 화면 3개 `,-1),K($,{text:`아래 세 카드는 전부 같은 SlotBaseCard.vue 파일입니다. 테두리·모서리·구분선이 똑같은 이유죠. 다른 것은 부모가 header·body·footer 세 구멍에 무엇을 넣었는지뿐입니다. 껍데기를 한 번만 만들어 두고 화면마다 알맹이만 갈아 끼우는 것이 Slot의 목적입니다.`})]),t[9]||=G(`p`,{class:`explain`},[q(` 세 카드 모두 `),G(`b`,null,`같은 파일`),q(`입니다. 껍데기를 고치고 싶으면 `),G(`code`,null,`SlotBaseCard.vue`),q(` 한 곳만 고치면 세 개가 동시에 바뀝니다. `)],-1),G(`div`,qm,[G(`div`,Jm,[t[4]||=G(`p`,{class:`case-label`},`구멍 3개 모두 채움`,-1),K(Wm,null,{header:L(()=>[...t[1]||=[G(`b`,null,`주간 리포트`,-1)]]),footer:L(()=>[...t[2]||=[G(`button`,{type:`button`},`자세히`,-1)]]),default:L(()=>[t[3]||=G(`p`,{class:`line`},`이번 주 방문자가 12% 늘었습니다.`,-1)]),_:1})]),G(`div`,Ym,[t[7]||=G(`p`,{class:`case-label`},`footer만 비움`,-1),K(Wm,null,{header:L(()=>[...t[5]||=[G(`b`,null,`공지`,-1)]]),default:L(()=>[t[6]||=G(`p`,{class:`line`},`금요일 18시에 배포가 있습니다.`,-1)]),_:1})]),G(`div`,Xm,[t[8]||=G(`p`,{class:`case-label`},`아무것도 안 채움`,-1),K(Wm)])]),t[10]||=oa(`<div class="verdict" data-v-1f455799><p class="verdict-title" data-v-1f455799>그럼 Props로 하면 안 되나?</p><div class="verdict-grid" data-v-1f455799><div class="side bad" data-v-1f455799><p class="side-head" data-v-1f455799>❌ Props로 시도</p><pre data-v-1f455799><code data-v-1f455799>&lt;BaseCard title=&quot;주간 리포트&quot; /&gt;</code></pre><p class="side-why" data-v-1f455799> 제목 <b data-v-1f455799>글자</b>는 넘길 수 있습니다. 그런데 위 첫 카드의 footer에는 <b data-v-1f455799>&lt;button&gt; 태그</b>가 들어 있습니다. Props로 버튼을 넘기려면 문자열로 <code data-v-1f455799>&quot;&lt;button&gt;&quot;</code>을 보내야 하는데, 그건 화면이 아니라 그냥 글자입니다. </p></div><div class="side good" data-v-1f455799><p class="side-head" data-v-1f455799>✅ Slot이어야만 하는 이유</p><pre data-v-1f455799><code data-v-1f455799>&lt;template #footer&gt;
  &lt;button @click=&quot;...&quot;&gt;자세히&lt;/button&gt;
&lt;/template&gt;</code></pre><p class="side-why" data-v-1f455799><b data-v-1f455799>태그·이벤트·컴포넌트</b>가 통째로 들어갑니다. 넘기는 것이 값이 아니라 화면 조각이기 때문입니다. <b data-v-1f455799>버튼 하나만 들어가도 Props로는 안 됩니다.</b></p></div></div></div>`,1)]))}},[[`__scopeId`,`data-v-1f455799`]]),Qm={class:`list`},$m={class:`fallback`},eh=Q({__name:`SlotItemList`,setup(e){let t=P([{id:1,name:`노트북 거치대`,price:32e3,stock:12},{id:2,name:`기계식 키보드`,price:89e3,stock:0},{id:3,name:`USB-C 허브`,price:45e3,stock:3}]);return(e,n)=>(H(),U(`ul`,Qm,[(H(!0),U(V,null,B(t.value,t=>(H(),U(`li`,{key:t.id},[kr(e.$slots,`default`,{item:t},()=>[G(`span`,$m,O(t.name)+` (부모가 그리는 방법을 정하지 않음)`,1)],!0)]))),128))]))}},[[`__scopeId`,`data-v-5164d7f2`]]),th=t({default:()=>mh}),nh={class:`practice-card`},rh={class:`views`},ih={class:`view`},ah={class:`plain`},oh={class:`view`},sh={class:`row`},ch={class:`price`},lh={class:`view`},uh={class:`row`},dh={key:0,class:`badge sold`},fh={key:1,class:`badge low`},ph={key:2,class:`badge ok`},mh=Q({__name:`SlotListPractice`,setup(e){let t=e=>e.toLocaleString(`ko-KR`)+`원`;return(e,n)=>(H(),U(`section`,nh,[G(`h2`,null,[n[0]||=q(` 더해보기 ② 같은 목록, 부모가 정하는 세 가지 모습 `,-1),K($,{text:`목록 컴포넌트는 '무엇을 반복할지'(데이터와 v-for)만 책임지고, '각 항목을 어떻게 그릴지'는 부모에게 맡깁니다. 아래 세 목록은 전부 같은 SlotItemList.vue이고 데이터도 완전히 같습니다. 부모가 v-slot으로 받은 item을 다르게 그렸을 뿐입니다.`})]),n[4]||=G(`p`,{class:`explain`},[q(` 세 목록 모두 `),G(`b`,null,`같은 컴포넌트 · 같은 데이터`),q(`입니다. 데이터는 `),G(`code`,null,`SlotItemList.vue`),q(` 안에만 있고, 부모는 그리는 방법만 정합니다. `)],-1),G(`div`,rh,[G(`div`,ih,[n[1]||=G(`p`,{class:`view-label`},`A · 이름만`,-1),K(eh,null,{default:L(({item:e})=>[G(`span`,ah,O(e.name),1)]),_:1})]),G(`div`,oh,[n[2]||=G(`p`,{class:`view-label`},`B · 가격 강조`,-1),K(eh,null,{default:L(({item:e})=>[G(`div`,sh,[G(`span`,null,O(e.name),1),G(`b`,ch,O(t(e.price)),1)])]),_:1})]),G(`div`,lh,[n[3]||=G(`p`,{class:`view-label`},`C · 재고 상태`,-1),K(eh,null,{default:L(({item:e})=>[G(`div`,uh,[G(`span`,{class:D({out:e.stock===0})},O(e.name),3),e.stock===0?(H(),U(`span`,dh,`품절`)):e.stock<5?(H(),U(`span`,fh,O(e.stock)+`개 남음`,1)):(H(),U(`span`,ph,`재고 충분`))])]),_:1})])]),n[5]||=G(`p`,{class:`note`},[q(` C의 `),G(`b`,null,`품절 · 임박`),q(` 판단은 목록 컴포넌트가 아니라 `),G(`b`,null,`부모`),q(`가 했습니다. 목록은 `),G(`code`,null,`stock`),q(`이 무슨 뜻인지조차 모릅니다. 그래서 같은 목록을 쇼핑몰에도, 관리자 페이지에도 쓸 수 있습니다. `)],-1)]))}},[[`__scopeId`,`data-v-94406ce4`]]),hh={class:`modal`,role:`dialog`,"aria-modal":`true`},gh={class:`modal-head`},_h={class:`modal-body`},vh={class:`modal-foot`},yh=Q({__name:`SlotModal`,props:{open:{type:Boolean,default:!1}},emits:[`close`],setup(e,{emit:t}){let n=t;return(t,r)=>e.open?(H(),U(`div`,{key:0,class:`backdrop`,onClick:r[2]||=Ro(e=>n(`close`),[`self`])},[G(`div`,hh,[G(`header`,gh,[kr(t.$slots,`title`,{},()=>[r[3]||=G(`b`,null,`제목 없음`,-1)],!0),G(`button`,{type:`button`,class:`close`,"aria-label":`닫기`,onClick:r[0]||=e=>n(`close`)},`✕`)]),G(`div`,_h,[kr(t.$slots,`default`,{},()=>[r[4]||=G(`p`,{class:`fallback`},`본문 구멍 (비어 있음)`,-1)],!0)]),G(`footer`,vh,[kr(t.$slots,`actions`,{},()=>[G(`button`,{type:`button`,onClick:r[1]||=e=>n(`close`)},`닫기`)],!0)])])])):J(``,!0)}},[[`__scopeId`,`data-v-4b2f4b14`]]),bh=t({default:()=>Eh}),xh={class:`practice-card`},Sh={class:`stage`},Ch={class:`buttons`},wh={key:0,class:`result`},Th={key:1,class:`hint`},Eh=Q({__name:`SlotModalPractice`,setup(e){let t=P(!1),n=P(!1),r=P(``),i=()=>{r.value=`삭제했습니다.`,t.value=!1};return(e,a)=>(H(),U(`section`,xh,[G(`h2`,null,[a[5]||=q(` 더해보기 ③ 모달 하나로 창 두 개 `,-1),K($,{text:`모달 껍데기(어둡게 덮기·가운데 띄우기·닫기)는 어느 창이든 똑같습니다. 다른 건 제목·내용·버튼뿐이죠. 그래서 그 세 곳만 Named Slot으로 열어 두면, 모달 파일 하나로 확인창·안내창·입력창을 전부 만들 수 있습니다.`})]),a[11]||=G(`p`,{class:`explain`},[q(` 아래 두 버튼은 `),G(`b`,null,`같은 SlotModal.vue`),q(`를 엽니다. 껍데기는 같고 `),G(`code`,null,`#title`),q(` · 본문 · `),G(`code`,null,`#actions`),q(` 세 구멍만 다릅니다. `)],-1),G(`div`,Sh,[G(`div`,Ch,[G(`button`,{type:`button`,onClick:a[0]||=e=>t.value=!0},`삭제 확인창 열기`),G(`button`,{type:`button`,onClick:a[1]||=e=>n.value=!0},`안내창 열기`)]),r.value?(H(),U(`p`,wh,O(r.value),1)):J(``,!0),!t.value&&!n.value?(H(),U(`p`,Th,[...a[6]||=[q(` 위 버튼을 눌러 보세요. 모달은 `,-1),G(`b`,null,`이 점선 안에서만`,-1),q(` 열립니다. `,-1)]])):J(``,!0),K(yh,{open:t.value,onClose:a[3]||=e=>t.value=!1},{title:L(()=>[...a[7]||=[G(`b`,null,`정말 삭제할까요?`,-1)]]),actions:L(()=>[G(`button`,{type:`button`,onClick:a[2]||=e=>t.value=!1},`취소`),G(`button`,{type:`button`,class:`danger`,onClick:i},`삭제`)]),default:L(()=>[a[8]||=G(`p`,null,`삭제한 항목은 되돌릴 수 없습니다.`,-1)]),_:1},8,[`open`]),K(yh,{open:n.value,onClose:a[4]||=e=>n.value=!1},{title:L(()=>[...a[9]||=[G(`b`,null,`배포 안내`,-1)]]),default:L(()=>[a[10]||=G(`p`,null,`금요일 18시에 서비스가 잠시 중단됩니다.`,-1)]),_:1},8,[`open`])]),a[12]||=G(`p`,{class:`note`},[q(` 안내창은 `),G(`code`,null,`#actions`),q(`를 `),G(`b`,null,`채우지 않았습니다`),q(`. 그래서 SlotModal이 준비해 둔 기본 `),G(`b`,null,`닫기`),q(` 버튼 하나만 나옵니다. 구멍마다 기본값을 넣어 두면 부모가 매번 다 채우지 않아도 됩니다. `)],-1)]))}},[[`__scopeId`,`data-v-c7612aa2`]]),Dh={},Oh={class:`base-card`};function kh(e,t){return H(),U(`div`,Oh,[kr(e.$slots,`default`,{},()=>[t[0]||=G(`p`,null,`기본 콘텐츠 영역입니다.`,-1)],!0)])}var Ah=Q(Dh,[[`render`,kh],[`__scopeId`,`data-v-187523ed`]]),jh={},Mh={class:`base-card`};function Nh(e,t){return H(),U(`div`,Mh,[G(`header`,null,[kr(e.$slots,`header`,{},void 0,!0)]),G(`main`,null,[kr(e.$slots,`default`,{},void 0,!0)])])}var Ph=Q(jh,[[`render`,Nh],[`__scopeId`,`data-v-f11484c5`]]),Fh={class:`base-card`},Ih=Q({__name:`SlotScopedChild`,setup(e){let t=P(`현재 서버 상태 정상`),n=P(150);return(e,r)=>(H(),U(`div`,Fh,[r[1]||=G(`p`,{class:`role`},`하위 컴포넌트 (Child)`,-1),kr(e.$slots,`default`,{text:t.value,count:n.value},()=>[r[0]||=G(`p`,null,`부모가 마크업을 주입하지 않았을 때의 디폴트 화면`,-1)],!0)]))}},[[`__scopeId`,`data-v-54665344`]]),Lh=t({default:()=>Uh}),Rh={class:`practice-card`},zh={class:`practice-area`},Bh={class:`practice-area`},Vh={class:`practice-area`},Hh={class:`display-panel`},Uh=Q({__name:`SlotPractice`,setup(e){return(e,t)=>(H(),U(`section`,Rh,[G(`h2`,null,[t[0]||=q(` Slot — 껍데기는 두고 알맹이만 갈아 끼우기 `,-1),K($,{text:`Props가 '값'을 넘기는 것이라면 Slot은 '화면 조각(HTML)'을 통째로 넘기는 것입니다. 액자를 하나 만들어 두고 사진만 바꿔 끼우는 셈이라, 카드·모달·레이아웃처럼 껍데기는 같고 안쪽만 다른 UI에 씁니다.`})]),G(`div`,zh,[t[3]||=G(`h3`,null,`1) Default Slot — 이름 없는 구멍 하나`,-1),t[4]||=G(`p`,{class:`explain`},[q(` 같은 `),G(`b`,null,`SlotDefaultChild`),q(` 카드에 서로 다른 내용을 넣었습니다. 마지막 카드는 아무것도 안 넣어서 `),G(`b`,null,`기본값`),q(`이 나옵니다. `)],-1),K(Ah,null,{default:L(()=>[...t[1]||=[G(`p`,null,`단순한 텍스트 문장을 주입합니다.`,-1)]]),_:1}),K(Ah,null,{default:L(()=>[...t[2]||=[G(`h4`,{class:`warn`},`🔥 경고 상태`,-1),G(`button`,null,`확인`,-1)]]),_:1}),K(Ah)]),G(`div`,Bh,[t[7]||=G(`h3`,null,`2) Named Slot — 구멍에 이름을 붙여 여러 개`,-1),t[8]||=G(`p`,{class:`explain`},[G(`b`,null,`#header`),q(` 자리와 이름 없는 `),G(`b`,null,`본문`),q(` 자리에 각각 다른 내용을 넣습니다. `)],-1),K(Ph,null,{header:L(()=>[...t[5]||=[G(`h4`,null,`Child 주입 제목`,-1)]]),default:L(()=>[t[6]||=G(`p`,null,` "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt..." `,-1)]),_:1})]),G(`div`,Vh,[t[9]||=G(`h3`,null,`3) Scoped Slot — 자식의 데이터를 부모가 받아 쓴다`,-1),t[10]||=G(`p`,{class:`explain`},[q(` 아래 값은 `),G(`b`,null,`자식이 가진 데이터`),q(`인데, 화면에 어떻게 그릴지는 `),G(`b`,null,`부모가`),q(` 정합니다. `)],-1),K(Ih,null,{default:L(e=>[G(`div`,Hh,[G(`p`,null,`알림 메시지: `+O(e.text),1),G(`p`,null,`접속자 수: `+O(e.count)+`명`,1)])]),_:1}),K(Ih)])]))}},[[`__scopeId`,`data-v-4d263364`]]),Wh=t({default:()=>Kh}),Gh={class:`practice-card`},Kh=Q({__name:`ComputedCachePractice`,setup(e){let t=P(0),n=P(0),r=()=>(console.log(`❌ 일반 함수 실행됨!`),t.value*2),i=X(()=>(console.log(`✅ Computed 연산 실행됨!`),t.value*2));return(e,a)=>(H(),U(`section`,Gh,[G(`h2`,null,[a[2]||=q(` computed() 캐싱 동작 비교 `,-1),K($,{text:`computed는 의존하는 값이 바뀔 때만 다시 계산하고 결과를 캐싱합니다. 일반 함수는 화면이 다시 그려질 때마다 무조건 재실행됩니다. dummy 버튼을 눌러 콘솔 출력 차이를 확인해 보세요.`})]),G(`p`,null,`count: `+O(t.value)+` | dummy: `+O(n.value),1),G(`button`,{onClick:a[0]||=e=>t.value++},`count 증가 (의존성 변경)`),G(`button`,{onClick:a[1]||=e=>n.value++},`dummy 증가 (무관한 변경)`),G(`p`,null,`일반 함수 결과: `+O(r()),1),G(`p`,null,`Computed 결과: `+O(i.value),1),a[3]||=G(`p`,{class:`console-hint`},[q(` 브라우저 콘솔(F12)을 열고 `),G(`b`,null,`dummy 증가`),q(`를 눌러보세요. 일반 함수만 계속 실행되고 computed는 조용합니다. `)],-1)]))}},[[`__scopeId`,`data-v-5263d813`]]),qh=t({default:()=>Qh}),Jh={class:`practice-card`},Yh={class:`practice-area`},Xh={class:`monitor`},Zh={class:`monitor target`},Qh=Q({__name:`DeepWatchPractice`,setup(e){let t=P({name:`홍길동`,age:20}),n=P(`아직 반응 없음`),r=P(`아직 반응 없음`);return z(t,e=>{n.value=`[deep 감지] 누군가 변경됨! 현재 이름: ${e.name}, 나이: ${e.age}`},{deep:!0}),z(()=>t.value.age,(e,t)=>{r.value=`[타겟 감지] 나이가 ${t}세 ➡️ ${e}세로 변경됨!`}),(e,i)=>(H(),U(`section`,Jh,[G(`h2`,null,[i[2]||=q(` ref 객체 감시 — Deep Watch `,-1),K($,{text:`ref에 객체를 담고 watch(user, ...)만 쓰면 속성 변경을 감지하지 못합니다. 객체 자체(참조)가 바뀐 게 아니기 때문입니다. deep: true로 내부 전체를 감시하거나, 화살표 함수로 특정 속성만 콕 집어 감시해야 합니다.`})]),G(`div`,Yh,[i[3]||=G(`h3`,null,`👨‍💻 회원 데이터 조작 panel`,-1),G(`p`,null,`이름: `+O(t.value.name)+` / 나이: `+O(t.value.age)+`세`,1),G(`button`,{onClick:i[0]||=e=>t.value.name=`이순신`},`이름만 변경`),G(`button`,{onClick:i[1]||=e=>t.value.age++},`나이만 변경 (age++)`)]),G(`div`,Xh,[i[4]||=G(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) deep: true 모니터 (전체 감시)`,-1),G(`p`,null,O(n.value),1)]),G(`div`,Zh,[i[5]||=G(`p`,{class:`monitor-title`},`🎯 2) 화살표 함수 모니터 (나이만 타겟 감시)`,-1),G(`p`,null,O(r.value),1)])]))}},[[`__scopeId`,`data-v-485827f2`]]),$h=t({default:()=>cg}),eg={class:`practice-card`},tg={class:`compare`},ng={class:`side`},rg={class:`check`},ig={class:`side highlight`},ag={class:`check`},og={class:`live`},sg={key:0,class:`submitted`},cg=Q({__name:`FormStatePractice`,setup(e){let t=P(``),n=P(``),r=P(``),i=P(!1),a=()=>{t.value=``,n.value=``,r.value=``,i.value=!1},o=()=>JSON.stringify({name:t.value,email:n.value,age:r.value,agree:i.value},null,1),s={name:``,email:``,age:``,agree:!1},c=Lt({...s}),l=()=>{Object.assign(c,s)},u=()=>JSON.stringify(c,null,1),d=P(``),f=()=>{d.value=`[ref 방식] ${o()}`},p=()=>{d.value=`[reactive 방식] ${u()}`};return(e,s)=>(H(),U(`section`,eg,[G(`h2`,null,[s[8]||=q(` 폼 상태 관리 — ref 여러 개 vs reactive 하나 `,-1),K($,{text:`reactive의 장점은 '관련 있는 값을 한 덩어리로 다룰 수 있다'는 점입니다. 초기화·전송·전달을 객체 단위로 처리할 수 있어 필드가 많아질수록 코드가 짧아집니다. 대신 통째로 재할당하면 반응성이 끊기고, 원시값에는 쓸 수 없습니다.`})]),G(`div`,tg,[G(`div`,ng,[s[13]||=G(`h3`,null,`A. ref 4개`,-1),G(`label`,null,[s[9]||=q(`이름 `,-1),R(G(`input`,{"onUpdate:modelValue":s[0]||=e=>t.value=e,type:`text`},null,512),[[Z,t.value]])]),G(`label`,null,[s[10]||=q(`이메일 `,-1),R(G(`input`,{"onUpdate:modelValue":s[1]||=e=>n.value=e,type:`text`},null,512),[[Z,n.value]])]),G(`label`,null,[s[11]||=q(`나이 `,-1),R(G(`input`,{"onUpdate:modelValue":s[2]||=e=>r.value=e,type:`number`},null,512),[[Z,r.value,void 0,{number:!0}]])]),G(`label`,rg,[R(G(`input`,{"onUpdate:modelValue":s[3]||=e=>i.value=e,type:`checkbox`},null,512),[[ko,i.value]]),s[12]||=q(` 약관 동의`,-1)]),G(`div`,{class:`buttons`},[G(`button`,{onClick:f},`전송`),G(`button`,{onClick:a},`초기화`)]),s[14]||=G(`pre`,{class:`code`},`name.value = ''
email.value = ''
age.value = ''
agree.value = false`,-1),s[15]||=G(`p`,{class:`note`},`필드가 늘면 이 줄도 같이 늘어난다`,-1)]),G(`div`,ig,[s[20]||=G(`h3`,null,`B. reactive 1개`,-1),G(`label`,null,[s[16]||=q(`이름 `,-1),R(G(`input`,{"onUpdate:modelValue":s[4]||=e=>c.name=e,type:`text`},null,512),[[Z,c.name]])]),G(`label`,null,[s[17]||=q(`이메일 `,-1),R(G(`input`,{"onUpdate:modelValue":s[5]||=e=>c.email=e,type:`text`},null,512),[[Z,c.email]])]),G(`label`,null,[s[18]||=q(`나이 `,-1),R(G(`input`,{"onUpdate:modelValue":s[6]||=e=>c.age=e,type:`number`},null,512),[[Z,c.age,void 0,{number:!0}]])]),G(`label`,ag,[R(G(`input`,{"onUpdate:modelValue":s[7]||=e=>c.agree=e,type:`checkbox`},null,512),[[ko,c.agree]]),s[19]||=q(` 약관 동의`,-1)]),G(`div`,{class:`buttons`},[G(`button`,{onClick:p},`전송`),G(`button`,{onClick:l},`초기화`)]),s[21]||=G(`pre`,{class:`code`},`Object.assign(form, INITIAL_FORM)`,-1),s[22]||=G(`p`,{class:`note`},`필드가 몇 개든 한 줄로 끝난다`,-1)])]),G(`div`,og,[G(`div`,null,[s[23]||=G(`p`,{class:`live-label`},`A · ref 4개를 손으로 조립`,-1),G(`pre`,null,O(o()),1)]),G(`div`,null,[s[24]||=G(`p`,{class:`live-label`},`B · reactive 객체를 그대로 사용`,-1),G(`pre`,null,O(u()),1)])]),d.value?(H(),U(`p`,sg,O(d.value),1)):J(``,!0)]))}},[[`__scopeId`,`data-v-be254916`]]),lg=t({default:()=>pg}),ug={class:`practice-card`},dg={class:`practice-area`},fg={class:`monitor`},pg=Q({__name:`MultiWatchPractice`,setup(e){let t=P(`서울`),n=P(`오늘`),r=P(`대기 중...`);return z([t,n],([e,t],[n,i])=>{r.value=`[변경 감지] ${n}(${i}) ➡️ ${e}(${t})`,console.log(`🤖 [통합 API 호출] ${e}의 ${t} 날씨를 불러옵니다...`)}),(e,i)=>(H(),U(`section`,ug,[G(`h2`,null,[i[4]||=q(` 여러 개의 변수 동시 감시 (Multi-Source Watch) `,-1),K($,{text:`watch의 첫 번째 인자에 배열을 넘기면 여러 값을 한 번에 감시합니다. 콜백이 받는 새 값·이전 값도 배열이며, 감시 대상을 적은 순서 그대로 매핑됩니다. 둘 중 하나만 바뀌어도 콜백이 한 번 실행됩니다.`})]),G(`div`,dg,[i[9]||=G(`h3`,null,`날씨 조건 설정`,-1),i[10]||=G(`label`,null,`도시: `,-1),R(G(`select`,{"onUpdate:modelValue":i[0]||=e=>t.value=e},[...i[5]||=[G(`option`,{value:`서울`},`서울`,-1),G(`option`,{value:`수원`},`수원`,-1),G(`option`,{value:`부산`},`부산`,-1)]],512),[[Mo,t.value]]),i[11]||=G(`p`,{class:`field-label`},`날짜:`,-1),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":i[1]||=e=>n.value=e,type:`radio`,value:`오늘`},null,512),[[jo,n.value]]),i[6]||=q(` 오늘`,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":i[2]||=e=>n.value=e,type:`radio`,value:`내일`},null,512),[[jo,n.value]]),i[7]||=q(` 내일`,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":i[3]||=e=>n.value=e,type:`radio`,value:`주간예보`},null,512),[[jo,n.value]]),i[8]||=q(` 주간예보`,-1)])]),G(`div`,fg,[i[12]||=G(`h3`,null,`통합 모니터링 로그`,-1),G(`p`,null,`현재 상태: `+O(r.value),1)])]))}},[[`__scopeId`,`data-v-25d6c99a`]]),mg=t({default:()=>yg}),hg={class:`practice-card`},gg={class:`practice-area`},_g={class:`monitor auto`},vg={class:`monitor target`},yg=Q({__name:`ReactiveArrayWatchPractice`,setup(e){let t=Lt([`서울`,`수원`]),n=P(`대기 중...`),r=P(`대기 중...`);return z(t,(e,t)=>{n.value=`[자동 감시] 배열 변동 발생! 옛날길이인척하는:${t.length} / 현재길이:${e.length}`}),z(()=>[...t],(e,t)=>{r.value=`[스냅샷 감시] 진짜 과거 길이:${t.length} (데이터: ${t}) ➡️ 바뀐 길이:${e.length}`}),(e,i)=>(H(),U(`section`,hg,[G(`h2`,null,[i[2]||=q(` reactive() 배열 감시 — 스냅샷 기법 `,-1),K($,{text:`배열도 객체와 같은 함정이 있습니다. 변수명을 그대로 넘기면 이전 배열과 현재 배열이 같은 것을 가리켜 비교가 불가능합니다. 스프레드로 복사본을 만들어([...cityList]) 감시하면 과거 상태가 그대로 보존됩니다.`})]),G(`div`,gg,[i[4]||=G(`h3`,null,`즐겨찾기 도시 목록 (reactive 배열)`,-1),G(`p`,null,[i[3]||=q(` 현재 등록된 도시: `,-1),G(`strong`,null,O(t),1)]),G(`button`,{onClick:i[0]||=e=>t.push(`부산`)},`부산 추가 (push)`),G(`button`,{onClick:i[1]||=e=>t.pop()},`최근 도시 삭제 (pop)`)]),G(`div`,_g,[i[5]||=G(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) cityList 변수명 쌩으로 감시`,-1),G(`p`,null,O(n.value),1),i[6]||=G(`small`,null,`※ 주의: 이전 배열과 현재 배열의 내용물·길이가 똑같이 동기화되어 버립니다.`,-1)]),G(`div`,vg,[i[7]||=G(`p`,{class:`monitor-title`},`🎯 2) () => [...cityList] 복사본 감시`,-1),G(`p`,null,O(r.value),1),i[8]||=G(`small`,null,`※ 성공: 과거 배열에 들어있던 내용물이 지워지지 않고 정상 대조됩니다.`,-1)])]))}},[[`__scopeId`,`data-v-e62c5023`]]),bg=t({default:()=>Tg}),xg={class:`practice-card`},Sg={class:`practice-area`},Cg={class:`practice-area`},wg=[`onClick`],Tg=Q({__name:`ReactiveStatePractice`,setup(e){let t=Lt({name:`이순신`,age:30}),n=()=>{t.age++},r=Lt([`사과`,`바나나`]),i=()=>{r.push(`과일 ${r.length+1}`)},a=e=>{r.splice(e,1)};return(e,o)=>(H(),U(`section`,xg,[G(`h2`,null,[o[0]||=q(` 반응형 상태 reactive() 특징 및 주의점 `,-1),K($,{text:`reactive()는 객체·배열 전용이며 .value 없이 바로 접근합니다. 다만 객체를 통째로 재할당(userReactive = { ... })하면 반응성이 끊기고, 원시값에는 쓸 수 없습니다. 그래서 실무는 ref()로 통일하는 추세입니다.`})]),G(`div`,Sg,[o[1]||=G(`h3`,null,`1) 객체(Object) reactive`,-1),G(`p`,null,`이름: `+O(t.name)+` / 나이: `+O(t.age)+`세`,1),G(`button`,{onClick:n},`reactive 나이 한 살 추가`)]),G(`div`,Cg,[o[2]||=G(`h3`,null,`2) 배열(Array) reactive`,-1),G(`ul`,null,[(H(!0),U(V,null,B(r,(e,t)=>(H(),U(`li`,{key:t},[q(O(e)+` `,1),G(`button`,{style:{"margin-left":`8px`,padding:`2px 8px`},onClick:e=>a(t)},` 삭제 `,8,wg)]))),128))]),G(`button`,{onClick:i},`과일 항목 추가`)])]))}},[[`__scopeId`,`data-v-524a2c66`]]),Eg=t({default:()=>jg}),Dg={class:`practice-card`},Og={class:`practice-area`},kg={class:`monitor auto`},Ag={class:`monitor target`},jg=Q({__name:`ReactiveWatchPractice`,setup(e){let t=Lt({productName:`노트북`,price:1e3}),n=P(`대기 중...`),r=P(`대기 중...`);return z(t,(e,t)=>{n.value=`[자동 deep] 가격 변동! 이전가격인척하는:${t.price}원 ➡️ 현재가격:${e.price}원`}),z(()=>t.price,(e,t)=>{r.value=`[타겟 조준] 가격이 진짜 올랐음! 옛날값:${t}원 ➡️ 바뀐값:${e}원`}),(e,i)=>(H(),U(`section`,Dg,[G(`h2`,null,[i[1]||=q(` reactive() 데이터 watch 감시 규칙 `,-1),K($,{text:`reactive 객체는 변수명을 그대로 넘기면 deep이 자동으로 켜져 내부 속성 변경까지 잡아냅니다. 다만 이전 값과 현재 값이 같은 객체를 가리켜서 oldVal이 쓸모없어집니다. 이전 값이 필요하면 화살표 함수로 특정 속성만 콕 집어야 합니다.`})]),G(`div`,Og,[i[2]||=G(`h3`,null,`🛒 상품 정보 관리 (reactive)`,-1),G(`p`,null,`상품명: `+O(t.productName)+` / 가격: `+O(t.price)+`원`,1),G(`button`,{onClick:i[0]||=e=>t.price+=500},`가격 500원 인상`)]),G(`div`,kg,[i[3]||=G(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) state 변수 통째로 감시 (deep 자동화)`,-1),G(`p`,null,O(n.value),1),i[4]||=G(`small`,null,`※ 주의: 이전 값과 현재 값이 똑같이 찍힌다.`,-1)]),G(`div`,Ag,[i[5]||=G(`p`,{class:`monitor-title`},`🎯 2) () => state.price 콕 집어 감시 (과거 추적)`,-1),G(`p`,null,O(r.value),1),i[6]||=G(`small`,null,`※ 성공: 과거의 원본 가격이 칼같이 보존된다.`,-1)])]))}},[[`__scopeId`,`data-v-50148cb5`]]),Mg=t({default:()=>Rg}),Ng={class:`practice-card`},Pg={class:`practice-area`},Fg={class:`log text`},Ig={class:`practice-area`},Lg={class:`log object`},Rg=Q({__name:`RefArrayWatchPractice`,setup(e){let t=P([`홍길동`,`이순신`,`강감찬`]),n=P(`대기 중...`),r=P([{name:`서울`,temp:25},{name:`수원`,temp:22}]),i=P(`대기 중...`);return z(()=>t.value[0],(e,t)=>{n.value=`[방출/영입] 0번 선수 교체: ${t} ➡️ ${e}`}),z(()=>r.value[0],e=>{i.value=`[날씨 변동] 서울의 온도가 현재 ${e.temp}°C 로 변경되었습니다.`},{deep:!0}),(e,a)=>(H(),U(`section`,Ng,[G(`h2`,null,[a[2]||=q(` ref 배열의 특정 인덱스 감시하기 `,-1),K($,{text:`배열의 특정 요소만 감시하려면 화살표 함수로 콕 집어야 합니다. 다만 그 요소가 문자열이면 그대로 동작하지만, 객체라면 { deep: true }가 없으면 내부 속성 변경을 감지하지 못합니다. 가리키는 대상의 타입에 따라 규칙이 달라집니다.`})]),G(`div`,Pg,[G(`h3`,null,`🏃‍♂️ 1) 문자열 배열: 현재 0번 멤버 [ `+O(t.value[0])+` ]`,1),G(`button`,{onClick:a[0]||=e=>t.value[0]=`손흥민`},`0번 멤버를 손흥민으로 교체`),G(`p`,Fg,`로그: `+O(n.value),1)]),G(`div`,Ig,[G(`h3`,null,`⛅ 2) 객체형 배열: 현재 `+O(r.value[0].name)+` 기온 [ `+O(r.value[0].temp)+`°C ]`,1),G(`button`,{onClick:a[1]||=e=>r.value[0].temp++},`서울 기온 1도 올리기 (temp++)`),G(`p`,Lg,`로그: `+O(i.value),1)])]))}},[[`__scopeId`,`data-v-b0ee05f5`]]),zg=t({default:()=>Vg}),Bg={class:`practice-card`},Vg={__name:`RefStatePractice`,setup(e){let t=P(0),n=P(`홍길동`),r=P(!0),i=P([`사과`,`배`]),a=P({name:`이순신`,age:30}),o=()=>{t.value++},s=()=>{a.value.name=`장보고`};return(e,c)=>(H(),U(`section`,Bg,[G(`h2`,null,[c[3]||=q(` 반응형 상태 ref() 기초 `,-1),K($,{text:`ref()는 값을 반응형 상자에 담습니다. script에서는 .value로 상자를 열어야 하고, template에서는 자동 언래핑되어 .value 없이 씁니다. 객체나 배열을 담아도 내부 속성 변경까지 감지됩니다.`})]),G(`p`,null,[c[4]||=q(` Ref 카운트: `,-1),G(`strong`,null,O(t.value),1)]),G(`p`,null,[c[5]||=q(`이름: `,-1),R(G(`input`,{"onUpdate:modelValue":c[0]||=e=>n.value=e},null,512),[[Z,n.value]]),q(O(n.value),1)]),G(`p`,null,`활성 상태: `+O(r.value?`활성`:`비활성`),1),G(`p`,null,`과일 목록: `+O(i.value.join(`, `)),1),G(`p`,null,`사용자 정보: 이름 - `+O(a.value.name)+`, 나이 - `+O(a.value.age),1),G(`button`,{onClick:o},`Ref 변수 증가`),G(`button`,{onClick:c[1]||=e=>r.value=!r.value},`토글`),G(`button`,{onClick:c[2]||=e=>i.value.push(`귤`)},`과일 추가`),G(`button`,{onClick:s},`사용자 이름 변경`)]))}},Hg=t({default:()=>t_}),Ug={class:`practice-card`},Wg={class:`todo-input`},Gg=[`disabled`],Kg={class:`filter`},qg={key:0,class:`todo-list`},Jg=[`checked`,`onChange`],Yg=[`onKeyup`,`onBlur`],Xg=[`onClick`],Zg=[`onClick`],Qg={key:1,class:`empty`},$g={key:2,class:`empty`},e_={key:3,class:`todo-foot`},t_=Q({__name:`TodoAdvancedPractice`,setup(e){let t=P([{id:1,title:`장보기`,done:!1},{id:2,title:`Vue 복습하기`,done:!0}]),n=P(``),r=3,i=()=>{let e=n.value.trim();e&&(t.value.push({id:r,title:e,done:!1}),r++,n.value=``)},a=e=>{e.done=!e.done},o=e=>{t.value=t.value.filter(t=>t.id!==e)},s=P(null),c=P(``),l=P(null),u=async e=>{s.value=e.id,c.value=e.title,await vn(),l.value?.focus()},d=e=>{if(s.value===null)return;let t=c.value.trim();t&&(e.title=t),s.value=null},f=()=>{s.value=null},p=P(!1),m=X(()=>p.value?t.value.filter(e=>!e.done):t.value),h=X(()=>t.value.filter(e=>!e.done).length),g=X(()=>t.value.length-h.value);return(e,r)=>(H(),U(`section`,Ug,[G(`h2`,null,[r[3]||=q(` 할 일 목록 응용 2 — 잠금 · 수정 · 필터 `,-1),K($,{text:`세 가지를 얹었습니다. ① :disabled로 빈 입력일 때 버튼 잠그기 ② 제목을 클릭해 인라인 수정(수정 중 상태를 ref로 관리) ③ computed로 필터와 집계를 옮기기. computed는 CC06에서 정식으로 배우지만 여기서 미리 써 봅니다.`})]),G(`div`,Wg,[R(G(`input`,{"onUpdate:modelValue":r[0]||=e=>n.value=e,type:`text`,placeholder:`할 일을 입력하고 Enter`,onKeyup:Bo(i,[`enter`])},null,544),[[Z,n.value]]),G(`button`,{disabled:!n.value.trim(),onClick:i},`추가`,8,Gg)]),G(`label`,Kg,[R(G(`input`,{"onUpdate:modelValue":r[1]||=e=>p.value=e,type:`checkbox`},null,512),[[ko,p.value]]),r[4]||=q(` 남은 일만 보기 `,-1)]),m.value.length?(H(),U(`ul`,qg,[(H(!0),U(V,null,B(m.value,e=>(H(),U(`li`,{key:e.id,class:D({done:e.done})},[G(`input`,{type:`checkbox`,checked:e.done,onChange:t=>a(e)},null,40,Jg),s.value===e.id?R((H(),U(`input`,{key:0,ref_for:!0,ref:e=>e&&(l.value=e),"onUpdate:modelValue":r[2]||=e=>c.value=e,class:`edit-input`,onKeyup:[Bo(t=>d(e),[`enter`]),Bo(f,[`esc`])],onBlur:t=>d(e)},null,40,Yg)),[[Z,c.value]]):(H(),U(`span`,{key:1,class:`title`,title:`클릭하면 제목을 고칠 수 있습니다`,onClick:t=>u(e)},O(e.title),9,Xg)),G(`button`,{onClick:t=>o(e.id)},`삭제`,8,Zg)],2))),128))])):t.value.length?(H(),U(`p`,Qg,` 🎉 남은 일이 없습니다. 필터를 끄면 완료한 항목을 볼 수 있어요. `)):(H(),U(`p`,$g,`아직 할 일이 없습니다. 위에서 하나 추가해 보세요.`)),t.value.length?(H(),U(`div`,e_,[G(`span`,null,[r[5]||=q(` 전체 `,-1),G(`b`,null,O(t.value.length),1),r[6]||=q(` · 남은 일 `,-1),G(`b`,null,O(h.value),1),r[7]||=q(` · 완료 `,-1),G(`b`,null,O(g.value),1)]),r[8]||=G(`span`,{class:`hint`},`제목을 클릭 → 수정 · Enter 확정 · Esc 취소`,-1)])):J(``,!0)]))}},[[`__scopeId`,`data-v-f5c37e4e`]]),n_=t({default:()=>d_}),r_={class:`practice-card`},i_={class:`todo-input`},a_={key:0,class:`todo-list`},o_=[`checked`,`onChange`],s_={class:`title`},c_=[`onClick`],l_={key:1,class:`empty`},u_={key:2,class:`todo-foot`},d_=Q({__name:`TodoListPractice`,setup(e){let t=P([]),n=P(``),r=1,i=()=>{let e=n.value.trim();e&&(t.value.push({id:r,title:e,done:!1}),r++,n.value=``)},a=e=>{e.done=!e.done},o=e=>{t.value=t.value.filter(t=>t.id!==e)},s=()=>{t.value=t.value.filter(e=>!e.done)};return(e,r)=>(H(),U(`section`,r_,[G(`h2`,null,[r[1]||=q(` 할 일 목록 — ref 배열 응용 `,-1),K($,{text:`ref([])에 객체를 담아 목록을 관리하는 연습입니다. 추가는 push, 삭제는 filter로 새 배열을 만들어 교체합니다. 배열 안 객체의 속성(done)을 직접 바꿔도 ref가 변화를 감지해 화면이 갱신됩니다.`})]),G(`div`,i_,[R(G(`input`,{"onUpdate:modelValue":r[0]||=e=>n.value=e,type:`text`,placeholder:`할 일을 입력하고 Enter`,onKeyup:Bo(i,[`enter`])},null,544),[[Z,n.value]]),G(`button`,{onClick:i},`추가`)]),t.value.length?(H(),U(`ul`,a_,[(H(!0),U(V,null,B(t.value,e=>(H(),U(`li`,{key:e.id,class:D({done:e.done})},[G(`input`,{type:`checkbox`,checked:e.done,onChange:t=>a(e)},null,40,o_),G(`span`,s_,O(e.title),1),G(`button`,{class:`remove`,onClick:t=>o(e.id)},`삭제`,8,c_)],2))),128))])):(H(),U(`p`,l_,`아직 할 일이 없습니다. 위에서 하나 추가해 보세요.`)),t.value.length?(H(),U(`div`,u_,[G(`span`,null,[r[2]||=q(` 전체 `,-1),G(`b`,null,O(t.value.length),1),r[3]||=q(` · 남은 일 `,-1),G(`b`,null,O(t.value.filter(e=>!e.done).length),1),r[4]||=q(` · 완료 `,-1),G(`b`,null,O(t.value.filter(e=>e.done).length),1)]),G(`button`,{onClick:s},`완료한 항목 지우기`)])):J(``,!0)]))}},[[`__scopeId`,`data-v-db2e98ce`]]),f_=t({default:()=>g_}),p_={class:`practice-card`},m_={class:`practice-area`},h_={class:`monitor`},g_=Q({__name:`WatchEffectPractice`,setup(e){let t=P(`홍길동`),n=P(20),r=P(`대기 중...`);return Pn(()=>{r.value=`[자동 감지] 이름: ${t.value} / 나이: ${n.value}세`,console.log(`🤖 watchEffect가 내부 변수 변경을 감지하여 실행되었습니다.`)}),(e,i)=>(H(),U(`section`,p_,[G(`h2`,null,[i[2]||=q(` 자동 감시자 watchEffect() `,-1),K($,{text:`watchEffect는 감시 대상을 적지 않습니다. 함수 안에서 읽은 반응형 값이 자동으로 의존성이 됩니다. 그리고 등록되는 즉시 한 번 실행되는 점이 watch와 가장 큰 차이입니다. 대신 이전 값은 받을 수 없습니다.`})]),G(`div`,m_,[G(`p`,null,`이름: `+O(t.value)+` / 나이: `+O(n.value)+`세`,1),G(`button`,{onClick:i[0]||=e=>t.value=`이순신`},`이름을 '이순신'으로 변경`),G(`button`,{onClick:i[1]||=e=>n.value++},`나이 한 살 추가 (age++)`)]),G(`div`,h_,[i[3]||=G(`h3`,null,`👁️‍🗨️ watchEffect 자동 모니터링 시스템`,-1),G(`p`,null,O(r.value),1),i[4]||=G(`small`,null,` ※ 새로고침하자마자 버튼을 안 눌러도 로그가 이미 찍혀있는 특징을 주목하세요! `,-1)])]))}},[[`__scopeId`,`data-v-542ebb87`]]),__=t({default:()=>x_}),v_={class:`practice-card`},y_={class:`practice-area`},b_={class:`monitor`},x_=Q({__name:`WatchPractice`,setup(e){let t=P(`서울`),n=P(`아직 감시 시스템이 작동하지 않았습니다.`);return z(t,(e,t)=>{n.value=`📍 감시자 발동! [${t}]에서 [${e}]로 변경됨.`,console.log(`🤖 [서버 요청 완료] 기상청 서버에서 ${e}의 날씨 API를 다시 조회합니다...`)}),(e,r)=>(H(),U(`section`,v_,[G(`h2`,null,[r[3]||=q(` 감시자 watch()의 원리와 실무 활용 `,-1),K($,{text:`watch()는 값이 바뀌는 순간 무언가를 실행하는 감시자입니다. 콜백은 (새 값, 이전 값)을 받습니다. 화면에 보여줄 값은 computed로, API 호출·로그 같은 부수 효과는 watch로 처리합니다.`})]),G(`div`,y_,[r[4]||=G(`h3`,null,`🏙️ 지역 선택 제어판`,-1),G(`p`,null,`현재 선택된 도시: `+O(t.value),1),G(`button`,{onClick:r[0]||=e=>t.value=`서울`},`서울 선택`),G(`button`,{onClick:r[1]||=e=>t.value=`수원`},`수원 선택`),G(`button`,{onClick:r[2]||=e=>t.value=`부산`},`부산 선택`)]),G(`div`,b_,[r[5]||=G(`h3`,null,`👁️‍🗨️ 파수꾼(watch) 모니터링 시스템`,-1),G(`p`,null,O(n.value),1),r[6]||=G(`small`,null,`(버튼을 누른 후 브라우저 콘솔창 F12를 확인해 보세요)`,-1)])]))}},[[`__scopeId`,`data-v-f25592fe`]]),S_=`<script setup>
import { ref } from 'vue'
...
`,ev=Object.assign({"./basic/BindPractice.vue":Vd,"./basic/ConditionalPractice.vue":tf,"./basic/EventPractice.vue":pf,"./basic/ForPractice.vue":Tf,"./basic/HtmlTextPractice.vue":kf,"./basic/ModelPractice.vue":Lf,"./basic/ReactivityPractice.vue":rp,"./basic/SpecialDirectivePractice.vue":op,"./component/ComponentRegistrationPractice.vue":gp,"./component/LifecyclePractice.vue":Tp,"./component/PropsEmitsPractice.vue":jp,"./component/PropsFlowPractice.vue":Bp,"./component/PropsReadonlyPractice.vue":rm,"./component/ProvideInjectPractice.vue":ym,"./component/SiblingTalkPractice.vue":Pm,"./component/SlotBaseCardPractice.vue":Gm,"./component/SlotListPractice.vue":th,"./component/SlotModalPractice.vue":bh,"./component/SlotPractice.vue":Lh,"./composition/ComputedCachePractice.vue":Wh,"./composition/DeepWatchPractice.vue":qh,"./composition/FormStatePractice.vue":$h,"./composition/MultiWatchPractice.vue":lg,"./composition/ReactiveArrayWatchPractice.vue":mg,"./composition/ReactiveStatePractice.vue":bg,"./composition/ReactiveWatchPractice.vue":Eg,"./composition/RefArrayWatchPractice.vue":Mg,"./composition/RefStatePractice.vue":zg,"./composition/TodoAdvancedPractice.vue":Hg,"./composition/TodoListPractice.vue":n_,"./composition/WatchEffectPractice.vue":f_,"./composition/WatchPractice.vue":__}),tv=e=>e.split(`/`).pop().replace(`.vue`,``),nv=Object.fromEntries(Object.entries(ev).map(([e,t])=>[tv(e),t.default])),rv=Object.fromEntries(Object.entries(ev).map(([e])=>[tv(e),e.replace(`./`,`src/components/practices/`)]));Object.keys(nv).sort();var iv=e=>nv[e]??null,av=e=>rv[e]??``,ov=Object.fromEntries(Object.entries(Object.assign({"./basic/BindPractice.vue":S_,"./basic/ConditionalPractice.vue":C_,"./basic/EventPractice.vue":w_,"./basic/ForPractice.vue":T_,"./basic/HtmlTextPractice.vue":E_,"./basic/ModelPractice.vue":D_,"./basic/ReactivityPractice.vue":O_,"./basic/SpecialDirectivePractice.vue":k_,"./component/ComponentRegistrationPractice.vue":A_,"./component/LifecyclePractice.vue":j_,"./component/PropsEmitsPractice.vue":M_,"./component/PropsFlowPractice.vue":N_,"./component/PropsReadonlyPractice.vue":P_,"./component/ProvideInjectPractice.vue":F_,"./component/SiblingTalkPractice.vue":I_,"./component/SlotBaseCardPractice.vue":L_,"./component/SlotListPractice.vue":R_,"./component/SlotModalPractice.vue":z_,"./component/SlotPractice.vue":B_,"./composition/ComputedCachePractice.vue":V_,"./composition/DeepWatchPractice.vue":H_,"./composition/FormStatePractice.vue":U_,"./composition/MultiWatchPractice.vue":W_,"./composition/ReactiveArrayWatchPractice.vue":G_,"./composition/ReactiveStatePractice.vue":K_,"./composition/ReactiveWatchPractice.vue":q_,"./composition/RefArrayWatchPractice.vue":J_,"./composition/RefStatePractice.vue":Y_,"./composition/TodoAdvancedPractice.vue":X_,"./composition/TodoListPractice.vue":Z_,"./composition/WatchEffectPractice.vue":Q_,"./composition/WatchPractice.vue":$_})).map(([e,t])=>[tv(e),t])),sv=e=>ov[e]??``,cv=[`id`],lv=[`aria-expanded`,`title`],uv={class:`card-chevron`,"aria-hidden":`true`},dv={class:`head-text`},fv={class:`label`},pv={class:`slide`},mv={key:0,class:`goal`},hv={key:1,class:`card-summary`},gv={class:`head-badges`},_v={key:0,class:`badge live`},vv={key:1,class:`tasks`},yv={key:2,class:`fold pitfalls`},bv={class:`fold-body`},xv={key:0,class:`compare`},Sv={key:0,class:`bad`},Cv={key:1,class:`good`},wv={class:`why`},Tv={key:3,class:`practice-note`},Ev={class:`practice-head`},Dv=[`aria-expanded`,`title`],Ov={class:`chevron`,"aria-hidden":`true`},kv={key:0,class:`count`},Av={class:`practice-hint`},jv={class:`practice-main`},Mv={key:0,class:`practice-mounts`},Nv={class:`slot-tools`},Pv=[`onClick`],Fv=[`onClick`],Iv={key:1,class:`practice-empty`},Lv={key:2,class:`practice-missing`},Rv=[`aria-expanded`,`title`],zv={class:`side-chevron`,"aria-hidden":`true`},Bv={class:`side-body`},Vv={key:0,class:`side-block`},Hv={class:`side-heading`},Uv=[`onClick`],Wv={class:`guide`},Gv=[`innerHTML`],Kv={class:`guide-see`},qv=[`innerHTML`],Jv={key:0,class:`guide-why`},Yv=[`innerHTML`],Xv={key:1,class:`group-extras`},Zv={key:1,class:`side-block fold extensions`},Qv={class:`fold-body`},$v={key:5,class:`fold extensions`},ey={class:`fold-body`},ty=Q({__name:`ChallengeCard`,props:{challenge:{type:Object,required:!0}},setup(e){let t=e,n=X(()=>t.challenge.practices.map(e=>({name:e,component:iv(e)})).filter(e=>e.component)),r=X(()=>t.challenge.practices.filter(e=>!iv(e))),i=X(()=>n.value.length>0),a=X(()=>t.challenge.practiceGuide??[]),o=X(()=>{let e=[];for(let t of a.value)t.practice||e.length===0?e.push({label:t.practice??null,steps:[t]}):e[e.length-1].steps.push(t);return e.map(e=>({...e,extras:l.value.filter(t=>typeof t==`object`&&t.practice===e.label)}))}),s=X(()=>{let e=new Set(o.value.map(e=>e.label));return l.value.filter(t=>typeof t==`string`||!e.has(t.practice))}),c=e=>typeof e==`string`?e:e.text,l=X(()=>t.challenge.extensions??[]),u=X(()=>i.value&&(a.value.length>0||l.value.length>0)),d=P(!0),f=P(!0),p=P(!1),m=X(()=>{let e=[];return t.challenge.tasks?.length&&e.push(`연습 ${t.challenge.tasks.length}`),t.challenge.pitfalls?.length&&e.push(`주의 ${t.challenge.pitfalls.length}`),n.value.length&&e.push(`실습 ${n.value.length}`),e.join(` · `)}),h=X(()=>!u.value&&l.value.length>0),g=Lt({}),_=e=>`${e}-${g[e]??0}`,v=e=>{g[e]=(g[e]??0)+1},y=()=>{n.value.forEach(e=>v(e.name))},b=P(null),x=e=>{b.value=e},S=P(null),C=e=>e.replace(/\s+/g,` `).trim(),ee=(e,t)=>{let n=S.value;if(!n)return;let r=[...n.querySelectorAll(`.practice-slot`)];if(!r.length)return;let i=r.find(t=>{let n=t.querySelector(`h2`);return n&&C(n.textContent)===C(e??``)})??r[t]??r[0];i.scrollIntoView({behavior:`smooth`,block:`center`}),i.classList.add(`is-target`),setTimeout(()=>i.classList.remove(`is-target`),1400)};return(t,g)=>(H(),U(`article`,{id:`challenge-${e.challenge.id}`,ref_key:`cardEl`,ref:S,class:D([`challenge`,[e.challenge.status,{collapsed:!p.value}]])},[G(`header`,{class:`challenge-head`,role:`button`,tabindex:`0`,"aria-expanded":p.value,title:p.value?`이 챌린지 접기`:`이 챌린지 펼치기`,onClick:g[0]||=e=>p.value=!p.value,onKeydown:[g[1]||=Bo(Ro(e=>p.value=!p.value,[`prevent`]),[`enter`]),g[2]||=Bo(Ro(e=>p.value=!p.value,[`prevent`]),[`space`])]},[G(`span`,uv,O(p.value?`▾`:`▸`),1),G(`div`,dv,[G(`p`,fv,[q(O(e.challenge.label)+` `,1),G(`span`,pv,`교안 `+O(e.challenge.slidePage),1)]),G(`h3`,null,O(e.challenge.title),1),p.value?(H(),U(`p`,mv,O(e.challenge.goal),1)):m.value?(H(),U(`p`,hv,O(m.value),1)):J(``,!0)]),G(`div`,gv,[G(`span`,{class:D([`badge`,e.challenge.status])},O(e.challenge.status===`done`?`학습 완료`:`진행 예정`),3),i.value?(H(),U(`span`,_v,` 실습 `+O(n.value.length)+`개 `,1)):J(``,!0)])],40,lv),p.value?(H(),U(V,{key:0},[e.challenge.lecture?(H(),W(Od,{key:0,lecture:e.challenge.lecture,"study-range":e.challenge.studyRange},null,8,[`lecture`,`study-range`])):J(``,!0),e.challenge.tasks?.length?(H(),U(`section`,vv,[g[6]||=G(`p`,{class:`section-label`},`✎ 연습 항목`,-1),G(`ul`,null,[(H(!0),U(V,null,B(e.challenge.tasks,e=>(H(),U(`li`,{key:e},O(e),1))),128))])])):J(``,!0),e.challenge.pitfalls?.length?(H(),U(`details`,yv,[G(`summary`,null,[g[7]||=G(`span`,{"aria-hidden":`true`},`⚠`,-1),g[8]||=q(` 조심할 점 `,-1),G(`b`,null,O(e.challenge.pitfalls.length),1)]),G(`div`,bv,[(H(!0),U(V,null,B(e.challenge.pitfalls,(e,t)=>(H(),U(`div`,{key:t,class:`pitfall`},[e.bad||e.good?(H(),U(`div`,xv,[e.bad?(H(),U(`p`,Sv,[g[9]||=G(`span`,null,`❌`,-1),G(`code`,null,O(e.bad),1)])):J(``,!0),e.good?(H(),U(`p`,Cv,[g[10]||=G(`span`,null,`✅`,-1),G(`code`,null,O(e.good),1)])):J(``,!0)])):J(``,!0),G(`p`,wv,O(e.why),1)]))),128))])])):J(``,!0),!i.value&&e.challenge.practiceNote?(H(),U(`p`,Tv,[g[11]||=G(`span`,{"aria-hidden":`true`},`✓`,-1),q(` `+O(e.challenge.practiceNote),1)])):(H(),U(`section`,{key:4,class:D([`practice-zone`,{closed:!f.value}])},[G(`header`,Ev,[G(`button`,{type:`button`,class:`practice-toggle`,"aria-expanded":f.value,title:f.value?`실습 화면 접기`:`실습 화면 펼치기`,onClick:g[3]||=e=>f.value=!f.value},[G(`span`,Ov,O(f.value?`▾`:`▸`),1),g[12]||=G(`span`,{class:`practice-mark`,"aria-hidden":`true`},`🖥`,-1),g[13]||=G(`span`,{class:`practice-title`},`실습 화면`,-1),i.value?(H(),U(`span`,kv,O(n.value.length),1)):J(``,!0)],8,Dv),G(`span`,Av,O(f.value?`직접 눌러보며 동작을 확인하세요`:`접어 둠 · 제목을 눌러 펼치기`),1),n.value.length>1&&f.value?(H(),U(`button`,{key:0,type:`button`,class:`reset-button reset-all`,"aria-label":`실습 전체 초기화`,title:`이 챌린지의 실습을 모두 처음 상태로 되돌립니다`,onClick:y},[...g[14]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),G(`path`,{d:`M20 4v4.5h-4.5`})],-1)]])):J(``,!0)]),R(G(`div`,{class:D([`practice-body`,{"has-guide":u.value,"side-closed":u.value&&!d.value}])},[G(`div`,jv,[i.value?(H(),U(`div`,Mv,[(H(!0),U(V,null,B(n.value,e=>(H(),U(`div`,{key:e.name,class:`practice-slot`},[G(`div`,Nv,[G(`button`,{type:`button`,class:`icon-button`,"aria-label":`소스 코드 보기`,title:`소스 코드를 새 창으로 엽니다`,onClick:t=>x(e.name)},[...g[15]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M9 7 4 12l5 5M15 7l5 5-5 5`})],-1)]],8,Pv),G(`button`,{type:`button`,class:`icon-button`,"aria-label":`이 실습 초기화`,title:`이 실습만 처음 상태로 되돌립니다 (페이지 새로고침 없음)`,onClick:t=>v(e.name)},[...g[16]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),G(`path`,{d:`M20 4v4.5h-4.5`})],-1)]],8,Fv)]),(H(),W(Er(e.component),{key:_(e.name)}))]))),128))])):(H(),U(`p`,Iv,[...g[17]||=[q(` 아직 이 챌린지에 연결된 실습 화면이 없습니다. `,-1),G(`code`,null,`src/components/practices/`,-1),q(` 에 컴포넌트를 추가하고 `,-1),G(`code`,null,`curriculum.js`,-1),q(` 의 `,-1),G(`code`,null,`practices`,-1),q(` 에 이름을 넣으면 여기에 나타납니다. `,-1)]])),r.value.length?(H(),U(`p`,Lv,` ⚠ 파일을 찾지 못한 실습: `+O(r.value.join(`, `)),1)):J(``,!0)]),u.value?(H(),U(`aside`,{key:0,class:D([`guide-side`,{collapsed:!d.value}])},[G(`button`,{type:`button`,class:`side-toggle`,"aria-expanded":d.value,title:d.value?`접어서 실습 화면 넓히기`:`실습 도우미 펼치기`,onClick:g[4]||=e=>d.value=!d.value},[g[18]||=G(`span`,{class:`side-toggle-label`},[G(`span`,{"aria-hidden":`true`},`✓`),q(` 실습 도우미 `)],-1),G(`span`,zv,O(d.value?`›`:`‹`),1)],8,Rv),R(G(`div`,Bv,[a.value.length?(H(),U(`section`,Vv,[G(`p`,Hv,[g[19]||=q(` 확인 가이드 `,-1),G(`b`,null,O(a.value.length),1)]),(H(!0),U(V,null,B(o.value,(e,t)=>(H(),U(`div`,{key:t,class:`guide-group`},[e.label?(H(),U(`button`,{key:0,type:`button`,class:`guide-chip`,title:`이 실습으로 이동합니다`,onClick:n=>ee(e.label,t)},[q(O(e.label)+` `,1),g[20]||=G(`span`,{class:`jump`,"aria-hidden":`true`},`↓`,-1)],8,Uv)):J(``,!0),G(`ol`,Wv,[(H(!0),U(V,null,B(e.steps,(e,t)=>(H(),U(`li`,{key:t},[G(`p`,{class:`guide-do`,innerHTML:F(cd)(e.do)},null,8,Gv),G(`p`,Kv,[g[21]||=G(`b`,null,`확인`,-1),g[22]||=q(),G(`span`,{innerHTML:F(cd)(e.see)},null,8,qv)]),e.why?(H(),U(`p`,Jv,[g[23]||=G(`b`,null,`왜`,-1),g[24]||=q(),G(`span`,{innerHTML:F(cd)(e.why)},null,8,Yv)])):J(``,!0)]))),128))]),e.extras.length?(H(),U(`div`,Xv,[g[25]||=G(`p`,{class:`extras-label`},[G(`span`,{"aria-hidden":`true`},`🚀`),q(` 더 해보기`)],-1),G(`ul`,null,[(H(!0),U(V,null,B(e.extras,(e,t)=>(H(),U(`li`,{key:t},O(c(e)),1))),128))])])):J(``,!0)]))),128))])):J(``,!0),s.value.length?(H(),U(`details`,Zv,[G(`summary`,null,[g[26]||=G(`span`,{"aria-hidden":`true`},`🚀`,-1),g[27]||=q(` 더 해보기 (전체) `,-1),G(`b`,null,O(s.value.length),1)]),G(`div`,Qv,[G(`ul`,null,[(H(!0),U(V,null,B(s.value,(e,t)=>(H(),U(`li`,{key:t},O(c(e)),1))),128))])])])):J(``,!0)],512),[[Ja,d.value]])],2)):J(``,!0)],2),[[Ja,f.value]])],2)),h.value?(H(),U(`details`,$v,[G(`summary`,null,[g[28]||=G(`span`,{"aria-hidden":`true`},`🚀`,-1),g[29]||=q(` 더 해보기 (심화 응용) `,-1),G(`b`,null,O(l.value.length),1)]),G(`div`,ey,[G(`ul`,null,[(H(!0),U(V,null,B(l.value,(e,t)=>(H(),U(`li`,{key:t},O(c(e)),1))),128))])])])):J(``,!0)],64)):J(``,!0),b.value?(H(),W(Fd,{key:1,path:F(av)(b.value),code:F(sv)(b.value),onClose:g[5]||=e=>b.value=null},null,8,[`path`,`code`])):J(``,!0)],10,cv))}},[[`__scopeId`,`data-v-6e637b45`]]),ny=[`aria-expanded`],ry={class:`chevron`,"aria-hidden":`true`},iy={class:`orientation-body`},ay={class:`rule`},oy={class:`lead`},sy={class:`cargo`},cy={class:`name`},ly={class:`payload`},uy={"aria-hidden":`true`},dy=[`innerHTML`],fy={class:`priority`},py={class:`p-name`},my={class:`p-weight`},hy={class:`p-when`},gy={class:`keep`},_y=[`innerHTML`],vy=Q({__name:`ChapterOrientation`,props:{orientation:{type:Object,required:!0}},setup(e){let t=P(!0);return(n,r)=>(H(),U(`section`,{class:D([`orientation`,{closed:!t.value}])},[G(`button`,{class:`orientation-toggle`,type:`button`,"aria-expanded":t.value,onClick:r[0]||=e=>t.value=!t.value},[r[1]||=G(`span`,{class:`marker`,"aria-hidden":`true`},`🧭`,-1),r[2]||=G(`span`,{class:`toggle-title`},`시작하기 전에 — 규칙은 하나뿐입니다`,-1),G(`span`,ry,O(t.value?`−`:`+`),1)],8,ny),R(G(`div`,iy,[G(`p`,ay,O(e.orientation.rule),1),G(`p`,oy,O(e.orientation.lead),1),G(`ul`,sy,[(H(!0),U(V,null,B(e.orientation.cargo,e=>(H(),U(`li`,{key:e.name},[G(`code`,cy,O(e.name),1),G(`span`,ly,O(e.payload),1),G(`span`,{class:D([`dir`,e.dir===`위로`?`up`:`down`])},[G(`span`,uy,O(e.dir===`위로`?`↑`:`↓`),1),q(` `+O(e.dir),1)],2)]))),128))]),G(`p`,{class:`why`,innerHTML:F(cd)(e.orientation.why)},null,8,dy),r[4]||=G(`p`,{class:`priority-label`},`실제로 쓰는 비중`,-1),G(`ul`,fy,[(H(!0),U(V,null,B(e.orientation.priority,e=>(H(),U(`li`,{key:e.name,class:D(e.level)},[G(`span`,py,O(e.name),1),G(`span`,my,O(e.weight),1),G(`span`,hy,O(e.when),1)],2))),128))]),G(`p`,gy,[r[3]||=G(`span`,{class:`keep-label`},`이것만은`,-1),G(`span`,{innerHTML:F(cd)(e.orientation.keep)},null,8,_y)])],512),[[Ja,t.value]])],2))}},[[`__scopeId`,`data-v-bfb97b66`]]),yy={class:`chapter-nav`},by={class:`nav-head`},xy={key:0,class:`nav-title`},Sy=[`title`,`aria-label`],Cy=[`title`,`onClick`],wy={class:`chapter-no`},Ty={key:0,class:`chapter-info`},Ey={key:1,class:`chapter-meta`},Dy=[`title`],Oy={key:0,class:`nav-legend`},ky={key:0},Ay={id:`learning-content`,class:`learning-content`},jy={class:`chapter-head`},My={class:`eyebrow`},Ny={class:`chapter-summary`},Py={class:`topic-chips`},Fy={key:1,class:`challenge-stack`},Iy={key:2,class:`empty-state`},Ly={key:3,class:`linked-assignments`},Ry={class:`step`},zy=Q({__name:`LearningView`,setup(e){let t=P(2),n=P(!1),r=X(()=>qo.find(e=>e.id===t.value)),i=X(()=>$o(t.value)),a=X(()=>es(t.value)),o=X(()=>qo.map(e=>{let t=$o(e.id),n=t.filter(e=>e.label.startsWith(`Code Challenge`));return{...e,total:n.length,live:t.filter(e=>e.practices.length>0).length,assignments:es(e.id).length}})),s=()=>{window.scrollTo({top:0,behavior:`smooth`})},c=e=>{t.value=e,document.getElementById(`learning-content`)?.scrollIntoView({behavior:`smooth`,block:`start`})};return(e,l)=>(H(),U(V,null,[l[6]||=G(`section`,{class:`page-intro`},[G(`p`,{class:`eyebrow`},`LEARNING & CODE CHALLENGES`),G(`h1`,null,`학습 & 코드 챌린지`),G(`p`,null,[q(` 왼쪽에서 챕터를 고르면 해당 챕터의 `),G(`strong`,null,`코드 챌린지`),q(`가 열립니다. 각 챌린지는 `),G(`strong`,null,`관련 강의 내용 → 연습 항목 → 실습 화면`),q(` 순서로 이어집니다. `)])],-1),G(`section`,{class:D([`learning-layout`,{"nav-collapsed":n.value}])},[G(`aside`,yy,[G(`div`,by,[n.value?J(``,!0):(H(),U(`p`,xy,`학습 로드맵`)),G(`button`,{type:`button`,class:`nav-toggle`,title:n.value?`메뉴 펼치기`:`메뉴 접기`,"aria-label":n.value?`메뉴 펼치기`:`메뉴 접기`,onClick:l[0]||=e=>n.value=!n.value},O(n.value?`»`:`«`),9,Sy)]),(H(!0),U(V,null,B(o.value,e=>(H(),U(`button`,{key:e.id,type:`button`,class:D([`chapter-item`,{active:e.id===t.value}]),title:n.value?`${e.title} · ${e.slides}`:``,onClick:t=>c(e.id)},[G(`span`,wy,O(String(e.id).padStart(2,`0`)),1),n.value?J(``,!0):(H(),U(`span`,Ty,[G(`b`,null,O(e.title),1),G(`small`,null,O(e.slides),1)])),n.value?J(``,!0):(H(),U(`span`,Ey,[G(`i`,{class:D([`dot`,{live:e.live,none:!e.total}]),title:e.total?`코드 챌린지 ${e.total}개${e.live?` · 실습 화면 ${e.live}개`:``}`:`코드 챌린지 없음`},O(e.total||`–`),11,Dy)]))],10,Cy))),128)),n.value?J(``,!0):(H(),U(`p`,Oy,[...l[1]||=[q(` 숫자 = 코드 챌린지 수 \xA0·\xA0 `,-1),G(`i`,{class:`dot live`},`n`,-1),q(` 실습 화면 있음 `,-1)]])),G(`button`,{type:`button`,class:`to-top`,title:`맨 위로`,"aria-label":`맨 위로 가기`,onClick:s},[l[2]||=G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`m6 15 6-6 6 6`})],-1),n.value?J(``,!0):(H(),U(`span`,ky,`맨 위로`))])]),G(`div`,Ay,[G(`header`,jy,[G(`div`,null,[G(`p`,My,O(r.value.code)+` · 교안 `+O(r.value.slides),1),G(`h2`,null,O(r.value.title),1),G(`p`,Ny,O(r.value.summary),1),G(`div`,Py,[(H(!0),U(V,null,B(r.value.topics,e=>(H(),U(`span`,{key:e},O(e),1))),128))])])]),r.value.orientation?(H(),W(vy,{key:0,orientation:r.value.orientation},null,8,[`orientation`])):J(``,!0),i.value.length?(H(),U(`div`,Fy,[(H(!0),U(V,null,B(i.value,e=>(H(),W(ty,{key:e.id,challenge:e},null,8,[`challenge`]))),128))])):(H(),U(`p`,Iy,[...l[3]||=[q(` 교안 기준으로 이 챕터에는 코드 챌린지가 없습니다. 아래 `,-1),G(`b`,null,`제출 과제`,-1),q(`로 바로 진행합니다. `,-1)]])),a.value.length?(H(),U(`section`,Ly,[l[5]||=G(`p`,{class:`section-label`},`이 챕터의 제출 과제`,-1),(H(!0),U(V,null,B(a.value,e=>(H(),U(`a`,{key:e.id,class:`assignment-link`,href:`#/assignments`},[G(`span`,Ry,O(String(e.id).padStart(2,`0`)),1),G(`span`,null,[G(`b`,null,O(e.title),1),G(`small`,null,O(e.goal),1)]),l[4]||=G(`span`,{class:`arrow`},`→`,-1)]))),128))])):J(``,!0)])],2)],64))}},[[`__scopeId`,`data-v-349ca045`]]),By={class:`anatomy`},Vy={class:`intro`},Hy={class:`node owner`},Uy={class:`node-head`},Wy={class:`node-name`},Gy={class:`node-role`},Ky=[`onClick`],qy={key:0,class:`state`},Jy={class:`node-note`},Yy={class:`children`},Xy={key:0,class:`under`},Zy={class:`node-head`},Qy={class:`node-name`},$y={class:`node-role`},eb=[`onClick`],tb={class:`wires`},nb={class:`wire down`},rb={key:0,class:`none`},ib={key:1},ab={class:`as`},ob={class:`wire-desc`},sb={class:`wire up`},cb={key:0,class:`none`},lb={key:1},ub={class:`as`},db={class:`wire-desc`},fb={class:`node-note`},pb={class:`flows`},mb={class:`flow-title`},hb={class:`steps`},gb={class:`arrow`,"aria-hidden":`true`},_b={class:`who`},vb={class:`what`},yb={class:`step-desc`},bb=[`innerHTML`],xb=Q({__name:`ResultAnatomy`,props:{anatomy:{type:Object,required:!0}},setup(e){let t=e=>e.includes(`.`)?e:`${e}.vue`,n=P(``),r=e=>n.value=e,i=()=>n.value=``;return(a,o)=>(H(),U(`div`,By,[G(`p`,Vy,O(e.anatomy.intro),1),o[4]||=G(`p`,{class:`section`},`컴포넌트 구조`,-1),(H(!0),U(V,null,B(e.anatomy.tree,e=>(H(),U(`div`,{key:e.name,class:`tree`},[G(`div`,Hy,[G(`div`,Uy,[G(`code`,Wy,O(t(e.name)),1),G(`span`,Gy,O(e.role),1),G(`button`,{type:`button`,class:`code-link`,onClick:t=>r(e.file)},`코드 보기`,8,Ky)]),e.state?.length?(H(),U(`p`,qy,[o[0]||=G(`span`,{class:`state-label`},`가진 데이터`,-1),(H(!0),U(V,null,B(e.state,e=>(H(),U(`code`,{key:e},O(e),1))),128))])):J(``,!0),G(`p`,Jy,O(e.note),1),G(`ul`,Yy,[(H(!0),U(V,null,B(e.children,e=>(H(),U(`li`,{key:e.name,class:D([`node child`,{nested:e.under}])},[e.under?(H(),U(`p`,Xy,[o[1]||=G(`span`,{"aria-hidden":`true`},`↳`,-1),q(` `+O(e.under)+` 안에서 쓰입니다 `,1)])):J(``,!0),G(`div`,Zy,[G(`code`,Qy,O(t(e.name)),1),G(`span`,$y,O(e.role),1),G(`button`,{type:`button`,class:`code-link`,onClick:t=>r(e.file)},` 코드 보기 `,8,eb)]),G(`div`,tb,[G(`div`,nb,[o[2]||=G(`p`,{class:`wire-head`},[G(`span`,{"aria-hidden":`true`},`↓`),q(` 받는다 (props)`)],-1),e.props.length?(H(),U(`ul`,ib,[(H(!0),U(V,null,B(e.props,e=>(H(),U(`li`,{key:e.name},[G(`code`,null,`:`+O(e.name),1),G(`span`,ab,`→ `+O(e.as)+` (`+O(e.type)+`)`,1),G(`span`,ob,O(e.desc),1)]))),128))])):(H(),U(`p`,rb,`없음`))]),G(`div`,sb,[o[3]||=G(`p`,{class:`wire-head`},[G(`span`,{"aria-hidden":`true`},`↑`),q(` 올린다 (emits)`)],-1),e.emits.length?(H(),U(`ul`,lb,[(H(!0),U(V,null,B(e.emits,e=>(H(),U(`li`,{key:e.name},[G(`code`,null,`@`+O(e.name),1),G(`span`,ub,O(e.payload),1),G(`span`,db,O(e.desc),1)]))),128))])):(H(),U(`p`,cb,`없음`))])]),G(`p`,fb,O(e.note),1)],2))),128))])])]))),128)),o[5]||=G(`p`,{class:`section`},`이벤트가 오가는 길`,-1),G(`div`,pb,[(H(!0),U(V,null,B(e.anatomy.flows,e=>(H(),U(`div`,{key:e.title,class:`flow`},[G(`p`,mb,O(e.title),1),G(`ol`,hb,[(H(!0),U(V,null,B(e.steps,(e,t)=>(H(),U(`li`,{key:t,class:D(e.dir)},[G(`span`,gb,O(e.dir===`up`?`↑`:e.dir===`down`?`↓`:`●`),1),G(`span`,_b,O(e.who),1),G(`code`,vb,O(e.label),1),G(`span`,yb,O(e.desc),1)],2))),128))])]))),128))]),G(`p`,{class:`point`,innerHTML:F(cd)(e.anatomy.point)},null,8,bb),n.value?(H(),W(Fd,{key:0,path:F(Au)(n.value),code:F(ku)(n.value),onClose:i},null,8,[`path`,`code`])):J(``,!0)]))}},[[`__scopeId`,`data-v-6080f9f4`]]),Sb={class:`check-layout`},Cb={class:`checklist-card`},wb={class:`checklist-head`},Tb={class:`track`},Eb=[`onUpdate:modelValue`],Db={class:`side`},Ob={class:`side-card`},kb={class:`side-card`},Ab={class:`grade-head`},jb=Q({__name:`SubmissionChecklist`,setup(e){let t=P(Qo.map(e=>({...e,done:!1}))),n=X(()=>t.value.filter(e=>e.done).length),r=X(()=>Math.round(n.value/t.value.length*100));return(e,i)=>(H(),U(`div`,Sb,[G(`section`,Cb,[G(`div`,wb,[i[0]||=G(`div`,null,[G(`h2`,null,`최종 제출 체크리스트`),G(`p`,null,`완료한 항목을 체크하면 진행률에 반영됩니다.`)],-1),G(`strong`,null,O(n.value)+` / `+O(t.value.length),1)]),G(`div`,Tb,[G(`i`,{style:E({width:`${r.value}%`})},null,4)]),(H(!0),U(V,null,B(t.value,e=>(H(),U(`label`,{key:e.title,class:D([`check-item`,{done:e.done}])},[R(G(`input`,{"onUpdate:modelValue":t=>e.done=t,type:`checkbox`},null,8,Eb),[[ko,e.done]]),G(`span`,null,[G(`b`,null,O(e.title),1),G(`small`,null,O(e.detail),1)])],2))),128))]),G(`aside`,Db,[G(`section`,Ob,[i[1]||=G(`p`,{class:`side-label`},`제출 조건 · 교안 5쪽`,-1),G(`ul`,null,[(H(!0),U(V,null,B(F(Xo),e=>(H(),U(`li`,{key:e},O(e),1))),128))])]),G(`section`,kb,[i[2]||=G(`p`,{class:`side-label`},`평가 기준 · 교안 6쪽`,-1),(H(!0),U(V,null,B(F(Zo),e=>(H(),U(`div`,{key:e.grade,class:`grade-row`},[G(`div`,Ab,[G(`b`,null,O(e.grade),1),G(`span`,null,O(e.score),1)]),G(`p`,null,O(e.criteria),1)]))),128))])])]))}},[[`__scopeId`,`data-v-8f40fe26`]]),Mb={class:`hero`},Nb={class:`hero-meter`,"aria-hidden":`true`},Pb={class:`meter-count`},Fb={class:`meter-total`},Ib={class:`meter-track`},Lb={class:`stage-tabs`,role:`tablist`},Rb=[`aria-selected`,`onClick`],zb={class:`tab-no`},Bb={class:`tab-title`},Vb={class:`stage-head`},Hb={class:`eyebrow`},Ub={class:`stage-goal`},Wb={class:`stage-frame`},Gb={class:`frame-bar`},Kb={class:`frame-title`},qb={class:`stage-body`},Jb={key:0,class:`stage-note`},Yb={key:1,class:`anatomy-fold`},Xb={class:`anatomy-body`},Zb={key:1,class:`empty-state`},Qb={key:2,class:`roadmap`},$b={class:`roadmap-grid`},ex={class:`number`},tx={class:`submission`},nx={class:`submission-body`},rx=Q({__name:`ProjectView`,setup(e){let t=X(()=>Yo.filter(e=>wu(e.result)).map(e=>({...e,component:wu(e.result)}))),n=X(()=>Yo.filter(e=>!wu(e.result)&&e.status!==`done`)),r=P(null),i=X(()=>{let e=t.value;return e.length?e.find(e=>e.id===r.value)??e[e.length-1]:null});return(e,a)=>(H(),U(V,null,[G(`section`,Mb,[a[1]||=G(`div`,{class:`hero-text`},[G(`p`,{class:`eyebrow`},`FINAL PROJECT`),G(`h1`,null,[q(`Weather`),G(`br`),G(`span`,null,`Dashboard`)]),G(`p`,{class:`hero-copy`},[q(` 제출 과제가 한 겹씩 쌓여 완성되는 결과물입니다. 아래에서 단계를 골라 `),G(`strong`,null,`지금까지 만든 앱을 그대로 실행`),q(`해 볼 수 있습니다. `)])],-1),G(`div`,Nb,[G(`span`,Pb,O(t.value.length),1),G(`span`,Fb,`/ `+O(F(Yo).length)+` 단계`,1),G(`span`,Ib,[G(`i`,{style:E({width:`${t.value.length/F(Yo).length*100}%`})},null,4)]),a[0]||=G(`span`,{class:`meter-label`},`완성한 단계`,-1)])]),i.value?(H(),U(V,{key:0},[G(`div`,Lb,[(H(!0),U(V,null,B(t.value,e=>(H(),U(`button`,{key:e.id,type:`button`,role:`tab`,class:D([`stage-tab`,{active:e.id===i.value.id}]),"aria-selected":e.id===i.value.id,onClick:t=>r.value=e.id},[G(`span`,zb,O(String(e.id).padStart(2,`0`)),1),G(`span`,Bb,O(e.title),1)],10,Rb))),128))]),G(`div`,Vb,[G(`div`,null,[G(`p`,Hb,`ASSIGNMENT `+O(String(i.value.id).padStart(2,`0`)),1),G(`h2`,null,O(i.value.title),1),G(`p`,Ub,O(i.value.goal),1)]),a[2]||=G(`a`,{class:`to-assignment`,href:`#/assignments`},`요구사항 보기 →`,-1)]),G(`div`,Wb,[G(`div`,Gb,[a[3]||=G(`span`,{class:`dots`,"aria-hidden":`true`},[G(`i`),G(`i`),G(`i`)],-1),G(`span`,Kb,`실행 중 · `+O(i.value.title),1)]),G(`div`,qb,[(H(),W(Er(i.value.component),{key:i.value.id}))])]),i.value.resultNote?(H(),U(`p`,Jb,O(i.value.resultNote),1)):J(``,!0),i.value.anatomy?(H(),U(`details`,Yb,[a[4]||=G(`summary`,null,[G(`span`,{class:`fold-mark`,"aria-hidden":`true`},`▶`),G(`span`,{class:`fold-title`},`컴포넌트 구조와 이벤트 흐름`),G(`span`,{class:`fold-hint`},`파일이 어떻게 연결되고 이벤트가 어디로 오가는지`)],-1),G(`div`,Xb,[K(xb,{anatomy:i.value.anatomy},null,8,[`anatomy`])])])):J(``,!0)],64)):(H(),U(`p`,Zb,[...a[5]||=[q(` 아직 실행할 수 있는 결과물이 없습니다. 과제를 완성한 뒤 `,-1),G(`code`,null,`src/components/assignments/`,-1),q(` 에 컴포넌트를 넣고 `,-1),G(`code`,null,`curriculum.js`,-1),q(` 의 `,-1),G(`code`,null,`result`,-1),q(` 에 이름을 적어 주세요. `,-1)]])),n.value.length?(H(),U(`section`,Qb,[a[6]||=G(`p`,{class:`section-label`},`앞으로 이어 붙일 단계`,-1),G(`div`,$b,[(H(!0),U(V,null,B(n.value,e=>(H(),U(`article`,{key:e.id},[G(`span`,ex,O(String(e.id).padStart(2,`0`)),1),G(`h3`,null,O(e.title),1),G(`p`,null,O(e.goal),1)]))),128))])])):J(``,!0),G(`details`,tx,[a[7]||=G(`summary`,null,[G(`span`,{class:`sum-title`},`제출 전 점검`),G(`span`,{class:`sum-hint`},`체크리스트 · 제출 조건 · 평가 기준`)],-1),G(`div`,nx,[K(jb)])])],64))}},[[`__scopeId`,`data-v-9a4a8adc`]]),ix=[{id:`editorial`,name:`Editorial`,tagline:`기술 문서`,description:`따뜻한 종이 위에 근접 블랙으로 찍은 인쇄물. 색을 아끼고 여백으로 읽힙니다.`,swatches:[`#f6f4ef`,`#fffefb`,`#0f7a4e`,`#16191c`]},{id:`terminal`,name:`Terminal`,tagline:`다크 IDE`,description:`코드를 오래 보는 화면. 저조도 배경에 형광 민트로 눌러야 할 곳만 밝힙니다.`,swatches:[`#14181f`,`#1b212b`,`#3ddc97`,`#e8edf4`]},{id:`blueprint`,name:`Blueprint`,tagline:`설계도`,description:`모눈종이 위의 도면. 차가운 청색과 각진 모서리로 구조를 드러냅니다.`,swatches:[`#eef1f6`,`#ffffff`,`#1d4ed8`,`#12213a`]}],ax=`inwoo-vue-theme`,ox=`editorial`,sx=e=>ix.some(t=>t.id===e),cx=P(ox),lx=e=>{if(sx(e)){cx.value=e,document.documentElement.dataset.theme=e;try{localStorage.setItem(ax,e)}catch{}}},ux=()=>{let e=null;try{e=localStorage.getItem(ax)}catch{e=null}lx(sx(e)?e:ox)},dx={class:`block`},fx={class:`theme-grid`},px=[`aria-pressed`,`onClick`],mx={class:`meta`},hx={class:`name-row`},gx={key:0,class:`badge`},_x={class:`desc`},vx=Q({__name:`SettingsView`,setup(e){return(e,t)=>(H(),U(V,null,[t[1]||=G(`section`,{class:`page-intro`},[G(`p`,{class:`eyebrow`},`SETTINGS`),G(`h1`,null,`환경 설정`),G(`p`,null,[q(` 화면 테마를 고를 수 있습니다. 고른 테마는 `),G(`strong`,null,`이 브라우저에 저장`),q(`되어 다음에 열어도 그대로 유지됩니다. `)])],-1),G(`section`,dx,[t[0]||=G(`div`,{class:`block-head`},[G(`p`,{class:`eyebrow`},`APPEARANCE`),G(`h2`,null,`테마`),G(`p`,{class:`block-desc`},`누르면 바로 적용됩니다. 실습 화면의 색은 각 실습 코드가 정한 대로 유지됩니다.`)],-1),G(`div`,fx,[(H(!0),U(V,null,B(F(ix),e=>(H(),U(`button`,{key:e.id,type:`button`,class:D([`theme-card`,{active:F(cx)===e.id}]),"aria-pressed":F(cx)===e.id,onClick:t=>F(lx)(e.id)},[G(`span`,{class:`preview`,style:E({background:e.swatches[0],borderColor:e.swatches[3]+`22`})},[G(`i`,{class:`bar`,style:E({background:e.swatches[1]})},[G(`em`,{style:E({background:e.swatches[2]})},null,4)],4),G(`i`,{class:`line long`,style:E({background:e.swatches[3],opacity:.85})},null,4),G(`i`,{class:`line`,style:E({background:e.swatches[3],opacity:.35})},null,4),G(`i`,{class:`line mid`,style:E({background:e.swatches[3],opacity:.35})},null,4),G(`i`,{class:`chip`,style:E({background:e.swatches[2]})},null,4)],4),G(`span`,mx,[G(`span`,hx,[G(`b`,null,O(e.name),1),G(`small`,null,O(e.tagline),1),F(cx)===e.id?(H(),U(`span`,gx,`사용 중`)):J(``,!0)]),G(`span`,_x,O(e.description),1)])],10,px))),128))])]),t[2]||=oa(`<section class="block" data-v-cc84f2a9><div class="block-head" data-v-cc84f2a9><p class="eyebrow" data-v-cc84f2a9>ABOUT</p><h2 data-v-cc84f2a9>이 사이트</h2></div><dl class="facts" data-v-cc84f2a9><dt data-v-cc84f2a9>구성</dt><dd data-v-cc84f2a9>학습 &amp; 코드 챌린지 · 제출 과제 · 최종 결과물</dd><dt data-v-cc84f2a9>내용 출처</dt><dd data-v-cc84f2a9>Full-stack Engineering · Frontend Framework (Vue.js) 교안 276쪽</dd><dt data-v-cc84f2a9>내용 추가</dt><dd data-v-cc84f2a9><code data-v-cc84f2a9>src/data/curriculum.js</code> 한 파일만 고치면 모든 화면에 반영됩니다</dd><dt data-v-cc84f2a9>가이드</dt><dd data-v-cc84f2a9><code data-v-cc84f2a9>docs/CONTENT_GUIDE.md</code></dd></dl></section>`,1)],64))}},[[`__scopeId`,`data-v-cc84f2a9`]]),yx={class:`app-shell`},bx={class:`app-header`},xx={class:`main-nav`,"aria-label":`주요 메뉴`},Sx={class:`page-container`},Cx={__name:`App`,setup(e){let t=P(window.location.hash.slice(1)||`/`),n=()=>{t.value=window.location.hash.slice(1)||`/`};mr(()=>window.addEventListener(`hashchange`,n)),vr(()=>window.removeEventListener(`hashchange`,n));let r=X(()=>t.value===`/learning`?zy:t.value===`/assignments`?Ju:t.value===`/project`?rx:t.value===`/settings`?vx:id),i=e=>t.value===e;return(e,t)=>(H(),U(`div`,yx,[G(`header`,bx,[t[0]||=G(`a`,{class:`brand`,href:`#/`},[G(`span`,{class:`brand-mark`},`V`),G(`span`,null,`Vue Learning Lab`)],-1),G(`nav`,xx,[G(`a`,{href:`#/`,class:D({active:i(`/`)})},`홈`,2),G(`a`,{href:`#/learning`,class:D({active:i(`/learning`)})},` 학습 & 챌린지 `,2),G(`a`,{href:`#/assignments`,class:D({active:i(`/assignments`)})},` 제출 과제 `,2),G(`a`,{href:`#/project`,class:D({active:i(`/project`)})},` 최종 결과물 `,2),G(`a`,{href:`#/settings`,class:D({active:i(`/settings`)})},` 환경 설정 `,2)])]),G(`main`,Sx,[(H(),W(Er(r.value)))])]))}},wx={class:`global-badge`},Tx=Q({__name:`GlobalBadge`,props:{text:{type:String,default:`전역 등록됨`}},setup(e){return(t,n)=>(H(),U(`span`,wx,[n[0]||=G(`i`,{"aria-hidden":`true`},null,-1),q(` `+O(e.text),1)]))}},[[`__scopeId`,`data-v-4c3191a7`]]);ux();var Ex=Wo(Cx);Ex.component(`GlobalBadge`,Tx),Ex.mount(`#app`);