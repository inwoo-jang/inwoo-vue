import{t as e}from"./rolldown-runtime-DK3Fl9T5.js";import{A as t,I as n,M as r,S as i,_ as a,a as o,at as s,c,f as l,it as u,j as d,k as f,l as p,n as m,o as h,p as g,rt as _,s as v,t as y,v as b,w as x,y as S,z as C}from"./_plugin-vue_export-helper-CoO-E1Sm.js";import{S as w,f as T,i as E,m as D,p as O,y as k}from"./index-Ct6NUfYS.js";import{t as A}from"./WeatherAboutView-DkmoYzno.js";import{a as j,c as M,i as N,l as P,o as F,s as I,t as L}from"./backdropState-CCsvWdon.js";import{t as R}from"./WeatherDetailView-DmMP40yN.js";import{a as z,i as ee,n as te,r as B,t as V}from"./WeatherHomeView-lZSS0qot.js";import{t as ne}from"./WeatherNotFoundView-DzVD_pa0.js";import{a as re,c as H,i as U,l as W,n as ie,o as G,r as ae,s as oe,t as K}from"./weatherApi-D01IqwYo.js";var q=e({default:()=>fe}),se={class:`dashboard-wrapper`},J={class:`search-box`},ce=[`value`],le={class:`list-box`},Y=[`onClick`],X={key:0,class:`badge hot`},Z={key:1,class:`badge cool`},Q=[`onClick`],ue={key:0,class:`empty-message`},de={class:`status-bar`},fe=y({__name:`WeatherComposition`,setup(e){let r=n([{id:`city_01`,name:`서울`,temp:28,status:`맑음`},{id:`city_02`,name:`수원`,temp:24,status:`비`},{id:`city_03`,name:`부산`,temp:26,status:`구름`}]),a=n(``),u=n(`카드를 클릭하거나 검색해 보세요.`),d=o(()=>{let e=a.value.trim();return e?r.value.filter(t=>t.name.includes(e)):r.value});f(u,e=>{console.log(`👁️‍🗨️ [watch 감지] 상태 바 문구가 업데이트되었습니다 -> "${e}"`)}),t(()=>{console.log(`🤖 [watchEffect 자동 호출] 현재 검색어 '${a.value}'에 매칭되는 API 데이터를 필터링합니다.`)});let g=(e,t)=>{window.alert(`${e}의 현재 날씨는 [${t}] 상태입니다.`)};return(e,t)=>(i(),p(`div`,se,[h(`section`,J,[t[2]||=h(`h3`,null,`🔍 도시 검색`,-1),h(`input`,{type:`text`,value:a.value,placeholder:`검색할 도시 이름 입력`,onInput:t[0]||=e=>a.value=e.target.value},null,40,ce),h(`p`,null,[t[1]||=l(` 검색 중인 도시: `,-1),h(`strong`,null,s(a.value),1)])]),h(`section`,le,[t[3]||=h(`h3`,null,`🏙️ 지역별 날씨 현황`,-1),(i(!0),p(m,null,x(d.value,e=>(i(),p(`div`,{key:e.id,class:`weather-card`,onClick:t=>u.value=`${e.name}이 선택되었습니다.`},[h(`h4`,null,s(e.name)+` (`+s(e.status)+`)`,1),h(`p`,null,`현재 기온: `+s(e.temp)+`°C`,1),e.temp>=25?(i(),p(`span`,X,`🔥 더움 (25도 이상)`)):(i(),p(`span`,Z,`❄️ 선선함 (25도 미만)`)),h(`button`,{class:`btn-detail`,onClick:w(t=>g(e.name,e.status),[`stop`])},` 상세보기 `,8,Q)],8,Y))),128)),d.value.length===0?(i(),p(`p`,ue,` 😭 검색 결과와 일치하는 도시가 없습니다. `)):c(``,!0)]),h(`div`,de,s(u.value),1)]))}},[[`__scopeId`,`data-v-6342b841`]]),pe=e({default:()=>Ee}),me={class:`weather-app`},he={class:`weather-search`},ge=[`value`],_e={class:`status-bar`},ve={class:`weather-grid`},ye=[`onClick`],be={class:`weather-card-header`},xe={class:`temperature`},Se={key:0,class:`hot`},Ce={key:1,class:`cool`},we=[`onClick`],Te={key:0,class:`empty-message`},Ee=y({__name:`WeatherMockup`,setup(e){let t=n(``),r=n(`도시 카드를 선택해 주세요.`),a=n([{id:1,city:`서울`,temperature:28,weather:`맑음`},{id:2,city:`부산`,temperature:24,weather:`흐림`},{id:3,city:`제주`,temperature:26,weather:`구름 조금`},{id:4,city:`대전`,temperature:22,weather:`비`},{id:5,city:`광주`,temperature:30,weather:`맑음`}]),o=e=>{t.value=e.target.value},l=()=>{let e=t.value.trim();return e?a.value.filter(t=>t.city.includes(e)):a.value},u=e=>e>=25?`🔥 더움`:`❄️ 선선함`,d=e=>{r.value=`${e}이 선택되었습니다.`},f=(e,t)=>{window.alert(`${e}의 현재 날씨는 [${t}] 상태입니다.`)};return(e,n)=>(i(),p(`main`,me,[n[1]||=h(`h1`,null,`날씨 Mockup`,-1),h(`div`,he,[n[0]||=h(`label`,{for:`city-search`},`한글 도시 검색`,-1),h(`input`,{id:`city-search`,value:t.value,type:`text`,placeholder:`예: 서울`,onInput:o},null,40,ge)]),h(`p`,_e,s(r.value),1),h(`div`,ve,[(i(!0),p(m,null,x(l(),e=>(i(),p(`article`,{key:e.id,class:`weather-card`,onClick:t=>d(e.city)},[h(`div`,be,[h(`h2`,null,s(e.city),1),h(`span`,null,s(e.weather),1)]),h(`p`,xe,s(e.temperature)+`℃`,1),e.temperature>=25?(i(),p(`p`,Se,`🔥 더움`)):(i(),p(`p`,Ce,`❄️ 선선함`)),h(`button`,{type:`button`,onClick:w(t=>f(e.city,u(e.temperature)),[`stop`])},` 상세보기 `,8,we)],8,ye))),128))]),l().length===0?(i(),p(`p`,Te,` 검색 결과와 일치하는 도시가 없습니다. `)):c(``,!0)]))}},[[`__scopeId`,`data-v-a56bc1a5`]]),De=e({default:()=>je}),Oe={class:`tabs`,role:`tablist`},ke=[`aria-selected`,`onClick`],Ae={key:0,class:`count`},je=y({__name:`RegionTabs`,props:{regions:{type:Array,required:!0},current:{type:String,default:`전체`},counts:{type:Object,default:()=>({})}},emits:[`select-region`],setup(e){return(t,n)=>(i(),p(`div`,Oe,[(i(!0),p(m,null,x([`전체`,...e.regions],n=>(i(),p(`button`,{key:n,type:`button`,role:`tab`,class:_([`tab`,{active:n===e.current}]),"aria-selected":n===e.current,onClick:e=>t.$emit(`select-region`,n)},[l(s(n)+` `,1),e.counts[n]?(i(),p(`span`,Ae,s(e.counts[n]),1)):c(``,!0)],10,ke))),128))]))}},[[`__scopeId`,`data-v-9f28431c`]]),Me=e({default:()=>We}),Ne={class:`by-status`},Pe={class:`group-head`},Fe={class:`status-name`},Ie={class:`count`},Le={class:`chips`},Re=[`onClick`],ze={class:`chip-name`},Be={class:`chip-temp`},Ve={class:`chip-region`},He=[`title`,`onClick`],Ue={key:0,class:`empty-message`},We=y({__name:`WeatherByStatus`,props:{list:{type:Array,required:!0},favorites:{type:Array,default:()=>[]},hereId:{type:String,default:``},selectedId:{type:String,default:``}},emits:[`select-card`,`toggle-favorite`],setup(e){let t=e,n=o(()=>{let e=new Map;for(let n of t.list)e.has(n.status)||e.set(n.status,[]),e.get(n.status).push(n);return[...e.entries()].map(([e,t])=>({status:e,cities:[...t].sort((e,t)=>t.temp-e.temp)})).sort((e,t)=>t.cities.length-e.cities.length)});return(t,r)=>(i(),p(`div`,Ne,[(i(!0),p(m,null,x(n.value,n=>(i(),p(`div`,{key:n.status,class:`group`},[h(`p`,Pe,[g(F,{status:n.status,size:26},null,8,[`status`]),h(`b`,Fe,s(n.status),1),h(`span`,Ie,s(n.cities.length)+`곳`,1)]),h(`ul`,Le,[(i(!0),p(m,null,x(n.cities,n=>(i(),p(`li`,{key:n.id},[h(`button`,{type:`button`,class:_([`chip`,{here:n.id===e.hereId,selected:n.id===e.selectedId}]),onClick:e=>t.$emit(`select-card`,n.id)},[n.id===e.hereId?(i(),v(N,{key:0,name:`location`,size:11})):c(``,!0),h(`span`,ze,s(n.name),1),n.id===e.selectedId?(i(),v(N,{key:1,name:`check`,size:12,class:`chip-check`})):c(``,!0),h(`span`,Be,s(n.temp)+`°`,1),h(`span`,Ve,s(n.region),1)],10,Re),h(`button`,{type:`button`,class:_([`chip-star`,{on:e.favorites.includes(n.id)}]),title:e.favorites.includes(n.id)?`즐겨찾기 해제`:`즐겨찾기에 추가`,onClick:e=>t.$emit(`toggle-favorite`,n.id)},[g(N,{name:`star`,size:13,filled:e.favorites.includes(n.id)},null,8,[`filled`])],10,He)]))),128))])]))),128)),n.value.length?c(``,!0):(i(),p(`p`,Ue,[g(N,{name:`empty`,size:22}),r[0]||=l(` 표시할 날씨가 없습니다. `,-1)]))]))}},[[`__scopeId`,`data-v-968dcb10`]]),Ge=e({default:()=>$}),Ke={key:0,class:`detail`},qe={class:`detail-head`},Je={key:0,class:`sido`},Ye={class:`current`},Xe={class:`date-bar`},Ze=[`disabled`],Qe={class:`date-field`},$e={class:`date-label`},et={key:0,class:`tag today`},tt={key:1,class:`tag past`},nt={key:2,class:`tag future`},rt=[`min`,`max`],it=[`disabled`],at={key:0,class:`state`},ot={key:1,class:`state error`},st={class:`axis`},ct={key:0},lt={class:`bar-slot`},ut={class:`temp`},dt={key:0,class:`rain`},ft={key:1,class:`rain none`},pt={class:`hour`},mt={key:2,class:`daymark`},ht=6,gt=12,$=y({__name:`HourlyDetail`,props:{city:{type:Object,default:null}},emits:[`close`],setup(e,{emit:t}){let d=e,v=t,y=n([]),b=n(!1),S=n(``),w=W(new Date),T=new Date().getHours(),E=n(w),D=n(null),O=o(()=>E.value===w),A=o(()=>E.value<w);f(()=>[d.city?.id,E.value],async()=>{if(d.city){b.value=!0,S.value=``;try{let e=G(d.city.id);if(O.value){let t=await U(e,E.value,H(E.value,1)),n=new Date,r=new Date(n).setHours(n.getHours()-ht,0,0,0),i=new Date(n).setHours(n.getHours()+gt,0,0,0);y.value=t.filter(e=>{let t=new Date(e.time).getTime();return t>=r&&t<=i})}else y.value=await U(e,E.value)}catch(e){S.value=`시간별 날씨를 불러오지 못했습니다.`,y.value=[],console.error(`[weather] 시간별 조회 실패`,e)}finally{b.value=!1}if(O.value){await a();let e=D.value,t=e?.querySelector(`.now`);e&&t&&(e.scrollLeft=t.offsetLeft-e.clientWidth/2+t.offsetWidth/2)}}},{immediate:!0}),f(()=>d.city?.id,()=>E.value=w);let j=e=>{let t=H(E.value,e);t>=K.min&&t<=K.max&&(E.value=t)},M=o(()=>{let e=new Date(`${E.value}T00:00:00`),t=[`일`,`월`,`화`,`수`,`목`,`금`,`토`][e.getDay()];return`${e.getMonth()+1}월 ${e.getDate()}일 (${t})`}),P=o(()=>{if(!y.value.length)return{min:0,max:1};let e=y.value.map(e=>e.temp),t=Math.min(...e),n=Math.max(...e);return{min:t,max:n===t?t+1:n}}),I=e=>Math.round(26+(e-P.value.min)/(P.value.max-P.value.min)*34);return(t,n)=>e.city?(i(),p(`section`,Ke,[h(`header`,qe,[g(F,{status:e.city.status,size:26},null,8,[`status`]),h(`div`,null,[h(`h4`,null,[l(s(e.city.name)+` `,1),e.city.region===e.city.name?c(``,!0):(i(),p(`span`,Je,s(e.city.region),1))]),h(`p`,Ye,`지금 `+s(e.city.temp)+`°C · 습도 `+s(e.city.humidity)+`% · `+s(e.city.status),1)]),h(`button`,{class:`close`,type:`button`,"aria-label":`닫기`,onClick:n[0]||=e=>v(`close`)},`✕`)]),h(`div`,Xe,[h(`button`,{type:`button`,class:`step`,disabled:C(H)(E.value,-1)<C(K).min,"aria-label":`하루 전`,onClick:n[1]||=e=>j(-1)},` ‹ `,8,Ze),h(`label`,Qe,[h(`span`,$e,[l(s(M.value)+` `,1),O.value?(i(),p(`b`,et,`오늘`)):A.value?(i(),p(`b`,tt,`지난 날씨`)):(i(),p(`b`,nt,`예보`))]),r(h(`input`,{"onUpdate:modelValue":n[2]||=e=>E.value=e,type:`date`,min:C(K).min,max:C(K).max},null,8,rt),[[k,E.value]])]),h(`button`,{type:`button`,class:`step`,disabled:C(H)(E.value,1)>C(K).max,"aria-label":`하루 뒤`,onClick:n[3]||=e=>j(1)},` › `,8,it),O.value?c(``,!0):(i(),p(`button`,{key:0,type:`button`,class:`today-btn`,onClick:n[4]||=e=>E.value=C(w)},` 오늘로 `))]),b.value?(i(),p(`p`,at,`시간별 예보를 불러오는 중…`)):S.value?(i(),p(`p`,ot,s(S.value),1)):y.value.length?(i(),p(m,{key:2},[h(`p`,st,[O.value?(i(),p(`span`,ct,`지금 기준 앞뒤 시간 · `)):c(``,!0),l(`최저 `+s(P.value.min)+`°C ~ 최고 `+s(P.value.max)+`°C `,1)]),h(`ul`,{ref_key:`hoursEl`,ref:D,class:`hours`},[(i(!0),p(m,null,x(y.value,e=>(i(),p(`li`,{key:e.time,class:_({now:O.value&&e.hour===C(T)})},[h(`span`,lt,[h(`span`,ut,s(e.temp)+`°`,1),h(`span`,{class:`bar`,style:u({height:I(e.temp)+`px`})},null,4)]),g(F,{status:e.status,size:18},null,8,[`status`]),e.rainChance>0?(i(),p(`span`,dt,[g(N,{name:`droplet`,size:10}),l(s(e.rainChance)+`% `,1)])):(i(),p(`span`,ft,`–`)),h(`span`,pt,s(O.value&&e.hour===C(T)?`지금`:e.hour+`시`),1),e.hour===0?(i(),p(`span`,mt,`다음날`)):c(``,!0)],2))),128))],512)],64)):c(``,!0)])):c(``,!0)}},[[`__scopeId`,`data-v-ab3056f6`]]),_t=e({default:()=>xt}),vt={key:0,class:`mist`},yt={key:0,class:`blizzard`},bt=.618033988749895,xt=y({__name:`WeatherBackdrop`,props:{status:{type:String,default:``}},setup(e){let t=e,r=Object.fromEntries(Object.entries(Object.assign({"../../../assets/photos/cloudy.jpg":()=>E(()=>import(`./cloudy-79FvOUrg.js`).then(e=>e.default),[]),"../../../assets/photos/lightning.jpg":()=>E(()=>import(`./lightning-BiLOcaih.js`).then(e=>e.default),[]),"../../../assets/photos/mostly-sunny.jpg":()=>E(()=>import(`./mostly-sunny-ia0xcVKP.js`).then(e=>e.default),[]),"../../../assets/photos/overcast.jpg":()=>E(()=>import(`./overcast-hCz2yzGp.js`).then(e=>e.default),[]),"../../../assets/photos/partly-cloudy.jpg":()=>E(()=>import(`./partly-cloudy-BCMTYjrN.js`).then(e=>e.default),[]),"../../../assets/photos/rain.jpg":()=>E(()=>import(`./rain-CRgnNhCC.js`).then(e=>e.default),[]),"../../../assets/photos/storm.jpg":()=>E(()=>import(`./storm-5A07q_Yo.js`).then(e=>e.default),[]),"../../../assets/photos/sunny.jpg":()=>E(()=>import(`./sunny-BxS2j8Tt.js`).then(e=>e.default),[])})).map(([e,t])=>[e.split(`/`).pop().replace(`.jpg`,``),t])),a={},s=async e=>(a[e]||(a[e]=await r[e]?.()),a[e]),l=[[`뇌우`,{photo:`storm`,effect:`storm`}],[`번개`,{photo:`lightning`,effect:`lightning`}],[`폭설`,{photo:`overcast`,effect:`snow-heavy`}],[`눈보라`,{photo:`overcast`,effect:`snow-heavy`}],[`싸락눈`,{photo:`overcast`,effect:`snow`}],[`눈`,{photo:`overcast`,effect:`snow`}],[`한파`,{photo:`overcast`,effect:`snow`}],[`소나기`,{photo:`rain`,effect:`shower`}],[`호우`,{photo:`rain`,effect:`rain-heavy`}],[`이슬비`,{photo:`rain`,effect:`drizzle`}],[`어는 비`,{photo:`rain`,effect:`rain`}],[`비`,{photo:`rain`,effect:`rain`}],[`안개`,{photo:`overcast`,effect:`fog`}],[`미세먼지`,{photo:`overcast`,effect:`fog`}],[`흐림`,{photo:`overcast`,effect:`clouds-slow`}],[`구름조금`,{photo:`partly-cloudy`,effect:`clouds`}],[`구름많`,{photo:`cloudy`,effect:`clouds`}],[`구름`,{photo:`cloudy`,effect:`clouds`}],[`대체로 맑`,{photo:`mostly-sunny`,effect:`sun-clouds`}],[`맑`,{photo:`sunny`,effect:`sun`}]],d={photo:`partly-cloudy`,effect:`clouds`},g=o(()=>{if(!t.status)return d;let e=l.find(([e])=>t.status.includes(e));return e?e[1]:d}),v=n([``,``]),y=n(0),C=0;f(()=>g.value.photo,async e=>{let t=++C,n=await s(e);if(!n||t!==C||v.value[y.value]===n)return;let r=1-y.value;v.value[r]=n,y.value=r},{immediate:!0});let w=n(null),T=n(1),D=null;S(()=>{let e=()=>{let e=w.value?.offsetHeight??0;T.value=Math.min(4,Math.max(1,Math.ceil(e/window.innerHeight)))};D=new ResizeObserver(e),w.value&&D.observe(w.value),window.addEventListener(`resize`,e),e(),b(()=>window.removeEventListener(`resize`,e))}),b(()=>D?.disconnect());let O=(e,{minDur:t,maxDur:n,minLen:r,maxLen:i,minOp:a,maxOp:o,width:s})=>Array.from({length:e},(e,c)=>{let l=c*bt%1,u=c*37%100/100,d=c*61%100/100,f=c*83%100/100,p=t+d*(n-t);return{left:u*106-3,dur:p,len:r+f*(i-r),delay:-l*p,opacity:a+f*(o-a),width:f>.7?s+.6:s}}),k=O(95,{minDur:1.8,maxDur:2.9,minLen:8,maxLen:22,minOp:.16,maxOp:.4,width:1}),A=O(150,{minDur:.7,maxDur:1.1,minLen:28,maxLen:70,minOp:.3,maxOp:.75,width:1.3}),j=O(200,{minDur:.5,maxDur:.78,minLen:42,maxLen:100,minOp:.34,maxOp:.85,width:1.6}),M=O(280,{minDur:.28,maxDur:.46,minLen:75,maxLen:175,minOp:.4,maxOp:.95,width:2.2}),N=(e,{minDur:t,maxDur:n,minSize:r,maxSize:i,swayMin:a,swayMax:o})=>Array.from({length:e},(e,s)=>{let c=s*bt%1,l=s*41%100/100,u=s*67%100/100,d=s*89%100/100,f=t+u*(n-t);return{left:l*106-3,dur:f,size:r+d*(i-r),delay:-c*f,opacity:.45+d*.5,sway:a+l*(o-a),swayDur:1.8+d*2.6}}),P=N(120,{minDur:4.5,maxDur:8,minSize:3,maxSize:8,swayMin:24,swayMax:70}),F=N(230,{minDur:1.6,maxDur:3.2,minSize:4,maxSize:13,swayMin:60,swayMax:150}),I=o(()=>{let e=g.value.effect===`snow-heavy`?F:P;return T.value>=3?e.filter((e,t)=>t%2==0):e}),L=o(()=>{let e={drizzle:k,shower:j,"rain-heavy":M}[g.value.effect]??A;return T.value>=3?e.filter((e,t)=>t%2==0):e}),R=o(()=>[`storm`,`lightning`,`rain-heavy`,`rain`,`shower`].includes(g.value.effect));return(e,t)=>(i(),p(`div`,{ref_key:`rootEl`,ref:w,class:_([`backdrop`,[`fx-${g.value.effect}`,{dark:R.value}]]),"aria-hidden":`true`},[(i(!0),p(m,null,x(v.value,(e,t)=>(i(),p(`div`,{key:t,class:_([`photo`,{on:t===y.value}]),style:u(e?{backgroundImage:`url(${e})`}:null)},null,6))),128)),g.value.effect===`sun`||g.value.effect===`sun-clouds`?(i(),p(m,{key:0},[t[0]||=h(`div`,{class:`glow`},null,-1),t[1]||=h(`div`,{class:`rays`},null,-1)],64)):c(``,!0),[`clouds`,`clouds-slow`,`sun-clouds`,`fog`,`overcast`].includes(g.value.effect)?(i(),p(m,{key:1},[t[2]||=h(`div`,{class:`cloud-layer a`},null,-1),t[3]||=h(`div`,{class:`cloud-layer b`},null,-1)],64)):c(``,!0),[`rain`,`rain-heavy`,`drizzle`,`shower`,`storm`].includes(g.value.effect)?(i(),p(m,{key:2},[(i(!0),p(m,null,x(T.value,e=>(i(),p(`div`,{key:e,class:`rain-field`,style:u({top:(e-1)*100+`vh`})},[(i(!0),p(m,null,x(L.value,(e,t)=>(i(),p(`span`,{key:t,class:`drop`,style:u({left:e.left+`%`,height:e.len+`px`,width:e.width+`px`,opacity:e.opacity,animationDuration:e.dur+`s`,animationDelay:e.delay+`s`})},null,4))),128))],4))),128)),g.value.effect===`drizzle`?c(``,!0):(i(),p(`div`,vt))],64)):c(``,!0),[`snow`,`snow-heavy`].includes(g.value.effect)?(i(),p(m,{key:3},[(i(!0),p(m,null,x(T.value,e=>(i(),p(`div`,{key:e,class:`snow-field`,style:u({top:(e-1)*100+`vh`})},[(i(!0),p(m,null,x(I.value,(e,t)=>(i(),p(`span`,{key:t,class:`flake-fall`,style:u({left:e.left+`%`,animationDuration:e.dur+`s`,animationDelay:e.delay+`s`})},[h(`span`,{class:`flake`,style:u({width:e.size+`px`,height:e.size+`px`,opacity:e.opacity,animationDuration:e.swayDur+`s`,"--sway":e.sway+`px`})},null,4)],4))),128))],4))),128)),g.value.effect===`snow-heavy`?(i(),p(`div`,yt)):c(``,!0)],64)):c(``,!0),g.value.effect===`fog`?(i(),p(m,{key:4},[t[4]||=h(`div`,{class:`fog-layer a`},null,-1),t[5]||=h(`div`,{class:`fog-layer b`},null,-1)],64)):c(``,!0),[`storm`,`lightning`].includes(g.value.effect)?(i(),p(m,{key:5},[t[7]||=h(`div`,{class:`flash`},null,-1),(i(),p(m,null,x(2,e=>h(`svg`,{key:e,class:_([`bolt`,e===1?`a`:`b`]),viewBox:`0 0 200 300`,preserveAspectRatio:`xMidYMin meet`},[...t[6]||=[h(`path`,{d:`M96 0 78 96 112 88 66 210`,fill:`none`,stroke:`#bfe0ff`,"stroke-width":`11`,"stroke-linejoin":`round`,"stroke-linecap":`round`,opacity:`0.55`},null,-1),h(`path`,{d:`M96 0 78 96 112 88 66 210 90 128 58 138Z`,fill:`#f2f9ff`},null,-1),h(`path`,{d:`M96 0 78 96 112 88 66 210`,fill:`none`,stroke:`#fff`,"stroke-width":`2.4`,"stroke-linejoin":`round`,"stroke-linecap":`round`},null,-1),h(`path`,{d:`M84 62 46 104M104 108 142 142M74 150 44 188`,fill:`none`,stroke:`#eaf5ff`,"stroke-width":`2.2`,"stroke-linecap":`round`},null,-1)]],2)),64))],64)):c(``,!0),t[8]||=h(`div`,{class:`veil`},null,-1)],2))}},[[`__scopeId`,`data-v-30c4148e`]]),St=e({default:()=>Kt}),Ct={class:`dashboard-wrapper`},wt={class:`view-tabs`,role:`tablist`},Tt=[`aria-selected`],Et=[`aria-selected`],Dt={class:`tool-row`},Ot={class:`summary`},kt={key:0,class:`fav-count`},At=[`disabled`],jt=[`disabled`],Mt={key:0,class:`hint stale`},Nt={key:1,class:`hint`},Pt={key:3,class:`error-message`},Ft={key:4,class:`skeleton`},It={key:0,class:`empty-message`},Lt={key:1,class:`pager`,"aria-label":`목록 페이지`},Rt=[`disabled`],zt=[`aria-current`,`onClick`],Bt=[`disabled`],Vt={class:`status-bar`},Ht={key:0,class:`stamp`},Ut=`inwoo-weather-favorites`,Wt=5,Gt=6e5,Kt=y({__name:`WeatherParent`,setup(e){let t=n([]),r=n(!1),a=n(``),u=n(!1),y=n(``),w=n(``),T=n(`전체`),E=n(`region`),D=n(`카드를 클릭하거나 검색해 보세요.`),O=n(``),k=n(1),A=()=>{O.value=``,D.value=`카드를 클릭하거나 검색해 보세요.`},j=e=>{if(O.value===e){A();return}O.value=e;let n=t.value.find(t=>t.id===e);D.value=n?`${n.name} · ${n.status} · ${n.temp}°C · 습도 ${n.humidity}%`:`카드를 클릭하거나 검색해 보세요.`},P=n(JSON.parse(localStorage.getItem(Ut)??`[]`)),F=e=>{P.value=P.value.includes(e)?P.value.filter(t=>t!==e):[...P.value,e]};f(P,e=>localStorage.setItem(Ut,JSON.stringify(e)),{deep:!0});let I=n(``),L=n(`idle`),R=()=>{if(!navigator.geolocation){L.value=`denied`;return}L.value=`asking`,navigator.geolocation.getCurrentPosition(({coords:e})=>{let t=oe(e.latitude,e.longitude);I.value=t?.id??``,L.value=`done`},()=>{L.value=`denied`},{timeout:8e3})},z=async(e=!1)=>{r.value=!0,a.value=``;try{let{rows:n,at:r,stale:i}=await re(void 0,e);t.value=[...n,...ie],u.value=i,i&&setTimeout(()=>z(!0),0),V=r,y.value=new Date(r).toLocaleTimeString(`ko-KR`,{hour:`2-digit`,minute:`2-digit`})}catch(e){a.value=`날씨를 불러오지 못했습니다. 네트워크를 확인하고 다시 시도해 주세요.`,u.value=!1,console.error(`[weather] 불러오기 실패`,e)}finally{r.value=!1}},B=null,V=0,ne=()=>{H(),B=setInterval(()=>{document.visibilityState===`visible`&&z(!0)},Gt)},H=()=>{B&&clearInterval(B),B=null},U=()=>{document.visibilityState===`visible`&&Date.now()-V>Gt&&z(!0)};b(()=>{H(),document.removeEventListener(`visibilitychange`,U)}),S(async()=>{z(),ne(),document.addEventListener(`visibilitychange`,U),(await navigator.permissions?.query({name:`geolocation`}).catch(()=>null))?.state===`granted`&&R()});let W=o(()=>{let e=w.value.trim();return t.value.filter(t=>!e||t.name.includes(e))}),G=o(()=>{let e=W.value.filter(e=>T.value===`전체`||e.group===T.value),t=e=>e.id===I.value?0:P.value.includes(e.id)?1:2;return[...e].sort((e,n)=>t(e)-t(n))}),K=o(()=>W.value.reduce((e,t)=>(e[t.group]=(e[t.group]??0)+1,e),{전체:W.value.length})),q=o(()=>Math.max(1,Math.ceil(G.value.length/Wt))),se=o(()=>G.value.slice((k.value-1)*Wt,k.value*Wt));f([w,T,E],()=>k.value=1),f(q,e=>{k.value>e&&(k.value=e)});let J=o(()=>t.value.find(e=>e.id===O.value)??null),ce=o(()=>t.value.find(e=>e.id===O.value)??t.value.find(e=>e.id===I.value)??null),le=o(()=>ce.value?.status??``),Y=o(()=>W.value.filter(e=>P.value.includes(e.id)).length);f(D,e=>{console.log(`👁️‍🗨️ [watch 감지] 상태 바 문구가 업데이트되었습니다 -> "${e}"`)});let X=n(``),Z=o(()=>t.value.find(e=>e.id===X.value)??null),Q=e=>{let n=t.value.find(t=>t.name===e);X.value=X.value===n?.id?``:n?.id??``};return(e,n)=>(i(),p(`div`,Ct,[g(xt,{status:le.value},null,8,[`status`]),g(M,null,{default:d(()=>[g(ee,{"current-query":w.value,onUpdateQuery:n[0]||=e=>w.value=e},null,8,[`current-query`])]),_:1}),g(M,null,{default:d(()=>[h(`div`,wt,[h(`button`,{type:`button`,role:`tab`,"aria-selected":E.value===`region`,class:_({active:E.value===`region`}),onClick:n[1]||=e=>E.value=`region`},[g(N,{name:`city`,size:16}),n[10]||=l(` 지역별 날씨 현황 `,-1)],10,Tt),h(`button`,{type:`button`,role:`tab`,"aria-selected":E.value===`status`,class:_({active:E.value===`status`}),onClick:n[2]||=e=>E.value=`status`},[g(N,{name:`droplet`,size:16}),n[11]||=l(` 날씨별 지역 현황 `,-1)],10,Et)]),h(`div`,Dt,[h(`p`,Ot,[h(`b`,null,s(W.value.length),1),n[12]||=l(`곳 `,-1),Y.value?(i(),p(`span`,kt,[g(N,{name:`star`,size:12,filled:!0}),l(` `+s(Y.value),1)])):c(``,!0)]),h(`button`,{class:`tool`,type:`button`,disabled:L.value===`asking`,onClick:R},[g(N,{name:`location`,size:14}),l(` `+s(L.value===`asking`?`찾는 중…`:`내 위치`),1)],8,At),h(`button`,{class:`tool`,type:`button`,disabled:r.value,onClick:n[3]||=e=>z(!0)},s(r.value?`불러오는 중…`:`새로고침`),9,jt)]),u.value?(i(),p(`p`,Mt,[n[13]||=l(` 지금 서버 응답을 받지 못해 `,-1),h(`b`,null,s(y.value)+`에 받아 둔 값`,1),n[14]||=l(`을 보여 주고 있습니다. 잠시 뒤 새로고침을 눌러 보세요. `,-1)])):c(``,!0),L.value===`denied`?(i(),p(`p`,Nt,` 위치 권한이 없어 현재 위치를 표시하지 못했습니다. 나머지 기능은 그대로 쓸 수 있습니다. `)):c(``,!0),E.value===`region`?(i(),v(je,{key:2,regions:[...C(ae),`데모`],current:T.value,counts:K.value,onSelectRegion:n[4]||=e=>T.value=e},null,8,[`regions`,`current`,`counts`])):c(``,!0),a.value?(i(),p(`p`,Pt,[l(s(a.value)+` `,1),h(`button`,{type:`button`,onClick:n[5]||=e=>z(!0)},`다시 시도`)])):r.value&&!t.value.length?(i(),p(`div`,Ft,[(i(),p(m,null,x(5,e=>h(`div`,{key:e,class:`skeleton-card`},[...n[15]||=[h(`span`,{class:`sk-tile`},null,-1),h(`span`,{class:`sk-lines`},[h(`i`,{class:`sk-line wide`}),h(`i`,{class:`sk-line`})],-1),h(`span`,{class:`sk-metrics`},[h(`i`,{class:`sk-pill`}),h(`i`,{class:`sk-pill`})],-1)]])),64))])):E.value===`region`?(i(),p(m,{key:5},[(i(!0),p(m,null,x(se.value,e=>(i(),p(m,{key:e.id},[g(te,{"city-item":e,favorite:P.value.includes(e.id),here:e.id===I.value,open:e.id===X.value,selected:e.id===O.value,onSelectCard:j,onClickDetail:Q,onToggleFavorite:F},null,8,[`city-item`,`favorite`,`here`,`open`,`selected`]),e.id===X.value?(i(),v($,{key:0,city:Z.value,onClose:n[6]||=e=>X.value=``},null,8,[`city`])):c(``,!0)],64))),128)),G.value.length===0?(i(),p(`p`,It,[g(N,{name:`empty`,size:22}),n[16]||=l(` 검색 결과와 일치하는 도시가 없습니다. `,-1)])):c(``,!0),q.value>1?(i(),p(`nav`,Lt,[h(`button`,{type:`button`,disabled:k.value===1,"aria-label":`이전`,onClick:n[7]||=e=>k.value--},`‹`,8,Rt),(i(!0),p(m,null,x(q.value,e=>(i(),p(`button`,{key:e,type:`button`,class:_({active:e===k.value}),"aria-current":e===k.value?`page`:void 0,onClick:t=>k.value=e},s(e),11,zt))),128)),h(`button`,{type:`button`,disabled:k.value===q.value,"aria-label":`다음`,onClick:n[8]||=e=>k.value++},` › `,8,Bt)])):c(``,!0)],64)):(i(),p(m,{key:6},[J.value?(i(),p(m,{key:0},[g(te,{"city-item":J.value,favorite:P.value.includes(J.value.id),here:J.value.id===I.value,open:J.value.id===X.value,selected:!0,onSelectCard:j,onClickDetail:Q,onToggleFavorite:F},null,8,[`city-item`,`favorite`,`here`,`open`]),J.value.id===X.value?(i(),v($,{key:0,city:Z.value,onClose:n[9]||=e=>X.value=``},null,8,[`city`])):c(``,!0)],64)):c(``,!0),g(We,{list:W.value,favorites:P.value,"here-id":I.value,"selected-id":O.value,onSelectCard:j,onToggleFavorite:F},null,8,[`list`,`favorites`,`here-id`,`selected-id`])],64))]),_:1}),h(`div`,Vt,[h(`span`,null,s(D.value),1),y.value?(i(),p(`small`,Ht,s(y.value)+` 기준 · Open-Meteo`,1)):c(``,!0)])]))}},[[`__scopeId`,`data-v-dba696e8`]]),qt=e({default:()=>Zt}),Jt={class:`app dashboard-wrapper`},Yt={class:`nav`,role:`tablist`},Xt={class:`url`},Zt=y({__name:`WeatherRouterApp`,setup(e){let t=D(),n=o(()=>t.params.stageId??`4`),r=o(()=>t.name===`a4-about`);return(e,a)=>(i(),p(`div`,Jt,[g(xt,{status:C(L)},null,8,[`status`]),h(`nav`,Yt,[g(C(T),{to:{name:`a4-home`,params:{stageId:n.value}},class:_({on:!r.value})},{default:d(()=>[...a[0]||=[l(` 홈 `,-1)]]),_:1},8,[`to`,`class`]),g(C(T),{to:{name:`a4-about`,params:{stageId:n.value}},"active-class":`on`},{default:d(()=>[...a[1]||=[l(` 소개 `,-1)]]),_:1},8,[`to`]),h(`code`,Xt,s(C(t).path),1)]),g(C(O))]))}},[[`__scopeId`,`data-v-3f5ec7f5`]]),Qt=`<script setup>
/**
...
`,yn=Object.fromEntries(Object.entries(Object.assign({"./WeatherComposition.vue":q,"./WeatherMockup.vue":pe,"./WeatherParent.vue":St,"./router4/WeatherAboutView.vue":A,"./router4/WeatherDetailView.vue":R,"./router4/WeatherHomeView.vue":V,"./router4/WeatherNotFoundView.vue":ne,"./router4/WeatherRouterApp.vue":qt,"./weather/BaseDashboardCard.vue":P,"./weather/HourlyDetail.vue":Ge,"./weather/RegionTabs.vue":De,"./weather/SearchBar.vue":z,"./weather/UiIcon.vue":j,"./weather/WeatherBackdrop.vue":_t,"./weather/WeatherByStatus.vue":Me,"./weather/WeatherCard.vue":B,"./weather/WeatherIcon.vue":I})).map(([e,t])=>[e.split(`/`).pop().replace(`.vue`,``),t.default]));Object.keys(yn).sort();var bn=e=>yn[e]??null,xn=Object.assign({"./WeatherComposition.vue":Qt,"./WeatherMockup.vue":$t,"./WeatherParent.vue":en,"./router4/WeatherAboutView.vue":tn,"./router4/WeatherDetailView.vue":nn,"./router4/WeatherHomeView.vue":rn,"./router4/WeatherNotFoundView.vue":an,"./router4/WeatherRouterApp.vue":on,"./router4/backdropState.js":sn,"./router4/mockCities.js":cn,"./weather/BaseDashboardCard.vue":ln,"./weather/HourlyDetail.vue":un,"./weather/RegionTabs.vue":dn,"./weather/SearchBar.vue":fn,"./weather/UiIcon.vue":pn,"./weather/WeatherBackdrop.vue":mn,"./weather/WeatherByStatus.vue":hn,"./weather/WeatherCard.vue":gn,"./weather/WeatherIcon.vue":_n,"./weather/weatherApi.js":vn}),Sn=Object.fromEntries(Object.entries(xn).map(([e,t])=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),t])),Cn=Object.fromEntries(Object.keys(xn).map(e=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),e.replace(`./`,`src/components/assignments/`)])),wn=e=>Sn[e]===void 0?Object.keys(Sn).find(t=>t.endsWith(`/${e}`)):e,Tn=e=>Sn[wn(e)]??``,En=e=>Cn[wn(e)]??``;export{bn as n,Tn as r,En as t};