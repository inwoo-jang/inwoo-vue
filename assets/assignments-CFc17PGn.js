import{n as e}from"./rolldown-runtime-hePW80VL.js";import{$ as t,L as n,P as r,Q as i,Wt as a,_ as o,bt as s,d as c,dt as l,et as u,f as d,i as f,j as p,l as m,p as h,qt as g,u as _,v,z as y}from"./runtime-core.esm-bundler-kkMznkCl.js";import{d as b}from"./runtime-dom.esm-bundler-CHanmBTQ.js";import{r as x}from"./pinia-Cmt0qqyQ.js";import{h as S,m as C}from"./useApi-CROJJdhE-BZRBkDcY.js";import{n as w,t as T}from"./vue-router-Cv6XZhD8.js";import{t as E}from"./_plugin-vue_export-helper-BDNMzG2s.js";import{t as D}from"./WeatherAboutView-_LuNZmaV.js";import{t as O}from"./WeatherNotFoundView-BRTy6Wy1.js";import{t as k}from"./BaseDashboardCard-BhrmAXPN.js";import{n as A,t as j}from"./configStore-DHGN-ap5.js";import{t as M}from"./UiIcon-Cq5UHP5E.js";import{i as ee,r as te,s as ne,u as re}from"./weatherApi-BF-tCb-P.js";import{t as ie}from"./HourlyDetail-CmUreY6v.js";import{a as N,i as P,n as F,r as I,t as L}from"./stageFeatures-C25RV7ww.js";import{t as R}from"./StageDetailView-DaG0S98-.js";import{n as ae,t as z}from"./StageHomeView-CLUA9Tu2.js";import{n as B,r as oe,t as se}from"./WeatherByStatus-CJxJbRFL.js";import{t as V}from"./StageTarotView-CdE1LB_-.js";import{t as H}from"./WeatherBackdrop-B5_isd66.js";var U=e({default:()=>me}),ce={class:`report`},le={class:`live`},W={class:`cell`},G={class:`c-note`},K={class:`cell`},ue={class:`c-value`},q={class:`c-note`},de={class:`cell`},J={class:`c-note`},fe={class:`reqs`},pe={class:`no`},Y={class:`body`},X={class:`r-title`},Z={class:`r-detail`},Q={class:`r-how`},me=E({__name:`DeployReport`,setup(e){let t=`/inwoo-vue/`,r=m(()=>!0),i=[{title:`ESLint 로 점검해 Error 0개`,how:`npm run lint:check`,detail:`eslint.config.js 에 Vue 3 규칙을 두고, 형식은 Prettier 에 넘겨 서로 다투지 않게 했다. 실습 중 일부러 남긴 위반(Props 직접 수정)은 그 한 줄만 주석으로 끈다.`},{title:`API Key 를 환경변수로 분리`,how:`import.meta.env.VITE_OPENWEATHER_API_KEY`,detail:`코드에 키를 적지 않는다. .env.example 에는 어떤 키가 필요한지만 적어 두고 실제 값은 .env.local 에 넣는다.`},{title:`.gitignore 로 키와 환경 파일 보호`,how:`.gitignore 의 .env*`,detail:`.env.example 만 일부러 추적한다 — 값이 없는 견본이라 올라가도 안전하고, 다른 사람이 무엇을 채워야 하는지 알 수 있다.`},{title:`npm run build 로 dist/ 생성`,how:`npm run build`,detail:`Vite 가 소스를 묶어 dist/ 에 정적 파일로 낸다. 이 화면도 그 결과물 안에서 돌고 있다.`},{title:`GitHub Pages 에 정적 배포`,how:`npm run deploy`,detail:`빌드 → 404.html 복사(SPA 라 새로고침에 필요) → .nojekyll 생성(Jekyll 이 _ 로 시작하는 파일을 지우지 않게) → gh-pages 브랜치에 올린다.`}];return(e,c)=>(n(),h(`section`,ce,[c[3]||=_(`header`,{class:`head`},[_(`p`,{class:`eyebrow`},`STAGE 09 · 교안 274쪽`),_(`h2`,null,`최종 완성과 배포`),_(`p`,{class:`lead`},[o(` 이 단계에는 새로 만든 화면이 없습니다. 대신 앞의 여덟 단계를 하나로 묶어 내보내는 일을 했습니다. 아래 값은 적어 둔 것이 아니라 `),_(`code`,null,`import.meta.env`),o(` 에서 지금 읽은 것입니다. `)])],-1),_(`div`,le,[_(`div`,W,[c[0]||=_(`p`,{class:`c-label`},`빌드 모드`,-1),_(`p`,{class:a([`c-value`,{prod:r.value}])},g(s(`production`)),3),_(`p`,G,g(r.value?`배포본에서 보고 있습니다.`:`개발 서버에서 보고 있습니다.`),1)]),_(`div`,K,[c[1]||=_(`p`,{class:`c-label`},`base 경로`,-1),_(`p`,ue,g(s(t)),1),_(`p`,q,g(s(t)===`/`?`로컬이라 최상위입니다.`:`GitHub Pages 는 저장소 이름이 앞에 붙습니다.`),1)]),_(`div`,de,[c[2]||=_(`p`,{class:`c-label`},`번들 안의 API Key`,-1),_(`p`,{class:a([`c-value`,`prod`])},g(`비어 있음`),3),_(`p`,J,g(`VITE_ 값은 파일에 그대로 박히므로, 배포본에서는 비어 있어야 안전합니다.`),1)])]),_(`ol`,fe,[(n(),h(f,null,y(i,(e,t)=>_(`li`,{key:e.title},[_(`span`,pe,g(String(t+1).padStart(2,`0`)),1),_(`div`,Y,[_(`p`,X,g(e.title),1),_(`p`,Z,g(e.detail),1),_(`code`,Q,g(e.how),1)])])),64))]),c[4]||=_(`p`,{class:`foot`},[o(` 키가 없어도 앱은 멈추지 않습니다. OpenWeather 키가 비면 키가 필요 없는 `),_(`b`,null,`Open-Meteo`),o(` 로 자동 전환되도록 만들어 두었습니다 — 배포본에서 날씨가 나오는 이유입니다. `)],-1)]))}},[[`__scopeId`,`data-v-135df7c4`]]),he=e({default:()=>Ee}),ge={class:`dashboard-wrapper`},_e={class:`search-box`},ve=[`value`],ye={class:`list-box`},be=[`onClick`],xe={key:0,class:`badge hot`},Se={key:1,class:`badge cool`},Ce=[`onClick`],we={key:0,class:`empty-message`},Te={class:`status-bar`},Ee=E({__name:`WeatherComposition`,setup(e){let r=l([{id:`city_01`,name:`서울`,temp:28,status:`맑음`},{id:`city_02`,name:`수원`,temp:24,status:`비`},{id:`city_03`,name:`부산`,temp:26,status:`구름`}]),a=l(``),s=l(`카드를 클릭하거나 검색해 보세요.`),c=m(()=>{let e=a.value.trim();return e?r.value.filter(t=>t.name.includes(e)):r.value});i(s,e=>{console.log(`👁️‍🗨️ [watch 감지] 상태 바 문구가 업데이트되었습니다 -> "${e}"`)}),t(()=>{console.log(`🤖 [watchEffect 자동 호출] 현재 검색어 '${a.value}'에 매칭되는 API 데이터를 필터링합니다.`)});let u=(e,t)=>{window.alert(`${e}의 현재 날씨는 [${t}] 상태입니다.`)};return(e,t)=>(n(),h(`div`,ge,[_(`section`,_e,[t[2]||=_(`h3`,null,`🔍 도시 검색`,-1),_(`input`,{type:`text`,value:a.value,placeholder:`검색할 도시 이름 입력`,onInput:t[0]||=e=>a.value=e.target.value},null,40,ve),_(`p`,null,[t[1]||=o(` 검색 중인 도시: `,-1),_(`strong`,null,g(a.value),1)])]),_(`section`,ye,[t[3]||=_(`h3`,null,`🏙️ 지역별 날씨 현황`,-1),(n(!0),h(f,null,y(c.value,e=>(n(),h(`div`,{key:e.id,class:`weather-card`,onClick:t=>s.value=`${e.name}이 선택되었습니다.`},[_(`h4`,null,g(e.name)+` (`+g(e.status)+`)`,1),_(`p`,null,`현재 기온: `+g(e.temp)+`°C`,1),e.temp>=25?(n(),h(`span`,xe,`🔥 더움 (25도 이상)`)):(n(),h(`span`,Se,`❄️ 선선함 (25도 미만)`)),_(`button`,{class:`btn-detail`,onClick:b(t=>u(e.name,e.status),[`stop`])},` 상세보기 `,8,Ce)],8,be))),128)),c.value.length===0?(n(),h(`p`,we,` 😭 검색 결과와 일치하는 도시가 없습니다. `)):d(``,!0)]),_(`div`,Te,g(s.value),1)]))}},[[`__scopeId`,`data-v-6342b841`]]),De=e({default:()=>Be}),Oe={class:`weather-app`},ke={class:`weather-search`},Ae=[`value`],je={class:`status-bar`},Me={class:`weather-grid`},Ne=[`onClick`],Pe={class:`weather-card-header`},Fe={class:`temperature`},Ie={key:0,class:`hot`},Le={key:1,class:`cool`},Re=[`onClick`],ze={key:0,class:`empty-message`},Be=E({__name:`WeatherMockup`,setup(e){let t=l(``),r=l(`도시 카드를 선택해 주세요.`),i=l([{id:1,city:`서울`,temperature:28,weather:`맑음`},{id:2,city:`부산`,temperature:24,weather:`흐림`},{id:3,city:`제주`,temperature:26,weather:`구름 조금`},{id:4,city:`대전`,temperature:22,weather:`비`},{id:5,city:`광주`,temperature:30,weather:`맑음`}]),a=e=>{t.value=e.target.value},o=()=>{let e=t.value.trim();return e?i.value.filter(t=>t.city.includes(e)):i.value},s=e=>e>=25?`🔥 더움`:`❄️ 선선함`,c=e=>{r.value=`${e}이 선택되었습니다.`},u=(e,t)=>{window.alert(`${e}의 현재 날씨는 [${t}] 상태입니다.`)};return(e,i)=>(n(),h(`main`,Oe,[i[1]||=_(`h1`,null,`날씨 Mockup`,-1),_(`div`,ke,[i[0]||=_(`label`,{for:`city-search`},`한글 도시 검색`,-1),_(`input`,{id:`city-search`,value:t.value,type:`text`,placeholder:`예: 서울`,onInput:a},null,40,Ae)]),_(`p`,je,g(r.value),1),_(`div`,Me,[(n(!0),h(f,null,y(o(),e=>(n(),h(`article`,{key:e.id,class:`weather-card`,onClick:t=>c(e.city)},[_(`div`,Pe,[_(`h2`,null,g(e.city),1),_(`span`,null,g(e.weather),1)]),_(`p`,Fe,g(e.temperature)+`℃`,1),e.temperature>=25?(n(),h(`p`,Ie,`🔥 더움`)):(n(),h(`p`,Le,`❄️ 선선함`)),_(`button`,{type:`button`,onClick:b(t=>u(e.city,s(e.temperature)),[`stop`])},` 상세보기 `,8,Re)],8,Ne))),128))]),o().length===0?(n(),h(`p`,ze,` 검색 결과와 일치하는 도시가 없습니다. `)):d(``,!0)]))}},[[`__scopeId`,`data-v-a56bc1a5`]]),Ve=e({default:()=>ut}),He={class:`dashboard-wrapper`},Ue={class:`view-tabs`,role:`tablist`},We=[`aria-selected`],Ge=[`aria-selected`],Ke={class:`tool-row`},qe={class:`summary`},Je={key:0,class:`fav-count`},Ye=[`disabled`],Xe=[`disabled`],Ze={key:0,class:`hint stale`},Qe={key:1,class:`hint`},$e={key:3,class:`error-message`},et={key:4,class:`skeleton`},tt={key:0,class:`empty-message`},nt={key:1,class:`pager`,"aria-label":`목록 페이지`},rt=[`disabled`],it=[`aria-current`,`onClick`],at=[`disabled`],ot={class:`status-bar`},st={key:0,class:`stamp`},ct=`inwoo-weather-favorites`,$=5,lt=6e5,ut=E({__name:`WeatherParent`,setup(e){let t=l([]),b=l(!1),x=l(``),S=l(!1),C=l(``),w=l(``),T=l(`전체`),E=l(`region`),D=l(`카드를 클릭하거나 검색해 보세요.`),O=l(``),A=l(1),j=()=>{O.value=``,D.value=`카드를 클릭하거나 검색해 보세요.`},N=e=>{if(O.value===e){j();return}O.value=e;let n=t.value.find(t=>t.id===e);D.value=n?`${n.name} · ${n.status} · ${n.temp}°C · 습도 ${n.humidity}%`:`카드를 클릭하거나 검색해 보세요.`},P=l(JSON.parse(localStorage.getItem(ct)??`[]`)),F=e=>{P.value=P.value.includes(e)?P.value.filter(t=>t!==e):[...P.value,e]};i(P,e=>localStorage.setItem(ct,JSON.stringify(e)),{deep:!0});let I=l(``),L=l(`idle`),R=()=>{if(!navigator.geolocation){L.value=`denied`;return}L.value=`asking`,navigator.geolocation.getCurrentPosition(({coords:e})=>{let t=re(e.latitude,e.longitude);I.value=t?.id??``,L.value=`done`},()=>{L.value=`denied`},{timeout:8e3})},z=async(e=!1)=>{b.value=!0,x.value=``;try{let{rows:n,at:r,stale:i}=await ne(void 0,e);t.value=[...n,...te],S.value=i,i&&setTimeout(()=>z(!0),0),U=r,C.value=new Date(r).toLocaleTimeString(`ko-KR`,{hour:`2-digit`,minute:`2-digit`})}catch(e){x.value=`날씨를 불러오지 못했습니다. 네트워크를 확인하고 다시 시도해 주세요.`,S.value=!1,console.error(`[weather] 불러오기 실패`,e)}finally{b.value=!1}},V=null,U=0,ce=()=>{le(),V=setInterval(()=>{document.visibilityState===`visible`&&z(!0)},lt)},le=()=>{V&&clearInterval(V),V=null},W=()=>{document.visibilityState===`visible`&&Date.now()-U>lt&&z(!0)};p(()=>{le(),document.removeEventListener(`visibilitychange`,W)}),r(async()=>{z(),ce(),document.addEventListener(`visibilitychange`,W),(await navigator.permissions?.query({name:`geolocation`}).catch(()=>null))?.state===`granted`&&R()});let G=m(()=>{let e=w.value.trim();return t.value.filter(t=>!e||t.name.includes(e))}),K=m(()=>{let e=G.value.filter(e=>T.value===`전체`||e.group===T.value),t=e=>e.id===I.value?0:P.value.includes(e.id)?1:2;return[...e].sort((e,n)=>t(e)-t(n))}),ue=m(()=>G.value.reduce((e,t)=>(e[t.group]=(e[t.group]??0)+1,e),{전체:G.value.length})),q=m(()=>Math.max(1,Math.ceil(K.value.length/$))),de=m(()=>K.value.slice((A.value-1)*$,A.value*$));i([w,T,E],()=>A.value=1),i(q,e=>{A.value>e&&(A.value=e)});let J=m(()=>t.value.find(e=>e.id===O.value)??null),fe=m(()=>t.value.find(e=>e.id===O.value)??t.value.find(e=>e.id===I.value)??null),pe=m(()=>fe.value?.status??``),Y=m(()=>G.value.filter(e=>P.value.includes(e.id)).length);i(D,e=>{console.log(`👁️‍🗨️ [watch 감지] 상태 바 문구가 업데이트되었습니다 -> "${e}"`)});let X=l(``),Z=m(()=>t.value.find(e=>e.id===X.value)??null),Q=e=>{let n=t.value.find(t=>t.name===e);X.value=X.value===n?.id?``:n?.id??``};return(e,r)=>(n(),h(`div`,He,[v(H,{status:pe.value},null,8,[`status`]),v(k,null,{default:u(()=>[v(ae,{"current-query":w.value,onUpdateQuery:r[0]||=e=>w.value=e},null,8,[`current-query`])]),_:1}),v(k,null,{default:u(()=>[_(`div`,Ue,[_(`button`,{type:`button`,role:`tab`,"aria-selected":E.value===`region`,class:a({active:E.value===`region`}),onClick:r[1]||=e=>E.value=`region`},[v(M,{name:`city`,size:16}),r[10]||=o(` 지역별 날씨 현황 `,-1)],10,We),_(`button`,{type:`button`,role:`tab`,"aria-selected":E.value===`status`,class:a({active:E.value===`status`}),onClick:r[2]||=e=>E.value=`status`},[v(M,{name:`droplet`,size:16}),r[11]||=o(` 날씨별 지역 현황 `,-1)],10,Ge)]),_(`div`,Ke,[_(`p`,qe,[_(`b`,null,g(G.value.length),1),r[12]||=o(`곳 `,-1),Y.value?(n(),h(`span`,Je,[v(M,{name:`star`,size:12,filled:!0}),o(` `+g(Y.value),1)])):d(``,!0)]),_(`button`,{class:`tool`,type:`button`,disabled:L.value===`asking`,onClick:R},[v(M,{name:`location`,size:14}),o(` `+g(L.value===`asking`?`찾는 중…`:`내 위치`),1)],8,Ye),_(`button`,{class:`tool`,type:`button`,disabled:b.value,onClick:r[3]||=e=>z(!0)},g(b.value?`불러오는 중…`:`새로고침`),9,Xe)]),S.value?(n(),h(`p`,Ze,[r[13]||=o(` 지금 서버 응답을 받지 못해 `,-1),_(`b`,null,g(C.value)+`에 받아 둔 값`,1),r[14]||=o(`을 보여 주고 있습니다. 잠시 뒤 새로고침을 눌러 보세요. `,-1)])):d(``,!0),L.value===`denied`?(n(),h(`p`,Qe,` 위치 권한이 없어 현재 위치를 표시하지 못했습니다. 나머지 기능은 그대로 쓸 수 있습니다. `)):d(``,!0),E.value===`region`?(n(),c(oe,{key:2,regions:[...s(ee),`데모`],current:T.value,counts:ue.value,onSelectRegion:r[4]||=e=>T.value=e},null,8,[`regions`,`current`,`counts`])):d(``,!0),x.value?(n(),h(`p`,$e,[o(g(x.value)+` `,1),_(`button`,{type:`button`,onClick:r[5]||=e=>z(!0)},`다시 시도`)])):b.value&&!t.value.length?(n(),h(`div`,et,[(n(),h(f,null,y(5,e=>_(`div`,{key:e,class:`skeleton-card`},[...r[15]||=[_(`span`,{class:`sk-tile`},null,-1),_(`span`,{class:`sk-lines`},[_(`i`,{class:`sk-line wide`}),_(`i`,{class:`sk-line`})],-1),_(`span`,{class:`sk-metrics`},[_(`i`,{class:`sk-pill`}),_(`i`,{class:`sk-pill`})],-1)]])),64))])):E.value===`region`?(n(),h(f,{key:5},[(n(!0),h(f,null,y(de.value,e=>(n(),h(f,{key:e.id},[v(B,{"city-item":e,favorite:P.value.includes(e.id),here:e.id===I.value,open:e.id===X.value,selected:e.id===O.value,onSelectCard:N,onClickDetail:Q,onToggleFavorite:F},null,8,[`city-item`,`favorite`,`here`,`open`,`selected`]),e.id===X.value?(n(),c(ie,{key:0,city:Z.value,onClose:r[6]||=e=>X.value=``},null,8,[`city`])):d(``,!0)],64))),128)),K.value.length===0?(n(),h(`p`,tt,[v(M,{name:`empty`,size:22}),r[16]||=o(` 검색 결과와 일치하는 도시가 없습니다. `,-1)])):d(``,!0),q.value>1?(n(),h(`nav`,nt,[_(`button`,{type:`button`,disabled:A.value===1,"aria-label":`이전`,onClick:r[7]||=e=>A.value--},`‹`,8,rt),(n(!0),h(f,null,y(q.value,e=>(n(),h(`button`,{key:e,type:`button`,class:a({active:e===A.value}),"aria-current":e===A.value?`page`:void 0,onClick:t=>A.value=e},g(e),11,it))),128)),_(`button`,{type:`button`,disabled:A.value===q.value,"aria-label":`다음`,onClick:r[8]||=e=>A.value++},` › `,8,at)])):d(``,!0)],64)):(n(),h(f,{key:6},[J.value?(n(),h(f,{key:0},[v(B,{"city-item":J.value,favorite:P.value.includes(J.value.id),here:J.value.id===I.value,open:J.value.id===X.value,selected:!0,onSelectCard:N,onClickDetail:Q,onToggleFavorite:F},null,8,[`city-item`,`favorite`,`here`,`open`]),J.value.id===X.value?(n(),c(ie,{key:0,city:Z.value,onClose:r[9]||=e=>X.value=``},null,8,[`city`])):d(``,!0)],64)):d(``,!0),v(se,{list:G.value,favorites:P.value,"here-id":I.value,"selected-id":O.value,onSelectCard:N,onToggleFavorite:F},null,8,[`list`,`favorites`,`here-id`,`selected-id`])],64))]),_:1}),_(`div`,ot,[_(`span`,null,g(D.value),1),C.value?(n(),h(`small`,st,g(C.value)+` 기준 · Open-Meteo`,1)):d(``,!0)])]))}},[[`__scopeId`,`data-v-4af13157`]]),dt=e({default:()=>ht}),ft=[`title`],pt={class:`symbol`},mt={class:`name`},ht=E({__name:`UnitToggler`,setup(e){let t=j(),{unit:r,unitSymbol:i}=x(t),{toggleUnit:a}=t;return(e,t)=>(n(),h(`button`,{type:`button`,class:`unit-toggler`,title:s(r)===`celsius`?`화씨(℉)로 보기`:`섭씨(℃)로 보기`,onClick:t[0]||=(...e)=>s(a)&&s(a)(...e)},[_(`span`,pt,g(s(i)),1),_(`span`,mt,g(s(r)===`celsius`?`섭씨`:`화씨`),1)],8,ft))}},[[`__scopeId`,`data-v-052b21fd`]]),gt=e({default:()=>xt}),_t={class:`app`},vt={class:`column`},yt={class:`nav`,role:`tablist`},bt={class:`url`},xt=E({__name:`WeatherUnitApp`,setup(e){let t=C(),r=m(()=>t.params.stageId??`5`),i=m(()=>t.name===`a4-about`);return(e,c)=>(n(),h(`div`,_t,[v(H,{status:s(I)},null,8,[`status`]),_(`div`,vt,[_(`nav`,yt,[v(s(T),{to:{name:`a4-home`,params:{stageId:r.value}},class:a({on:!i.value})},{default:u(()=>[...c[0]||=[o(` 홈 `,-1)]]),_:1},8,[`to`,`class`]),v(s(T),{to:{name:`a4-about`,params:{stageId:r.value}},"active-class":`on`},{default:u(()=>[...c[1]||=[o(` 소개 `,-1)]]),_:1},8,[`to`]),_(`code`,bt,g(s(t).path),1),v(ht)]),v(s(w))])]))}},[[`__scopeId`,`data-v-666130dd`]]),St=e({default:()=>Pt}),Ct={class:`head`},wt={class:`title`},Tt={class:`eyebrow`},Et={class:`status`},Dt={class:`temp`},Ot={class:`unit`},kt={class:`observation`},At={class:`small`},jt={class:`foot`},Mt={key:0,class:`from`},Nt={key:1,class:`missing`},Pt=E({__name:`WeatherDetailView`,setup(e){let t=C(),i=S(),p=l(null);r(()=>{p.value=N(t.params.cityId),p.value&&(I.value=p.value.status)});let y=m(()=>{let e=p.value?.status??``;return e.includes(`맑`)?`warm`:e.includes(`비`)||e.includes(`눈`)?`cool`:`neutral`}),{unit:b,unitSymbol:w}=x(j()),T=m(()=>{let e=p.value?.temp??0;return b.value===`celsius`?e:Math.round(e*9/5+32)}),E=()=>i.go(-1);return(e,r)=>(n(),c(k,null,{default:u(()=>[p.value?(n(),h(f,{key:0},[_(`header`,Ct,[_(`div`,{class:a([`icon-tile`,y.value])},[v(A,{status:p.value.status,size:34},null,8,[`status`])],2),_(`div`,wt,[_(`p`,Tt,[o(g(p.value.region)+` · `,1),_(`code`,null,g(s(t).params.cityId),1)]),_(`h3`,null,g(p.value.name),1),_(`p`,Et,g(p.value.status),1)]),_(`p`,Dt,[o(g(T.value),1),_(`span`,Ot,g(s(w)),1)])]),_(`dl`,kt,[_(`div`,null,[r[1]||=_(`dt`,null,`습도`,-1),_(`dd`,null,[o(g(p.value.humidity),1),r[0]||=_(`i`,null,`%`,-1)])]),_(`div`,null,[r[3]||=_(`dt`,null,`풍속`,-1),_(`dd`,null,[o(g(p.value.wind),1),r[2]||=_(`i`,null,`m/s`,-1)])]),_(`div`,null,[r[5]||=_(`dt`,null,`기압`,-1),_(`dd`,null,[o(g(p.value.pressure),1),r[4]||=_(`i`,null,`hPa`,-1)])]),_(`div`,null,[r[7]||=_(`dt`,null,`가시거리`,-1),_(`dd`,null,[o(g(p.value.visibility),1),r[6]||=_(`i`,null,`km`,-1)])]),_(`div`,null,[r[8]||=_(`dt`,null,`미세먼지`,-1),_(`dd`,null,g(p.value.dust),1)]),_(`div`,null,[r[9]||=_(`dt`,null,`일출 · 일몰`,-1),_(`dd`,At,g(p.value.sunrise)+` · `+g(p.value.sunset),1)])]),_(`footer`,jt,[s(t).query.from?(n(),h(`p`,Mt,[r[10]||=_(`span`,{class:`tag`},`route.query`,-1),_(`code`,null,g(s(t).query),1)])):d(``,!0),_(`button`,{type:`button`,onClick:E},`← 이전 화면으로`)])],64)):(n(),h(`div`,Nt,[v(M,{name:`empty`,size:24}),_(`p`,null,[_(`code`,null,g(s(t).params.cityId),1),r[11]||=o(` 에 해당하는 도시가 없습니다.`,-1)]),_(`button`,{type:`button`,onClick:E},`← 이전 화면으로`)]))]),_:1}))}},[[`__scopeId`,`data-v-0ad346f0`]]),Ft=e({default:()=>Rt}),It={class:`home`},Lt={key:0,class:`empty`},Rt=E({__name:`WeatherHomeView`,setup(e){let t=C(),a=S(),{unit:p,unitSymbol:g}=x(j()),b=e=>p.value===`celsius`?e:Math.round(e*9/5+32),w=l(``),T=l(``),E=()=>{let e=P.find(e=>e.id===T.value);I.value=(e??P[0]).status};r(E),i(T,E);let D=m(()=>{let e=w.value.trim();return e?P.filter(t=>t.name.includes(e)):P}),O=e=>{let n=P.find(t=>t.name===e);n&&a.push({name:`a4-detail`,params:{stageId:t.params.stageId??`4`,cityId:n.id},query:{from:`home`}})};return(e,t)=>(n(),h(`div`,It,[v(k,null,{default:u(()=>[v(ae,{"current-query":w.value,onUpdateQuery:t[0]||=e=>w.value=e},null,8,[`current-query`])]),_:1}),v(k,null,{default:u(()=>[_(`h3`,null,[v(M,{name:`city`,size:19}),t[2]||=o(` 지역별 날씨 현황`,-1)]),(n(!0),h(f,null,y(D.value,e=>(n(),c(B,{key:e.id,"city-item":e,selected:e.id===T.value,"temp-value":b(e.temp),"temp-unit":s(g),"detail-label":`상세보기`,onSelectCard:t[1]||=e=>T.value=T.value===e?``:e,onClickDetail:O},null,8,[`city-item`,`selected`,`temp-value`,`temp-unit`]))),128)),D.value.length?d(``,!0):(n(),h(`p`,Lt,[v(M,{name:`empty`,size:22}),t[3]||=o(` 검색 결과와 일치하는 도시가 없습니다. `,-1)]))]),_:1})]))}},[[`__scopeId`,`data-v-de035d07`]]),zt=e({default:()=>Wt}),Bt={class:`app`},Vt={class:`column`},Ht={class:`nav`,role:`tablist`},Ut={class:`url`},Wt=E({__name:`WeatherRouterApp`,setup(e){let t=C(),r=m(()=>t.params.stageId??`4`),i=m(()=>t.name===`a4-about`);return(e,c)=>(n(),h(`div`,Bt,[v(H,{status:s(I)},null,8,[`status`]),_(`div`,Vt,[_(`nav`,Ht,[v(s(T),{to:{name:`a4-home`,params:{stageId:r.value}},class:a({on:!i.value})},{default:u(()=>[...c[0]||=[o(` 홈 `,-1)]]),_:1},8,[`to`,`class`]),v(s(T),{to:{name:`a4-about`,params:{stageId:r.value}},"active-class":`on`},{default:u(()=>[...c[1]||=[o(` 소개 `,-1)]]),_:1},8,[`to`]),_(`code`,Ut,g(s(t).path),1)]),v(s(w))])]))}},[[`__scopeId`,`data-v-bc06f5e7`]]),Gt=e({default:()=>Xt}),Kt={class:`app`},qt={class:`column`},Jt={class:`nav`,role:`tablist`},Yt={class:`url`},Xt=E({__name:`WeatherStackedApp`,setup(e){let t=C(),r=m(()=>F(t.params.stageId)),i=m(()=>String(r.value)),l=m(()=>L(t.params.stageId)),f=m(()=>t.name===`a4-about`),p=m(()=>t.name===`a4-tarot`),y=m(()=>!f.value&&!p.value);return(e,r)=>(n(),h(`div`,Kt,[v(H,{status:s(I)},null,8,[`status`]),_(`div`,qt,[_(`nav`,Jt,[v(s(T),{to:{name:`a4-home`,params:{stageId:i.value}},class:a({on:y.value})},{default:u(()=>[...r[0]||=[o(` 홈 `,-1)]]),_:1},8,[`to`,`class`]),v(s(T),{to:{name:`a4-about`,params:{stageId:i.value}},"active-class":`on`},{default:u(()=>[...r[1]||=[o(` 소개 `,-1)]]),_:1},8,[`to`]),l.value.fortune?(n(),c(s(T),{key:0,to:{name:`a4-tarot`,params:{stageId:i.value}},"active-class":`on`},{default:u(()=>[...r[2]||=[o(` 운세 `,-1)]]),_:1},8,[`to`])):d(``,!0),_(`code`,Yt,g(s(t).path),1),l.value.unitToggle?(n(),c(ht,{key:1})):d(``,!0)]),v(s(w))])]))}},[[`__scopeId`,`data-v-f7dcddb8`]]),Zt=`<script setup>
...
`,gn=Object.fromEntries(Object.entries(Object.assign({"./DeployReport.vue":U,"./WeatherComposition.vue":he,"./WeatherMockup.vue":De,"./WeatherParent.vue":Ve,"./pinia5/UnitToggler.vue":dt,"./pinia5/WeatherUnitApp.vue":gt,"./router4/WeatherAboutView.vue":D,"./router4/WeatherDetailView.vue":St,"./router4/WeatherHomeView.vue":Ft,"./router4/WeatherNotFoundView.vue":O,"./router4/WeatherRouterApp.vue":zt,"./stages/StageDetailView.vue":R,"./stages/StageHomeView.vue":z,"./stages/StageTarotView.vue":V,"./stages/WeatherStackedApp.vue":Gt})).map(([e,t])=>[e.split(`/`).pop().replace(`.vue`,``),t.default]));Object.keys(gn).sort();var _n=e=>gn[e]??null,vn=Object.assign({"./DeployReport.vue":Zt,"./WeatherComposition.vue":Qt,"./WeatherMockup.vue":$t,"./WeatherParent.vue":en,"./pinia5/UnitToggler.vue":tn,"./pinia5/WeatherUnitApp.vue":nn,"./router4/WeatherAboutView.vue":rn,"./router4/WeatherDetailView.vue":an,"./router4/WeatherHomeView.vue":on,"./router4/WeatherNotFoundView.vue":sn,"./router4/WeatherRouterApp.vue":cn,"./router4/backdropState.js":ln,"./router4/mockCities.js":un,"./stages/StageDetailView.vue":dn,"./stages/StageHomeView.vue":fn,"./stages/StageTarotView.vue":pn,"./stages/WeatherStackedApp.vue":mn,"./stages/stageFeatures.js":hn}),yn=Object.fromEntries(Object.entries(vn).map(([e,t])=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),t])),bn=Object.fromEntries(Object.keys(vn).map(e=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),e.replace(`./`,`src/components/assignments/`)])),xn=e=>yn[e]===void 0?Object.keys(yn).find(t=>t.endsWith(`/${e}`)):e,Sn=e=>yn[xn(e)]??``,Cn=e=>bn[xn(e)]??``;export{_n as n,Sn as r,Cn as t};