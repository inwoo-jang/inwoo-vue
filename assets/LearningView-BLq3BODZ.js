...
`,ol=Object.assign({"./basic/BindPractice.vue":De,"./basic/ConditionalPractice.vue":Ve,"./basic/EventPractice.vue":Qe,"./basic/ForPractice.vue":ut,"./basic/HtmlTextPractice.vue":mt,"./basic/ModelPractice.vue":xt,"./basic/ReactivityPractice.vue":Vt,"./basic/SpecialDirectivePractice.vue":Wt,"./component/ComponentRegistrationPractice.vue":en,"./component/LifecyclePractice.vue":un,"./component/PropsEmitsPractice.vue":gn,"./component/PropsFlowPractice.vue":Tn,"./component/PropsReadonlyPractice.vue":Hn,"./component/ProvideInjectPractice.vue":ir,"./component/SiblingTalkPractice.vue":yr,"./component/SlotBaseCardPractice.vue":kr,"./component/SlotListPractice.vue":Rr,"./component/SlotModalPractice.vue":ri,"./component/SlotPractice.vue":yi,"./composition/ComputedCachePractice.vue":Ei,"./composition/DeepWatchPractice.vue":ki,"./composition/FormStatePractice.vue":Fi,"./composition/MultiWatchPractice.vue":Gi,"./composition/ReactiveArrayWatchPractice.vue":Xi,"./composition/ReactiveStatePractice.vue":na,"./composition/ReactiveWatchPractice.vue":ca,"./composition/RefArrayWatchPractice.vue":ma,"./composition/RefStatePractice.vue":xa,"./composition/TodoAdvancedPractice.vue":wa,"./composition/TodoListPractice.vue":Ra,"./composition/WatchEffectPractice.vue":Ja,"./composition/WatchPractice.vue":$a,"./library/ModernAsyncPractice.vue":io,"./library/ModernExtractPractice.vue":vo,"./library/ModernImmutablePractice.vue":No,"./library/StoreCounterPractice.vue":ss,"./router/RouterBasicPractice.vue":bs,"./router/RouterGuardPractice.vue":Rs,"./router/RouterNavigatePractice.vue":tc}),$=e=>e.split(`/`).pop().replace(`.vue`,``),sl=Object.fromEntries(Object.entries(ol).map(([e,t])=>[$(e),t.default])),cl=Object.fromEntries(Object.entries(ol).map(([e])=>[$(e),e.replace(`./`,`src/components/practices/`)]));Object.keys(sl).sort();var ll=e=>sl[e]??null,ul=e=>cl[e]??``,dl=Object.fromEntries(Object.entries(Object.assign({"./basic/BindPractice.vue":xc,"./basic/ConditionalPractice.vue":Sc,"./basic/EventPractice.vue":Cc,"./basic/ForPractice.vue":wc,"./basic/HtmlTextPractice.vue":Tc,"./basic/ModelPractice.vue":Ec,"./basic/ReactivityPractice.vue":Dc,"./basic/SpecialDirectivePractice.vue":Oc,"./component/ComponentRegistrationPractice.vue":kc,"./component/LifecyclePractice.vue":Ac,"./component/PropsEmitsPractice.vue":jc,"./component/PropsFlowPractice.vue":Mc,"./component/PropsReadonlyPractice.vue":Nc,"./component/ProvideInjectPractice.vue":Pc,"./component/SiblingTalkPractice.vue":Fc,"./component/SlotBaseCardPractice.vue":Ic,"./component/SlotListPractice.vue":Lc,"./component/SlotModalPractice.vue":Rc,"./component/SlotPractice.vue":zc,"./composition/ComputedCachePractice.vue":Bc,"./composition/DeepWatchPractice.vue":Vc,"./composition/FormStatePractice.vue":Hc,"./composition/MultiWatchPractice.vue":Uc,"./composition/ReactiveArrayWatchPractice.vue":Wc,"./composition/ReactiveStatePractice.vue":Gc,"./composition/ReactiveWatchPractice.vue":Kc,"./composition/RefArrayWatchPractice.vue":qc,"./composition/RefStatePractice.vue":Jc,"./composition/TodoAdvancedPractice.vue":Yc,"./composition/TodoListPractice.vue":Xc,"./composition/WatchEffectPractice.vue":Zc,"./composition/WatchPractice.vue":Qc,"./library/ModernAsyncPractice.vue":$c,"./library/ModernExtractPractice.vue":el,"./library/ModernImmutablePractice.vue":tl,"./library/StoreCounterPractice.vue":nl,"./router/RouterBasicPractice.vue":rl,"./router/RouterGuardPractice.vue":il,"./router/RouterNavigatePractice.vue":al})).map(([e,t])=>[$(e),t])),fl=e=>dl[e]??``,pl=[`id`],ml=[`aria-expanded`,`title`],hl={class:`card-chevron`,"aria-hidden":`true`},gl={class:`head-text`},_l={class:`label`},vl={class:`slide`},yl={key:0,class:`goal`},bl={key:1,class:`card-summary`},xl={class:`head-badges`},Sl={key:0,class:`badge live`},Cl={key:1,class:`tasks`},wl={key:2,class:`fold pitfalls`},Tl={class:`fold-body`},El={key:0,class:`compare`},Dl={key:0,class:`bad`},Ol={key:1,class:`good`},kl={class:`why`},Al={key:3,class:`practice-note`},jl={class:`practice-head`},Ml=[`aria-expanded`,`title`],Nl={class:`chevron`,"aria-hidden":`true`},Pl={key:0,class:`count`},Fl={class:`practice-hint`},Il={class:`practice-main`},Ll={key:0,class:`practice-mounts`},Rl={class:`slot-tools`},zl=[`onClick`],Bl=[`onClick`],Vl={key:1,class:`practice-empty`},Hl={key:2,class:`practice-missing`},Ul=[`aria-expanded`,`title`],Wl={class:`side-chevron`,"aria-hidden":`true`},Gl={class:`side-body`},Kl={key:0,class:`side-block`},ql={class:`side-heading`},Jl=[`onClick`],Yl={class:`guide`},Xl=[`innerHTML`],Zl={class:`guide-see`},Ql=[`innerHTML`],$l={key:0,class:`guide-why`},eu=[`innerHTML`],tu={key:1,class:`group-extras`},nu={key:1,class:`side-block fold extensions`},ru={class:`fold-body`},iu={key:5,class:`fold extensions`},au={class:`fold-body`},ou=K({__name:`ChallengeCard`,props:{challenge:{type:Object,required:!0}},setup(e){let t=e,n=T(()=>t.challenge.practices.map(e=>({name:e,component:ll(e)})).filter(e=>e.component)),r=T(()=>t.challenge.practices.filter(e=>!ll(e))),i=T(()=>n.value.length>0),a=T(()=>t.challenge.practiceGuide??[]),o=T(()=>{let e=[];for(let t of a.value)t.practice||e.length===0?e.push({label:t.practice??null,steps:[t]}):e[e.length-1].steps.push(t);return e.map(e=>({...e,extras:u.value.filter(t=>typeof t==`object`&&t.practice===e.label)}))}),c=T(()=>{let e=new Set(o.value.map(e=>e.label));return u.value.filter(t=>typeof t==`string`||!e.has(t.practice))}),l=e=>typeof e==`string`?e:e.text,u=T(()=>t.challenge.extensions??[]),d=T(()=>i.value&&(a.value.length>0||u.value.length>0)),f=y(!0),m=y(!0),b=y(!1),S=T(()=>{let e=[];return t.challenge.tasks?.length&&e.push(`연습 ${t.challenge.tasks.length}`),t.challenge.pitfalls?.length&&e.push(`주의 ${t.challenge.pitfalls.length}`),n.value.length&&e.push(`실습 ${n.value.length}`),e.join(` · `)}),w=T(()=>!d.value&&u.value.length>0),D=E({}),O=e=>`${e}-${D[e]??0}`,N=e=>{D[e]=(D[e]??0)+1},F=()=>{n.value.forEach(e=>N(e.name))},I=y(null),z=e=>{I.value=e},B=y(null),H=e=>e.replace(/\s+/g,` `).trim(),U=(e,t)=>{let n=B.value;if(!n)return;let r=[...n.querySelectorAll(`.practice-slot`)];if(!r.length)return;let i=r.find(t=>{let n=t.querySelector(`h2`);return n&&H(n.textContent)===H(e??``)})??r[t]??r[0];i.scrollIntoView({behavior:`smooth`,block:`center`}),i.classList.add(`is-target`),setTimeout(()=>i.classList.remove(`is-target`),1400)};return(t,y)=>(s(),k(`article`,{id:`challenge-${e.challenge.id}`,ref_key:`cardEl`,ref:B,class:h([`challenge`,[e.challenge.status,{collapsed:!b.value}]])},[M(`header`,{class:`challenge-head`,role:`button`,tabindex:`0`,"aria-expanded":b.value,title:b.value?`이 챌린지 접기`:`이 챌린지 펼치기`,onClick:y[0]||=e=>b.value=!b.value,onKeydown:[y[1]||=V(L(e=>b.value=!b.value,[`prevent`]),[`enter`]),y[2]||=V(L(e=>b.value=!b.value,[`prevent`]),[`space`])]},[M(`span`,hl,A(b.value?`▾`:`▸`),1),M(`div`,gl,[M(`p`,_l,[g(A(e.challenge.label)+` `,1),M(`span`,vl,`교안 `+A(e.challenge.slidePage),1)]),M(`h3`,null,A(e.challenge.title),1),b.value?(s(),k(`p`,yl,A(e.challenge.goal),1)):S.value?(s(),k(`p`,bl,A(S.value),1)):x(``,!0)]),M(`div`,xl,[M(`span`,{class:h([`badge`,e.challenge.status])},A(e.challenge.status===`done`?`학습 완료`:`진행 예정`),3),i.value?(s(),k(`span`,Sl,` 실습 `+A(n.value.length)+`개 `,1)):x(``,!0)])],40,ml),b.value?(s(),k(C,{key:0},[e.challenge.lecture?(s(),v(xe,{key:0,lecture:e.challenge.lecture,"study-range":e.challenge.studyRange},null,8,[`lecture`,`study-range`])):x(``,!0),e.challenge.tasks?.length?(s(),k(`section`,Cl,[y[6]||=M(`p`,{class:`section-label`},`✎ 연습 항목`,-1),M(`ul`,null,[(s(!0),k(C,null,P(e.challenge.tasks,e=>(s(),k(`li`,{key:e},A(e),1))),128))])])):x(``,!0),e.challenge.pitfalls?.length?(s(),k(`details`,wl,[M(`summary`,null,[y[7]||=M(`span`,{"aria-hidden":`true`},`⚠`,-1),y[8]||=g(` 조심할 점 `,-1),M(`b`,null,A(e.challenge.pitfalls.length),1)]),M(`div`,Tl,[(s(!0),k(C,null,P(e.challenge.pitfalls,(e,t)=>(s(),k(`div`,{key:t,class:`pitfall`},[e.bad||e.good?(s(),k(`div`,El,[e.bad?(s(),k(`p`,Dl,[y[9]||=M(`span`,null,`❌`,-1),M(`code`,null,A(e.bad),1)])):x(``,!0),e.good?(s(),k(`p`,Ol,[y[10]||=M(`span`,null,`✅`,-1),M(`code`,null,A(e.good),1)])):x(``,!0)])):x(``,!0),M(`p`,kl,A(e.why),1)]))),128))])])):x(``,!0),!i.value&&e.challenge.practiceNote?(s(),k(`p`,Al,[y[11]||=M(`span`,{"aria-hidden":`true`},`✓`,-1),g(` `+A(e.challenge.practiceNote),1)])):(s(),k(`section`,{key:4,class:h([`practice-zone`,{closed:!m.value}])},[M(`header`,jl,[M(`button`,{type:`button`,class:`practice-toggle`,"aria-expanded":m.value,title:m.value?`실습 화면 접기`:`실습 화면 펼치기`,onClick:y[3]||=e=>m.value=!m.value},[M(`span`,Nl,A(m.value?`▾`:`▸`),1),y[12]||=M(`span`,{class:`practice-mark`,"aria-hidden":`true`},`🖥`,-1),y[13]||=M(`span`,{class:`practice-title`},`실습 화면`,-1),i.value?(s(),k(`span`,Pl,A(n.value.length),1)):x(``,!0)],8,Ml),M(`span`,Fl,A(m.value?`직접 눌러보며 동작을 확인하세요`:`접어 둠 · 제목을 눌러 펼치기`),1),n.value.length>1&&m.value?(s(),k(`button`,{key:0,type:`button`,class:`reset-button reset-all`,"aria-label":`실습 전체 초기화`,title:`이 챌린지의 실습을 모두 처음 상태로 되돌립니다`,onClick:F},[...y[14]||=[M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),M(`path`,{d:`M20 4v4.5h-4.5`})],-1)]])):x(``,!0)]),j(M(`div`,{class:h([`practice-body`,{"has-guide":d.value,"side-closed":d.value&&!f.value}])},[M(`div`,Il,[i.value?(s(),k(`div`,Ll,[(s(!0),k(C,null,P(n.value,e=>(s(),k(`div`,{key:e.name,class:`practice-slot`},[M(`div`,Rl,[M(`button`,{type:`button`,class:`icon-button`,"aria-label":`소스 코드 보기`,title:`소스 코드를 새 창으로 엽니다`,onClick:t=>z(e.name)},[...y[15]||=[M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`M9 7 4 12l5 5M15 7l5 5-5 5`})],-1)]],8,zl),M(`button`,{type:`button`,class:`icon-button`,"aria-label":`이 실습 초기화`,title:`이 실습만 처음 상태로 되돌립니다 (페이지 새로고침 없음)`,onClick:t=>N(e.name)},[...y[16]||=[M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),M(`path`,{d:`M20 4v4.5h-4.5`})],-1)]],8,Bl)]),(s(),v(p(e.component),{key:O(e.name)}))]))),128))])):(s(),k(`p`,Vl,[...y[17]||=[g(` 아직 이 챌린지에 연결된 실습 화면이 없습니다. `,-1),M(`code`,null,`src/components/practices/`,-1),g(` 에 컴포넌트를 추가하고 `,-1),M(`code`,null,`curriculum.js`,-1),g(` 의 `,-1),M(`code`,null,`practices`,-1),g(` 에 이름을 넣으면 여기에 나타납니다. `,-1)]])),r.value.length?(s(),k(`p`,Hl,` ⚠ 파일을 찾지 못한 실습: `+A(r.value.join(`, `)),1)):x(``,!0)]),d.value?(s(),k(`aside`,{key:0,class:h([`guide-side`,{collapsed:!f.value}])},[M(`button`,{type:`button`,class:`side-toggle`,"aria-expanded":f.value,title:f.value?`접어서 실습 화면 넓히기`:`실습 도우미 펼치기`,onClick:y[4]||=e=>f.value=!f.value},[y[18]||=M(`span`,{class:`side-toggle-label`},[M(`span`,{"aria-hidden":`true`},`✓`),g(` 실습 도우미 `)],-1),M(`span`,Wl,A(f.value?`›`:`‹`),1)],8,Ul),j(M(`div`,Gl,[a.value.length?(s(),k(`section`,Kl,[M(`p`,ql,[y[19]||=g(` 확인 가이드 `,-1),M(`b`,null,A(a.value.length),1)]),(s(!0),k(C,null,P(o.value,(e,t)=>(s(),k(`div`,{key:t,class:`guide-group`},[e.label?(s(),k(`button`,{key:0,type:`button`,class:`guide-chip`,title:`이 실습으로 이동합니다`,onClick:n=>U(e.label,t)},[g(A(e.label)+` `,1),y[20]||=M(`span`,{class:`jump`,"aria-hidden":`true`},`↓`,-1)],8,Jl)):x(``,!0),M(`ol`,Yl,[(s(!0),k(C,null,P(e.steps,(e,t)=>(s(),k(`li`,{key:t},[M(`p`,{class:`guide-do`,innerHTML:_(q)(e.do)},null,8,Xl),M(`p`,Zl,[y[21]||=M(`b`,null,`확인`,-1),y[22]||=g(),M(`span`,{innerHTML:_(q)(e.see)},null,8,Ql)]),e.why?(s(),k(`p`,$l,[y[23]||=M(`b`,null,`왜`,-1),y[24]||=g(),M(`span`,{innerHTML:_(q)(e.why)},null,8,eu)])):x(``,!0)]))),128))]),e.extras.length?(s(),k(`div`,tu,[y[25]||=M(`p`,{class:`extras-label`},[M(`span`,{"aria-hidden":`true`},`🚀`),g(` 더 해보기`)],-1),M(`ul`,null,[(s(!0),k(C,null,P(e.extras,(e,t)=>(s(),k(`li`,{key:t},A(l(e)),1))),128))])])):x(``,!0)]))),128))])):x(``,!0),c.value.length?(s(),k(`details`,nu,[M(`summary`,null,[y[26]||=M(`span`,{"aria-hidden":`true`},`🚀`,-1),y[27]||=g(` 더 해보기 (전체) `,-1),M(`b`,null,A(c.value.length),1)]),M(`div`,ru,[M(`ul`,null,[(s(!0),k(C,null,P(c.value,(e,t)=>(s(),k(`li`,{key:t},A(l(e)),1))),128))])])])):x(``,!0)],512),[[R,f.value]])],2)):x(``,!0)],2),[[R,m.value]])],2)),w.value?(s(),k(`details`,iu,[M(`summary`,null,[y[28]||=M(`span`,{"aria-hidden":`true`},`🚀`,-1),y[29]||=g(` 더 해보기 (심화 응용) `,-1),M(`b`,null,A(u.value.length),1)]),M(`div`,au,[M(`ul`,null,[(s(!0),k(C,null,P(u.value,(e,t)=>(s(),k(`li`,{key:t},A(l(e)),1))),128))])])])):x(``,!0)],64)):x(``,!0),I.value?(s(),v(ie,{key:1,path:_(ul)(I.value),code:_(fl)(I.value),onClose:y[5]||=e=>I.value=null},null,8,[`path`,`code`])):x(``,!0)],10,pl))}},[[`__scopeId`,`data-v-6e637b45`]]),su=[`aria-expanded`],cu={class:`toggle-title`},lu={class:`chevron`,"aria-hidden":`true`},uu={class:`notes-body`},du={class:`lead`},fu=[`aria-expanded`,`onClick`],pu={class:`no`},mu={class:`section-title`},hu={key:0,class:`slide`},gu={class:`section-body`},_u={key:1,class:`bullets`},vu={key:2,class:`table-wrap`},yu={key:3,class:`code`},bu={key:4,class:`note-line`},xu={key:0,class:`checklist`},Su={key:1,class:`quiz`},Cu=K({__name:`ChapterNotes`,props:{notes:{type:Object,required:!0}},setup(e){let t=e,n=y(!1),r=y(0),i=e=>{r.value=r.value===e?-1:e},a=e=>Array.isArray(e)?e:[e],o=T(()=>t.notes.sections.length);return(t,c)=>(s(),k(`section`,{class:h([`notes`,{closed:!n.value}])},[M(`button`,{class:`notes-toggle`,type:`button`,"aria-expanded":n.value,onClick:c[0]||=e=>n.value=!n.value},[c[2]||=M(`span`,{class:`marker`,"aria-hidden":`true`},`📖`,-1),M(`span`,cu,[c[1]||=g(` 교안 정리 — 이 챕터를 여기서 복습합니다 `,-1),M(`small`,null,A(e.notes.range)+` · `+A(o.value)+`개 항목`,1)]),M(`span`,lu,A(n.value?`−`:`+`),1)],8,su),j(M(`div`,uu,[M(`p`,du,A(e.notes.lead),1),(s(!0),k(C,null,P(e.notes.sections,(e,t)=>(s(),k(`article`,{key:e.title,class:h([`note-section`,{open:r.value===t}])},[M(`button`,{class:`section-head`,type:`button`,"aria-expanded":r.value===t,onClick:e=>i(t)},[M(`span`,pu,A(String(t+1).padStart(2,`0`)),1),M(`span`,mu,A(e.title),1),e.slide?(s(),k(`span`,hu,A(e.slide),1)):x(``,!0)],8,fu),j(M(`div`,gu,[e.body?(s(!0),k(C,{key:0},P(a(e.body),(e,t)=>(s(),k(`p`,{key:t,class:`para`},A(e),1))),128)):x(``,!0),e.bullets?(s(),k(`ul`,_u,[(s(!0),k(C,null,P(e.bullets,e=>(s(),k(`li`,{key:e},A(e),1))),128))])):x(``,!0),e.table?(s(),k(`div`,vu,[M(`table`,null,[M(`thead`,null,[M(`tr`,null,[(s(!0),k(C,null,P(e.table.head,e=>(s(),k(`th`,{key:e},A(e),1))),128))])]),M(`tbody`,null,[(s(!0),k(C,null,P(e.table.rows,(e,t)=>(s(),k(`tr`,{key:t},[(s(!0),k(C,null,P(e,(e,t)=>(s(),k(`td`,{key:t},A(e),1))),128))]))),128))])])])):x(``,!0),e.code?(s(),k(`figure`,yu,[M(`figcaption`,null,A(e.code.caption),1),M(`pre`,null,[M(`code`,null,A(e.code.text),1)])])):x(``,!0),e.note?(s(),k(`p`,bu,[c[3]||=M(`span`,{"aria-hidden":`true`},`⚠`,-1),g(` `+A(e.note),1)])):x(``,!0)],512),[[R,r.value===t]])],2))),128)),e.notes.checklist?(s(),k(`section`,xu,[c[4]||=M(`p`,{class:`block-label`},`이만큼 말할 수 있으면 이 챕터는 넘어가도 됩니다`,-1),M(`ul`,null,[(s(!0),k(C,null,P(e.notes.checklist,e=>(s(),k(`li`,{key:e},A(e),1))),128))])])):x(``,!0),e.notes.quiz?(s(),k(`section`,Su,[c[5]||=M(`p`,{class:`block-label`},`스스로 확인 — 답을 떠올린 뒤 펼쳐 보세요`,-1),(s(!0),k(C,null,P(e.notes.quiz,e=>(s(),k(`details`,{key:e.q},[M(`summary`,null,A(e.q),1),M(`p`,null,A(e.a),1)]))),128))])):x(``,!0)],512),[[R,n.value]])],2))}},[[`__scopeId`,`data-v-ec97fd99`]]),wu=[`aria-expanded`],Tu={class:`chevron`,"aria-hidden":`true`},Eu={class:`orientation-body`},Du={class:`rule`},Ou={class:`lead`},ku={class:`cargo`},Au={class:`name`},ju={class:`payload`},Mu={"aria-hidden":`true`},Nu=[`innerHTML`],Pu={class:`priority`},Fu={class:`p-name`},Iu={class:`p-weight`},Lu={class:`p-when`},Ru={class:`keep`},zu=[`innerHTML`],Bu=K({__name:`ChapterOrientation`,props:{orientation:{type:Object,required:!0}},setup(e){let t=y(!0);return(n,r)=>(s(),k(`section`,{class:h([`orientation`,{closed:!t.value}])},[M(`button`,{class:`orientation-toggle`,type:`button`,"aria-expanded":t.value,onClick:r[0]||=e=>t.value=!t.value},[r[1]||=M(`span`,{class:`marker`,"aria-hidden":`true`},`🧭`,-1),r[2]||=M(`span`,{class:`toggle-title`},`시작하기 전에 — 규칙은 하나뿐입니다`,-1),M(`span`,Tu,A(t.value?`−`:`+`),1)],8,wu),j(M(`div`,Eu,[M(`p`,Du,A(e.orientation.rule),1),M(`p`,Ou,A(e.orientation.lead),1),M(`ul`,ku,[(s(!0),k(C,null,P(e.orientation.cargo,e=>(s(),k(`li`,{key:e.name},[M(`code`,Au,A(e.name),1),M(`span`,ju,A(e.payload),1),M(`span`,{class:h([`dir`,e.dir===`위로`?`up`:`down`])},[M(`span`,Mu,A(e.dir===`위로`?`↑`:`↓`),1),g(` `+A(e.dir),1)],2)]))),128))]),M(`p`,{class:`why`,innerHTML:_(q)(e.orientation.why)},null,8,Nu),r[4]||=M(`p`,{class:`priority-label`},`실제로 쓰는 비중`,-1),M(`ul`,Pu,[(s(!0),k(C,null,P(e.orientation.priority,e=>(s(),k(`li`,{key:e.name,class:h(e.level)},[M(`span`,Fu,A(e.name),1),M(`span`,Iu,A(e.weight),1),M(`span`,Lu,A(e.when),1)],2))),128))]),M(`p`,Ru,[r[3]||=M(`span`,{class:`keep-label`},`이것만은`,-1),M(`span`,{innerHTML:_(q)(e.orientation.keep)},null,8,zu)])],512),[[R,t.value]])],2))}},[[`__scopeId`,`data-v-bfb97b66`]]),Vu={6:{range:`178~190쪽`,lead:`컴포넌트 계층을 타고 값을 넘기는 대신, 화면 밖 저장소 하나를 두고 모두가 거기를 본다. 이 챕터의 절반은 Store 만드는 법, 나머지 절반은 그것으로 로그인을 구현하는 사례연구다.`,sections:[{title:`Pinia란 무엇인가`,slide:`179쪽`,body:`Vue Application이 크고 복잡해질수록 Component 간 데이터를 전달하는 일이 어려워집니다. Pinia는 Component 계층 구조와 상관없이 별도의 전역 데이터 저장소(Store)를 개설해 반응형 데이터를 관리합니다.`,bullets:[`Pinia는 Vue 3의 상태(state) 관리 라이브러리다. Vue 2에서는 Vuex를 썼다.`,`상태(State)란 웹 애플리케이션을 렌더링하는 과정에 영향을 줄 수 있는 값을 말하고, 상태관리란 그 값을 다루는 방법을 말한다.`,`package.json 의 dependencies 에 pinia 가 들어 있어야 한다.`]},{title:`Store — 무엇을 한 파일에 담는가`,slide:`180쪽`,body:`Store는 여러 파일로 구성될 수 있으며, 일반적으로 의미가 있는 상태끼리 파일 하나로 작성합니다. 예를 들어 인증스토어(authStore.js), UI스토어(uiStore.js), 알림스토어(alertStore.js), 공통코드스토어(commonStore.js)처럼 나눕니다.`,table:{head:[`용어`,`기술적 본질`,`Vue 3 내장 문법 매핑`,`주요 역할`],rows:[[`state`,`반응형 데이터 변수`,`ref() / reactive()`,`전역으로 공유할 상태 데이터 객체를 정의한다`],[`getters`,`읽기 전용 계산된 변수`,`computed()`,`원본 state를 기반으로 실시간 가공한다`],[`actions`,`상태 변경 및 통신 함수`,`function()`,`state 값을 변경하는 핸들러 로직 / 서버 비동기 API 통신(axios 등) 수행`]]},note:`Pinia 를 새로 외우는 것이 아니다. 이미 아는 ref · computed · function 에 이름을 새로 붙인 것뿐이다.`},{title:`구축 3단계 ① Pinia 등록`,slide:`181쪽`,body:`src/main.js 에서 createPinia() 함수로 pinia 인스턴스를 생성하고, 애플리케이션 인스턴스의 use() 함수로 등록합니다.`,code:{caption:`src/main.js`,text:`import { createApp } from 'vue'
...
}`},note:`취소를 누르면 reject 되어 catch 로 간다. catch 를 빼먹으면 콘솔에 처리되지 않은 Promise 경고가 뜬다.`}],checklist:[`UI 라이브러리를 쓰면 무엇이 절감되는지 세 가지로 말할 수 있다`,`Element Plus 를 국내에서 많이 쓰는 이유를 비교표로 설명할 수 있다`,`main.js 에 라이브러리와 CSS 를 등록하는 두 줄을 외우지 않고도 찾아 쓸 수 있다`,`태그로 쓰는 컴포넌트와 JS 함수로 부르는 컴포넌트(ElMessage 등)를 구분할 수 있다`,`el-form 검증과 직접 if 로 검증하는 방식의 차이를 안다`,`ElMessageBox.confirm 이 Promise 를 돌려준다는 점과 취소가 catch 로 간다는 점을 안다`],quiz:[{q:`el-button 은 나오는데 스타일이 하나도 없다. 무엇을 빠뜨렸나?`,a:`import 'element-plus/dist/index.css' 다. 컴포넌트 등록과 CSS 로드는 별개다.`},{q:`ElMessage 를 쓰려면 템플릿에 어떤 태그를 적어야 하는가?`,a:`적지 않는다. 태그가 아니라 JS 함수라서 import 해서 호출만 하면 화면에 알아서 떠오른다.`},{q:`ElMessageBox.confirm 에서 사용자가 취소를 눌렀다. 코드의 어디로 가는가?`,a:`catch 로 간다. 확인은 then, 취소는 catch 다. catch 가 없으면 처리되지 않은 Promise 경고가 뜬다.`},{q:`데이터가 오기 전 화면이 텅 비어 보인다. 어떤 컴포넌트가 어울리나?`,a:`el-skeleton 이다. 회색 유령 레이아웃을 미리 깔아 체감 속도를 높인다. 결과가 없을 때는 el-empty 를 쓴다.`}]},9:{range:`229~249쪽`,lead:"새 문법을 배우는 챕터가 아니다. 앞의 여덟 챕터에서 이미 써 온 문법들을 이제야 이름과 함께 정리하는 자리다. ref, computed, axios 예제에 계속 나오던 =>, `${}`, {...}, async/await 가 전부 여기 있다. 관통하는 생각은 하나다 — 원본을 건드리지 말고, 필요한 것만 꺼내 새로 만든다.",sections:[{title:`JavaScript 는 어떻게 지금 모습이 되었나`,slide:`230쪽`,body:`JavaScript 는 1995년 Netscape 가 웹 브라우저에 동적인 기능을 넣으려고 만든 언어에서 출발했습니다. 지금 우리가 쓰는 문법 대부분은 2015년 ES6 한 번의 대규모 개편에서 나왔습니다.`,table:{head:[`세대`,`시기`,`무슨 일이 있었나`],rows:[[`1세대 · ECMAScript 탄생`,`1995~1999`,`Internet Explorer 가 비슷하지만 다른 Jscript 를 실었다. 브라우저마다 코드가 다르게 도는 것을 막으려고 ECMA 국제표준기구가 표준 규격을 정했다 (ECMAScript = ES)`],[`2세대 · Web 의 한계와 jQuery`,`2000~2008`,`IE 독점으로 표준화(ES4)가 무산됐다. JavaScript 는 팝업창이나 띄우는 가벼운 스크립트 취급이었고, 브라우저별 차이를 메워 준 jQuery 가 시장을 지배했다`],[`3세대 · ES5 표준`,`2009~2014`,`Chrome 의 V8 엔진이 공개되며 Node.js 가 태어났다 — JavaScript 가 브라우저 밖 서버에서도 돌기 시작했다. use strict, forEach · map · filter 가 이때 들어왔다`],[`4세대 · Modern JavaScript`,`2015~`,`ES6 가 문법을 혁신적으로 뜯어고쳤다. 이후로는 매년 소규모 문법을 발표한다. 이 연례 업데이트 시대를 통칭해 Modern JavaScript 라 부른다`]]},note:`우리가 이 챕터에서 배우는 것은 사실상 "ES6 이후에 추가된 것들"이다. 그래서 ES6 를 기준으로 이전/이후를 가른다.`},{title:`최신 문법을 써도 되는가 — 브라우저 지원`,slide:`231쪽`,body:`결론부터 말하면 마음껏 써도 됩니다. 우리가 쓰는 Vite 안에 이미 해결 장치가 들어 있기 때문입니다.`,bullets:[`ES6(2015)~ES11(2020) 규격 — let/const, Arrow Function, Promise, async/await, Optional Chaining(?.) 등은 데스크톱·모바일 브라우저를 가리지 않고 100% 네이티브로 지원된다.`,`ES12(2021)~ES15(2024) 규격 — replaceAll(), 논리 할당(&&=, ||=), toReversed() 같은 비교적 최신 기능도 모던 브라우저 점유율 기준 96% 이상 지원된다.`,`Babel — 개발자가 최신 문법으로 코딩해도, 빌드 시스템이 배포 직전에 구형 브라우저도 알아들을 수 있는 ES5(2009년형) 문법으로 번역해 내려 준다.`,`Polyfill — 구형 엔진에 아예 존재하지 않는 객체나 메서드(Promise, Array.prototype.includes 등)를 JavaScript 로 직접 구현해 임시로 제공하는 코드다. 번역이 아니라 없는 부품을 만들어 끼우는 쪽이다.`],note:`Vite 번들러 내부에 Babel 과 Polyfill 기반 변환 엔진이 기본 내장돼 있다. 그래서 브라우저 호환성을 걱정하지 않고 가장 최신 문법으로 코딩할 수 있다.`},{title:`let & const — var 를 쓰지 않는 이유`,slide:`232쪽`,body:`var 는 구시대의 유산입니다. 같은 이름을 두 번 선언해도 조용히 넘어가기 때문에, 큰 파일에서 변수 이름이 겹치면 어디서 값이 바뀌었는지 찾을 수 없게 됩니다.`,table:{head:[`특성`,`var (구시대의 유산)`,`let (변수)`,`const (상수)`],rows:[[`스코프(Scope)`,`함수 레벨 스코프`,`블록 레벨 스코프 ({})`,`블록 레벨 스코프 ({})`],[`재선언`,`가능 (버그의 원인)`,`불가능`,`불가능`],[`재할당`,`가능`,`가능`,`불가능`],[`호이스팅(Hoisting)`,`발생 (undefined 로 초기화)`,`발생 (TDZ 로 인해 에러 발생)`,`발생 (TDZ 로 인해 에러 발생)`]]},code:{caption:`재선언 · 재할당이 어디서 막히는가`,text:`var name = '철수'
var name = '영희'
...
const name = '철수'
name = '영희'       // 에러: Assignment to constant variable`},note:`기본은 const 로 쓰고, 값이 바뀌어야 할 때만 let 으로 바꾼다. var 는 쓰지 않는다.`},{title:`Arrow Function — Vue 코드에 계속 나오던 =>`,slide:`233쪽`,body:`함수를 선언하는 방법은 세 가지입니다. 모던 프레임워크에서 주로 쓰는 것은 화살표 함수입니다.`,table:{head:[`비교 항목`,`Function Declaration`,`Function Expression`,`Arrow Function`],rows:[[`Syntax`,`function foo(arg1, arg2) { return }`,`const foo = function(arg1, arg2) { return }`,`const foo = (arg1, arg2) => { return }`],[`Hoisting`,`함수 전체가 호이스팅됨 (선언문 전에도 호출 가능)`,`변수만 호이스팅됨 (초기화 전 호출 시 에러)`,`변수만 호이스팅됨 (초기화 전 호출 시 에러)`],[`주요 용도`,`전통적인 전역 / 유틸리티 함수 정의`,`클로저(Closure) 구현, 콜백 함수`,`모던 프레임워크(Vue/React), 메서드 내부 비동기 콜백 함수`]]},code:{caption:`줄일 수 있는 것들 — 그리고 함수를 인자로 넘기기`,text:`// 코드가 한 줄이면 return 과 중괄호를 생략할 수 있다
...
console.log(\`곱하기 결과: \${multiplyResult}\`) // 출력: 50`},note:`@click="() => doSomething()" 이나 map(item => item.name) 에서 매일 보던 그 문법이다.`},{title:"Template Literals — 백틱(`)과 ${}",slide:`234쪽`,body:`ES6에서 도입된 문자열 표기법입니다. 일반 따옴표(')나 쌍따옴표(")가 아닌, 키보드 숫자 1 왼쪽에 있는 백틱(\`) 기호를 사용해 문자열을 선언합니다. 문자열 안에 변수나 연산 결과를 동적으로 주입하고 줄바꿈을 자유롭게 허용합니다.`,code:{caption:"+ 로 잇던 것을 ${} 하나로",text:`const city = '수원'
const temp = 24
...
\``},note:'\\${} 안에는 변수뿐 아니라 연산식도 들어간다. \\${temp > 30 ? "덥다" : "선선하다"} 처럼 쓸 수 있다.'},{title:`Destructuring Assignment — 필요한 것만 꺼내기`,slide:`235쪽`,body:`Array 나 Object 의 구조를 분해하여, 내부의 값들을 별도의 독립된 개별 변수에 각각 직접 할당하는 표현식입니다. arr[0] 이나 obj.key 를 반복해서 치던 번거로움을 제거하고 코드 라인 수를 획기적으로 단축합니다.`,code:{caption:`객체는 이름으로, 배열은 순서로`,text:`// Object — key 이름을 기준으로 매칭된다. 순서는 상관없다
...
const [first, , third] = colors   // green 은 건너뛰고 'red' 와 'blue' 만`},note:`객체 분해는 이름이 맞아야 하고, 배열 분해는 순서가 맞아야 한다. 이 차이가 헷갈리는 지점의 전부다.`},{title:`Spread Operator (...) — 펼쳐서 흩뿌리기`,slide:`236~237쪽`,body:`배열이나 객체 앞에 마침표 3개(...)를 붙여, 그 내부의 요소를 하나하나 낱개로 순서대로 '펼쳐서(전개하여) 흩뿌려주는' 연산자입니다. 복잡한 반복문 없이 대량의 데이터를 복사하거나 결합(병합)할 수 있습니다.`,code:{caption:`병합 · 복사 · 덮어쓰기`,text:`// 배열 병합 — 기존 배열의 괄호를 풀어서 새 배열 안에 흩뿌린다
...
}`},note:`Vue 의 상태 관리나 백엔드 요청 바디를 만들 때 필수 문법이다. 원본을 그대로 두고 새 것을 만드는 이 챕터의 핵심 도구다.`},{title:`Rest 문법 (...) — 나머지를 한데 묶기`,slide:`238쪽`,body:`똑같이 ... 기호를 쓰지만, Spread 가 주로 값을 전개하는 데 활용된다면 Rest 는 나머지 값을 처리하는 데 주로 사용됩니다. 몇 개만 변수로 빼고 남은 속성을 한데 묶어 별도의 객체나 배열로 보존합니다.`,code:{caption:`같은 ... 인데 위치가 다르다`,text:`const employee = {
  name: 'Graves', age: 35,
...
printMedalList('수원', '서울', '부산', '대구', '제주', '광주')`},note:`오른쪽(값을 만드는 자리)에 있으면 Spread, 왼쪽(값을 받는 자리)에 있으면 Rest 다. 기호가 같으니 위치로 구분한다.`},{title:`Promise — "결과를 알려주겠다"는 약속`,slide:`239쪽`,body:`JavaScript 엔진에서 비동기 연산의 최종 완료 또는 실패와 그 결과 값을 나타내는 표준 객체입니다. Promise 는 비동기 작업이 성공하거나 실패할 때 그 결과를 알려주겠다고 "약속"하는 객체입니다. ES6 이전에는 비동기 처리가 끝난 후 실행할 로직을 함수 인자로 전달하는 Callback 함수를 썼는데, 이것이 겹겹이 쌓이면서 Callback Hell 을 유발했습니다.`,table:{head:[`상태(State)`,`의미`],rows:[[`Pending (대기)`,`작업이 시작됐지만 아직 성공도 실패도 아닌 초기 상태`],[`Fulfilled (이행/성공)`,`작업이 성공적으로 완료되었고 결과 값이 준비된 상태`],[`Rejected (거부/실패)`,`작업이 실패했고 그 이유(error)를 알 수 있는 상태`]]},code:{caption:`Promise Chains — .then / .catch / .finally`,text:`fetchWeatherData()          // fetchWeatherData 는 Promise 객체를 return
  .then((data) => {
  ...
  })`}},{title:`async / await — 비동기를 동기처럼 읽기`,slide:`240쪽`,body:`ES8(2017)에서 도입되었습니다. Promise 를 기반으로 작동하되, 체이닝 대신 위에서 아래로 읽히는 동기식 코드 구조로 작성할 수 있게 해 줍니다.`,bullets:[`async — "이 함수 안에서 비동기 처리를 할 거야!"라고 선언하는 키워드다. async 함수는 항상 Promise 를 반환한다.`,`await — "비동기 작업이 끝날 때까지 다음 줄로 넘어가지 말고 기다려!"라고 명령하는 키워드다. async 함수 안에서만 쓸 수 있다.`,`.then / .catch 대신 try / catch 로 에러를 잡는다.`],code:{caption:`기다린 값을 그대로 다음 줄에서 쓴다`,text:`async function hello() {
  return '안녕하세요!'
}
...
}`},note:`await 를 빼먹으면 값 대신 Promise 객체가 담긴다. "[object Promise]" 가 화면에 찍히면 십중팔구 await 누락이다.`},{title:`ES6 이후 추가된 Array Methods`,slide:`241쪽`,table:{head:[`도입 버전`,`메서드`,`예시`,`핵심 요약`],rows:[[`ES6 (2015)`,`Array.from()`,`Array.from(arguments)`,`유사 배열 객체(Arguments, DOM NodeList)를 순수 배열로 변환해 배열 내장 고차함수를 쓸 수 있게 유도`],[`ES6 (2015)`,`find()`,`arr.find(item => item.id === 3)`,`조건을 만족하는 최초의 '아이템 알맹이 자체'를 반환 (없으면 undefined)`],[`ES6 (2015)`,`findIndex()`,`arr.findIndex(item => item.id === 3)`,`조건을 만족하는 최초의 '방 번호(인덱스 숫자)'를 반환 (없으면 -1)`],[`ES7 (2016)`,`includes()`,`arr.includes('수원')`,`배열 내 특정 값이 있는지 여부를 true / false 로만 반환. 구식 indexOf 조건식을 전면 대체`],[`ES10 (2019)`,`flat()`,`[1, [2, 3]].flat()`,`다차원으로 중첩된 다층 배열을 지정한 깊이만큼 평평하게 1차원 배열로 펴 준다`],[`ES13 (2022)`,`at()`,`arr.at(-1)`,`대괄호 인덱서(arr[arr.length - 1]) 대신, 음수 인덱스(-1)를 지원하여 맨 뒤 요소를 쉽게 역추적`],[`ES14 (2023)`,`toReversed() · toSorted() · toSpliced()`,`const newArr = arr.toSorted()`,`[최신 실무 표준] 원본 배열을 강제로 변형시키던 구형 메서드와 달리, 원본을 안전하게 보존하면서 정렬/반전된 새로운 복사본 배열을 리턴하는 불변성 메서드 세트`]]},note:`sort() 는 원본을 뒤집어 버리지만 toSorted() 는 새 배열을 준다. Vue 의 computed 안에서는 반드시 toSorted() 쪽을 써야 한다.`},{title:`ES6 이후 추가된 Object 기능`,slide:`242~244쪽`,table:{head:[`도입 버전`,`기능`,`예시`,`핵심 요약`],rows:[[`ES6 (2015)`,`단축 속성명 (Property Shorthand)`,`const user = { name, age }`,`key 이름과 대입할 변수명이 같다면, name: name 처럼 중복해서 쓰지 않고 이름만 한 번만 적어도 자동 매핑`],[`ES6 (2015)`,`계산된 속성명 (Computed Property)`,`const obj = { [keyName]: value }`,`key 자리에 고정된 문자열이 아니라, 대괄호[]를 쳐서 변수나 연산식의 결과물을 실시간 key 명으로 박아넣는 기술`],[`ES6 (2015)`,`메서드 축약 표현 (Method Shorthand)`,`const obj = { greet() {} }`,`function 키워드를 완전히 생략하고 함수명() {} 형태로 담백하게 선언`],[`ES6 (2015)`,`Object.assign()`,`Object.assign(target, src)`,`여러 객체의 속성을 하나의 대상 객체로 병합하거나 복사할 때 쓰던 메서드 (현재는 스프레드 연산자에 밀려 빈도 감소)`],[`ES8 (2017)`,`Object.keys() · values() · entries()`,`Object.entries(user)`,`객체의 [key 배열], [value 배열], [[key, value] 쌍의 2차원 배열]을 각각 추출하여 배열로 변환`],[`ES11 (2020)`,`Optional Chaining`,`user?.profile?.address`,`[실무 빈도 극상] 깊숙한 객체를 참조할 때 중간에 데이터가 비어 있어도(null/undefined) 에러로 뻗지 않고, 안전하게 undefined 를 뱉으며 프로그램을 보호`]]},code:{caption:`Object.entries() — 객체를 배열로 바꿔 순회하기`,text:`const scoreBoard = { math: 90, english: 80, science: 100 }
...
})`}},{title:`Optional Chaining (?.) — 중간이 비어도 뻗지 않게`,slide:`245쪽`,body:`. 왼쪽에 있는 대상이 null 이거나 undefined 이면, 다음 하위 속성으로 진입하지 않고 에러 없이 undefined 를 반환합니다. 서버에서 온 데이터는 항상 필드가 다 차 있으리라는 보장이 없기 때문에 실무 빈도가 가장 높은 문법 중 하나입니다.`,code:{caption:`탐색하다 null 을 만나면 즉시 중단하고 undefined`,text:`const user1 = { name: 'Graves', profile: { address: { city: 'Suwon' } } }
...
console.log(finalCity)   // '등록된 주소 없음'`},note:`?. 없이 user2.profile.address 를 읽으면 TypeError 로 앱 전체가 멈춘다. 화면 하나가 빈 게 아니라 흰 화면이 된다.`},{title:`Nullish Coalescing (??) — || 이 만들던 버그`,slide:`246쪽`,body:`ES11(2020)에 도입된 문법입니다. 좌항의 피연산자가 null 이거나 undefined 일 때만 우항의 기본값을 반환하고, 그 외의 값이면 좌항의 값을 그대로 유지하는 연산자입니다. 과거에는 기본값을 줄 때 논리합(||)을 썼는데, || 는 null/undefined 뿐 아니라 JavaScript 가 false 로 취급하는 모든 Falsy 값(0, "", false)까지 전부 우항의 기본값으로 덮어버리는 버그를 유발했습니다.`,code:{caption:`0 과 빈 문자열은 "값이 없는 것"이 아니다`,text:`const userSetting = {
  alertCount: 0,
...
console.log(nameModern)  // '' — 안전 보존: 빈 문자열 데이터 유지`},note:`기온 0도, 강수량 0mm, 재고 0개 — 날씨 앱과 쇼핑몰에서 || 를 쓰면 반드시 터지는 자리다.`}],checklist:[`var 를 쓰지 않고 const 를 기본으로, 바뀌는 값만 let 으로 선언했다`,`객체·배열에서 값을 꺼낼 때 obj.key 반복 대신 구조 분해를 썼다`,"문자열을 + 로 잇지 않고 백틱과 ${} 로 조립했다",`배열·객체를 복사할 때 = 대입 대신 스프레드(...)로 새것을 만들었다`,`정렬할 때 sort() 대신 toSorted() 를 써서 원본을 지켰다`,`서버 데이터를 깊게 참조하는 곳에 ?. 를 붙였다`,`기본값을 줄 때 || 대신 ?? 를 써서 0 과 빈 문자열을 지켰다`,`비동기 함수에 async 를 붙이고 호출 앞에 await 를 빠짐없이 넣었다`,`비동기 에러를 try / catch 로 감쌌다`],quiz:[{q:`const 로 선언한 배열에 push() 를 하면 에러가 나는가?`,a:`나지 않는다. const 가 막는 것은 재할당(=)이지 내용 변경이 아니다. arr = [] 는 에러지만 arr.push(1) 은 된다.`},{q:`const cloneWrong = original 로 배열을 복사했다. 무엇이 문제인가?`,a:`주소값만 복사돼 둘이 같은 배열을 가리킨다. 복사본을 고치면 원본도 함께 깨진다. [...original] 로 새 복사본을 만들어야 한다.`},{q:`... 이 Spread 인지 Rest 인지 어떻게 구분하는가?`,a:`위치로 구분한다. 값을 만드는 오른쪽에 있으면 펼치는 Spread, 값을 받는 왼쪽에 있으면 남은 것을 모으는 Rest 다.`},{q:`기온이 0도인데 화면에 기본값이 나온다. 어디를 고쳐야 하는가?`,a:`temp || 20 처럼 || 를 쓴 자리다. 0 은 Falsy 라 우항으로 넘어간다. temp ?? 20 으로 바꾸면 0 이 살아남는다.`},{q:`화면에 "[object Promise]" 가 찍힌다. 무엇을 빠뜨렸나?`,a:`await 다. async 함수는 항상 Promise 를 반환하므로, 값을 쓰려면 호출 앞에 await 를 붙여야 한다.`},{q:`find() 와 findIndex() 는 무엇이 다른가?`,a:`find() 는 조건을 만족하는 아이템 자체를(없으면 undefined), findIndex() 는 그 아이템의 인덱스 숫자를(없으면 -1) 돌려준다.`},{q:`Babel 과 Polyfill 은 무엇이 다른가?`,a:`Babel 은 최신 문법을 구형 문법으로 번역한다. Polyfill 은 구형 엔진에 아예 없는 객체·메서드를 JavaScript 로 직접 구현해 끼워 넣는다.`}]}},Hu=e=>Vu[e]??null,Uu={class:`chapter-nav`},Wu={class:`nav-head`},Gu={key:0,class:`nav-title`},Ku=[`title`,`aria-label`],qu=[`title`,`onClick`],Ju={class:`chapter-no`},Yu={key:0,class:`chapter-info`},Xu={key:1,class:`chapter-meta`},Zu=[`title`],Qu={key:0,class:`nav-legend`},$u={key:0},ed={id:`learning-content`,class:`learning-content`},td={class:`chapter-head`},nd={class:`eyebrow`},rd={class:`chapter-summary`},id={class:`topic-chips`},ad={key:2,class:`challenge-stack`},od={key:3,class:`empty-state`},sd={key:4,class:`linked-assignments`},cd={class:`step`},ld=2,ud=K({__name:`LearningView`,props:{chapterId:{type:String,default:``}},setup(e){te();let t=ee(),n=e,r=T(()=>{let e=Number(n.chapterId);return W.some(t=>t.id===e)?e:ld}),i=e=>{t.push({name:`learning`,params:{chapterId:String(e)}}),document.getElementById(`learning-content`)?.scrollIntoView({behavior:`smooth`,block:`start`})};u(()=>n.chapterId,e=>{e||t.replace({name:`learning`,params:{chapterId:String(ld)}})},{immediate:!0});let a=y(!1),o=T(()=>W.find(e=>e.id===r.value)),c=T(()=>Hu(r.value)),l=T(()=>ne(r.value)),d=T(()=>G(r.value)),f=T(()=>W.map(e=>{let t=ne(e.id),n=t.filter(e=>e.label.startsWith(`Code Challenge`));return{...e,total:n.length,live:t.filter(e=>e.practices.length>0).length,assignments:G(e.id).length}})),p=()=>{window.scrollTo({top:0,behavior:`smooth`})};return(e,t)=>{let n=m(`RouterLink`);return s(),k(C,null,[t[6]||=M(`section`,{class:`page-intro`},[M(`p`,{class:`eyebrow`},`LEARNING & CODE CHALLENGES`),M(`h1`,null,`학습 & 코드 챌린지`),M(`p`,null,[g(` 왼쪽에서 챕터를 고르면 해당 챕터의 `),M(`strong`,null,`코드 챌린지`),g(`가 열립니다. 각 챌린지는 `),M(`strong`,null,`관련 강의 내용 → 연습 항목 → 실습 화면`),g(` 순서로 이어집니다. `)])],-1),M(`section`,{class:h([`learning-layout`,{"nav-collapsed":a.value}])},[M(`aside`,Uu,[M(`div`,Wu,[a.value?x(``,!0):(s(),k(`p`,Gu,`학습 로드맵`)),M(`button`,{type:`button`,class:`nav-toggle`,title:a.value?`메뉴 펼치기`:`메뉴 접기`,"aria-label":a.value?`메뉴 펼치기`:`메뉴 접기`,onClick:t[0]||=e=>a.value=!a.value},A(a.value?`»`:`«`),9,Ku)]),(s(!0),k(C,null,P(f.value,e=>(s(),k(`button`,{key:e.id,type:`button`,class:h([`chapter-item`,{active:e.id===r.value}]),title:a.value?`${e.title} · ${e.slides}`:``,onClick:t=>i(e.id)},[M(`span`,Ju,A(String(e.id).padStart(2,`0`)),1),a.value?x(``,!0):(s(),k(`span`,Yu,[M(`b`,null,A(e.title),1),M(`small`,null,A(e.slides),1)])),a.value?x(``,!0):(s(),k(`span`,Xu,[M(`i`,{class:h([`dot`,{live:e.live,none:!e.total}]),title:e.total?`코드 챌린지 ${e.total}개${e.live?` · 실습 화면 ${e.live}개`:``}`:`코드 챌린지 없음`},A(e.total||`–`),11,Zu)]))],10,qu))),128)),a.value?x(``,!0):(s(),k(`p`,Qu,[...t[1]||=[g(` 숫자 = 코드 챌린지 수 \xA0·\xA0 `,-1),M(`i`,{class:`dot live`},`n`,-1),g(` 실습 화면 있음 `,-1)]])),M(`button`,{type:`button`,class:`to-top`,title:`맨 위로`,"aria-label":`맨 위로 가기`,onClick:p},[t[2]||=M(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[M(`path`,{d:`m6 15 6-6 6 6`})],-1),a.value?x(``,!0):(s(),k(`span`,$u,`맨 위로`))])]),M(`div`,ed,[M(`header`,td,[M(`div`,null,[M(`p`,nd,A(o.value.code)+` · 교안 `+A(o.value.slides),1),M(`h2`,null,A(o.value.title),1),M(`p`,rd,A(o.value.summary),1),M(`div`,id,[(s(!0),k(C,null,P(o.value.topics,e=>(s(),k(`span`,{key:e},A(e),1))),128))])])]),o.value.orientation?(s(),v(Bu,{key:0,orientation:o.value.orientation},null,8,[`orientation`])):x(``,!0),c.value?(s(),v(Cu,{key:1,notes:c.value},null,8,[`notes`])):x(``,!0),l.value.length?(s(),k(`div`,ad,[(s(!0),k(C,null,P(l.value,e=>(s(),v(ou,{key:e.id,challenge:e},null,8,[`challenge`]))),128))])):(s(),k(`p`,od,[...t[3]||=[g(` 교안 기준으로 이 챕터에는 코드 챌린지가 없습니다. 아래 `,-1),M(`b`,null,`제출 과제`,-1),g(`로 바로 진행합니다. `,-1)]])),d.value.length?(s(),k(`section`,sd,[t[5]||=M(`p`,{class:`section-label`},`이 챕터의 제출 과제`,-1),(s(!0),k(C,null,P(d.value,e=>(s(),v(n,{key:e.id,class:`assignment-link`,to:`/assignments`},{default:b(()=>[M(`span`,cd,A(String(e.id).padStart(2,`0`)),1),M(`span`,null,[M(`b`,null,A(e.title),1),M(`small`,null,A(e.goal),1)]),t[4]||=M(`span`,{class:`arrow`},`→`,-1)]),_:2},1024))),128))])):x(``,!0)])],2)],64)}}},[[`__scopeId`,`data-v-94fb5490`]]);export{ud as default};