...
`,Fo=Object.assign({"./basic/BindPractice.vue":Te,"./basic/ConditionalPractice.vue":ze,"./basic/EventPractice.vue":Xe,"./basic/ForPractice.vue":ct,"./basic/HtmlTextPractice.vue":ft,"./basic/ModelPractice.vue":yt,"./basic/ReactivityPractice.vue":zt,"./basic/SpecialDirectivePractice.vue":Ht,"./component/ComponentRegistrationPractice.vue":Qt,"./component/LifecyclePractice.vue":cn,"./component/PropsEmitsPractice.vue":mn,"./component/PropsFlowPractice.vue":Cn,"./component/PropsReadonlyPractice.vue":Bn,"./component/ProvideInjectPractice.vue":nr,"./component/SiblingTalkPractice.vue":_r,"./component/SlotBaseCardPractice.vue":Dr,"./component/SlotListPractice.vue":Ir,"./component/SlotModalPractice.vue":ti,"./component/SlotPractice.vue":_i,"./composition/ComputedCachePractice.vue":wi,"./composition/DeepWatchPractice.vue":Di,"./composition/FormStatePractice.vue":Ni,"./composition/MultiWatchPractice.vue":Ui,"./composition/ReactiveArrayWatchPractice.vue":Ji,"./composition/ReactiveStatePractice.vue":ea,"./composition/ReactiveWatchPractice.vue":oa,"./composition/RefArrayWatchPractice.vue":fa,"./composition/RefStatePractice.vue":ya,"./composition/TodoAdvancedPractice.vue":Sa,"./composition/TodoListPractice.vue":Ia,"./composition/WatchEffectPractice.vue":Ka,"./composition/WatchPractice.vue":Za}),$=e=>e.split(`/`).pop().replace(`.vue`,``),Io=Object.fromEntries(Object.entries(Fo).map(([e,t])=>[$(e),t.default])),Lo=Object.fromEntries(Object.entries(Fo).map(([e])=>[$(e),e.replace(`./`,`src/components/practices/`)]));Object.keys(Io).sort();var Ro=e=>Io[e]??null,zo=e=>Lo[e]??``,Bo=Object.fromEntries(Object.entries(Object.assign({"./basic/BindPractice.vue":no,"./basic/ConditionalPractice.vue":ro,"./basic/EventPractice.vue":io,"./basic/ForPractice.vue":ao,"./basic/HtmlTextPractice.vue":oo,"./basic/ModelPractice.vue":so,"./basic/ReactivityPractice.vue":co,"./basic/SpecialDirectivePractice.vue":lo,"./component/ComponentRegistrationPractice.vue":uo,"./component/LifecyclePractice.vue":fo,"./component/PropsEmitsPractice.vue":po,"./component/PropsFlowPractice.vue":mo,"./component/PropsReadonlyPractice.vue":ho,"./component/ProvideInjectPractice.vue":go,"./component/SiblingTalkPractice.vue":_o,"./component/SlotBaseCardPractice.vue":vo,"./component/SlotListPractice.vue":yo,"./component/SlotModalPractice.vue":bo,"./component/SlotPractice.vue":xo,"./composition/ComputedCachePractice.vue":So,"./composition/DeepWatchPractice.vue":Co,"./composition/FormStatePractice.vue":wo,"./composition/MultiWatchPractice.vue":To,"./composition/ReactiveArrayWatchPractice.vue":Eo,"./composition/ReactiveStatePractice.vue":Do,"./composition/ReactiveWatchPractice.vue":Oo,"./composition/RefArrayWatchPractice.vue":ko,"./composition/RefStatePractice.vue":Ao,"./composition/TodoAdvancedPractice.vue":jo,"./composition/TodoListPractice.vue":Mo,"./composition/WatchEffectPractice.vue":No,"./composition/WatchPractice.vue":Po})).map(([e,t])=>[$(e),t])),Vo=e=>Bo[e]??``,Ho=[`id`],Uo=[`aria-expanded`,`title`],Wo={class:`card-chevron`,"aria-hidden":`true`},Go={class:`head-text`},Ko={class:`label`},qo={class:`slide`},Jo={key:0,class:`goal`},Yo={key:1,class:`card-summary`},Xo={class:`head-badges`},Zo={key:0,class:`badge live`},Qo={key:1,class:`tasks`},$o={key:2,class:`fold pitfalls`},es={class:`fold-body`},ts={key:0,class:`compare`},ns={key:0,class:`bad`},rs={key:1,class:`good`},is={class:`why`},as={key:3,class:`practice-note`},os={class:`practice-head`},ss=[`aria-expanded`,`title`],cs={class:`chevron`,"aria-hidden":`true`},ls={key:0,class:`count`},us={class:`practice-hint`},ds={class:`practice-main`},fs={key:0,class:`practice-mounts`},ps={class:`slot-tools`},ms=[`onClick`],hs=[`onClick`],gs={key:1,class:`practice-empty`},_s={key:2,class:`practice-missing`},vs=[`aria-expanded`,`title`],ys={class:`side-chevron`,"aria-hidden":`true`},bs={class:`side-body`},xs={key:0,class:`side-block`},Ss={class:`side-heading`},Cs=[`onClick`],ws={class:`guide`},Ts=[`innerHTML`],Es={class:`guide-see`},Ds=[`innerHTML`],Os={key:0,class:`guide-why`},ks=[`innerHTML`],As={key:1,class:`group-extras`},js={key:1,class:`side-block fold extensions`},Ms={class:`fold-body`},Ns={key:5,class:`fold extensions`},Ps={class:`fold-body`},Fs=A({__name:`ChallengeCard`,props:{challenge:{type:Object,required:!0}},setup(e){let t=e,n=m(()=>t.challenge.practices.map(e=>({name:e,component:Ro(e)})).filter(e=>e.component)),i=m(()=>t.challenge.practices.filter(e=>!Ro(e))),c=m(()=>n.value.length>0),l=m(()=>t.challenge.practiceGuide??[]),u=m(()=>{let e=[];for(let t of l.value)t.practice||e.length===0?e.push({label:t.practice??null,steps:[t]}):e[e.length-1].steps.push(t);return e.map(e=>({...e,extras:g.value.filter(t=>typeof t==`object`&&t.practice===e.label)}))}),f=m(()=>{let e=new Set(u.value.map(e=>e.label));return g.value.filter(t=>typeof t==`string`||!e.has(t.practice))}),p=e=>typeof e==`string`?e:e.text,g=m(()=>t.challenge.extensions??[]),v=m(()=>c.value&&(l.value.length>0||g.value.length>0)),b=o(!0),x=o(!0),S=o(!1),C=m(()=>{let e=[];return t.challenge.tasks?.length&&e.push(`연습 ${t.challenge.tasks.length}`),t.challenge.pitfalls?.length&&e.push(`주의 ${t.challenge.pitfalls.length}`),n.value.length&&e.push(`실습 ${n.value.length}`),e.join(` · `)}),D=m(()=>!v.value&&g.value.length>0),A=a({}),j=e=>`${e}-${A[e]??0}`,N=e=>{A[e]=(A[e]??0)+1},P=()=>{n.value.forEach(e=>N(e.name))},I=o(null),R=e=>{I.value=e},z=o(null),B=e=>e.replace(/\s+/g,` `).trim(),V=(e,t)=>{let n=z.value;if(!n)return;let r=[...n.querySelectorAll(`.practice-slot`)];if(!r.length)return;let i=r.find(t=>{let n=t.querySelector(`h2`);return n&&B(n.textContent)===B(e??``)})??r[t]??r[0];i.scrollIntoView({behavior:`smooth`,block:`center`}),i.classList.add(`is-target`),setTimeout(()=>i.classList.remove(`is-target`),1400)};return(t,a)=>(d(),w(`article`,{id:`challenge-${e.challenge.id}`,ref_key:`cardEl`,ref:z,class:O([`challenge`,[e.challenge.status,{collapsed:!S.value}]])},[E(`header`,{class:`challenge-head`,role:`button`,tabindex:`0`,"aria-expanded":S.value,title:S.value?`이 챌린지 접기`:`이 챌린지 펼치기`,onClick:a[0]||=e=>S.value=!S.value,onKeydown:[a[1]||=L(G(e=>S.value=!S.value,[`prevent`]),[`enter`]),a[2]||=L(G(e=>S.value=!S.value,[`prevent`]),[`space`])]},[E(`span`,Wo,h(S.value?`▾`:`▸`),1),E(`div`,Go,[E(`p`,Ko,[y(h(e.challenge.label)+` `,1),E(`span`,qo,`교안 `+h(e.challenge.slidePage),1)]),E(`h3`,null,h(e.challenge.title),1),S.value?(d(),w(`p`,Jo,h(e.challenge.goal),1)):C.value?(d(),w(`p`,Yo,h(C.value),1)):_(``,!0)]),E(`div`,Xo,[E(`span`,{class:O([`badge`,e.challenge.status])},h(e.challenge.status===`done`?`학습 완료`:`진행 예정`),3),c.value?(d(),w(`span`,Zo,` 실습 `+h(n.value.length)+`개 `,1)):_(``,!0)])],40,Uo),S.value?(d(),w(T,{key:0},[e.challenge.lecture?(d(),k(ye,{key:0,lecture:e.challenge.lecture,"study-range":e.challenge.studyRange},null,8,[`lecture`,`study-range`])):_(``,!0),e.challenge.tasks?.length?(d(),w(`section`,Qo,[a[6]||=E(`p`,{class:`section-label`},`✎ 연습 항목`,-1),E(`ul`,null,[(d(!0),w(T,null,M(e.challenge.tasks,e=>(d(),w(`li`,{key:e},h(e),1))),128))])])):_(``,!0),e.challenge.pitfalls?.length?(d(),w(`details`,$o,[E(`summary`,null,[a[7]||=E(`span`,{"aria-hidden":`true`},`⚠`,-1),a[8]||=y(` 조심할 점 `,-1),E(`b`,null,h(e.challenge.pitfalls.length),1)]),E(`div`,es,[(d(!0),w(T,null,M(e.challenge.pitfalls,(e,t)=>(d(),w(`div`,{key:t,class:`pitfall`},[e.bad||e.good?(d(),w(`div`,ts,[e.bad?(d(),w(`p`,ns,[a[9]||=E(`span`,null,`❌`,-1),E(`code`,null,h(e.bad),1)])):_(``,!0),e.good?(d(),w(`p`,rs,[a[10]||=E(`span`,null,`✅`,-1),E(`code`,null,h(e.good),1)])):_(``,!0)])):_(``,!0),E(`p`,is,h(e.why),1)]))),128))])])):_(``,!0),!c.value&&e.challenge.practiceNote?(d(),w(`p`,as,[a[11]||=E(`span`,{"aria-hidden":`true`},`✓`,-1),y(` `+h(e.challenge.practiceNote),1)])):(d(),w(`section`,{key:4,class:O([`practice-zone`,{closed:!x.value}])},[E(`header`,os,[E(`button`,{type:`button`,class:`practice-toggle`,"aria-expanded":x.value,title:x.value?`실습 화면 접기`:`실습 화면 펼치기`,onClick:a[3]||=e=>x.value=!x.value},[E(`span`,cs,h(x.value?`▾`:`▸`),1),a[12]||=E(`span`,{class:`practice-mark`,"aria-hidden":`true`},`🖥`,-1),a[13]||=E(`span`,{class:`practice-title`},`실습 화면`,-1),c.value?(d(),w(`span`,ls,h(n.value.length),1)):_(``,!0)],8,ss),E(`span`,us,h(x.value?`직접 눌러보며 동작을 확인하세요`:`접어 둠 · 제목을 눌러 펼치기`),1),n.value.length>1&&x.value?(d(),w(`button`,{key:0,type:`button`,class:`reset-button reset-all`,"aria-label":`실습 전체 초기화`,title:`이 챌린지의 실습을 모두 처음 상태로 되돌립니다`,onClick:P},[...a[14]||=[E(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[E(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),E(`path`,{d:`M20 4v4.5h-4.5`})],-1)]])):_(``,!0)]),s(E(`div`,{class:O([`practice-body`,{"has-guide":v.value,"side-closed":v.value&&!b.value}])},[E(`div`,ds,[c.value?(d(),w(`div`,fs,[(d(!0),w(T,null,M(n.value,e=>(d(),w(`div`,{key:e.name,class:`practice-slot`},[E(`div`,ps,[E(`button`,{type:`button`,class:`icon-button`,"aria-label":`소스 코드 보기`,title:`소스 코드를 새 창으로 엽니다`,onClick:t=>R(e.name)},[...a[15]||=[E(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[E(`path`,{d:`M9 7 4 12l5 5M15 7l5 5-5 5`})],-1)]],8,ms),E(`button`,{type:`button`,class:`icon-button`,"aria-label":`이 실습 초기화`,title:`이 실습만 처음 상태로 되돌립니다 (페이지 새로고침 없음)`,onClick:t=>N(e.name)},[...a[16]||=[E(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[E(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),E(`path`,{d:`M20 4v4.5h-4.5`})],-1)]],8,hs)]),(d(),k(r(e.component),{key:j(e.name)}))]))),128))])):(d(),w(`p`,gs,[...a[17]||=[y(` 아직 이 챌린지에 연결된 실습 화면이 없습니다. `,-1),E(`code`,null,`src/components/practices/`,-1),y(` 에 컴포넌트를 추가하고 `,-1),E(`code`,null,`curriculum.js`,-1),y(` 의 `,-1),E(`code`,null,`practices`,-1),y(` 에 이름을 넣으면 여기에 나타납니다. `,-1)]])),i.value.length?(d(),w(`p`,_s,` ⚠ 파일을 찾지 못한 실습: `+h(i.value.join(`, `)),1)):_(``,!0)]),v.value?(d(),w(`aside`,{key:0,class:O([`guide-side`,{collapsed:!b.value}])},[E(`button`,{type:`button`,class:`side-toggle`,"aria-expanded":b.value,title:b.value?`접어서 실습 화면 넓히기`:`실습 도우미 펼치기`,onClick:a[4]||=e=>b.value=!b.value},[a[18]||=E(`span`,{class:`side-toggle-label`},[E(`span`,{"aria-hidden":`true`},`✓`),y(` 실습 도우미 `)],-1),E(`span`,ys,h(b.value?`›`:`‹`),1)],8,vs),s(E(`div`,bs,[l.value.length?(d(),w(`section`,xs,[E(`p`,Ss,[a[19]||=y(` 확인 가이드 `,-1),E(`b`,null,h(l.value.length),1)]),(d(!0),w(T,null,M(u.value,(e,t)=>(d(),w(`div`,{key:t,class:`guide-group`},[e.label?(d(),w(`button`,{key:0,type:`button`,class:`guide-chip`,title:`이 실습으로 이동합니다`,onClick:n=>V(e.label,t)},[y(h(e.label)+` `,1),a[20]||=E(`span`,{class:`jump`,"aria-hidden":`true`},`↓`,-1)],8,Cs)):_(``,!0),E(`ol`,ws,[(d(!0),w(T,null,M(e.steps,(e,t)=>(d(),w(`li`,{key:t},[E(`p`,{class:`guide-do`,innerHTML:F(q)(e.do)},null,8,Ts),E(`p`,Es,[a[21]||=E(`b`,null,`확인`,-1),a[22]||=y(),E(`span`,{innerHTML:F(q)(e.see)},null,8,Ds)]),e.why?(d(),w(`p`,Os,[a[23]||=E(`b`,null,`왜`,-1),a[24]||=y(),E(`span`,{innerHTML:F(q)(e.why)},null,8,ks)])):_(``,!0)]))),128))]),e.extras.length?(d(),w(`div`,As,[a[25]||=E(`p`,{class:`extras-label`},[E(`span`,{"aria-hidden":`true`},`🚀`),y(` 더 해보기`)],-1),E(`ul`,null,[(d(!0),w(T,null,M(e.extras,(e,t)=>(d(),w(`li`,{key:t},h(p(e)),1))),128))])])):_(``,!0)]))),128))])):_(``,!0),f.value.length?(d(),w(`details`,js,[E(`summary`,null,[a[26]||=E(`span`,{"aria-hidden":`true`},`🚀`,-1),a[27]||=y(` 더 해보기 (전체) `,-1),E(`b`,null,h(f.value.length),1)]),E(`div`,Ms,[E(`ul`,null,[(d(!0),w(T,null,M(f.value,(e,t)=>(d(),w(`li`,{key:t},h(p(e)),1))),128))])])])):_(``,!0)],512),[[K,b.value]])],2)):_(``,!0)],2),[[K,x.value]])],2)),D.value?(d(),w(`details`,Ns,[E(`summary`,null,[a[28]||=E(`span`,{"aria-hidden":`true`},`🚀`,-1),a[29]||=y(` 더 해보기 (심화 응용) `,-1),E(`b`,null,h(g.value.length),1)]),E(`div`,Ps,[E(`ul`,null,[(d(!0),w(T,null,M(g.value,(e,t)=>(d(),w(`li`,{key:t},h(p(e)),1))),128))])])])):_(``,!0)],64)):_(``,!0),I.value?(d(),k(ne,{key:1,path:F(zo)(I.value),code:F(Vo)(I.value),onClose:a[5]||=e=>I.value=null},null,8,[`path`,`code`])):_(``,!0)],10,Ho))}},[[`__scopeId`,`data-v-6e637b45`]]),Is=[`aria-expanded`],Ls={class:`chevron`,"aria-hidden":`true`},Rs={class:`orientation-body`},zs={class:`rule`},Bs={class:`lead`},Vs={class:`cargo`},Hs={class:`name`},Us={class:`payload`},Ws={"aria-hidden":`true`},Gs=[`innerHTML`],Ks={class:`priority`},qs={class:`p-name`},Js={class:`p-weight`},Ys={class:`p-when`},Xs={class:`keep`},Zs=[`innerHTML`],Qs=A({__name:`ChapterOrientation`,props:{orientation:{type:Object,required:!0}},setup(e){let t=o(!0);return(n,r)=>(d(),w(`section`,{class:O([`orientation`,{closed:!t.value}])},[E(`button`,{class:`orientation-toggle`,type:`button`,"aria-expanded":t.value,onClick:r[0]||=e=>t.value=!t.value},[r[1]||=E(`span`,{class:`marker`,"aria-hidden":`true`},`🧭`,-1),r[2]||=E(`span`,{class:`toggle-title`},`시작하기 전에 — 규칙은 하나뿐입니다`,-1),E(`span`,Ls,h(t.value?`−`:`+`),1)],8,Is),s(E(`div`,Rs,[E(`p`,zs,h(e.orientation.rule),1),E(`p`,Bs,h(e.orientation.lead),1),E(`ul`,Vs,[(d(!0),w(T,null,M(e.orientation.cargo,e=>(d(),w(`li`,{key:e.name},[E(`code`,Hs,h(e.name),1),E(`span`,Us,h(e.payload),1),E(`span`,{class:O([`dir`,e.dir===`위로`?`up`:`down`])},[E(`span`,Ws,h(e.dir===`위로`?`↑`:`↓`),1),y(` `+h(e.dir),1)],2)]))),128))]),E(`p`,{class:`why`,innerHTML:F(q)(e.orientation.why)},null,8,Gs),r[4]||=E(`p`,{class:`priority-label`},`실제로 쓰는 비중`,-1),E(`ul`,Ks,[(d(!0),w(T,null,M(e.orientation.priority,e=>(d(),w(`li`,{key:e.name,class:O(e.level)},[E(`span`,qs,h(e.name),1),E(`span`,Js,h(e.weight),1),E(`span`,Ys,h(e.when),1)],2))),128))]),E(`p`,Xs,[r[3]||=E(`span`,{class:`keep-label`},`이것만은`,-1),E(`span`,{innerHTML:F(q)(e.orientation.keep)},null,8,Zs)])],512),[[K,t.value]])],2))}},[[`__scopeId`,`data-v-bfb97b66`]]),$s={class:`chapter-nav`},ec={class:`nav-head`},tc={key:0,class:`nav-title`},nc=[`title`,`aria-label`],rc=[`title`,`onClick`],ic={class:`chapter-no`},ac={key:0,class:`chapter-info`},oc={key:1,class:`chapter-meta`},sc=[`title`],cc={key:0,class:`nav-legend`},lc={key:0},uc={id:`learning-content`,class:`learning-content`},dc={class:`chapter-head`},fc={class:`eyebrow`},pc={class:`chapter-summary`},mc={class:`topic-chips`},hc={key:1,class:`challenge-stack`},gc={key:2,class:`empty-state`},_c={key:3,class:`linked-assignments`},vc={class:`step`},yc=2,bc=A({__name:`LearningView`,props:{chapterId:{type:String,default:``}},setup(e){ee();let t=V(),n=e,r=m(()=>{let e=Number(n.chapterId);return R.some(t=>t.id===e)?e:yc}),a=e=>{t.push({name:`learning`,params:{chapterId:String(e)}}),document.getElementById(`learning-content`)?.scrollIntoView({behavior:`smooth`,block:`start`})};C(()=>n.chapterId,e=>{e||t.replace({name:`learning`,params:{chapterId:String(yc)}})},{immediate:!0});let s=o(!1),c=m(()=>R.find(e=>e.id===r.value)),l=m(()=>U(r.value)),u=m(()=>H(r.value)),f=m(()=>R.map(e=>{let t=U(e.id),n=t.filter(e=>e.label.startsWith(`Code Challenge`));return{...e,total:n.length,live:t.filter(e=>e.practices.length>0).length,assignments:H(e.id).length}})),p=()=>{window.scrollTo({top:0,behavior:`smooth`})};return(e,t)=>{let n=i(`RouterLink`);return d(),w(T,null,[t[6]||=E(`section`,{class:`page-intro`},[E(`p`,{class:`eyebrow`},`LEARNING & CODE CHALLENGES`),E(`h1`,null,`학습 & 코드 챌린지`),E(`p`,null,[y(` 왼쪽에서 챕터를 고르면 해당 챕터의 `),E(`strong`,null,`코드 챌린지`),y(`가 열립니다. 각 챌린지는 `),E(`strong`,null,`관련 강의 내용 → 연습 항목 → 실습 화면`),y(` 순서로 이어집니다. `)])],-1),E(`section`,{class:O([`learning-layout`,{"nav-collapsed":s.value}])},[E(`aside`,$s,[E(`div`,ec,[s.value?_(``,!0):(d(),w(`p`,tc,`학습 로드맵`)),E(`button`,{type:`button`,class:`nav-toggle`,title:s.value?`메뉴 펼치기`:`메뉴 접기`,"aria-label":s.value?`메뉴 펼치기`:`메뉴 접기`,onClick:t[0]||=e=>s.value=!s.value},h(s.value?`»`:`«`),9,nc)]),(d(!0),w(T,null,M(f.value,e=>(d(),w(`button`,{key:e.id,type:`button`,class:O([`chapter-item`,{active:e.id===r.value}]),title:s.value?`${e.title} · ${e.slides}`:``,onClick:t=>a(e.id)},[E(`span`,ic,h(String(e.id).padStart(2,`0`)),1),s.value?_(``,!0):(d(),w(`span`,ac,[E(`b`,null,h(e.title),1),E(`small`,null,h(e.slides),1)])),s.value?_(``,!0):(d(),w(`span`,oc,[E(`i`,{class:O([`dot`,{live:e.live,none:!e.total}]),title:e.total?`코드 챌린지 ${e.total}개${e.live?` · 실습 화면 ${e.live}개`:``}`:`코드 챌린지 없음`},h(e.total||`–`),11,sc)]))],10,rc))),128)),s.value?_(``,!0):(d(),w(`p`,cc,[...t[1]||=[y(` 숫자 = 코드 챌린지 수 \xA0·\xA0 `,-1),E(`i`,{class:`dot live`},`n`,-1),y(` 실습 화면 있음 `,-1)]])),E(`button`,{type:`button`,class:`to-top`,title:`맨 위로`,"aria-label":`맨 위로 가기`,onClick:p},[t[2]||=E(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[E(`path`,{d:`m6 15 6-6 6 6`})],-1),s.value?_(``,!0):(d(),w(`span`,lc,`맨 위로`))])]),E(`div`,uc,[E(`header`,dc,[E(`div`,null,[E(`p`,fc,h(c.value.code)+` · 교안 `+h(c.value.slides),1),E(`h2`,null,h(c.value.title),1),E(`p`,pc,h(c.value.summary),1),E(`div`,mc,[(d(!0),w(T,null,M(c.value.topics,e=>(d(),w(`span`,{key:e},h(e),1))),128))])])]),c.value.orientation?(d(),k(Qs,{key:0,orientation:c.value.orientation},null,8,[`orientation`])):_(``,!0),l.value.length?(d(),w(`div`,hc,[(d(!0),w(T,null,M(l.value,e=>(d(),k(Fs,{key:e.id,challenge:e},null,8,[`challenge`]))),128))])):(d(),w(`p`,gc,[...t[3]||=[y(` 교안 기준으로 이 챕터에는 코드 챌린지가 없습니다. 아래 `,-1),E(`b`,null,`제출 과제`,-1),y(`로 바로 진행합니다. `,-1)]])),u.value.length?(d(),w(`section`,_c,[t[5]||=E(`p`,{class:`section-label`},`이 챕터의 제출 과제`,-1),(d(!0),w(T,null,M(u.value,e=>(d(),k(n,{key:e.id,class:`assignment-link`,to:`/assignments`},{default:S(()=>[E(`span`,vc,h(String(e.id).padStart(2,`0`)),1),E(`span`,null,[E(`b`,null,h(e.title),1),E(`small`,null,h(e.goal),1)]),t[4]||=E(`span`,{class:`arrow`},`→`,-1)]),_:2},1024))),128))])):_(``,!0)])],2)],64)}}},[[`__scopeId`,`data-v-2064475a`]]);export{bc as default};