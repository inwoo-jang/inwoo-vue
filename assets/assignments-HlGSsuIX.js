...
`,Qn=Object.fromEntries(Object.entries(Object.assign({"./WeatherComposition.vue":O,"./WeatherMockup.vue":z,"./WeatherParent.vue":gn})).map(([e,t])=>[e.replace(`./`,``).replace(`.vue`,``),t.default]));Object.keys(Qn).sort();var $n=e=>Qn[e]??null,er=Object.assign({"./WeatherComposition.vue":zn,"./WeatherMockup.vue":Bn,"./WeatherParent.vue":Vn,"./weather/BaseDashboardCard.vue":Hn,"./weather/HourlyDetail.vue":Un,"./weather/RegionTabs.vue":Wn,"./weather/SearchBar.vue":Gn,"./weather/UiIcon.vue":Kn,"./weather/WeatherBackdrop.vue":qn,"./weather/WeatherByStatus.vue":Jn,"./weather/WeatherCard.vue":Yn,"./weather/WeatherIcon.vue":Xn,"./weather/weatherApi.js":Zn}),$=Object.fromEntries(Object.entries(er).map(([e,t])=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),t])),tr=Object.fromEntries(Object.keys(er).map(e=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),e.replace(`./`,`src/components/assignments/`)])),nr=e=>$[e]===void 0?Object.keys($).find(t=>t.endsWith(`/${e}`)):e,rr=e=>$[nr(e)]??``,ir=e=>tr[nr(e)]??``;export{$n as n,rr as r,ir as t};