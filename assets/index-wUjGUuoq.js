...
`,Au=Object.fromEntries(Object.entries(Object.assign({"./WeatherComposition.vue":is,"./WeatherMockup.vue":gs,"./WeatherParent.vue":ql})).map(([e,t])=>[e.replace(`./`,``).replace(`.vue`,``),t.default]));Object.keys(Au).sort();var ju=e=>Au[e]??null,Mu=Object.assign({"./WeatherComposition.vue":_u,"./WeatherMockup.vue":vu,"./WeatherParent.vue":yu,"./weather/BaseDashboardCard.vue":bu,"./weather/HourlyDetail.vue":xu,"./weather/RegionTabs.vue":Su,"./weather/SearchBar.vue":Cu,"./weather/UiIcon.vue":wu,"./weather/WeatherBackdrop.vue":Tu,"./weather/WeatherByStatus.vue":Eu,"./weather/WeatherCard.vue":Du,"./weather/WeatherIcon.vue":Ou,"./weather/weatherApi.js":ku}),Nu=Object.fromEntries(Object.entries(Mu).map(([e,t])=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),t])),Pu=Object.fromEntries(Object.keys(Mu).map(e=>[e.replace(`./`,``).replace(/\.(vue|js)$/,``),e.replace(`./`,`src/components/assignments/`)])),Fu=e=>Nu[e]===void 0?Object.keys(Nu).find(t=>t.endsWith(`/${e}`)):e,Iu=e=>Nu[Fu(e)]??``,Lu=e=>Pu[Fu(e)]??``,Ru={class:`progress-bar`},zu={class:`track`},Bu={class:`assignment-timeline`},Vu={class:`step`},Hu={class:`assignment-body`},Uu={class:`topline`},Wu={class:`eyebrow`},Gu={class:`slide`},Ku={class:`goal`},qu={class:`scope`},Ju={class:`chapter-tag`},Yu={class:`range`},Xu=[`open`],Zu={key:0,class:`note`},Qu={key:1,class:`result`},$u={key:0},ed={class:`result-stage`},td=Q({__name:`AssignmentsView`,setup(e){let t=e=>qo.find(t=>t.id===e)?.title??``,n={done:`완료`,todo:`진행 예정`,final:`최종`},r=X(()=>Yo.filter(e=>e.status===`done`).length);return(e,i)=>(H(),U(V,null,[i[3]||=G(`section`,{class:`page-intro`},[G(`p`,{class:`eyebrow`},`SUBMISSION ASSIGNMENTS`),G(`h1`,null,`제출 과제`),G(`p`,null,[q(` 각 과제는 이전 결과물에서 `),G(`strong`,null,`이어집니다`),q(`. 여기서 완성한 결과가 최종 날씨 서비스의 기반이 됩니다. `)])],-1),G(`section`,Ru,[G(`div`,null,[i[0]||=G(`p`,{class:`label`},`전체 진행률`,-1),G(`strong`,null,O(r.value)+` / `+O(F(Yo).length),1)]),G(`div`,zu,[G(`i`,{style:E({width:`${r.value/F(Yo).length*100}%`})},null,4)])]),G(`section`,Bu,[(H(!0),U(V,null,B(F(Yo),e=>(H(),U(`article`,{key:e.id,class:D([`assignment-card`,e.status])},[G(`div`,Vu,O(String(e.id).padStart(2,`0`)),1),G(`div`,Hu,[G(`div`,Uu,[G(`p`,Wu,[q(` ASSIGNMENT `+O(String(e.id).padStart(2,`0`))+` `,1),G(`span`,Gu,`교안 `+O(e.slidePage),1)]),G(`span`,{class:D([`status`,e.status])},O(n[e.status]),3)]),G(`h2`,null,O(e.title),1),G(`p`,Ku,O(e.goal),1),G(`div`,qu,[G(`span`,Ju,O(t(e.chapterId)),1),G(`span`,Yu,O(e.scope),1)]),G(`details`,{class:`requirements`,open:e.status!==`todo`},[G(`summary`,null,`요구사항 `+O(e.requirements.length)+`개`,1),G(`ul`,null,[(H(!0),U(V,null,B(e.requirements,e=>(H(),U(`li`,{key:e},O(e),1))),128))])],8,Xu),e.note?(H(),U(`p`,Zu,`⚠ `+O(e.note),1)):J(``,!0),F(ju)(e.result)?(H(),U(`details`,Qu,[G(`summary`,null,[i[1]||=G(`span`,{"aria-hidden":`true`},`▶`,-1),i[2]||=q(` 결과물 보기 `,-1),e.resultNote?(H(),U(`small`,$u,O(e.resultNote),1)):J(``,!0)]),G(`div`,ed,[(H(),W(Er(F(ju)(e.result))))])])):J(``,!0)])],2))),128))])],64))}},[[`__scopeId`,`data-v-59c19f57`]]),nd={class:`hero`},rd={class:`progress-card`},id={class:`progress-track`},ad={class:`section-block`},od={class:`chapter-grid`},sd={class:`number`},cd={class:`section-block`},ld={class:`project-strip`},ud={class:`mini-stats`},dd=Q({__name:`HomeView`,setup(e){let t=Math.round(rs/Yo.length*100);return(e,n)=>(H(),U(V,null,[G(`section`,nd,[n[3]||=oa(`<div data-v-9ae6c4f2><p class="eyebrow" data-v-9ae6c4f2>LEARN · PRACTICE · SUBMIT</p><h1 data-v-9ae6c4f2>Vue를 배우고,<br data-v-9ae6c4f2><span data-v-9ae6c4f2>하나의 결과물</span>로 완성하세요.</h1><p class="hero-copy" data-v-9ae6c4f2> 코드 챌린지로 개념을 익히고, 단계별 제출 과제로 날씨 웹 애플리케이션을 발전시킵니다. </p><div class="hero-actions" data-v-9ae6c4f2><a class="primary-button" href="#/learning" data-v-9ae6c4f2>학습 시작하기</a><a class="secondary-button" href="#/assignments" data-v-9ae6c4f2>제출 과제 보기</a></div></div>`,1),G(`div`,rd,[n[0]||=G(`p`,{class:`card-label`},`MY LEARNING`,-1),G(`strong`,null,O(F(rs))+` / `+O(F(Yo).length),1),n[1]||=G(`span`,null,`제출 과제 진행률`,-1),G(`div`,id,[G(`i`,{style:E({width:`${F(t)}%`})},null,4)]),n[2]||=G(`a`,{href:`#/project`},`최종 결과물 확인 →`,-1)])]),G(`section`,ad,[n[4]||=G(`div`,{class:`section-heading`},[G(`div`,null,[G(`p`,{class:`eyebrow`},`CURRICULUM`),G(`h2`,null,`학습 영역`)]),G(`a`,{href:`#/learning`},`전체 학습 보기 →`)],-1),G(`div`,od,[(H(!0),U(V,null,B(F(qo).slice(0,4),e=>(H(),U(`article`,{key:e.id,class:`info-card`},[G(`span`,sd,O(String(e.id).padStart(2,`0`)),1),G(`h3`,null,O(e.title),1),G(`p`,null,O(e.subtitle),1),G(`small`,null,`교안 `+O(e.slides),1)]))),128))])]),G(`section`,cd,[n[9]||=G(`div`,{class:`section-heading`},[G(`div`,null,[G(`p`,{class:`eyebrow`},`SUBMISSION PROJECT`),G(`h2`,null,`하나의 날씨 프로젝트`)]),G(`a`,{href:`#/assignments`},`과제 전체 보기 →`)],-1),G(`div`,ld,[n[8]||=G(`div`,null,[G(`span`,{class:`project-icon`},`☁`),G(`h3`,null,`Weather Dashboard`),G(`p`,null,`Mockup에서 API 연동과 배포까지, 과제 결과물이 순서대로 이어집니다.`)],-1),G(`div`,ud,[G(`strong`,null,O(F(ns)),1),n[5]||=G(`span`,null,`개 코드 챌린지`,-1),G(`strong`,null,O(F(ts)),1),n[6]||=G(`span`,null,`개 실습 화면 연결됨`,-1),G(`strong`,null,O(F(Yo).length),1),n[7]||=G(`span`,null,`단계별 제출 과제`,-1)])])])],64))}},[[`__scopeId`,`data-v-9ae6c4f2`]]),fd=new Set(`const.let.var.function.return.if.else.for.while.do.switch.case.default.break.continue.new.delete.typeof.instanceof.in.of.import.export.from.as.async.await.try.catch.finally.throw.class.extends.this.null.undefined.true.false.void.yield`.split(`.`)),pd=new Set(`ref.reactive.computed.watch.watchEffect.toRefs.toRef.unref.isRef.shallowRef.readonly.nextTick.onMounted.onUnmounted.onBeforeMount.onBeforeUnmount.onUpdated.onBeforeUpdate.onErrorCaptured.defineProps.defineEmits.defineExpose.defineModel.createApp.defineStore.storeToRefs.provide.inject.useRoute.useRouter.createPinia.createRouter`.split(`.`)),md=e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`),hd=e=>e?md(String(e)).replace(/\*\*([^*]+)\*\*/g,`<mark>$1</mark>`).replace(/`([^`]+)`/g,`<code>$1</code>`):``,gd=(e,t)=>`<span class="tok-${e}">${md(t)}</span>`,_d=new RegExp([`(<!--[\\s\\S]*?-->)`,`(/\\*[\\s\\S]*?\\*/)`,`(//[^\\n]*)`,"(`(?:\\\\[\\s\\S]|[^`\\\\])*`)",`('(?:\\\\[\\s\\S]|[^'\\\\\\n])*')`,`("(?:\\\\[\\s\\S]|[^"\\\\\\n])*")`,`(</?[A-Za-z][\\w.-]*)`,`(\\s(?:v-[\\w:.\\-\\[\\]]+|[@:#][\\w.\\-\\[\\]]+))`,`(\\b\\d+(?:\\.\\d+)?\\b)`,`([A-Za-z_$][\\w$]*)`].join(`|`),`g`),vd=e=>{if(!e)return``;let t=``,n=0;for(let r of e.matchAll(_d)){t+=md(e.slice(n,r.index)),n=r.index+r[0].length;let[i,a,o,s,c,l,u,d,f,p,m]=r;a||o||s?t+=gd(`comment`,i):c||l||u?t+=gd(`string`,i):d?t+=gd(`tag`,i):f?t+=i.slice(0,1)+gd(`attr`,i.slice(1)):p?t+=gd(`number`,i):m?fd.has(m)?t+=gd(`keyword`,i):pd.has(m)?t+=gd(`api`,i):t+=md(i):t+=md(i)}return t+md(e.slice(n))},yd={class:`snippet`},bd=[`innerHTML`],xd={key:0,class:`parts`},Sd={key:1,class:`returns`},Cd={key:2},wd=Q({__name:`CodeSnippet`,props:{code:{type:String,required:!0},desc:{type:String,default:``},parts:{type:Array,default:()=>[]},returns:{type:String,default:``}},setup(e){let t=e,n=X(()=>vd(t.code));return(t,r)=>(H(),U(`figure`,yd,[G(`pre`,null,[G(`code`,{innerHTML:n.value},null,8,bd)]),e.parts.length?(H(),U(`dl`,xd,[(H(!0),U(V,null,B(e.parts,e=>(H(),U(V,{key:e.token},[G(`dt`,null,O(e.token),1),G(`dd`,null,O(e.role),1)],64))),128))])):J(``,!0),e.returns?(H(),U(`p`,Sd,[r[0]||=G(`span`,{class:`returns-label`},`돌려주는 값`,-1),q(O(e.returns),1)])):J(``,!0),e.desc?(H(),U(`figcaption`,Cd,O(e.desc),1)):J(``,!0)]))}},[[`__scopeId`,`data-v-264d774b`]]),Td=[`aria-expanded`],Ed={key:0,class:`range`},Dd={class:`chevron`},Od={class:`lecture-body`},kd={key:0,class:`intro`},Ad=[`innerHTML`],jd=[`innerHTML`],Md={key:1,class:`points`},Nd=[`innerHTML`],Pd={key:2,class:`syntax`},Fd=Q({__name:`LectureBrief`,props:{lecture:{type:Object,required:!0},studyRange:{type:String,default:``},open:{type:Boolean,default:!1}},setup(e){let t=P(e.open);return(n,r)=>(H(),U(`section`,{class:D([`lecture`,{closed:!t.value}])},[G(`button`,{class:`lecture-toggle`,type:`button`,"aria-expanded":t.value,onClick:r[0]||=e=>t.value=!t.value},[r[1]||=G(`span`,{class:`marker`},`📖`,-1),r[2]||=G(`span`,{class:`toggle-title`},`관련 강의 내용`,-1),e.studyRange?(H(),U(`span`,Ed,`교안 `+O(e.studyRange),1)):J(``,!0),G(`span`,Dd,O(t.value?`−`:`+`),1)],8,Td),R(G(`div`,Od,[e.lecture.intro?(H(),U(`p`,kd,[r[3]||=G(`span`,{class:`intro-label`},`쉽게 말하면`,-1),G(`span`,{innerHTML:F(hd)(e.lecture.intro)},null,8,Ad)])):J(``,!0),G(`p`,{class:`lead`,innerHTML:F(hd)(e.lecture.summary)},null,8,jd),e.lecture.points?.length?(H(),U(`ul`,Md,[(H(!0),U(V,null,B(e.lecture.points,e=>(H(),U(`li`,{key:e,innerHTML:F(hd)(e)},null,8,Nd))),128))])):J(``,!0),e.lecture.syntax?.length?(H(),U(`div`,Pd,[r[4]||=G(`p`,{class:`syntax-label`},`문법 정리`,-1),(H(!0),U(V,null,B(e.lecture.syntax,e=>(H(),W(wd,{key:e.code,code:e.code,desc:e.desc,parts:e.parts??[],returns:e.returns??``},null,8,[`code`,`desc`,`parts`,`returns`]))),128))])):J(``,!0)],512),[[Ja,t.value]])],2))}},[[`__scopeId`,`data-v-dd03eb2e`]]),Id={class:`code-window`},Ld={class:`window-bar`},Rd={class:`path`},zd={class:`meta`},Bd={class:`code-scroll`},Vd=[`innerHTML`],Hd=Q({__name:`CodeWindow`,props:{path:{type:String,required:!0},code:{type:String,required:!0}},emits:[`close`],setup(e,{emit:t}){let n=e,r=t,i=X(()=>vd(n.code)),a=X(()=>n.code.split(`
`).length),o=P(!1),s=async()=>{try{await navigator.clipboard.writeText(n.code),o.value=!0,setTimeout(()=>o.value=!1,1500)}catch{o.value=!1}},c=e=>{e.key===`Escape`&&r(`close`)};return mr(()=>{document.addEventListener(`keydown`,c),document.body.style.overflow=`hidden`}),_r(()=>{document.removeEventListener(`keydown`,c),document.body.style.overflow=``}),(t,n)=>(H(),W(Yn,{to:`body`},[G(`div`,{class:`code-backdrop`,role:`dialog`,"aria-modal":`true`,onClick:n[1]||=Ro(e=>r(`close`),[`self`])},[G(`div`,Id,[G(`header`,Ld,[n[3]||=G(`span`,{class:`dots`,"aria-hidden":`true`},[G(`i`),G(`i`),G(`i`)],-1),G(`code`,Rd,O(e.path),1),G(`span`,zd,O(a.value)+`줄`,1),G(`button`,{type:`button`,class:`bar-button`,onClick:s},O(o.value?`복사됨`:`복사`),1),G(`button`,{type:`button`,class:`bar-button close`,"aria-label":`닫기`,onClick:n[0]||=e=>r(`close`)},[...n[2]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M18 6 6 18M6 6l12 12`})],-1)]])]),G(`div`,Bd,[G(`pre`,null,[G(`code`,{innerHTML:i.value},null,8,Vd)])]),n[4]||=G(`footer`,{class:`window-foot`},[G(`span`,null,[G(`kbd`,null,`Esc`),q(` 또는 바깥을 클릭하면 닫힙니다`)]),G(`span`,{class:`legend`},[G(`i`,{class:`tok-keyword`},`키워드`),G(`i`,{class:`tok-api`},`Vue 함수`),G(`i`,{class:`tok-tag`},`태그`),G(`i`,{class:`tok-attr`},`디렉티브`),G(`i`,{class:`tok-string`},`문자열`),G(`i`,{class:`tok-comment`},`주석`)])],-1)])])]))}},[[`__scopeId`,`data-v-fe776e53`]]),Ud=[`aria-expanded`,`aria-label`,`title`],Wd={key:0,class:`icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2.2`,"stroke-linecap":`round`,"aria-hidden":`true`},Gd={key:1,class:`icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`,"aria-hidden":`true`},Kd={class:`help-popover`,role:`note`},qd={class:`help-text`},$=Q({__name:`ConceptHelp`,props:{text:{type:String,required:!0}},setup(e){let t=P(!1),n=P(null),r=e=>{t.value&&n.value&&!n.value.contains(e.target)&&(t.value=!1)},i=e=>{e.key===`Escape`&&(t.value=!1)};return mr(()=>{document.addEventListener(`mousedown`,r),document.addEventListener(`keydown`,i)}),_r(()=>{document.removeEventListener(`mousedown`,r),document.removeEventListener(`keydown`,i)}),(r,i)=>(H(),U(`span`,{ref_key:`root`,ref:n,class:`concept-help`},[G(`button`,{class:D([`help-button`,{open:t.value}]),type:`button`,"aria-expanded":t.value,"aria-label":t.value?`개념 설명 닫기`:`개념 설명 보기`,title:t.value?`닫기`:`개념 설명 보기`,onClick:i[0]||=e=>t.value=!t.value},[t.value?(H(),U(`svg`,Wd,[...i[1]||=[G(`path`,{d:`M18 6 6 18M6 6l12 12`},null,-1)]])):(H(),U(`svg`,Gd,[...i[2]||=[G(`circle`,{cx:`12`,cy:`12`,r:`9.5`},null,-1),G(`path`,{d:`M12 16.5v-5`},null,-1),G(`circle`,{cx:`12`,cy:`8`,r:`1.15`,fill:`currentColor`,stroke:`none`},null,-1)]]))],10,Ud),R(G(`span`,Kd,[i[3]||=G(`span`,{class:`help-arrow`,"aria-hidden":`true`},null,-1),i[4]||=G(`span`,{class:`help-label`},`개념 설명`,-1),G(`span`,qd,O(e.text),1)],512),[[Ja,t.value]])],512))}},[[`__scopeId`,`data-v-46feb191`]]),Jd=t({default:()=>cf}),Yd={class:`practice-card`},Xd={class:`practice-area`},Zd=[`disabled`],Qd={class:`practice-area`},$d={class:`practice-area`},ef={class:`input-group`},tf={class:`practice-area`},nf={class:`practice-area`},rf=`https://vuejs.org`,af=`https://vuejs.org/images/logo.png`,of=`user-profile-card`,sf=`https://vuejs.org/images/logo.png`,cf=Q({__name:`BindPractice`,setup(e){let t=P(!0),n=P(!1),r=P(`dark-box`),i=P(`purple`),a=P(200),o={height:`80px`,color:`white`,backgroundColor:`#42b883`,transition:`all 0.3s ease`};return(e,s)=>(H(),U(`section`,Yd,[G(`div`,Xd,[G(`h2`,null,[s[4]||=q(` v-bind 디렉티브 기본 (축약형: 콜론) `,-1),K($,{text:`v-bind는 href, src, disabled 같은 HTML 속성에 JavaScript 데이터를 연결합니다. 축약형은 : 입니다.`})]),G(`a`,{href:rf,target:`_blank`},`Vue 공식 사이트`),G(`img`,{src:af,alt:`Vue 로고`,width:`80`}),G(`button`,{disabled:t.value},`잠기는 버튼`,8,Zd),G(`button`,{onClick:s[0]||=e=>t.value=!t.value},` 잠금 상태 변경 `)]),G(`div`,Qd,[G(`h2`,null,[s[5]||=q(` v-bind 디렉티브 고급 (클래스 바인딩) `,-1),K($,{text:`:class는 조건에 따라 CSS 클래스를 추가하거나 제거합니다. 객체와 배열 형식을 사용할 수 있습니다.`})]),G(`p`,{class:D({danger:n.value})},` 현재 경고 상태: `+O(n.value),3),G(`button`,{onClick:s[1]||=e=>n.value=!n.value},`경고 상태 변경`),G(`div`,{class:D([r.value,n.value?`red-border`:`gray-border`])},` 배열로 클래스를 조합한 상자 `,2)]),G(`div`,$d,[G(`h2`,null,[s[6]||=q(` v-bind 디렉티브 고급 (스타일 바인딩) `,-1),K($,{text:`:style은 색상이나 크기 같은 인라인 CSS 값을 데이터와 직접 연결합니다. 객체와 배열 형식을 지원합니다.`})]),G(`p`,{style:E({color:i.value,fontWeight:`bold`})},` 동적 스타일이 적용된 글자 `,4),G(`button`,{onClick:s[2]||=e=>i.value=i.value===`purple`?`blue`:`purple`},` 글자색 변경 `),G(`div`,ef,[s[7]||=G(`label`,{for:`box-width`},`박스 너비: `,-1),R(G(`input`,{id:`box-width`,"onUpdate:modelValue":s[3]||=e=>a.value=e,type:`number`,step:`50`},null,512),[[Z,a.value,void 0,{number:!0}]])]),G(`div`,{class:`size-box`,style:E([o,{width:a.value+`px`}])},O(a.value)+`px `,5)]),G(`div`,tf,[G(`h2`,null,[s[8]||=q(` Class Binding vs. Style Binding `,-1),K($,{text:`미리 만든 디자인을 바꿀 때는 :class, 너비처럼 값 자체를 실시간으로 바꿀 때는 :style이 적합합니다.`})]),s[9]||=G(`p`,null,[q(` 미리 만든 디자인을 상태에 따라 바꿀 때는 `),G(`strong`,null,`:class`),q(`를 사용합니다. `)],-1),s[10]||=G(`p`,null,[q(` 너비나 색상 값을 실시간으로 직접 바꿀 때는 `),G(`strong`,null,`:style`),q(`을 사용합니다. `)],-1)]),G(`div`,nf,[G(`h2`,null,[s[11]||=q(` v-bind 디렉티브 고급 (단축 문법) `,-1),K($,{text:`HTML 속성명과 JavaScript 변수명이 같으면 :src='src'를 :src처럼 줄일 수 있는 Vue 3.4 이상의 문법입니다.`})]),G(`div`,{id:of},[G(`img`,{src:sf,alt:`Vue 로고`,width:`50`})])])]))}},[[`__scopeId`,`data-v-e7a49731`]]),lf=t({default:()=>yf}),uf={class:`practice-card`},df={key:0},ff={key:1},pf={key:2,style:{color:`green`,"font-weight":`bold`}},mf={key:3,style:{color:`blue`}},hf={key:4,style:{color:`orange`}},gf={key:5,style:{color:`red`,"font-weight":`bold`}},_f={class:`box`},vf={class:`practice-area comparison-area`},yf=Q({__name:`ConditionalPractice`,setup(e){let t=P(!1),n=P(85),r=P(!0);return(e,i)=>(H(),U(`section`,uf,[G(`h2`,null,[i[3]||=q(` v-if, v-else-if, v-else 디렉티브 학습 `,-1),K($,{text:`조건에 따라 DOM 요소를 생성하거나 제거합니다. 여러 조건은 v-else-if와 v-else로 이어서 표현합니다.`})]),i[8]||=G(`h3`,null,`1) 기본 로그인 상태 스위치`,-1),t.value?(H(),U(`p`,df,`환영합니다! 회원 전용 화면입니다.`)):(H(),U(`p`,ff,`로그인이 필요합니다. 먼저 로그인해 주세요.`)),G(`button`,{onClick:i[0]||=e=>t.value=!t.value},O(t.value?`로그아웃 하기`:`로그인 하기`),1),i[9]||=G(`br`,null,null,-1),i[10]||=G(`h3`,null,`2) 성적별 학점 등급 측정 (다중 조건문)`,-1),i[11]||=G(`label`,null,`현재 점수 입력: `,-1),R(G(`input`,{"onUpdate:modelValue":i[1]||=e=>n.value=e,type:`number`,min:`0`,max:`100`,step:`5`},null,512),[[Z,n.value]]),i[12]||=G(`br`,null,null,-1),n.value>=90?(H(),U(`div`,pf,` 합격 등급: A 학점 (훌륭합니다!) `)):n.value>=80?(H(),U(`div`,mf,` 합격 등급: B 학점 (양호합니다.) `)):n.value>=70?(H(),U(`div`,hf,` 합격 등급: C 학점 (조금 더 분발하세요.) `)):(H(),U(`div`,gf,` 합격 등급: F 학점 (재시험 대상입니다.) `)),G(`h2`,null,[i[4]||=q(` v-show 디렉티브 학습 `,-1),K($,{text:`v-show는 요소를 DOM에 유지하면서 CSS display 속성으로 보이거나 숨깁니다.`})]),G(`button`,{onClick:i[2]||=e=>r.value=!r.value},` 화면 토글하기 `),i[13]||=G(`br`,null,null,-1),R(G(`div`,_f,[...i[5]||=[G(`p`,null,`v-show 상자`,-1),G(`p`,null,` 조건이 false가 되면 CSS display: none이 붙습니다. `,-1)]],512),[[Ja,r.value]]),G(`div`,vf,[G(`h2`,null,[i[6]||=q(` v-if vs. v-show `,-1),K($,{text:`전환이 드물면 DOM을 생성·제거하는 v-if, 자주 열고 닫으면 display만 바꾸는 v-show가 적합합니다.`})]),i[7]||=G(`p`,null,` v-if는 DOM을 생성·제거하고, v-show는 DOM을 유지한 채 CSS display 속성으로 표시 여부를 바꿉니다. `,-1)])]))}},[[`__scopeId`,`data-v-e3392bd5`]]),bf=t({default:()=>jf}),xf={class:`practice-card`},Sf={class:`practice-area`},Cf={class:`practice-area`},wf={class:`practice-area`},Tf=[`disabled`],Ef=[`disabled`],Df={class:`practice-area`},Of={class:`practice-area`},kf={class:`modifier-stop-area`},Af={class:`modifier-chain-area`},jf=Q({__name:`EventPractice`,setup(e){let t=P(0),n=P(``),r=P(!1),i=P(``),a=P(``),o=P(`transparent`),s=P(0),c=P(!1),l=P(0),u=P(0),d=P(0),f=()=>{window.alert(`함수가 성공적으로 호출되었습니다!`)},p=e=>{n.value=`창 좌표: X=${e.clientX}, Y=${e.clientY} / 문서 좌표: X=${e.pageX}, Y=${e.pageY}`},m=()=>{r.value||(window.addEventListener(`click`,p),r.value=!0,n.value=`좌표 확인 중: 브라우저 창 안을 클릭해 보세요.`)},h=()=>{window.removeEventListener(`click`,p),r.value=!1},g=(e,t)=>{i.value=`대상: ${e} / 클릭된 태그: ${t.target.tagName}`},_=e=>{let t=e.currentTarget.getBoundingClientRect(),n=Math.min(1,Math.max(0,(e.clientX-t.left)/t.width)),r=Math.round(n*360);s.value=n*100,o.value=`hsl(${r}, 100%, 50%)`,a.value=`무지개 바 선택 / HSL 값: hsl(${r}, 100%, 50%)`},v=e=>{c.value=!0,e.currentTarget.setPointerCapture(e.pointerId),_(e)},y=e=>{c.value&&_(e)},b=e=>{c.value&&(_(e),c.value=!1,e.currentTarget.hasPointerCapture(e.pointerId)&&e.currentTarget.releasePointerCapture(e.pointerId))},x=()=>{window.alert(`수식어 덕분에 네이버로 이동하지 않고 함수만 실행됩니다!`)},S=()=>{window.alert(`부모 박스가 클릭되었습니다!`)},C=()=>{window.alert(`1번 자식 클릭!`)},ee=()=>{window.alert(`2번 자식(나만 켜짐) 클릭!`)},te=()=>{l.value++},ne=()=>{u.value++},re=()=>{l.value=0,u.value=0,d.value++};return vr(()=>{window.removeEventListener(`click`,p)}),(e,c)=>(H(),U(`section`,xf,[G(`h2`,null,[c[2]||=q(` v-on 이벤트 핸들링 기초 `,-1),K($,{text:`v-on은 클릭이나 키보드 입력 같은 이벤트를 감지해 코드를 실행합니다. 축약형은 @입니다.`})]),G(`div`,Sf,[G(`h3`,null,[c[3]||=q(` 1) 인라인 연산 처리 `,-1),K($,{text:`Inline Handler는 count++처럼 간단한 JavaScript 표현식을 템플릿 안에서 바로 실행하는 방식입니다.`})]),G(`p`,null,`현재 카운트: `+O(t.value),1),G(`button`,{onClick:c[0]||=e=>t.value++},`1씩 증가`)]),G(`div`,Cf,[G(`h3`,null,[c[4]||=q(` 2) 스크립트 함수 호출 `,-1),K($,{text:`Method Handler는 script에 함수를 정의하고 이벤트에는 함수 이름을 연결하는 방식입니다.`})]),G(`button`,{onClick:f},`알림창 띄우기`)]),G(`div`,wf,[G(`h2`,null,[c[5]||=q(` v-on 이벤트 객체($event) 활용 `,-1),K($,{text:`함수 이름만 전달하면 이벤트 객체가 자동으로 전달됩니다. 다른 값과 이벤트 객체를 함께 넘길 때는 $event를 명시합니다.`})]),G(`p`,null,O(n.value||`좌표 확인 시작 버튼을 눌러주세요.`),1),G(`p`,null,` 현재 상태: `+O(r.value?`좌표 확인 중`:`좌표 확인 중지`),1),G(`p`,null,O(i.value||`태그: 버튼을 클릭해 보세요.`),1),G(`button`,{disabled:r.value,onClick:Ro(m,[`stop`])},` 좌표 확인 시작 `,8,Tf),G(`button`,{disabled:!r.value,onClick:Ro(h,[`stop`])},` 좌표 그만 확인하기 `,8,Ef),G(`button`,{onClick:c[1]||=e=>g(`회원A`,e)},` 회원 정보와 태그 확인 `)]),G(`div`,Df,[G(`h2`,null,[c[6]||=q(` 클릭한 색상 알아내기 `,-1),K($,{text:`색상 이름은 함수 인자로 전달하고, 실제 CSS 배경색은 $event의 currentTarget에서 읽습니다.`})]),G(`div`,{class:`rainbow-bar`,role:`button`,tabindex:`0`,"aria-label":`무지개 색상 선택`,onPointerdown:v,onPointermove:y,onPointerup:b,onPointercancel:b},[G(`span`,{class:`rainbow-marker`,style:E({left:s.value+`%`})},null,4)],32),G(`p`,null,O(a.value||`무지개 바나 색상 버튼을 클릭해 보세요.`),1),G(`div`,{class:`selected-color`,style:E({backgroundColor:o.value})},null,4)]),G(`div`,Of,[G(`h2`,null,[c[7]||=q(` 이벤트 수식어(Modifiers) 학습 `,-1),K($,{text:`이벤트 수식어는 이벤트의 기본 동작이나 전파 방식을 간단한 접미어로 제어합니다.`})]),G(`h3`,null,[c[8]||=q(` 1) .prevent (기본 동작 막기) `,-1),K($,{text:`.prevent는 preventDefault()와 같으며 링크 이동이나 폼 제출 후 새로고침 같은 기본 동작을 막습니다.`})]),G(`a`,{href:`https://www.naver.com`,onClick:Ro(x,[`prevent`])},` 네이버 링크 `),G(`div`,kf,[G(`h3`,null,[c[9]||=q(` 2) .stop (이벤트 버블링 막기) `,-1),K($,{text:`.stop은 stopPropagation()과 같으며 자식에서 발생한 이벤트가 부모로 올라가는 것을 막습니다.`})]),G(`div`,{class:`modifier-box`,onClick:S},[c[10]||=G(`p`,null,`부모 영역 (클릭 시 alert 발동)`,-1),G(`button`,{onClick:C},` 버블링 발생 버튼 `),G(`button`,{onClick:Ro(ee,[`stop`])},` 버블링 차단 버튼 `)])]),G(`div`,Af,[G(`h3`,null,[c[11]||=q(` 3) .prevent.stop.once 연결하기 `,-1),K($,{text:`첫 클릭에는 기본 동작 방지, 버블링 차단, 한 번만 실행이 함께 적용됩니다. once로 리스너가 제거된 뒤에는 나머지 수식어도 더 이상 실행되지 않습니다.`})]),G(`div`,{class:`modifier-box`,onClick:ne},[G(`p`,null,`부모 클릭 횟수: `+O(u.value),1),G(`p`,null,`자식 함수 실행 횟수: `+O(l.value),1),(H(),U(`input`,{key:d.value,type:`checkbox`,onClickOnce:Ro(te,[`prevent`,`stop`])},null,32)),c[12]||=q(` 체크박스를 클릭해 보세요. `,-1)]),c[13]||=G(`p`,{class:`modifier-guide`},` 첫 클릭은 체크되지 않고 부모 클릭도 발생하지 않으며, 자식 함수만 한 번 실행됩니다. 두 번째 클릭부터는 once로 리스너가 제거되어 체크와 부모 클릭이 다시 동작합니다. `,-1),G(`button`,{onClick:Ro(re,[`stop`])},` 연결 수식어 실습 초기화 `)])])]))}},[[`__scopeId`,`data-v-dd838579`]]),Mf=t({default:()=>Ff}),Nf={class:`practice-card`},Pf={class:`practice-area lists`},Ff=Q({__name:`ForPractice`,setup(e){let t=P([`사과`,`바나나`,`딸기`]),n=P({name:`홍길동`,age:25,role:`개발자`}),r=P([{id:`prod-101`,name:`아이폰`},{id:`prod-102`,name:`갤럭시`}]);return(e,i)=>(H(),U(`section`,Nf,[G(`h2`,null,[i[0]||=q(` v-for 디렉티브 학습 `,-1),K($,{text:`v-for는 배열이나 객체의 항목을 반복해서 화면에 출력합니다. 각 항목에는 가능한 한 고유한 :key를 지정합니다.`})]),G(`div`,Pf,[G(`div`,null,[i[1]||=G(`h3`,null,`배열 반복`,-1),G(`ul`,null,[(H(!0),U(V,null,B(t.value,(e,t)=>(H(),U(`li`,{key:e},O(t+1)+`번 과일: `+O(e),1))),128))])]),G(`div`,null,[i[2]||=G(`h3`,null,`객체 반복`,-1),G(`ul`,null,[(H(!0),U(V,null,B(n.value,(e,t,n)=>(H(),U(`li`,{key:t},` [`+O(n)+`] `+O(t)+`: `+O(e),1))),128))])]),G(`div`,null,[i[3]||=G(`h3`,null,`객체 배열 반복`,-1),G(`ul`,null,[(H(!0),U(V,null,B(r.value,e=>(H(),U(`li`,{key:e.id},O(e.name),1))),128))])])])]))}},[[`__scopeId`,`data-v-e533b99b`]]),If=t({default:()=>Uf}),Lf={class:`practice-card`},Rf={class:`practice-area`},zf={class:`practice-area`},Bf=[`innerHTML`],Vf={class:`practice-area`},Hf=`이 글자는 <span style="color: red; font-weight: bold;">빨간색 굵은 글자</span>이다.`,Uf=Q({__name:`HtmlTextPractice`,setup(e){let t=P(``),n=P(``);function r(){n.value=t.value}return(e,i)=>(H(),U(`section`,Lf,[G(`div`,Rf,[G(`h2`,null,[i[1]||=q(` v-html 디렉티브 학습 `,-1),K($,{text:`v-html은 문자열에 들어 있는 HTML 태그를 실제 HTML 요소로 해석해 출력합니다.`})]),i[2]||=G(`h3`,null,`일반 보간법 {{ }} 사용 결과:`,-1),G(`p`,null,O(Hf)),i[3]||=G(`br`,null,null,-1),i[4]||=G(`h3`,null,`v-html 디렉티브 사용 결과:`,-1),G(`p`,{innerHTML:Hf})]),G(`div`,zf,[G(`h2`,null,[i[5]||=q(` v-html XSS 학습 `,-1),K($,{text:`XSS는 악성 스크립트가 다른 사용자의 브라우저에서 실행되는 공격입니다. 사용자 입력을 v-html에 직접 연결하면 위험합니다.`})]),R(G(`input`,{"onUpdate:modelValue":i[0]||=e=>t.value=e,placeholder:`내용을 입력하세요`},null,512),[[Z,t.value]]),G(`button`,{onClick:r},`확인`),G(`div`,{innerHTML:n.value},null,8,Bf)]),i[7]||=G(`p`,{class:`warning`},` 위 코드는 XSS 위험을 확인하기 위한 학습용 예제입니다. 실제 서비스에서는 사용자 입력을 v-html로 직접 출력하지 않습니다. `,-1),G(`div`,Vf,[G(`h2`,null,[i[6]||=q(` v-text 디렉티브 학습 `,-1),K($,{text:`v-text는 값을 일반 텍스트로 출력합니다. HTML 태그가 포함되어 있어도 실제 태그로 해석하지 않습니다.`})]),G(`p`,{textContent:Hf})])]))}},[[`__scopeId`,`data-v-860fa86e`]]),Wf=t({default:()=>lp}),Gf={class:`practice-card`},Kf={class:`practice-area`},qf={class:`form-item`},Jf={class:`form-item`},Yf=[`value`],Xf={class:`practice-area`},Zf={class:`form-item`},Qf={class:`form-item`},$f={class:`form-item`},ep={class:`option-group`},tp={class:`form-item`},np={class:`option-group`},rp={class:`form-item`},ip={class:`practice-area`},ap={class:`form-item`},op={class:`form-item`},sp={class:`form-item`},cp={class:`form-item`},lp=Q({__name:`ModelPractice`,setup(e){let t=P(``),n=P(``),r=P(``),i=P(!1),a=P([]),o=P(``),s=P(``),c=P(``),l=P(``),u=P(``),d=P(``);return(e,f)=>(H(),U(`section`,Gf,[G(`div`,Kf,[G(`h2`,null,[f[14]||=q(` v-model 양방향 데이터 바인딩 `,-1),K($,{text:`v-model은 입력 요소의 값과 Vue 데이터를 연결해 한쪽이 바뀌면 다른 쪽도 자동으로 반영되게 합니다.`})]),G(`div`,qf,[f[16]||=G(`h3`,null,`1) v-model 축약 문법 (양방향)`,-1),R(G(`input`,{"onUpdate:modelValue":f[0]||=e=>t.value=e,type:`text`,placeholder:`여기에 입력하세요`},null,512),[[Z,t.value]]),G(`p`,null,[f[15]||=q(` 입력된 값: `,-1),G(`strong`,null,O(t.value),1)])]),G(`div`,Jf,[f[18]||=G(`h3`,null,`2) v-model의 내부 작동 원리 (단방향 + 이벤트)`,-1),G(`input`,{value:n.value,type:`text`,placeholder:`원리 파악용 입력창`,onInput:f[1]||=e=>n.value=e.target.value},null,40,Yf),G(`p`,null,[f[17]||=q(` 입력된 값: `,-1),G(`strong`,null,O(n.value),1)])])]),G(`div`,Xf,[G(`h2`,null,[f[19]||=q(` 모든 HTML Form 요소와 v-model 매핑 `,-1),K($,{text:`Form 요소마다 v-model이 저장하는 값의 형태가 다릅니다. 단일 체크박스는 Boolean, 다중 체크박스는 Array로 시작합니다.`})]),G(`div`,Zf,[f[20]||=G(`h3`,null,`1) Textarea (장문 텍스트)`,-1),R(G(`textarea`,{"onUpdate:modelValue":f[2]||=e=>r.value=e,placeholder:`의견을 남겨주세요`},null,512),[[Z,r.value]]),G(`p`,null,`데이터 상태: `+O(r.value),1)]),G(`div`,Qf,[f[22]||=G(`h3`,null,`2) 단일 Checkbox (동의 여부)`,-1),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[3]||=e=>i.value=e,type:`checkbox`},null,512),[[ko,i.value]]),f[21]||=q(` 약관에 동의합니다. `,-1)]),G(`p`,null,`데이터 상태: `+O(i.value),1)]),G(`div`,$f,[f[26]||=G(`h3`,null,`3) 다중 Checkbox (복수 선택 → 배열에 저장)`,-1),G(`div`,ep,[G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[4]||=e=>a.value=e,type:`checkbox`,value:`사과`},null,512),[[ko,a.value]]),f[23]||=q(` 사과 `,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[5]||=e=>a.value=e,type:`checkbox`,value:`바나나`},null,512),[[ko,a.value]]),f[24]||=q(` 바나나 `,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[6]||=e=>a.value=e,type:`checkbox`,value:`딸기`},null,512),[[ko,a.value]]),f[25]||=q(` 딸기 `,-1)])]),G(`p`,null,`데이터 상태 (배열): `+O(a.value),1)]),G(`div`,tp,[f[29]||=G(`h3`,null,`4) Radio (단일 선택)`,-1),G(`div`,np,[G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[7]||=e=>o.value=e,type:`radio`,value:`남성`},null,512),[[jo,o.value]]),f[27]||=q(` 남성 `,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":f[8]||=e=>o.value=e,type:`radio`,value:`여성`},null,512),[[jo,o.value]]),f[28]||=q(` 여성 `,-1)])]),G(`p`,null,`데이터 상태: `+O(o.value),1)]),G(`div`,rp,[f[31]||=G(`h3`,null,`5) Select (드롭다운 선택)`,-1),R(G(`select`,{"onUpdate:modelValue":f[9]||=e=>s.value=e},[...f[30]||=[G(`option`,{value:``},`-- 선택하세요 --`,-1),G(`option`,{value:`tesla`},`테슬라`,-1),G(`option`,{value:`hyundai`},`현대자동차`,-1),G(`option`,{value:`bmw`},`BMW`,-1)]],512),[[Mo,s.value]]),G(`p`,null,`데이터 상태: `+O(s.value),1)])]),G(`div`,ip,[G(`h2`,null,[f[32]||=q(` v-model 수식어(Modifiers) 활용 `,-1),K($,{text:`v-model 수식어는 값의 반영 시점이나 저장 형태를 간단히 제어합니다. .lazy, .number, .trim을 단독 또는 연결해서 사용할 수 있습니다.`})]),G(`div`,ap,[f[34]||=G(`h3`,null,`1) .lazy 수식어 (change 이벤트 시점 반영)`,-1),R(G(`input`,{"onUpdate:modelValue":f[10]||=e=>c.value=e,type:`text`,placeholder:`입력 후 Enter 또는 외부 클릭`},null,512),[[Z,c.value,void 0,{lazy:!0}]]),G(`p`,null,[f[33]||=q(` 실시간이 아닌 확정된 값: `,-1),G(`strong`,null,O(c.value),1)])]),G(`div`,op,[f[37]||=G(`h3`,null,`2) .number 수식어 (Number 타입 자동 형변환)`,-1),R(G(`input`,{"onUpdate:modelValue":f[11]||=e=>l.value=e,type:`text`,placeholder:`나이를 입력하세요`},null,512),[[Z,l.value,void 0,{number:!0}]]),G(`p`,null,[f[35]||=q(` 입력된 값: `,-1),G(`strong`,null,O(l.value),1)]),G(`p`,null,[f[36]||=q(` 데이터 타입: `,-1),G(`strong`,null,O(typeof l.value),1)])]),G(`div`,sp,[f[40]||=G(`h3`,null,`3) .trim 수식어 (양끝 공백 자동 제거)`,-1),R(G(`input`,{"onUpdate:modelValue":f[12]||=e=>u.value=e,type:`text`,placeholder:`앞뒤 공백을 포함해 입력해 보세요`},null,512),[[Z,u.value,void 0,{trim:!0}]]),G(`p`,null,[f[38]||=q(` 공백 제거된 값: `,-1),G(`strong`,null,`"`+O(u.value)+`"`,1)]),G(`p`,null,[f[39]||=q(` 문자열 길이: `,-1),G(`strong`,null,O(u.value.length),1)])]),G(`div`,cp,[f[43]||=G(`h3`,null,`4) Chaining (수식어 체이닝: .trim.number)`,-1),R(G(`input`,{"onUpdate:modelValue":f[13]||=e=>d.value=e,type:`text`,placeholder:`공백과 숫자를 섞어 입력해 보세요`},null,512),[[Z,d.value,void 0,{trim:!0,number:!0}]]),G(`p`,null,[f[41]||=q(` 처리된 값: `,-1),G(`strong`,null,`"`+O(d.value)+`"`,1)]),G(`p`,null,[f[42]||=q(` 데이터 타입: `,-1),G(`strong`,null,O(typeof d.value),1)])])])]))}},[[`__scopeId`,`data-v-208c25e3`]]),up=t({default:()=>fp}),dp={class:`practice-card`},fp={__name:`ReactivityPractice`,setup(e){let t=0,n=P(0),r=P(`hello vue`);return(e,i)=>(H(),U(`section`,dp,[G(`h2`,null,[i[2]||=q(` 실습 1 — Reactivity와 보간법 `,-1),K($,{text:`Reactivity는 데이터가 바뀌면 화면도 자동으로 갱신되는 특성이고, 보간법은 {{ }} 안의 값이나 표현식을 화면에 출력하는 문법입니다.`})]),G(`div`,null,[G(`p`,null,`일반 변수: `+O(F(t)),1),G(`button`,{onClick:i[0]||=e=>N(t)?t.value++:t++},`일반 변수 증가`),G(`p`,null,`반응형 변수: `+O(n.value),1),G(`button`,{onClick:i[1]||=e=>n.value++},`반응형 변수 증가`)]),G(`div`,null,[G(`p`,null,`원래 문자열: `+O(r.value),1),G(`p`,null,`대문자 변환: `+O(r.value.toUpperCase()),1),G(`p`,null,O(`Random number: `+Math.ceil(Math.random()*100)),1)])]))}},pp=t({default:()=>bp}),mp={class:`practice-card`},hp={class:`practice-area`},gp={class:`practice-area`},_p={class:`practice-area`},vp={class:`practice-area`},yp={class:`button-group`},bp=Q({__name:`SpecialDirectivePractice`,setup(e){let t=P(`안녕하세요!`),n=P(1),r=P(`홍길동`),i=P(20);return(e,a)=>(H(),U(`section`,mp,[G(`div`,hp,[G(`h2`,null,[a[5]||=q(` v-pre 디렉티브 학습 `,-1),K($,{text:`v-pre는 해당 요소와 자식의 Vue 문법을 해석하지 않고 작성된 내용을 그대로 표시합니다.`})]),G(`p`,null,`일반 출력: `+O(t.value),1),a[6]||=G(`p`,null,`v-pre 출력: {{ message }}`,-1)]),G(`div`,gp,[G(`h2`,null,[a[7]||=q(` v-cloak 디렉티브 학습 `,-1),K($,{text:`v-cloak은 Vue가 준비되기 전에 {{ message }} 같은 템플릿 원문이 잠깐 보이는 것을 CSS와 함께 방지합니다.`})]),G(`p`,null,`Vue가 준비되면 표시: `+O(t.value),1)]),G(`div`,_p,[G(`h2`,null,[a[8]||=q(` v-once 디렉티브 학습 `,-1),K($,{text:`v-once는 최초 한 번만 렌더링하고 이후 데이터가 변경되어도 해당 화면을 갱신하지 않습니다.`})]),G(`p`,null,`일반 값: `+O(n.value),1),a[0]||(Zi(-1,!0),(a[0]=G(`p`,null,[q(`최초 값으로 고정: `+O(n.value),1)])).cacheIndex=0,Zi(1),a[0]),G(`button`,{onClick:a[1]||=e=>n.value++},`숫자 증가`)]),G(`div`,vp,[G(`h2`,null,[a[9]||=q(` v-memo 디렉티브 학습 `,-1),K($,{text:`v-memo는 지정한 의존성이 바뀔 때만 영역을 다시 렌더링합니다. 큰 목록 등 실제 성능 문제가 있는 경우에 제한적으로 사용합니다.`})]),Na([r.value,i.value],()=>(H(),U(`div`,{class:`memo-box`},[G(`p`,null,`이름: `+O(r.value),1),G(`p`,null,`나이: `+O(i.value),1)])),a,2),G(`div`,yp,[G(`button`,{onClick:a[3]||=e=>r.value=r.value===`홍길동`?`이순신`:`홍길동`},` 이름 변경 `),G(`button`,{onClick:a[4]||=e=>i.value++},`나이 증가`)])])]))}},[[`__scopeId`,`data-v-0ad0fb48`]]),xp={type:`button`,class:`base-button`},Sp=Q({__name:`BaseButton`,props:{label:{type:String,default:`기본 버튼`}},setup(e){return(t,n)=>(H(),U(`button`,xp,O(e.label),1))}},[[`__scopeId`,`data-v-2e39ae80`]]),Cp=t({default:()=>kp}),wp={class:`practice-card`},Tp={class:`practice-area`},Ep={class:`row`},Dp={class:`practice-area`},Op={class:`row`},kp=Q({__name:`ComponentRegistrationPractice`,setup(e){return(e,t)=>{let n=wr(`GlobalBadge`);return H(),U(`section`,wp,[G(`h2`,null,[t[0]||=q(` Component 등록 — 지역 vs 전역 `,-1),K($,{text:`지역 등록은 쓰는 파일에서 import 하는 방식이라 어디서 쓰는지 코드로 드러납니다. 전역 등록은 main.js에서 app.component()로 한 번만 해두면 어디서든 import 없이 쓸 수 있지만, 안 쓰는 컴포넌트까지 번들에 들어갑니다.`})]),G(`div`,Tp,[t[1]||=G(`h3`,null,`1) 지역(Local) 등록 — import 한 줄이 등록`,-1),t[2]||=G(`p`,{class:`explain`},[q(` 아래 두 버튼은 `),G(`b`,null,`같은 컴포넌트`),q(`입니다. 등록한 컴포넌트는 PascalCase와 kebab-case 두 가지로 부를 수 있습니다. `)],-1),G(`div`,Ep,[K(Sp,{label:`PascalCase 호출`}),K(Sp,{label:`kebab-case 호출`})]),t[3]||=G(`pre`,{class:`code`},`import BaseButton from './BaseButton.vue'

<BaseButton />
<base-button></base-button>`,-1)]),G(`div`,Dp,[t[4]||=G(`h3`,null,`2) 전역(Global) 등록 — import가 없다`,-1),t[5]||=G(`p`,{class:`explain`},[q(` 아래 배지는 이 파일에서 `),G(`b`,null,`import 하지 않았습니다.`),q(` main.js에서 한 번 등록해 둔 덕분에 바로 쓸 수 있습니다. `)],-1),G(`div`,Op,[K(n),K(n,{text:`어디서든 사용 가능`})]),t[6]||=G(`pre`,{class:`code`},`// main.js
app.component('GlobalBadge', GlobalBadge)

// 이 파일 — import 없이 바로
<GlobalBadge />`,-1)]),t[7]||=oa(`<div class="practice-area" data-v-369125df><h3 data-v-369125df>3) 언제 무엇을 쓸까</h3><table class="compare" data-v-369125df><thead data-v-369125df><tr data-v-369125df><th data-v-369125df></th><th data-v-369125df>지역 등록</th><th data-v-369125df>전역 등록</th></tr></thead><tbody data-v-369125df><tr data-v-369125df><td data-v-369125df>등록 위치</td><td data-v-369125df>쓰는 파일에서 import</td><td data-v-369125df>main.js 한 곳</td></tr><tr data-v-369125df><td data-v-369125df>사용 범위</td><td data-v-369125df>그 파일 안에서만</td><td data-v-369125df>앱 전체</td></tr><tr data-v-369125df><td data-v-369125df>의존 관계</td><td data-v-369125df>코드에 드러남</td><td data-v-369125df>어디서 왔는지 안 보임</td></tr><tr data-v-369125df><td data-v-369125df>번들 크기</td><td data-v-369125df>쓰는 것만 포함</td><td data-v-369125df>안 써도 포함</td></tr><tr data-v-369125df><td data-v-369125df>적합한 경우</td><td data-v-369125df><b data-v-369125df>대부분의 컴포넌트</b></td><td data-v-369125df>앱 전반에서 반복되는 소수</td></tr></tbody></table></div>`,1)])}}},[[`__scopeId`,`data-v-369125df`]]),Ap={class:`counter-display`},jp=Q({__name:`LifecycleChild`,setup(e){let t=P(0),n=null;return console.log(`1. [setup] 컴포넌트가 메모리에 생성되었습니다. (DOM 접근 불가능)`),mr(()=>{console.log(`2. [onMounted] 화면에 완벽히 부착되었습니다! (API 호출/DOM 조작 적기)`),n=setInterval(()=>{t.value++},3e3)}),gr(()=>{console.log(`3. [onUpdated] 데이터가 변경되어 화면을 새로 그렸습니다. (현재 count: ${t.value})`)}),vr(()=>{clearInterval(n),console.log(`4. [onUnmounted] 컴포넌트가 소멸했습니다. 타이머 청소 완료!`)}),(e,n)=>(H(),U(V,null,[n[1]||=G(`h3`,null,`⏱️ 라이프사이클 훅 흐름 탐색기`,-1),G(`div`,Ap,[G(`p`,null,`실시간 타이머 카운트: `+O(t.value),1),G(`button`,{onClick:n[0]||=e=>t.value++},`수동으로 숫자 올리기`)])],64))}},[[`__scopeId`,`data-v-4c2f5f04`]]),Mp=t({default:()=>Fp}),Np={class:`practice-card`},Pp={key:1,class:`gone`},Fp=Q({__name:`LifecyclePractice`,setup(e){let t=P(!0);return(e,n)=>(H(),U(`section`,Np,[G(`h2`,null,[n[1]||=q(` Lifecycle Hook — 생성부터 소멸까지 `,-1),K($,{text:`컴포넌트는 생성 → 부착(mount) → 갱신(update) → 소멸(unmount)의 생애를 거칩니다. 각 시점에 Vue가 불러주는 함수가 Lifecycle Hook입니다. 브라우저 콘솔(F12)을 열고 아래 버튼으로 컴포넌트를 껐다 켜면 네 단계가 순서대로 찍힙니다.`})]),n[2]||=G(`p`,{class:`hint`},`브라우저 콘솔(F12)을 열어두고 버튼을 눌러 보세요.`,-1),G(`button`,{class:`toggle-btn`,onClick:n[0]||=e=>t.value=!t.value},O(t.value?`🛑 실습 컴포넌트 파괴하기 (v-if="false")`:`🟢 실습 컴포넌트 다시 살리기`),1),n[3]||=G(`hr`,null,null,-1),t.value?(H(),W(jp,{key:0})):(H(),U(`p`,Pp,`컴포넌트가 소멸했습니다. 콘솔에서 타이머 정리 로그를 확인해 보세요.`))]))}},[[`__scopeId`,`data-v-d955f165`]]),Ip={class:`child-container`},Lp=Q({__name:`PropsEmitsChild`,props:{parentData:{type:String,required:!0}},emits:[`update-request`],setup(e,{emit:t}){let n=t,r=()=>{n(`update-request`,`Child에서 가공한 새로운 데이터`)};return(t,n)=>(H(),U(`div`,Ip,[n[1]||=G(`p`,{class:`role`},`하위 컴포넌트 (Child)`,-1),G(`p`,null,[n[0]||=q(` 수신된 Props 데이터: `,-1),G(`strong`,null,O(e.parentData),1)]),G(`button`,{onClick:r},`상위 컴포넌트로 갱신 요청 (Emit)`)]))}},[[`__scopeId`,`data-v-e98cd097`]]),Rp=t({default:()=>Hp}),zp={class:`practice-card`},Bp={class:`parent-container`},Vp={class:`state`},Hp=Q({__name:`PropsEmitsPractice`,setup(e){let t=P(`Parent 초기 메시지`),n=e=>{t.value=e};return(e,r)=>(H(),U(`section`,zp,[G(`h2`,null,[r[0]||=q(` Props & Emits — 부모와 자식의 대화 `,-1),K($,{text:`데이터는 부모 → 자식 한 방향으로만 흐릅니다(Props). 자식이 값을 바꾸고 싶으면 직접 고치지 않고 부모에게 '바꿔 달라'고 신호를 보냅니다(Emits). 실제로 값을 바꾸는 주체는 언제나 데이터를 가진 부모입니다.`})]),G(`div`,Bp,[r[2]||=G(`p`,{class:`role`},`상위 컴포넌트 (Parent)`,-1),G(`p`,Vp,[r[1]||=q(` 현재 로컬 데이터(State): `,-1),G(`strong`,null,O(t.value),1)]),K(Lp,{"parent-data":t.value,onUpdateRequest:n},null,8,[`parent-data`])])]))}},[[`__scopeId`,`data-v-cfac9a78`]]),Up={class:`node child`},Wp={class:`field`},Gp={class:`val`},Kp=Q({__name:`FlowChild`,props:{message:{type:String,required:!0}},emits:[`reply`],setup(e,{emit:t}){let n=t;return(t,r)=>(H(),U(`div`,Up,[r[2]||=G(`p`,{class:`node-role`},`자식 (Child)`,-1),G(`p`,Wp,[r[1]||=G(`span`,{class:`key`},`props.message`,-1),G(`span`,Gp,O(e.message||`(빈 값)`),1)]),G(`button`,{onClick:r[0]||=e=>n(`reply`,`자식이 보낸 인사 👋`)},` 부모에게 신호 보내기 (emit) `)]))}},[[`__scopeId`,`data-v-8ceed664`]]),qp=t({default:()=>am}),Jp={class:`practice-card`},Yp={class:`flow`},Xp={class:`node parent`},Zp={class:`field`},Qp=[`value`],$p={class:`field`},em={class:`val`},tm={class:`arrows`},nm={class:`log`},rm={key:0,class:`log-empty`},im={class:`log-dir`},am=Q({__name:`PropsFlowPractice`,setup(e){let t=P(`안녕하세요`),n=P(`아직 없음`),r=P(null),i=P([]),a=e=>{r.value=e,setTimeout(()=>{r.value===e&&(r.value=null)},700)},o=(e,t)=>{i.value.unshift({dir:e,text:t}),i.value.length>6&&i.value.pop()},s=e=>{t.value=e.target.value,a(`down`),o(`down`,`props.message = "${t.value}"`)},c=e=>{n.value=e,a(`up`),o(`up`,`emit('reply', "${e}")`)};return(e,a)=>(H(),U(`section`,Jp,[G(`h2`,null,[a[0]||=q(` 데이터는 어느 쪽으로 흐르나 — Props ↓ / Emits ↑ `,-1),K($,{text:`Props는 부모에서 자식으로 내려가고(↓), Emits는 자식에서 부모로 올라갑니다(↑). 반대 방향은 없습니다. 아래에서 입력하거나 버튼을 누르면 그 순간 어느 화살표가 켜지는지 확인해 보세요.`})]),G(`div`,Yp,[G(`div`,Xp,[a[3]||=G(`p`,{class:`node-role`},`부모 (Parent)`,-1),G(`label`,Zp,[a[1]||=G(`span`,{class:`key`},`message`,-1),G(`input`,{value:t.value,type:`text`,onInput:s},null,40,Qp)]),G(`p`,$p,[a[2]||=G(`span`,{class:`key`},`받은 신호`,-1),G(`span`,em,O(n.value),1)])]),G(`div`,tm,[G(`div`,{class:D([`arrow down`,{on:r.value===`down`}])},[...a[4]||=[G(`span`,{class:`head`},`↓`,-1),G(`span`,{class:`tag`},`props`,-1)]],2),G(`div`,{class:D([`arrow up`,{on:r.value===`up`}])},[...a[5]||=[G(`span`,{class:`head`},`↑`,-1),G(`span`,{class:`tag`},`emits`,-1)]],2)]),K(Kp,{message:t.value,onReply:c},null,8,[`message`])]),G(`div`,nm,[a[6]||=G(`p`,{class:`log-title`},`주고받은 기록`,-1),i.value.length?J(``,!0):(H(),U(`p`,rm,`입력하거나 버튼을 눌러 보세요.`)),(H(!0),U(V,null,B(i.value,(e,t)=>(H(),U(`p`,{key:t,class:D([`log-row`,e.dir])},[G(`span`,im,O(e.dir===`down`?`↓ 내려감`:`↑ 올라감`),1),G(`code`,null,O(e.text),1)],2))),128))])]))}},[[`__scopeId`,`data-v-f9dc9376`]]),om={class:`child`},sm={class:`field`},cm={class:`val`},lm=Q({__name:`ReadonlyChild`,props:{count:{type:Number,required:!0}},emits:[`increase`],setup(e,{emit:t}){let n=e,r=t,i=P(``),a=()=>{let e=n.count;try{n.count=e+1}catch{}i.value=n.count===e?`실패 — 값은 그대로 ${n.count} 입니다. (콘솔 경고 확인)`:`어라, 바뀌었습니다: ${n.count}`},o=()=>{r(`increase`),i.value=`성공 — 부모가 값을 바꿔 주었습니다.`};return(t,n)=>(H(),U(`div`,om,[n[1]||=G(`p`,{class:`node-role`},`자식 (Child)`,-1),G(`p`,sm,[n[0]||=G(`span`,{class:`key`},`props.count`,-1),G(`span`,cm,O(e.count),1)]),G(`div`,{class:`buttons`},[G(`button`,{class:`bad`,onClick:a},`❌ 직접 바꾸기 (props.count++)`),G(`button`,{class:`good`,onClick:o},`✅ 부모에게 요청 (emit)`)]),i.value?(H(),U(`p`,{key:0,class:D([`result`,{fail:i.value.startsWith(`실패`)}])},O(i.value),3)):J(``,!0)]))}},[[`__scopeId`,`data-v-d711a9c2`]]),um=t({default:()=>hm}),dm={class:`practice-card`},fm={class:`parent`},pm={class:`field`},mm={class:`val`},hm=Q({__name:`PropsReadonlyPractice`,setup(e){let t=P(0),n=()=>{t.value++};return(e,r)=>(H(),U(`section`,dm,[G(`h2`,null,[r[0]||=q(` Props는 읽기 전용 — 값의 주인은 부모다 `,-1),K($,{text:`자식이 받은 Props를 직접 바꾸면 Vue가 막습니다. 값이 어디서 바뀌었는지 추적할 수 없게 되기 때문입니다. 자식은 '바꿔 달라'고 요청(emit)하고, 실제로 바꾸는 것은 값을 가진 부모입니다.`})]),G(`div`,fm,[r[2]||=G(`p`,{class:`node-role`},`부모 (Parent) — 값의 주인`,-1),G(`p`,pm,[r[1]||=G(`span`,{class:`key`},`count`,-1),G(`span`,mm,O(t.value),1)]),K(lm,{count:t.value,onIncrease:n},null,8,[`count`])]),r[3]||=G(`p`,{class:`hint`},[q(` 브라우저 콘솔(F12)을 열고 ❌ 버튼을 누르면 `),G(`code`,null,`Set operation on key "count" failed: target is readonly`),q(` 경고가 찍힙니다. `)],-1)]))}},[[`__scopeId`,`data-v-24c24705`]]),gm={class:`named`},_m={class:`value`},vm=Q({__name:`DrillLeaf`,props:{theme:{type:String,required:!0}},setup(e){return(t,n)=>(H(),U(`div`,{class:D([`level`,e.theme])},[n[1]||=G(`p`,{class:`role`},`자식 (Child)`,-1),G(`p`,gm,[n[0]||=G(`span`,{class:`name`},`props.theme :`,-1),G(`span`,_m,O(e.theme),1)])],2))}},[[`__scopeId`,`data-v-54c3d013`]]),ym={class:`data`},bm=Q({__name:`DrillMid`,props:{theme:{type:String,required:!0}},setup(e){let t=e,n=P(!1);return z(()=>t.theme,()=>{n.value=!0,setTimeout(()=>n.value=!1,900)}),(t,r)=>(H(),U(`div`,{class:D([`level`,{passing:n.value}])},[r[1]||=G(`p`,{class:`role`},`부모 (Parent)`,-1),G(`p`,{class:D([`hold`,{passing:n.value}])},[r[0]||=G(`span`,{class:`name`},`props.theme :`,-1),G(`span`,ym,O(e.theme),1)],2),r[2]||=G(`p`,{class:`desc`},`😩 쓰지도 않는 값을 받아서 아래로 넘긴다`,-1),K(vm,{theme:e.theme},null,8,[`theme`])],2))}},[[`__scopeId`,`data-v-803c609f`]]),xm={class:`named`},Sm={class:`value`},Cm=Q({__name:`InjectLeaf`,setup(e){let t=jn(`globalTheme`,`(주입된 값 없음)`);return(e,n)=>(H(),U(`div`,{class:D([`level`,F(t)])},[n[1]||=G(`p`,{class:`role`},`자식 (Child)`,-1),G(`p`,xm,[n[0]||=G(`span`,{class:`name`},`inject('globalTheme') :`,-1),G(`span`,Sm,O(F(t)),1)])],2))}},[[`__scopeId`,`data-v-79d6cd3e`]]),wm={class:`level`},Tm=Q({__name:`InjectMid`,setup(e){return(e,t)=>(H(),U(`div`,wm,[t[0]||=oa(`<p class="role" data-v-c476208c>부모 (Parent)</p><p class="hold" data-v-c476208c><span class="name" data-v-c476208c>props :</span><span class="none" data-v-c476208c>없음 (0개)</span></p><p class="desc" data-v-c476208c>😌 값이 지나가는지도 모른다. 조용하다.</p>`,3),K(Cm)]))}},[[`__scopeId`,`data-v-c476208c`]]),Em=t({default:()=>Pm}),Dm={class:`practice-card`},Om={class:`root`},km={class:`field`},Am={class:`val`},jm={class:`compare`},Mm={class:`col`},Nm={class:`col`},Pm=Q({__name:`ProvideInjectPractice`,setup(e){let t=P(`dark-mode`);An(`globalTheme`,t);let n=()=>{t.value=t.value===`dark-mode`?`light-mode`:`dark-mode`};return(e,r)=>(H(),U(`section`,Dm,[G(`h2`,null,[r[0]||=q(` Provide & Inject — 중간을 건너뛰고 전달하기 `,-1),K($,{text:`계층이 깊어지면 중간 컴포넌트들이 자기는 쓰지도 않는 값을 받아서 아래로 넘기기만 하는 일이 생깁니다(Props Drilling). provide/inject는 그 중간을 건너뛰고 조상이 선언한 값을 후손이 직접 꺼내 쓰게 해 줍니다.`})]),G(`div`,Om,[r[6]||=G(`p`,{class:`root-role`},`조부모 (GrandParent) — 값의 주인`,-1),G(`p`,km,[r[1]||=G(`span`,{class:`key`},`themeColor :`,-1),G(`span`,Am,O(t.value),1),G(`button`,{onClick:n},`테마 바꾸기`)]),G(`div`,jm,[G(`div`,Mm,[r[2]||=G(`p`,{class:`col-title bad`},`A · Props Drilling`,-1),r[3]||=G(`p`,{class:`col-desc`},[q(`값이 `),G(`b`,null,`중간을 통과해`),q(` 내려갑니다.`)],-1),K(bm,{theme:t.value},null,8,[`theme`])]),G(`div`,Nm,[r[4]||=G(`p`,{class:`col-title good`},`B · Provide / Inject`,-1),r[5]||=G(`p`,{class:`col-desc`},[q(`값이 `),G(`b`,null,`중간을 건너뛰고`),q(` 바로 갑니다.`)],-1),K(Tm)])])]),r[7]||=G(`p`,{class:`footnote`},[q(` 버튼을 누를 때 `),G(`b`,null,`A의 중간 카드만 번쩍이는지`),q(` 보세요. 값이 그곳을 지나간다는 뜻입니다. 여기는 조부모 → 부모 → 자식 3단계라 차이가 작아 보이지만, 10단계쯤 되면 A는 중간 8곳을 전부 고쳐야 합니다. `)],-1)]))}},[[`__scopeId`,`data-v-8bf7e4c2`]]),Fm={class:`sibling`},Im={class:`buttons`},Lm=[`onClick`],Rm=Q({__name:`SiblingA`,emits:[`send`],setup(e,{emit:t}){let n=t,r=[`안녕!`,`점심 먹었어?`,`과제 다 했어?`];return(e,t)=>(H(),U(`div`,Fm,[t[0]||=G(`p`,{class:`node-role`},`형제 A (보내는 쪽)`,-1),t[1]||=G(`p`,{class:`desc`},`누르면 부모에게 올려보냅니다(emit).`,-1),G(`div`,Im,[(H(),U(V,null,B(r,e=>G(`button`,{key:e,onClick:t=>n(`send`,e)},O(e),9,Lm)),64))])]))}},[[`__scopeId`,`data-v-6a5f088d`]]),zm={class:`sibling`},Bm=Q({__name:`SiblingB`,props:{received:{type:String,default:``}},setup(e){return(t,n)=>(H(),U(`div`,zm,[n[0]||=G(`p`,{class:`node-role`},`형제 B (받는 쪽)`,-1),n[1]||=G(`p`,{class:`desc`},`부모가 내려준 값(props)만 볼 수 있습니다.`,-1),G(`p`,{class:D([`bubble`,{empty:!e.received}])},O(e.received||`아직 받은 말이 없습니다`),3)]))}},[[`__scopeId`,`data-v-c96b2e77`]]),Vm=t({default:()=>Km}),Hm={class:`practice-card`},Um={class:`parent`},Wm={class:`route`},Gm={class:`siblings`},Km=Q({__name:`SiblingTalkPractice`,setup(e){let t=P(``),n=P(0),r=e=>{n.value=1,setTimeout(()=>{t.value=e,n.value=2,setTimeout(()=>n.value=0,900)},450)};return(e,i)=>(H(),U(`section`,Hm,[G(`h2`,null,[i[0]||=q(` 형제끼리는 부모를 거쳐야 한다 `,-1),K($,{text:`같은 부모 아래 나란히 있는 컴포넌트끼리는 직접 연결된 선이 없습니다. A가 B에게 말하려면 반드시 부모에게 올렸다가(emit) 부모가 다시 B에게 내려줘야(props) 합니다. 부모를 거치는 이 경로가 눈에 보이도록 만들었습니다.`})]),G(`div`,Um,[i[2]||=G(`p`,{class:`node-role`},`부모 (Parent) — 중계자`,-1),G(`div`,Wm,[G(`span`,{class:D([`leg up`,{on:n.value>=1}])},`① A → 부모 \xA0emit`,2),G(`span`,{class:D([`leg down`,{on:n.value>=2}])},`② 부모 → B \xA0props`,2)]),G(`div`,Gm,[K(Rm,{onSend:r}),i[1]||=G(`span`,{class:`cut`,"aria-hidden":`true`},`✕ 직접 연결 없음`,-1),K(Bm,{received:t.value},null,8,[`received`])])])]))}},[[`__scopeId`,`data-v-9ac8d55d`]]),qm={class:`base-card`},Jm={class:`slot-zone head`},Ym={class:`slot-zone body`},Xm={class:`slot-zone foot`},Zm=Q({__name:`SlotBaseCard`,setup(e){return(e,t)=>(H(),U(`div`,qm,[G(`div`,Jm,[kr(e.$slots,`header`,{},()=>[t[0]||=G(`span`,{class:`fallback`},`header 구멍 (비어 있음)`,-1)],!0)]),G(`div`,Ym,[kr(e.$slots,`default`,{},()=>[t[1]||=G(`span`,{class:`fallback`},`기본 구멍 (비어 있음)`,-1)],!0)]),G(`div`,Xm,[kr(e.$slots,`footer`,{},()=>[t[2]||=G(`span`,{class:`fallback`},`footer 구멍 (비어 있음)`,-1)],!0)])]))}},[[`__scopeId`,`data-v-fa66589e`]]),Qm=t({default:()=>ih}),$m={class:`practice-card`},eh={class:`deck`},th={class:`case`},nh={class:`case`},rh={class:`case`},ih=Q({__name:`SlotBaseCardPractice`,setup(e){return(e,t)=>(H(),U(`section`,$m,[G(`h2`,null,[t[0]||=q(` 더해보기 ① BaseCard 하나로 화면 3개 `,-1),K($,{text:`아래 세 카드는 전부 같은 SlotBaseCard.vue 파일입니다. 테두리·모서리·구분선이 똑같은 이유죠. 다른 것은 부모가 header·body·footer 세 구멍에 무엇을 넣었는지뿐입니다. 껍데기를 한 번만 만들어 두고 화면마다 알맹이만 갈아 끼우는 것이 Slot의 목적입니다.`})]),t[9]||=G(`p`,{class:`explain`},[q(` 세 카드 모두 `),G(`b`,null,`같은 파일`),q(`입니다. 껍데기를 고치고 싶으면 `),G(`code`,null,`SlotBaseCard.vue`),q(` 한 곳만 고치면 세 개가 동시에 바뀝니다. `)],-1),G(`div`,eh,[G(`div`,th,[t[4]||=G(`p`,{class:`case-label`},`구멍 3개 모두 채움`,-1),K(Zm,null,{header:L(()=>[...t[1]||=[G(`b`,null,`주간 리포트`,-1)]]),footer:L(()=>[...t[2]||=[G(`button`,{type:`button`},`자세히`,-1)]]),default:L(()=>[t[3]||=G(`p`,{class:`line`},`이번 주 방문자가 12% 늘었습니다.`,-1)]),_:1})]),G(`div`,nh,[t[7]||=G(`p`,{class:`case-label`},`footer만 비움`,-1),K(Zm,null,{header:L(()=>[...t[5]||=[G(`b`,null,`공지`,-1)]]),default:L(()=>[t[6]||=G(`p`,{class:`line`},`금요일 18시에 배포가 있습니다.`,-1)]),_:1})]),G(`div`,rh,[t[8]||=G(`p`,{class:`case-label`},`아무것도 안 채움`,-1),K(Zm)])]),t[10]||=oa(`<div class="verdict" data-v-1f455799><p class="verdict-title" data-v-1f455799>그럼 Props로 하면 안 되나?</p><div class="verdict-grid" data-v-1f455799><div class="side bad" data-v-1f455799><p class="side-head" data-v-1f455799>❌ Props로 시도</p><pre data-v-1f455799><code data-v-1f455799>&lt;BaseCard title=&quot;주간 리포트&quot; /&gt;</code></pre><p class="side-why" data-v-1f455799> 제목 <b data-v-1f455799>글자</b>는 넘길 수 있습니다. 그런데 위 첫 카드의 footer에는 <b data-v-1f455799>&lt;button&gt; 태그</b>가 들어 있습니다. Props로 버튼을 넘기려면 문자열로 <code data-v-1f455799>&quot;&lt;button&gt;&quot;</code>을 보내야 하는데, 그건 화면이 아니라 그냥 글자입니다. </p></div><div class="side good" data-v-1f455799><p class="side-head" data-v-1f455799>✅ Slot이어야만 하는 이유</p><pre data-v-1f455799><code data-v-1f455799>&lt;template #footer&gt;
  &lt;button @click=&quot;...&quot;&gt;자세히&lt;/button&gt;
&lt;/template&gt;</code></pre><p class="side-why" data-v-1f455799><b data-v-1f455799>태그·이벤트·컴포넌트</b>가 통째로 들어갑니다. 넘기는 것이 값이 아니라 화면 조각이기 때문입니다. <b data-v-1f455799>버튼 하나만 들어가도 Props로는 안 됩니다.</b></p></div></div></div>`,1)]))}},[[`__scopeId`,`data-v-1f455799`]]),ah={class:`list`},oh={class:`fallback`},sh=Q({__name:`SlotItemList`,setup(e){let t=P([{id:1,name:`노트북 거치대`,price:32e3,stock:12},{id:2,name:`기계식 키보드`,price:89e3,stock:0},{id:3,name:`USB-C 허브`,price:45e3,stock:3}]);return(e,n)=>(H(),U(`ul`,ah,[(H(!0),U(V,null,B(t.value,t=>(H(),U(`li`,{key:t.id},[kr(e.$slots,`default`,{item:t},()=>[G(`span`,oh,O(t.name)+` (부모가 그리는 방법을 정하지 않음)`,1)],!0)]))),128))]))}},[[`__scopeId`,`data-v-5164d7f2`]]),ch=t({default:()=>xh}),lh={class:`practice-card`},uh={class:`views`},dh={class:`view`},fh={class:`plain`},ph={class:`view`},mh={class:`row`},hh={class:`price`},gh={class:`view`},_h={class:`row`},vh={key:0,class:`badge sold`},yh={key:1,class:`badge low`},bh={key:2,class:`badge ok`},xh=Q({__name:`SlotListPractice`,setup(e){let t=e=>e.toLocaleString(`ko-KR`)+`원`;return(e,n)=>(H(),U(`section`,lh,[G(`h2`,null,[n[0]||=q(` 더해보기 ② 같은 목록, 부모가 정하는 세 가지 모습 `,-1),K($,{text:`목록 컴포넌트는 '무엇을 반복할지'(데이터와 v-for)만 책임지고, '각 항목을 어떻게 그릴지'는 부모에게 맡깁니다. 아래 세 목록은 전부 같은 SlotItemList.vue이고 데이터도 완전히 같습니다. 부모가 v-slot으로 받은 item을 다르게 그렸을 뿐입니다.`})]),n[4]||=G(`p`,{class:`explain`},[q(` 세 목록 모두 `),G(`b`,null,`같은 컴포넌트 · 같은 데이터`),q(`입니다. 데이터는 `),G(`code`,null,`SlotItemList.vue`),q(` 안에만 있고, 부모는 그리는 방법만 정합니다. `)],-1),G(`div`,uh,[G(`div`,dh,[n[1]||=G(`p`,{class:`view-label`},`A · 이름만`,-1),K(sh,null,{default:L(({item:e})=>[G(`span`,fh,O(e.name),1)]),_:1})]),G(`div`,ph,[n[2]||=G(`p`,{class:`view-label`},`B · 가격 강조`,-1),K(sh,null,{default:L(({item:e})=>[G(`div`,mh,[G(`span`,null,O(e.name),1),G(`b`,hh,O(t(e.price)),1)])]),_:1})]),G(`div`,gh,[n[3]||=G(`p`,{class:`view-label`},`C · 재고 상태`,-1),K(sh,null,{default:L(({item:e})=>[G(`div`,_h,[G(`span`,{class:D({out:e.stock===0})},O(e.name),3),e.stock===0?(H(),U(`span`,vh,`품절`)):e.stock<5?(H(),U(`span`,yh,O(e.stock)+`개 남음`,1)):(H(),U(`span`,bh,`재고 충분`))])]),_:1})])]),n[5]||=G(`p`,{class:`note`},[q(` C의 `),G(`b`,null,`품절 · 임박`),q(` 판단은 목록 컴포넌트가 아니라 `),G(`b`,null,`부모`),q(`가 했습니다. 목록은 `),G(`code`,null,`stock`),q(`이 무슨 뜻인지조차 모릅니다. 그래서 같은 목록을 쇼핑몰에도, 관리자 페이지에도 쓸 수 있습니다. `)],-1)]))}},[[`__scopeId`,`data-v-94406ce4`]]),Sh={class:`modal`,role:`dialog`,"aria-modal":`true`},Ch={class:`modal-head`},wh={class:`modal-body`},Th={class:`modal-foot`},Eh=Q({__name:`SlotModal`,props:{open:{type:Boolean,default:!1}},emits:[`close`],setup(e,{emit:t}){let n=t;return(t,r)=>e.open?(H(),U(`div`,{key:0,class:`backdrop`,onClick:r[2]||=Ro(e=>n(`close`),[`self`])},[G(`div`,Sh,[G(`header`,Ch,[kr(t.$slots,`title`,{},()=>[r[3]||=G(`b`,null,`제목 없음`,-1)],!0),G(`button`,{type:`button`,class:`close`,"aria-label":`닫기`,onClick:r[0]||=e=>n(`close`)},`✕`)]),G(`div`,wh,[kr(t.$slots,`default`,{},()=>[r[4]||=G(`p`,{class:`fallback`},`본문 구멍 (비어 있음)`,-1)],!0)]),G(`footer`,Th,[kr(t.$slots,`actions`,{},()=>[G(`button`,{type:`button`,onClick:r[1]||=e=>n(`close`)},`닫기`)],!0)])])])):J(``,!0)}},[[`__scopeId`,`data-v-4b2f4b14`]]),Dh=t({default:()=>Nh}),Oh={class:`practice-card`},kh={class:`stage`},Ah={class:`buttons`},jh={key:0,class:`result`},Mh={key:1,class:`hint`},Nh=Q({__name:`SlotModalPractice`,setup(e){let t=P(!1),n=P(!1),r=P(``),i=()=>{r.value=`삭제했습니다.`,t.value=!1};return(e,a)=>(H(),U(`section`,Oh,[G(`h2`,null,[a[5]||=q(` 더해보기 ③ 모달 하나로 창 두 개 `,-1),K($,{text:`모달 껍데기(어둡게 덮기·가운데 띄우기·닫기)는 어느 창이든 똑같습니다. 다른 건 제목·내용·버튼뿐이죠. 그래서 그 세 곳만 Named Slot으로 열어 두면, 모달 파일 하나로 확인창·안내창·입력창을 전부 만들 수 있습니다.`})]),a[11]||=G(`p`,{class:`explain`},[q(` 아래 두 버튼은 `),G(`b`,null,`같은 SlotModal.vue`),q(`를 엽니다. 껍데기는 같고 `),G(`code`,null,`#title`),q(` · 본문 · `),G(`code`,null,`#actions`),q(` 세 구멍만 다릅니다. `)],-1),G(`div`,kh,[G(`div`,Ah,[G(`button`,{type:`button`,onClick:a[0]||=e=>t.value=!0},`삭제 확인창 열기`),G(`button`,{type:`button`,onClick:a[1]||=e=>n.value=!0},`안내창 열기`)]),r.value?(H(),U(`p`,jh,O(r.value),1)):J(``,!0),!t.value&&!n.value?(H(),U(`p`,Mh,[...a[6]||=[q(` 위 버튼을 눌러 보세요. 모달은 `,-1),G(`b`,null,`이 점선 안에서만`,-1),q(` 열립니다. `,-1)]])):J(``,!0),K(Eh,{open:t.value,onClose:a[3]||=e=>t.value=!1},{title:L(()=>[...a[7]||=[G(`b`,null,`정말 삭제할까요?`,-1)]]),actions:L(()=>[G(`button`,{type:`button`,onClick:a[2]||=e=>t.value=!1},`취소`),G(`button`,{type:`button`,class:`danger`,onClick:i},`삭제`)]),default:L(()=>[a[8]||=G(`p`,null,`삭제한 항목은 되돌릴 수 없습니다.`,-1)]),_:1},8,[`open`]),K(Eh,{open:n.value,onClose:a[4]||=e=>n.value=!1},{title:L(()=>[...a[9]||=[G(`b`,null,`배포 안내`,-1)]]),default:L(()=>[a[10]||=G(`p`,null,`금요일 18시에 서비스가 잠시 중단됩니다.`,-1)]),_:1},8,[`open`])]),a[12]||=G(`p`,{class:`note`},[q(` 안내창은 `),G(`code`,null,`#actions`),q(`를 `),G(`b`,null,`채우지 않았습니다`),q(`. 그래서 SlotModal이 준비해 둔 기본 `),G(`b`,null,`닫기`),q(` 버튼 하나만 나옵니다. 구멍마다 기본값을 넣어 두면 부모가 매번 다 채우지 않아도 됩니다. `)],-1)]))}},[[`__scopeId`,`data-v-c7612aa2`]]),Ph={},Fh={class:`base-card`};function Ih(e,t){return H(),U(`div`,Fh,[kr(e.$slots,`default`,{},()=>[t[0]||=G(`p`,null,`기본 콘텐츠 영역입니다.`,-1)],!0)])}var Lh=Q(Ph,[[`render`,Ih],[`__scopeId`,`data-v-187523ed`]]),Rh={},zh={class:`base-card`};function Bh(e,t){return H(),U(`div`,zh,[G(`header`,null,[kr(e.$slots,`header`,{},void 0,!0)]),G(`main`,null,[kr(e.$slots,`default`,{},void 0,!0)])])}var Vh=Q(Rh,[[`render`,Bh],[`__scopeId`,`data-v-f11484c5`]]),Hh={class:`base-card`},Uh=Q({__name:`SlotScopedChild`,setup(e){let t=P(`현재 서버 상태 정상`),n=P(150);return(e,r)=>(H(),U(`div`,Hh,[r[1]||=G(`p`,{class:`role`},`하위 컴포넌트 (Child)`,-1),kr(e.$slots,`default`,{text:t.value,count:n.value},()=>[r[0]||=G(`p`,null,`부모가 마크업을 주입하지 않았을 때의 디폴트 화면`,-1)],!0)]))}},[[`__scopeId`,`data-v-54665344`]]),Wh=t({default:()=>Xh}),Gh={class:`practice-card`},Kh={class:`practice-area`},qh={class:`practice-area`},Jh={class:`practice-area`},Yh={class:`display-panel`},Xh=Q({__name:`SlotPractice`,setup(e){return(e,t)=>(H(),U(`section`,Gh,[G(`h2`,null,[t[0]||=q(` Slot — 껍데기는 두고 알맹이만 갈아 끼우기 `,-1),K($,{text:`Props가 '값'을 넘기는 것이라면 Slot은 '화면 조각(HTML)'을 통째로 넘기는 것입니다. 액자를 하나 만들어 두고 사진만 바꿔 끼우는 셈이라, 카드·모달·레이아웃처럼 껍데기는 같고 안쪽만 다른 UI에 씁니다.`})]),G(`div`,Kh,[t[3]||=G(`h3`,null,`1) Default Slot — 이름 없는 구멍 하나`,-1),t[4]||=G(`p`,{class:`explain`},[q(` 같은 `),G(`b`,null,`SlotDefaultChild`),q(` 카드에 서로 다른 내용을 넣었습니다. 마지막 카드는 아무것도 안 넣어서 `),G(`b`,null,`기본값`),q(`이 나옵니다. `)],-1),K(Lh,null,{default:L(()=>[...t[1]||=[G(`p`,null,`단순한 텍스트 문장을 주입합니다.`,-1)]]),_:1}),K(Lh,null,{default:L(()=>[...t[2]||=[G(`h4`,{class:`warn`},`🔥 경고 상태`,-1),G(`button`,null,`확인`,-1)]]),_:1}),K(Lh)]),G(`div`,qh,[t[7]||=G(`h3`,null,`2) Named Slot — 구멍에 이름을 붙여 여러 개`,-1),t[8]||=G(`p`,{class:`explain`},[G(`b`,null,`#header`),q(` 자리와 이름 없는 `),G(`b`,null,`본문`),q(` 자리에 각각 다른 내용을 넣습니다. `)],-1),K(Vh,null,{header:L(()=>[...t[5]||=[G(`h4`,null,`Child 주입 제목`,-1)]]),default:L(()=>[t[6]||=G(`p`,null,` "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt..." `,-1)]),_:1})]),G(`div`,Jh,[t[9]||=G(`h3`,null,`3) Scoped Slot — 자식의 데이터를 부모가 받아 쓴다`,-1),t[10]||=G(`p`,{class:`explain`},[q(` 아래 값은 `),G(`b`,null,`자식이 가진 데이터`),q(`인데, 화면에 어떻게 그릴지는 `),G(`b`,null,`부모가`),q(` 정합니다. `)],-1),K(Uh,null,{default:L(e=>[G(`div`,Yh,[G(`p`,null,`알림 메시지: `+O(e.text),1),G(`p`,null,`접속자 수: `+O(e.count)+`명`,1)])]),_:1}),K(Uh)])]))}},[[`__scopeId`,`data-v-4d263364`]]),Zh=t({default:()=>$h}),Qh={class:`practice-card`},$h=Q({__name:`ComputedCachePractice`,setup(e){let t=P(0),n=P(0),r=()=>(console.log(`❌ 일반 함수 실행됨!`),t.value*2),i=X(()=>(console.log(`✅ Computed 연산 실행됨!`),t.value*2));return(e,a)=>(H(),U(`section`,Qh,[G(`h2`,null,[a[2]||=q(` computed() 캐싱 동작 비교 `,-1),K($,{text:`computed는 의존하는 값이 바뀔 때만 다시 계산하고 결과를 캐싱합니다. 일반 함수는 화면이 다시 그려질 때마다 무조건 재실행됩니다. dummy 버튼을 눌러 콘솔 출력 차이를 확인해 보세요.`})]),G(`p`,null,`count: `+O(t.value)+` | dummy: `+O(n.value),1),G(`button`,{onClick:a[0]||=e=>t.value++},`count 증가 (의존성 변경)`),G(`button`,{onClick:a[1]||=e=>n.value++},`dummy 증가 (무관한 변경)`),G(`p`,null,`일반 함수 결과: `+O(r()),1),G(`p`,null,`Computed 결과: `+O(i.value),1),a[3]||=G(`p`,{class:`console-hint`},[q(` 브라우저 콘솔(F12)을 열고 `),G(`b`,null,`dummy 증가`),q(`를 눌러보세요. 일반 함수만 계속 실행되고 computed는 조용합니다. `)],-1)]))}},[[`__scopeId`,`data-v-5263d813`]]),eg=t({default:()=>ag}),tg={class:`practice-card`},ng={class:`practice-area`},rg={class:`monitor`},ig={class:`monitor target`},ag=Q({__name:`DeepWatchPractice`,setup(e){let t=P({name:`홍길동`,age:20}),n=P(`아직 반응 없음`),r=P(`아직 반응 없음`);return z(t,e=>{n.value=`[deep 감지] 누군가 변경됨! 현재 이름: ${e.name}, 나이: ${e.age}`},{deep:!0}),z(()=>t.value.age,(e,t)=>{r.value=`[타겟 감지] 나이가 ${t}세 ➡️ ${e}세로 변경됨!`}),(e,i)=>(H(),U(`section`,tg,[G(`h2`,null,[i[2]||=q(` ref 객체 감시 — Deep Watch `,-1),K($,{text:`ref에 객체를 담고 watch(user, ...)만 쓰면 속성 변경을 감지하지 못합니다. 객체 자체(참조)가 바뀐 게 아니기 때문입니다. deep: true로 내부 전체를 감시하거나, 화살표 함수로 특정 속성만 콕 집어 감시해야 합니다.`})]),G(`div`,ng,[i[3]||=G(`h3`,null,`👨‍💻 회원 데이터 조작 panel`,-1),G(`p`,null,`이름: `+O(t.value.name)+` / 나이: `+O(t.value.age)+`세`,1),G(`button`,{onClick:i[0]||=e=>t.value.name=`이순신`},`이름만 변경`),G(`button`,{onClick:i[1]||=e=>t.value.age++},`나이만 변경 (age++)`)]),G(`div`,rg,[i[4]||=G(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) deep: true 모니터 (전체 감시)`,-1),G(`p`,null,O(n.value),1)]),G(`div`,ig,[i[5]||=G(`p`,{class:`monitor-title`},`🎯 2) 화살표 함수 모니터 (나이만 타겟 감시)`,-1),G(`p`,null,O(r.value),1)])]))}},[[`__scopeId`,`data-v-485827f2`]]),og=t({default:()=>hg}),sg={class:`practice-card`},cg={class:`compare`},lg={class:`side`},ug={class:`check`},dg={class:`side highlight`},fg={class:`check`},pg={class:`live`},mg={key:0,class:`submitted`},hg=Q({__name:`FormStatePractice`,setup(e){let t=P(``),n=P(``),r=P(``),i=P(!1),a=()=>{t.value=``,n.value=``,r.value=``,i.value=!1},o=()=>JSON.stringify({name:t.value,email:n.value,age:r.value,agree:i.value},null,1),s={name:``,email:``,age:``,agree:!1},c=Lt({...s}),l=()=>{Object.assign(c,s)},u=()=>JSON.stringify(c,null,1),d=P(``),f=()=>{d.value=`[ref 방식] ${o()}`},p=()=>{d.value=`[reactive 방식] ${u()}`};return(e,s)=>(H(),U(`section`,sg,[G(`h2`,null,[s[8]||=q(` 폼 상태 관리 — ref 여러 개 vs reactive 하나 `,-1),K($,{text:`reactive의 장점은 '관련 있는 값을 한 덩어리로 다룰 수 있다'는 점입니다. 초기화·전송·전달을 객체 단위로 처리할 수 있어 필드가 많아질수록 코드가 짧아집니다. 대신 통째로 재할당하면 반응성이 끊기고, 원시값에는 쓸 수 없습니다.`})]),G(`div`,cg,[G(`div`,lg,[s[13]||=G(`h3`,null,`A. ref 4개`,-1),G(`label`,null,[s[9]||=q(`이름 `,-1),R(G(`input`,{"onUpdate:modelValue":s[0]||=e=>t.value=e,type:`text`},null,512),[[Z,t.value]])]),G(`label`,null,[s[10]||=q(`이메일 `,-1),R(G(`input`,{"onUpdate:modelValue":s[1]||=e=>n.value=e,type:`text`},null,512),[[Z,n.value]])]),G(`label`,null,[s[11]||=q(`나이 `,-1),R(G(`input`,{"onUpdate:modelValue":s[2]||=e=>r.value=e,type:`number`},null,512),[[Z,r.value,void 0,{number:!0}]])]),G(`label`,ug,[R(G(`input`,{"onUpdate:modelValue":s[3]||=e=>i.value=e,type:`checkbox`},null,512),[[ko,i.value]]),s[12]||=q(` 약관 동의`,-1)]),G(`div`,{class:`buttons`},[G(`button`,{onClick:f},`전송`),G(`button`,{onClick:a},`초기화`)]),s[14]||=G(`pre`,{class:`code`},`name.value = ''
email.value = ''
age.value = ''
agree.value = false`,-1),s[15]||=G(`p`,{class:`note`},`필드가 늘면 이 줄도 같이 늘어난다`,-1)]),G(`div`,dg,[s[20]||=G(`h3`,null,`B. reactive 1개`,-1),G(`label`,null,[s[16]||=q(`이름 `,-1),R(G(`input`,{"onUpdate:modelValue":s[4]||=e=>c.name=e,type:`text`},null,512),[[Z,c.name]])]),G(`label`,null,[s[17]||=q(`이메일 `,-1),R(G(`input`,{"onUpdate:modelValue":s[5]||=e=>c.email=e,type:`text`},null,512),[[Z,c.email]])]),G(`label`,null,[s[18]||=q(`나이 `,-1),R(G(`input`,{"onUpdate:modelValue":s[6]||=e=>c.age=e,type:`number`},null,512),[[Z,c.age,void 0,{number:!0}]])]),G(`label`,fg,[R(G(`input`,{"onUpdate:modelValue":s[7]||=e=>c.agree=e,type:`checkbox`},null,512),[[ko,c.agree]]),s[19]||=q(` 약관 동의`,-1)]),G(`div`,{class:`buttons`},[G(`button`,{onClick:p},`전송`),G(`button`,{onClick:l},`초기화`)]),s[21]||=G(`pre`,{class:`code`},`Object.assign(form, INITIAL_FORM)`,-1),s[22]||=G(`p`,{class:`note`},`필드가 몇 개든 한 줄로 끝난다`,-1)])]),G(`div`,pg,[G(`div`,null,[s[23]||=G(`p`,{class:`live-label`},`A · ref 4개를 손으로 조립`,-1),G(`pre`,null,O(o()),1)]),G(`div`,null,[s[24]||=G(`p`,{class:`live-label`},`B · reactive 객체를 그대로 사용`,-1),G(`pre`,null,O(u()),1)])]),d.value?(H(),U(`p`,mg,O(d.value),1)):J(``,!0)]))}},[[`__scopeId`,`data-v-be254916`]]),gg=t({default:()=>bg}),_g={class:`practice-card`},vg={class:`practice-area`},yg={class:`monitor`},bg=Q({__name:`MultiWatchPractice`,setup(e){let t=P(`서울`),n=P(`오늘`),r=P(`대기 중...`);return z([t,n],([e,t],[n,i])=>{r.value=`[변경 감지] ${n}(${i}) ➡️ ${e}(${t})`,console.log(`🤖 [통합 API 호출] ${e}의 ${t} 날씨를 불러옵니다...`)}),(e,i)=>(H(),U(`section`,_g,[G(`h2`,null,[i[4]||=q(` 여러 개의 변수 동시 감시 (Multi-Source Watch) `,-1),K($,{text:`watch의 첫 번째 인자에 배열을 넘기면 여러 값을 한 번에 감시합니다. 콜백이 받는 새 값·이전 값도 배열이며, 감시 대상을 적은 순서 그대로 매핑됩니다. 둘 중 하나만 바뀌어도 콜백이 한 번 실행됩니다.`})]),G(`div`,vg,[i[9]||=G(`h3`,null,`날씨 조건 설정`,-1),i[10]||=G(`label`,null,`도시: `,-1),R(G(`select`,{"onUpdate:modelValue":i[0]||=e=>t.value=e},[...i[5]||=[G(`option`,{value:`서울`},`서울`,-1),G(`option`,{value:`수원`},`수원`,-1),G(`option`,{value:`부산`},`부산`,-1)]],512),[[Mo,t.value]]),i[11]||=G(`p`,{class:`field-label`},`날짜:`,-1),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":i[1]||=e=>n.value=e,type:`radio`,value:`오늘`},null,512),[[jo,n.value]]),i[6]||=q(` 오늘`,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":i[2]||=e=>n.value=e,type:`radio`,value:`내일`},null,512),[[jo,n.value]]),i[7]||=q(` 내일`,-1)]),G(`label`,null,[R(G(`input`,{"onUpdate:modelValue":i[3]||=e=>n.value=e,type:`radio`,value:`주간예보`},null,512),[[jo,n.value]]),i[8]||=q(` 주간예보`,-1)])]),G(`div`,yg,[i[12]||=G(`h3`,null,`통합 모니터링 로그`,-1),G(`p`,null,`현재 상태: `+O(r.value),1)])]))}},[[`__scopeId`,`data-v-25d6c99a`]]),xg=t({default:()=>Eg}),Sg={class:`practice-card`},Cg={class:`practice-area`},wg={class:`monitor auto`},Tg={class:`monitor target`},Eg=Q({__name:`ReactiveArrayWatchPractice`,setup(e){let t=Lt([`서울`,`수원`]),n=P(`대기 중...`),r=P(`대기 중...`);return z(t,(e,t)=>{n.value=`[자동 감시] 배열 변동 발생! 옛날길이인척하는:${t.length} / 현재길이:${e.length}`}),z(()=>[...t],(e,t)=>{r.value=`[스냅샷 감시] 진짜 과거 길이:${t.length} (데이터: ${t}) ➡️ 바뀐 길이:${e.length}`}),(e,i)=>(H(),U(`section`,Sg,[G(`h2`,null,[i[2]||=q(` reactive() 배열 감시 — 스냅샷 기법 `,-1),K($,{text:`배열도 객체와 같은 함정이 있습니다. 변수명을 그대로 넘기면 이전 배열과 현재 배열이 같은 것을 가리켜 비교가 불가능합니다. 스프레드로 복사본을 만들어([...cityList]) 감시하면 과거 상태가 그대로 보존됩니다.`})]),G(`div`,Cg,[i[4]||=G(`h3`,null,`즐겨찾기 도시 목록 (reactive 배열)`,-1),G(`p`,null,[i[3]||=q(` 현재 등록된 도시: `,-1),G(`strong`,null,O(t),1)]),G(`button`,{onClick:i[0]||=e=>t.push(`부산`)},`부산 추가 (push)`),G(`button`,{onClick:i[1]||=e=>t.pop()},`최근 도시 삭제 (pop)`)]),G(`div`,wg,[i[5]||=G(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) cityList 변수명 쌩으로 감시`,-1),G(`p`,null,O(n.value),1),i[6]||=G(`small`,null,`※ 주의: 이전 배열과 현재 배열의 내용물·길이가 똑같이 동기화되어 버립니다.`,-1)]),G(`div`,Tg,[i[7]||=G(`p`,{class:`monitor-title`},`🎯 2) () => [...cityList] 복사본 감시`,-1),G(`p`,null,O(r.value),1),i[8]||=G(`small`,null,`※ 성공: 과거 배열에 들어있던 내용물이 지워지지 않고 정상 대조됩니다.`,-1)])]))}},[[`__scopeId`,`data-v-e62c5023`]]),Dg=t({default:()=>Mg}),Og={class:`practice-card`},kg={class:`practice-area`},Ag={class:`practice-area`},jg=[`onClick`],Mg=Q({__name:`ReactiveStatePractice`,setup(e){let t=Lt({name:`이순신`,age:30}),n=()=>{t.age++},r=Lt([`사과`,`바나나`]),i=()=>{r.push(`과일 ${r.length+1}`)},a=e=>{r.splice(e,1)};return(e,o)=>(H(),U(`section`,Og,[G(`h2`,null,[o[0]||=q(` 반응형 상태 reactive() 특징 및 주의점 `,-1),K($,{text:`reactive()는 객체·배열 전용이며 .value 없이 바로 접근합니다. 다만 객체를 통째로 재할당(userReactive = { ... })하면 반응성이 끊기고, 원시값에는 쓸 수 없습니다. 그래서 실무는 ref()로 통일하는 추세입니다.`})]),G(`div`,kg,[o[1]||=G(`h3`,null,`1) 객체(Object) reactive`,-1),G(`p`,null,`이름: `+O(t.name)+` / 나이: `+O(t.age)+`세`,1),G(`button`,{onClick:n},`reactive 나이 한 살 추가`)]),G(`div`,Ag,[o[2]||=G(`h3`,null,`2) 배열(Array) reactive`,-1),G(`ul`,null,[(H(!0),U(V,null,B(r,(e,t)=>(H(),U(`li`,{key:t},[q(O(e)+` `,1),G(`button`,{style:{"margin-left":`8px`,padding:`2px 8px`},onClick:e=>a(t)},` 삭제 `,8,jg)]))),128))]),G(`button`,{onClick:i},`과일 항목 추가`)])]))}},[[`__scopeId`,`data-v-524a2c66`]]),Ng=t({default:()=>Rg}),Pg={class:`practice-card`},Fg={class:`practice-area`},Ig={class:`monitor auto`},Lg={class:`monitor target`},Rg=Q({__name:`ReactiveWatchPractice`,setup(e){let t=Lt({productName:`노트북`,price:1e3}),n=P(`대기 중...`),r=P(`대기 중...`);return z(t,(e,t)=>{n.value=`[자동 deep] 가격 변동! 이전가격인척하는:${t.price}원 ➡️ 현재가격:${e.price}원`}),z(()=>t.price,(e,t)=>{r.value=`[타겟 조준] 가격이 진짜 올랐음! 옛날값:${t}원 ➡️ 바뀐값:${e}원`}),(e,i)=>(H(),U(`section`,Pg,[G(`h2`,null,[i[1]||=q(` reactive() 데이터 watch 감시 규칙 `,-1),K($,{text:`reactive 객체는 변수명을 그대로 넘기면 deep이 자동으로 켜져 내부 속성 변경까지 잡아냅니다. 다만 이전 값과 현재 값이 같은 객체를 가리켜서 oldVal이 쓸모없어집니다. 이전 값이 필요하면 화살표 함수로 특정 속성만 콕 집어야 합니다.`})]),G(`div`,Fg,[i[2]||=G(`h3`,null,`🛒 상품 정보 관리 (reactive)`,-1),G(`p`,null,`상품명: `+O(t.productName)+` / 가격: `+O(t.price)+`원`,1),G(`button`,{onClick:i[0]||=e=>t.price+=500},`가격 500원 인상`)]),G(`div`,Ig,[i[3]||=G(`p`,{class:`monitor-title`},`👁️‍🗨️ 1) state 변수 통째로 감시 (deep 자동화)`,-1),G(`p`,null,O(n.value),1),i[4]||=G(`small`,null,`※ 주의: 이전 값과 현재 값이 똑같이 찍힌다.`,-1)]),G(`div`,Lg,[i[5]||=G(`p`,{class:`monitor-title`},`🎯 2) () => state.price 콕 집어 감시 (과거 추적)`,-1),G(`p`,null,O(r.value),1),i[6]||=G(`small`,null,`※ 성공: 과거의 원본 가격이 칼같이 보존된다.`,-1)])]))}},[[`__scopeId`,`data-v-50148cb5`]]),zg=t({default:()=>Gg}),Bg={class:`practice-card`},Vg={class:`practice-area`},Hg={class:`log text`},Ug={class:`practice-area`},Wg={class:`log object`},Gg=Q({__name:`RefArrayWatchPractice`,setup(e){let t=P([`홍길동`,`이순신`,`강감찬`]),n=P(`대기 중...`),r=P([{name:`서울`,temp:25},{name:`수원`,temp:22}]),i=P(`대기 중...`);return z(()=>t.value[0],(e,t)=>{n.value=`[방출/영입] 0번 선수 교체: ${t} ➡️ ${e}`}),z(()=>r.value[0],e=>{i.value=`[날씨 변동] 서울의 온도가 현재 ${e.temp}°C 로 변경되었습니다.`},{deep:!0}),(e,a)=>(H(),U(`section`,Bg,[G(`h2`,null,[a[2]||=q(` ref 배열의 특정 인덱스 감시하기 `,-1),K($,{text:`배열의 특정 요소만 감시하려면 화살표 함수로 콕 집어야 합니다. 다만 그 요소가 문자열이면 그대로 동작하지만, 객체라면 { deep: true }가 없으면 내부 속성 변경을 감지하지 못합니다. 가리키는 대상의 타입에 따라 규칙이 달라집니다.`})]),G(`div`,Vg,[G(`h3`,null,`🏃‍♂️ 1) 문자열 배열: 현재 0번 멤버 [ `+O(t.value[0])+` ]`,1),G(`button`,{onClick:a[0]||=e=>t.value[0]=`손흥민`},`0번 멤버를 손흥민으로 교체`),G(`p`,Hg,`로그: `+O(n.value),1)]),G(`div`,Ug,[G(`h3`,null,`⛅ 2) 객체형 배열: 현재 `+O(r.value[0].name)+` 기온 [ `+O(r.value[0].temp)+`°C ]`,1),G(`button`,{onClick:a[1]||=e=>r.value[0].temp++},`서울 기온 1도 올리기 (temp++)`),G(`p`,Wg,`로그: `+O(i.value),1)])]))}},[[`__scopeId`,`data-v-b0ee05f5`]]),Kg=t({default:()=>Jg}),qg={class:`practice-card`},Jg={__name:`RefStatePractice`,setup(e){let t=P(0),n=P(`홍길동`),r=P(!0),i=P([`사과`,`배`]),a=P({name:`이순신`,age:30}),o=()=>{t.value++},s=()=>{a.value.name=`장보고`};return(e,c)=>(H(),U(`section`,qg,[G(`h2`,null,[c[3]||=q(` 반응형 상태 ref() 기초 `,-1),K($,{text:`ref()는 값을 반응형 상자에 담습니다. script에서는 .value로 상자를 열어야 하고, template에서는 자동 언래핑되어 .value 없이 씁니다. 객체나 배열을 담아도 내부 속성 변경까지 감지됩니다.`})]),G(`p`,null,[c[4]||=q(` Ref 카운트: `,-1),G(`strong`,null,O(t.value),1)]),G(`p`,null,[c[5]||=q(`이름: `,-1),R(G(`input`,{"onUpdate:modelValue":c[0]||=e=>n.value=e},null,512),[[Z,n.value]]),q(O(n.value),1)]),G(`p`,null,`활성 상태: `+O(r.value?`활성`:`비활성`),1),G(`p`,null,`과일 목록: `+O(i.value.join(`, `)),1),G(`p`,null,`사용자 정보: 이름 - `+O(a.value.name)+`, 나이 - `+O(a.value.age),1),G(`button`,{onClick:o},`Ref 변수 증가`),G(`button`,{onClick:c[1]||=e=>r.value=!r.value},`토글`),G(`button`,{onClick:c[2]||=e=>i.value.push(`귤`)},`과일 추가`),G(`button`,{onClick:s},`사용자 이름 변경`)]))}},Yg=t({default:()=>c_}),Xg={class:`practice-card`},Zg={class:`todo-input`},Qg=[`disabled`],$g={class:`filter`},e_={key:0,class:`todo-list`},t_=[`checked`,`onChange`],n_=[`onKeyup`,`onBlur`],r_=[`onClick`],i_=[`onClick`],a_={key:1,class:`empty`},o_={key:2,class:`empty`},s_={key:3,class:`todo-foot`},c_=Q({__name:`TodoAdvancedPractice`,setup(e){let t=P([{id:1,title:`장보기`,done:!1},{id:2,title:`Vue 복습하기`,done:!0}]),n=P(``),r=3,i=()=>{let e=n.value.trim();e&&(t.value.push({id:r,title:e,done:!1}),r++,n.value=``)},a=e=>{e.done=!e.done},o=e=>{t.value=t.value.filter(t=>t.id!==e)},s=P(null),c=P(``),l=P(null),u=async e=>{s.value=e.id,c.value=e.title,await vn(),l.value?.focus()},d=e=>{if(s.value===null)return;let t=c.value.trim();t&&(e.title=t),s.value=null},f=()=>{s.value=null},p=P(!1),m=X(()=>p.value?t.value.filter(e=>!e.done):t.value),h=X(()=>t.value.filter(e=>!e.done).length),g=X(()=>t.value.length-h.value);return(e,r)=>(H(),U(`section`,Xg,[G(`h2`,null,[r[3]||=q(` 할 일 목록 응용 2 — 잠금 · 수정 · 필터 `,-1),K($,{text:`세 가지를 얹었습니다. ① :disabled로 빈 입력일 때 버튼 잠그기 ② 제목을 클릭해 인라인 수정(수정 중 상태를 ref로 관리) ③ computed로 필터와 집계를 옮기기. computed는 CC06에서 정식으로 배우지만 여기서 미리 써 봅니다.`})]),G(`div`,Zg,[R(G(`input`,{"onUpdate:modelValue":r[0]||=e=>n.value=e,type:`text`,placeholder:`할 일을 입력하고 Enter`,onKeyup:Bo(i,[`enter`])},null,544),[[Z,n.value]]),G(`button`,{disabled:!n.value.trim(),onClick:i},`추가`,8,Qg)]),G(`label`,$g,[R(G(`input`,{"onUpdate:modelValue":r[1]||=e=>p.value=e,type:`checkbox`},null,512),[[ko,p.value]]),r[4]||=q(` 남은 일만 보기 `,-1)]),m.value.length?(H(),U(`ul`,e_,[(H(!0),U(V,null,B(m.value,e=>(H(),U(`li`,{key:e.id,class:D({done:e.done})},[G(`input`,{type:`checkbox`,checked:e.done,onChange:t=>a(e)},null,40,t_),s.value===e.id?R((H(),U(`input`,{key:0,ref_for:!0,ref:e=>e&&(l.value=e),"onUpdate:modelValue":r[2]||=e=>c.value=e,class:`edit-input`,onKeyup:[Bo(t=>d(e),[`enter`]),Bo(f,[`esc`])],onBlur:t=>d(e)},null,40,n_)),[[Z,c.value]]):(H(),U(`span`,{key:1,class:`title`,title:`클릭하면 제목을 고칠 수 있습니다`,onClick:t=>u(e)},O(e.title),9,r_)),G(`button`,{onClick:t=>o(e.id)},`삭제`,8,i_)],2))),128))])):t.value.length?(H(),U(`p`,a_,` 🎉 남은 일이 없습니다. 필터를 끄면 완료한 항목을 볼 수 있어요. `)):(H(),U(`p`,o_,`아직 할 일이 없습니다. 위에서 하나 추가해 보세요.`)),t.value.length?(H(),U(`div`,s_,[G(`span`,null,[r[5]||=q(` 전체 `,-1),G(`b`,null,O(t.value.length),1),r[6]||=q(` · 남은 일 `,-1),G(`b`,null,O(h.value),1),r[7]||=q(` · 완료 `,-1),G(`b`,null,O(g.value),1)]),r[8]||=G(`span`,{class:`hint`},`제목을 클릭 → 수정 · Enter 확정 · Esc 취소`,-1)])):J(``,!0)]))}},[[`__scopeId`,`data-v-f5c37e4e`]]),l_=t({default:()=>v_}),u_={class:`practice-card`},d_={class:`todo-input`},f_={key:0,class:`todo-list`},p_=[`checked`,`onChange`],m_={class:`title`},h_=[`onClick`],g_={key:1,class:`empty`},__={key:2,class:`todo-foot`},v_=Q({__name:`TodoListPractice`,setup(e){let t=P([]),n=P(``),r=1,i=()=>{let e=n.value.trim();e&&(t.value.push({id:r,title:e,done:!1}),r++,n.value=``)},a=e=>{e.done=!e.done},o=e=>{t.value=t.value.filter(t=>t.id!==e)},s=()=>{t.value=t.value.filter(e=>!e.done)};return(e,r)=>(H(),U(`section`,u_,[G(`h2`,null,[r[1]||=q(` 할 일 목록 — ref 배열 응용 `,-1),K($,{text:`ref([])에 객체를 담아 목록을 관리하는 연습입니다. 추가는 push, 삭제는 filter로 새 배열을 만들어 교체합니다. 배열 안 객체의 속성(done)을 직접 바꿔도 ref가 변화를 감지해 화면이 갱신됩니다.`})]),G(`div`,d_,[R(G(`input`,{"onUpdate:modelValue":r[0]||=e=>n.value=e,type:`text`,placeholder:`할 일을 입력하고 Enter`,onKeyup:Bo(i,[`enter`])},null,544),[[Z,n.value]]),G(`button`,{onClick:i},`추가`)]),t.value.length?(H(),U(`ul`,f_,[(H(!0),U(V,null,B(t.value,e=>(H(),U(`li`,{key:e.id,class:D({done:e.done})},[G(`input`,{type:`checkbox`,checked:e.done,onChange:t=>a(e)},null,40,p_),G(`span`,m_,O(e.title),1),G(`button`,{class:`remove`,onClick:t=>o(e.id)},`삭제`,8,h_)],2))),128))])):(H(),U(`p`,g_,`아직 할 일이 없습니다. 위에서 하나 추가해 보세요.`)),t.value.length?(H(),U(`div`,__,[G(`span`,null,[r[2]||=q(` 전체 `,-1),G(`b`,null,O(t.value.length),1),r[3]||=q(` · 남은 일 `,-1),G(`b`,null,O(t.value.filter(e=>!e.done).length),1),r[4]||=q(` · 완료 `,-1),G(`b`,null,O(t.value.filter(e=>e.done).length),1)]),G(`button`,{onClick:s},`완료한 항목 지우기`)])):J(``,!0)]))}},[[`__scopeId`,`data-v-db2e98ce`]]),y_=t({default:()=>C_}),b_={class:`practice-card`},x_={class:`practice-area`},S_={class:`monitor`},C_=Q({__name:`WatchEffectPractice`,setup(e){let t=P(`홍길동`),n=P(20),r=P(`대기 중...`);return Pn(()=>{r.value=`[자동 감지] 이름: ${t.value} / 나이: ${n.value}세`,console.log(`🤖 watchEffect가 내부 변수 변경을 감지하여 실행되었습니다.`)}),(e,i)=>(H(),U(`section`,b_,[G(`h2`,null,[i[2]||=q(` 자동 감시자 watchEffect() `,-1),K($,{text:`watchEffect는 감시 대상을 적지 않습니다. 함수 안에서 읽은 반응형 값이 자동으로 의존성이 됩니다. 그리고 등록되는 즉시 한 번 실행되는 점이 watch와 가장 큰 차이입니다. 대신 이전 값은 받을 수 없습니다.`})]),G(`div`,x_,[G(`p`,null,`이름: `+O(t.value)+` / 나이: `+O(n.value)+`세`,1),G(`button`,{onClick:i[0]||=e=>t.value=`이순신`},`이름을 '이순신'으로 변경`),G(`button`,{onClick:i[1]||=e=>n.value++},`나이 한 살 추가 (age++)`)]),G(`div`,S_,[i[3]||=G(`h3`,null,`👁️‍🗨️ watchEffect 자동 모니터링 시스템`,-1),G(`p`,null,O(r.value),1),i[4]||=G(`small`,null,` ※ 새로고침하자마자 버튼을 안 눌러도 로그가 이미 찍혀있는 특징을 주목하세요! `,-1)])]))}},[[`__scopeId`,`data-v-542ebb87`]]),w_=t({default:()=>O_}),T_={class:`practice-card`},E_={class:`practice-area`},D_={class:`monitor`},O_=Q({__name:`WatchPractice`,setup(e){let t=P(`서울`),n=P(`아직 감시 시스템이 작동하지 않았습니다.`);return z(t,(e,t)=>{n.value=`📍 감시자 발동! [${t}]에서 [${e}]로 변경됨.`,console.log(`🤖 [서버 요청 완료] 기상청 서버에서 ${e}의 날씨 API를 다시 조회합니다...`)}),(e,r)=>(H(),U(`section`,T_,[G(`h2`,null,[r[3]||=q(` 감시자 watch()의 원리와 실무 활용 `,-1),K($,{text:`watch()는 값이 바뀌는 순간 무언가를 실행하는 감시자입니다. 콜백은 (새 값, 이전 값)을 받습니다. 화면에 보여줄 값은 computed로, API 호출·로그 같은 부수 효과는 watch로 처리합니다.`})]),G(`div`,E_,[r[4]||=G(`h3`,null,`🏙️ 지역 선택 제어판`,-1),G(`p`,null,`현재 선택된 도시: `+O(t.value),1),G(`button`,{onClick:r[0]||=e=>t.value=`서울`},`서울 선택`),G(`button`,{onClick:r[1]||=e=>t.value=`수원`},`수원 선택`),G(`button`,{onClick:r[2]||=e=>t.value=`부산`},`부산 선택`)]),G(`div`,D_,[r[5]||=G(`h3`,null,`👁️‍🗨️ 파수꾼(watch) 모니터링 시스템`,-1),G(`p`,null,O(n.value),1),r[6]||=G(`small`,null,`(버튼을 누른 후 브라우저 콘솔창 F12를 확인해 보세요)`,-1)])]))}},[[`__scopeId`,`data-v-f25592fe`]]),k_=`<script setup>
import { ref } from 'vue'
...
`,sv=Object.assign({"./basic/BindPractice.vue":Jd,"./basic/ConditionalPractice.vue":lf,"./basic/EventPractice.vue":bf,"./basic/ForPractice.vue":Mf,"./basic/HtmlTextPractice.vue":If,"./basic/ModelPractice.vue":Wf,"./basic/ReactivityPractice.vue":up,"./basic/SpecialDirectivePractice.vue":pp,"./component/ComponentRegistrationPractice.vue":Cp,"./component/LifecyclePractice.vue":Mp,"./component/PropsEmitsPractice.vue":Rp,"./component/PropsFlowPractice.vue":qp,"./component/PropsReadonlyPractice.vue":um,"./component/ProvideInjectPractice.vue":Em,"./component/SiblingTalkPractice.vue":Vm,"./component/SlotBaseCardPractice.vue":Qm,"./component/SlotListPractice.vue":ch,"./component/SlotModalPractice.vue":Dh,"./component/SlotPractice.vue":Wh,"./composition/ComputedCachePractice.vue":Zh,"./composition/DeepWatchPractice.vue":eg,"./composition/FormStatePractice.vue":og,"./composition/MultiWatchPractice.vue":gg,"./composition/ReactiveArrayWatchPractice.vue":xg,"./composition/ReactiveStatePractice.vue":Dg,"./composition/ReactiveWatchPractice.vue":Ng,"./composition/RefArrayWatchPractice.vue":zg,"./composition/RefStatePractice.vue":Kg,"./composition/TodoAdvancedPractice.vue":Yg,"./composition/TodoListPractice.vue":l_,"./composition/WatchEffectPractice.vue":y_,"./composition/WatchPractice.vue":w_}),cv=e=>e.split(`/`).pop().replace(`.vue`,``),lv=Object.fromEntries(Object.entries(sv).map(([e,t])=>[cv(e),t.default])),uv=Object.fromEntries(Object.entries(sv).map(([e])=>[cv(e),e.replace(`./`,`src/components/practices/`)]));Object.keys(lv).sort();var dv=e=>lv[e]??null,fv=e=>uv[e]??``,pv=Object.fromEntries(Object.entries(Object.assign({"./basic/BindPractice.vue":k_,"./basic/ConditionalPractice.vue":A_,"./basic/EventPractice.vue":j_,"./basic/ForPractice.vue":M_,"./basic/HtmlTextPractice.vue":N_,"./basic/ModelPractice.vue":P_,"./basic/ReactivityPractice.vue":F_,"./basic/SpecialDirectivePractice.vue":I_,"./component/ComponentRegistrationPractice.vue":L_,"./component/LifecyclePractice.vue":R_,"./component/PropsEmitsPractice.vue":z_,"./component/PropsFlowPractice.vue":B_,"./component/PropsReadonlyPractice.vue":V_,"./component/ProvideInjectPractice.vue":H_,"./component/SiblingTalkPractice.vue":U_,"./component/SlotBaseCardPractice.vue":W_,"./component/SlotListPractice.vue":G_,"./component/SlotModalPractice.vue":K_,"./component/SlotPractice.vue":q_,"./composition/ComputedCachePractice.vue":J_,"./composition/DeepWatchPractice.vue":Y_,"./composition/FormStatePractice.vue":X_,"./composition/MultiWatchPractice.vue":Z_,"./composition/ReactiveArrayWatchPractice.vue":Q_,"./composition/ReactiveStatePractice.vue":$_,"./composition/ReactiveWatchPractice.vue":ev,"./composition/RefArrayWatchPractice.vue":tv,"./composition/RefStatePractice.vue":nv,"./composition/TodoAdvancedPractice.vue":rv,"./composition/TodoListPractice.vue":iv,"./composition/WatchEffectPractice.vue":av,"./composition/WatchPractice.vue":ov})).map(([e,t])=>[cv(e),t])),mv=e=>pv[e]??``,hv=[`id`],gv=[`aria-expanded`,`title`],_v={class:`card-chevron`,"aria-hidden":`true`},vv={class:`head-text`},yv={class:`label`},bv={class:`slide`},xv={key:0,class:`goal`},Sv={key:1,class:`card-summary`},Cv={class:`head-badges`},wv={key:0,class:`badge live`},Tv={key:1,class:`tasks`},Ev={key:2,class:`fold pitfalls`},Dv={class:`fold-body`},Ov={key:0,class:`compare`},kv={key:0,class:`bad`},Av={key:1,class:`good`},jv={class:`why`},Mv={key:3,class:`practice-note`},Nv={class:`practice-head`},Pv=[`aria-expanded`,`title`],Fv={class:`chevron`,"aria-hidden":`true`},Iv={key:0,class:`count`},Lv={class:`practice-hint`},Rv={class:`practice-main`},zv={key:0,class:`practice-mounts`},Bv={class:`slot-tools`},Vv=[`onClick`],Hv=[`onClick`],Uv={key:1,class:`practice-empty`},Wv={key:2,class:`practice-missing`},Gv=[`aria-expanded`,`title`],Kv={class:`side-chevron`,"aria-hidden":`true`},qv={class:`side-body`},Jv={key:0,class:`side-block`},Yv={class:`side-heading`},Xv=[`onClick`],Zv={class:`guide`},Qv=[`innerHTML`],$v={class:`guide-see`},ey=[`innerHTML`],ty={key:0,class:`guide-why`},ny=[`innerHTML`],ry={key:1,class:`group-extras`},iy={key:1,class:`side-block fold extensions`},ay={class:`fold-body`},oy={key:5,class:`fold extensions`},sy={class:`fold-body`},cy=Q({__name:`ChallengeCard`,props:{challenge:{type:Object,required:!0}},setup(e){let t=e,n=X(()=>t.challenge.practices.map(e=>({name:e,component:dv(e)})).filter(e=>e.component)),r=X(()=>t.challenge.practices.filter(e=>!dv(e))),i=X(()=>n.value.length>0),a=X(()=>t.challenge.practiceGuide??[]),o=X(()=>{let e=[];for(let t of a.value)t.practice||e.length===0?e.push({label:t.practice??null,steps:[t]}):e[e.length-1].steps.push(t);return e.map(e=>({...e,extras:l.value.filter(t=>typeof t==`object`&&t.practice===e.label)}))}),s=X(()=>{let e=new Set(o.value.map(e=>e.label));return l.value.filter(t=>typeof t==`string`||!e.has(t.practice))}),c=e=>typeof e==`string`?e:e.text,l=X(()=>t.challenge.extensions??[]),u=X(()=>i.value&&(a.value.length>0||l.value.length>0)),d=P(!0),f=P(!0),p=P(!1),m=X(()=>{let e=[];return t.challenge.tasks?.length&&e.push(`연습 ${t.challenge.tasks.length}`),t.challenge.pitfalls?.length&&e.push(`주의 ${t.challenge.pitfalls.length}`),n.value.length&&e.push(`실습 ${n.value.length}`),e.join(` · `)}),h=X(()=>!u.value&&l.value.length>0),g=Lt({}),_=e=>`${e}-${g[e]??0}`,v=e=>{g[e]=(g[e]??0)+1},y=()=>{n.value.forEach(e=>v(e.name))},b=P(null),x=e=>{b.value=e},S=P(null),C=e=>e.replace(/\s+/g,` `).trim(),ee=(e,t)=>{let n=S.value;if(!n)return;let r=[...n.querySelectorAll(`.practice-slot`)];if(!r.length)return;let i=r.find(t=>{let n=t.querySelector(`h2`);return n&&C(n.textContent)===C(e??``)})??r[t]??r[0];i.scrollIntoView({behavior:`smooth`,block:`center`}),i.classList.add(`is-target`),setTimeout(()=>i.classList.remove(`is-target`),1400)};return(t,g)=>(H(),U(`article`,{id:`challenge-${e.challenge.id}`,ref_key:`cardEl`,ref:S,class:D([`challenge`,[e.challenge.status,{collapsed:!p.value}]])},[G(`header`,{class:`challenge-head`,role:`button`,tabindex:`0`,"aria-expanded":p.value,title:p.value?`이 챌린지 접기`:`이 챌린지 펼치기`,onClick:g[0]||=e=>p.value=!p.value,onKeydown:[g[1]||=Bo(Ro(e=>p.value=!p.value,[`prevent`]),[`enter`]),g[2]||=Bo(Ro(e=>p.value=!p.value,[`prevent`]),[`space`])]},[G(`span`,_v,O(p.value?`▾`:`▸`),1),G(`div`,vv,[G(`p`,yv,[q(O(e.challenge.label)+` `,1),G(`span`,bv,`교안 `+O(e.challenge.slidePage),1)]),G(`h3`,null,O(e.challenge.title),1),p.value?(H(),U(`p`,xv,O(e.challenge.goal),1)):m.value?(H(),U(`p`,Sv,O(m.value),1)):J(``,!0)]),G(`div`,Cv,[G(`span`,{class:D([`badge`,e.challenge.status])},O(e.challenge.status===`done`?`학습 완료`:`진행 예정`),3),i.value?(H(),U(`span`,wv,` 실습 `+O(n.value.length)+`개 `,1)):J(``,!0)])],40,gv),p.value?(H(),U(V,{key:0},[e.challenge.lecture?(H(),W(Fd,{key:0,lecture:e.challenge.lecture,"study-range":e.challenge.studyRange},null,8,[`lecture`,`study-range`])):J(``,!0),e.challenge.tasks?.length?(H(),U(`section`,Tv,[g[6]||=G(`p`,{class:`section-label`},`✎ 연습 항목`,-1),G(`ul`,null,[(H(!0),U(V,null,B(e.challenge.tasks,e=>(H(),U(`li`,{key:e},O(e),1))),128))])])):J(``,!0),e.challenge.pitfalls?.length?(H(),U(`details`,Ev,[G(`summary`,null,[g[7]||=G(`span`,{"aria-hidden":`true`},`⚠`,-1),g[8]||=q(` 조심할 점 `,-1),G(`b`,null,O(e.challenge.pitfalls.length),1)]),G(`div`,Dv,[(H(!0),U(V,null,B(e.challenge.pitfalls,(e,t)=>(H(),U(`div`,{key:t,class:`pitfall`},[e.bad||e.good?(H(),U(`div`,Ov,[e.bad?(H(),U(`p`,kv,[g[9]||=G(`span`,null,`❌`,-1),G(`code`,null,O(e.bad),1)])):J(``,!0),e.good?(H(),U(`p`,Av,[g[10]||=G(`span`,null,`✅`,-1),G(`code`,null,O(e.good),1)])):J(``,!0)])):J(``,!0),G(`p`,jv,O(e.why),1)]))),128))])])):J(``,!0),!i.value&&e.challenge.practiceNote?(H(),U(`p`,Mv,[g[11]||=G(`span`,{"aria-hidden":`true`},`✓`,-1),q(` `+O(e.challenge.practiceNote),1)])):(H(),U(`section`,{key:4,class:D([`practice-zone`,{closed:!f.value}])},[G(`header`,Nv,[G(`button`,{type:`button`,class:`practice-toggle`,"aria-expanded":f.value,title:f.value?`실습 화면 접기`:`실습 화면 펼치기`,onClick:g[3]||=e=>f.value=!f.value},[G(`span`,Fv,O(f.value?`▾`:`▸`),1),g[12]||=G(`span`,{class:`practice-mark`,"aria-hidden":`true`},`🖥`,-1),g[13]||=G(`span`,{class:`practice-title`},`실습 화면`,-1),i.value?(H(),U(`span`,Iv,O(n.value.length),1)):J(``,!0)],8,Pv),G(`span`,Lv,O(f.value?`직접 눌러보며 동작을 확인하세요`:`접어 둠 · 제목을 눌러 펼치기`),1),n.value.length>1&&f.value?(H(),U(`button`,{key:0,type:`button`,class:`reset-button reset-all`,"aria-label":`실습 전체 초기화`,title:`이 챌린지의 실습을 모두 처음 상태로 되돌립니다`,onClick:y},[...g[14]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),G(`path`,{d:`M20 4v4.5h-4.5`})],-1)]])):J(``,!0)]),R(G(`div`,{class:D([`practice-body`,{"has-guide":u.value,"side-closed":u.value&&!d.value}])},[G(`div`,Rv,[i.value?(H(),U(`div`,zv,[(H(!0),U(V,null,B(n.value,e=>(H(),U(`div`,{key:e.name,class:`practice-slot`},[G(`div`,Bv,[G(`button`,{type:`button`,class:`icon-button`,"aria-label":`소스 코드 보기`,title:`소스 코드를 새 창으로 엽니다`,onClick:t=>x(e.name)},[...g[15]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M9 7 4 12l5 5M15 7l5 5-5 5`})],-1)]],8,Vv),G(`button`,{type:`button`,class:`icon-button`,"aria-label":`이 실습 초기화`,title:`이 실습만 처음 상태로 되돌립니다 (페이지 새로고침 없음)`,onClick:t=>v(e.name)},[...g[16]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M20 12a8 8 0 1 1-2.6-5.9`}),G(`path`,{d:`M20 4v4.5h-4.5`})],-1)]],8,Hv)]),(H(),W(Er(e.component),{key:_(e.name)}))]))),128))])):(H(),U(`p`,Uv,[...g[17]||=[q(` 아직 이 챌린지에 연결된 실습 화면이 없습니다. `,-1),G(`code`,null,`src/components/practices/`,-1),q(` 에 컴포넌트를 추가하고 `,-1),G(`code`,null,`curriculum.js`,-1),q(` 의 `,-1),G(`code`,null,`practices`,-1),q(` 에 이름을 넣으면 여기에 나타납니다. `,-1)]])),r.value.length?(H(),U(`p`,Wv,` ⚠ 파일을 찾지 못한 실습: `+O(r.value.join(`, `)),1)):J(``,!0)]),u.value?(H(),U(`aside`,{key:0,class:D([`guide-side`,{collapsed:!d.value}])},[G(`button`,{type:`button`,class:`side-toggle`,"aria-expanded":d.value,title:d.value?`접어서 실습 화면 넓히기`:`실습 도우미 펼치기`,onClick:g[4]||=e=>d.value=!d.value},[g[18]||=G(`span`,{class:`side-toggle-label`},[G(`span`,{"aria-hidden":`true`},`✓`),q(` 실습 도우미 `)],-1),G(`span`,Kv,O(d.value?`›`:`‹`),1)],8,Gv),R(G(`div`,qv,[a.value.length?(H(),U(`section`,Jv,[G(`p`,Yv,[g[19]||=q(` 확인 가이드 `,-1),G(`b`,null,O(a.value.length),1)]),(H(!0),U(V,null,B(o.value,(e,t)=>(H(),U(`div`,{key:t,class:`guide-group`},[e.label?(H(),U(`button`,{key:0,type:`button`,class:`guide-chip`,title:`이 실습으로 이동합니다`,onClick:n=>ee(e.label,t)},[q(O(e.label)+` `,1),g[20]||=G(`span`,{class:`jump`,"aria-hidden":`true`},`↓`,-1)],8,Xv)):J(``,!0),G(`ol`,Zv,[(H(!0),U(V,null,B(e.steps,(e,t)=>(H(),U(`li`,{key:t},[G(`p`,{class:`guide-do`,innerHTML:F(hd)(e.do)},null,8,Qv),G(`p`,$v,[g[21]||=G(`b`,null,`확인`,-1),g[22]||=q(),G(`span`,{innerHTML:F(hd)(e.see)},null,8,ey)]),e.why?(H(),U(`p`,ty,[g[23]||=G(`b`,null,`왜`,-1),g[24]||=q(),G(`span`,{innerHTML:F(hd)(e.why)},null,8,ny)])):J(``,!0)]))),128))]),e.extras.length?(H(),U(`div`,ry,[g[25]||=G(`p`,{class:`extras-label`},[G(`span`,{"aria-hidden":`true`},`🚀`),q(` 더 해보기`)],-1),G(`ul`,null,[(H(!0),U(V,null,B(e.extras,(e,t)=>(H(),U(`li`,{key:t},O(c(e)),1))),128))])])):J(``,!0)]))),128))])):J(``,!0),s.value.length?(H(),U(`details`,iy,[G(`summary`,null,[g[26]||=G(`span`,{"aria-hidden":`true`},`🚀`,-1),g[27]||=q(` 더 해보기 (전체) `,-1),G(`b`,null,O(s.value.length),1)]),G(`div`,ay,[G(`ul`,null,[(H(!0),U(V,null,B(s.value,(e,t)=>(H(),U(`li`,{key:t},O(c(e)),1))),128))])])])):J(``,!0)],512),[[Ja,d.value]])],2)):J(``,!0)],2),[[Ja,f.value]])],2)),h.value?(H(),U(`details`,oy,[G(`summary`,null,[g[28]||=G(`span`,{"aria-hidden":`true`},`🚀`,-1),g[29]||=q(` 더 해보기 (심화 응용) `,-1),G(`b`,null,O(l.value.length),1)]),G(`div`,sy,[G(`ul`,null,[(H(!0),U(V,null,B(l.value,(e,t)=>(H(),U(`li`,{key:t},O(c(e)),1))),128))])])])):J(``,!0)],64)):J(``,!0),b.value?(H(),W(Hd,{key:1,path:F(fv)(b.value),code:F(mv)(b.value),onClose:g[5]||=e=>b.value=null},null,8,[`path`,`code`])):J(``,!0)],10,hv))}},[[`__scopeId`,`data-v-6e637b45`]]),ly=[`aria-expanded`],uy={class:`chevron`,"aria-hidden":`true`},dy={class:`orientation-body`},fy={class:`rule`},py={class:`lead`},my={class:`cargo`},hy={class:`name`},gy={class:`payload`},_y={"aria-hidden":`true`},vy=[`innerHTML`],yy={class:`priority`},by={class:`p-name`},xy={class:`p-weight`},Sy={class:`p-when`},Cy={class:`keep`},wy=[`innerHTML`],Ty=Q({__name:`ChapterOrientation`,props:{orientation:{type:Object,required:!0}},setup(e){let t=P(!0);return(n,r)=>(H(),U(`section`,{class:D([`orientation`,{closed:!t.value}])},[G(`button`,{class:`orientation-toggle`,type:`button`,"aria-expanded":t.value,onClick:r[0]||=e=>t.value=!t.value},[r[1]||=G(`span`,{class:`marker`,"aria-hidden":`true`},`🧭`,-1),r[2]||=G(`span`,{class:`toggle-title`},`시작하기 전에 — 규칙은 하나뿐입니다`,-1),G(`span`,uy,O(t.value?`−`:`+`),1)],8,ly),R(G(`div`,dy,[G(`p`,fy,O(e.orientation.rule),1),G(`p`,py,O(e.orientation.lead),1),G(`ul`,my,[(H(!0),U(V,null,B(e.orientation.cargo,e=>(H(),U(`li`,{key:e.name},[G(`code`,hy,O(e.name),1),G(`span`,gy,O(e.payload),1),G(`span`,{class:D([`dir`,e.dir===`위로`?`up`:`down`])},[G(`span`,_y,O(e.dir===`위로`?`↑`:`↓`),1),q(` `+O(e.dir),1)],2)]))),128))]),G(`p`,{class:`why`,innerHTML:F(hd)(e.orientation.why)},null,8,vy),r[4]||=G(`p`,{class:`priority-label`},`실제로 쓰는 비중`,-1),G(`ul`,yy,[(H(!0),U(V,null,B(e.orientation.priority,e=>(H(),U(`li`,{key:e.name,class:D(e.level)},[G(`span`,by,O(e.name),1),G(`span`,xy,O(e.weight),1),G(`span`,Sy,O(e.when),1)],2))),128))]),G(`p`,Cy,[r[3]||=G(`span`,{class:`keep-label`},`이것만은`,-1),G(`span`,{innerHTML:F(hd)(e.orientation.keep)},null,8,wy)])],512),[[Ja,t.value]])],2))}},[[`__scopeId`,`data-v-bfb97b66`]]),Ey={class:`chapter-nav`},Dy={class:`nav-head`},Oy={key:0,class:`nav-title`},ky=[`title`,`aria-label`],Ay=[`title`,`onClick`],jy={class:`chapter-no`},My={key:0,class:`chapter-info`},Ny={key:1,class:`chapter-meta`},Py=[`title`],Fy={key:0,class:`nav-legend`},Iy={key:0},Ly={id:`learning-content`,class:`learning-content`},Ry={class:`chapter-head`},zy={class:`eyebrow`},By={class:`chapter-summary`},Vy={class:`topic-chips`},Hy={key:1,class:`challenge-stack`},Uy={key:2,class:`empty-state`},Wy={key:3,class:`linked-assignments`},Gy={class:`step`},Ky=Q({__name:`LearningView`,setup(e){let t=P(2),n=P(!1),r=X(()=>qo.find(e=>e.id===t.value)),i=X(()=>$o(t.value)),a=X(()=>es(t.value)),o=X(()=>qo.map(e=>{let t=$o(e.id),n=t.filter(e=>e.label.startsWith(`Code Challenge`));return{...e,total:n.length,live:t.filter(e=>e.practices.length>0).length,assignments:es(e.id).length}})),s=()=>{window.scrollTo({top:0,behavior:`smooth`})},c=e=>{t.value=e,document.getElementById(`learning-content`)?.scrollIntoView({behavior:`smooth`,block:`start`})};return(e,l)=>(H(),U(V,null,[l[6]||=G(`section`,{class:`page-intro`},[G(`p`,{class:`eyebrow`},`LEARNING & CODE CHALLENGES`),G(`h1`,null,`학습 & 코드 챌린지`),G(`p`,null,[q(` 왼쪽에서 챕터를 고르면 해당 챕터의 `),G(`strong`,null,`코드 챌린지`),q(`가 열립니다. 각 챌린지는 `),G(`strong`,null,`관련 강의 내용 → 연습 항목 → 실습 화면`),q(` 순서로 이어집니다. `)])],-1),G(`section`,{class:D([`learning-layout`,{"nav-collapsed":n.value}])},[G(`aside`,Ey,[G(`div`,Dy,[n.value?J(``,!0):(H(),U(`p`,Oy,`학습 로드맵`)),G(`button`,{type:`button`,class:`nav-toggle`,title:n.value?`메뉴 펼치기`:`메뉴 접기`,"aria-label":n.value?`메뉴 펼치기`:`메뉴 접기`,onClick:l[0]||=e=>n.value=!n.value},O(n.value?`»`:`«`),9,ky)]),(H(!0),U(V,null,B(o.value,e=>(H(),U(`button`,{key:e.id,type:`button`,class:D([`chapter-item`,{active:e.id===t.value}]),title:n.value?`${e.title} · ${e.slides}`:``,onClick:t=>c(e.id)},[G(`span`,jy,O(String(e.id).padStart(2,`0`)),1),n.value?J(``,!0):(H(),U(`span`,My,[G(`b`,null,O(e.title),1),G(`small`,null,O(e.slides),1)])),n.value?J(``,!0):(H(),U(`span`,Ny,[G(`i`,{class:D([`dot`,{live:e.live,none:!e.total}]),title:e.total?`코드 챌린지 ${e.total}개${e.live?` · 실습 화면 ${e.live}개`:``}`:`코드 챌린지 없음`},O(e.total||`–`),11,Py)]))],10,Ay))),128)),n.value?J(``,!0):(H(),U(`p`,Fy,[...l[1]||=[q(` 숫자 = 코드 챌린지 수 \xA0·\xA0 `,-1),G(`i`,{class:`dot live`},`n`,-1),q(` 실습 화면 있음 `,-1)]])),G(`button`,{type:`button`,class:`to-top`,title:`맨 위로`,"aria-label":`맨 위로 가기`,onClick:s},[l[2]||=G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`m6 15 6-6 6 6`})],-1),n.value?J(``,!0):(H(),U(`span`,Iy,`맨 위로`))])]),G(`div`,Ly,[G(`header`,Ry,[G(`div`,null,[G(`p`,zy,O(r.value.code)+` · 교안 `+O(r.value.slides),1),G(`h2`,null,O(r.value.title),1),G(`p`,By,O(r.value.summary),1),G(`div`,Vy,[(H(!0),U(V,null,B(r.value.topics,e=>(H(),U(`span`,{key:e},O(e),1))),128))])])]),r.value.orientation?(H(),W(Ty,{key:0,orientation:r.value.orientation},null,8,[`orientation`])):J(``,!0),i.value.length?(H(),U(`div`,Hy,[(H(!0),U(V,null,B(i.value,e=>(H(),W(cy,{key:e.id,challenge:e},null,8,[`challenge`]))),128))])):(H(),U(`p`,Uy,[...l[3]||=[q(` 교안 기준으로 이 챕터에는 코드 챌린지가 없습니다. 아래 `,-1),G(`b`,null,`제출 과제`,-1),q(`로 바로 진행합니다. `,-1)]])),a.value.length?(H(),U(`section`,Wy,[l[5]||=G(`p`,{class:`section-label`},`이 챕터의 제출 과제`,-1),(H(!0),U(V,null,B(a.value,e=>(H(),U(`a`,{key:e.id,class:`assignment-link`,href:`#/assignments`},[G(`span`,Gy,O(String(e.id).padStart(2,`0`)),1),G(`span`,null,[G(`b`,null,O(e.title),1),G(`small`,null,O(e.goal),1)]),l[4]||=G(`span`,{class:`arrow`},`→`,-1)]))),128))])):J(``,!0)])],2)],64))}},[[`__scopeId`,`data-v-6cb2a7c2`]]),qy={class:`anatomy`},Jy={class:`intro`},Yy={class:`node owner`},Xy={class:`node-head`},Zy={class:`node-name`},Qy={class:`node-role`},$y=[`onClick`],eb={key:0,class:`state`},tb={class:`node-note`},nb={class:`children`},rb={key:0,class:`under`},ib={class:`node-head`},ab={class:`node-name`},ob={class:`node-role`},sb=[`onClick`],cb={class:`wires`},lb={class:`wire down`},ub={key:0,class:`none`},db={key:1},fb={class:`as`},pb={class:`wire-desc`},mb={class:`wire up`},hb={key:0,class:`none`},gb={key:1},_b={class:`as`},vb={class:`wire-desc`},yb={class:`node-note`},bb={class:`flows`},xb={class:`flow-title`},Sb={class:`steps`},Cb={class:`arrow`,"aria-hidden":`true`},wb={class:`who`},Tb={class:`what`},Eb={class:`step-desc`},Db=[`innerHTML`],Ob=Q({__name:`ResultAnatomy`,props:{anatomy:{type:Object,required:!0}},setup(e){let t=e=>e.includes(`.`)?e:`${e}.vue`,n=P(``),r=e=>n.value=e,i=()=>n.value=``;return(a,o)=>(H(),U(`div`,qy,[G(`p`,Jy,O(e.anatomy.intro),1),o[4]||=G(`p`,{class:`section`},`컴포넌트 구조`,-1),(H(!0),U(V,null,B(e.anatomy.tree,e=>(H(),U(`div`,{key:e.name,class:`tree`},[G(`div`,Yy,[G(`div`,Xy,[G(`code`,Zy,O(t(e.name)),1),G(`span`,Qy,O(e.role),1),G(`button`,{type:`button`,class:`code-link`,onClick:t=>r(e.file)},`코드 보기`,8,$y)]),e.state?.length?(H(),U(`p`,eb,[o[0]||=G(`span`,{class:`state-label`},`가진 데이터`,-1),(H(!0),U(V,null,B(e.state,e=>(H(),U(`code`,{key:e},O(e),1))),128))])):J(``,!0),G(`p`,tb,O(e.note),1),G(`ul`,nb,[(H(!0),U(V,null,B(e.children,e=>(H(),U(`li`,{key:e.name,class:D([`node child`,{nested:e.under}])},[e.under?(H(),U(`p`,rb,[o[1]||=G(`span`,{"aria-hidden":`true`},`↳`,-1),q(` `+O(e.under)+` 안에서 쓰입니다 `,1)])):J(``,!0),G(`div`,ib,[G(`code`,ab,O(t(e.name)),1),G(`span`,ob,O(e.role),1),G(`button`,{type:`button`,class:`code-link`,onClick:t=>r(e.file)},` 코드 보기 `,8,sb)]),G(`div`,cb,[G(`div`,lb,[o[2]||=G(`p`,{class:`wire-head`},[G(`span`,{"aria-hidden":`true`},`↓`),q(` 받는다 (props)`)],-1),e.props.length?(H(),U(`ul`,db,[(H(!0),U(V,null,B(e.props,e=>(H(),U(`li`,{key:e.name},[G(`code`,null,`:`+O(e.name),1),G(`span`,fb,`→ `+O(e.as)+` (`+O(e.type)+`)`,1),G(`span`,pb,O(e.desc),1)]))),128))])):(H(),U(`p`,ub,`없음`))]),G(`div`,mb,[o[3]||=G(`p`,{class:`wire-head`},[G(`span`,{"aria-hidden":`true`},`↑`),q(` 올린다 (emits)`)],-1),e.emits.length?(H(),U(`ul`,gb,[(H(!0),U(V,null,B(e.emits,e=>(H(),U(`li`,{key:e.name},[G(`code`,null,`@`+O(e.name),1),G(`span`,_b,O(e.payload),1),G(`span`,vb,O(e.desc),1)]))),128))])):(H(),U(`p`,hb,`없음`))])]),G(`p`,yb,O(e.note),1)],2))),128))])])]))),128)),o[5]||=G(`p`,{class:`section`},`이벤트가 오가는 길`,-1),G(`div`,bb,[(H(!0),U(V,null,B(e.anatomy.flows,e=>(H(),U(`div`,{key:e.title,class:`flow`},[G(`p`,xb,O(e.title),1),G(`ol`,Sb,[(H(!0),U(V,null,B(e.steps,(e,t)=>(H(),U(`li`,{key:t,class:D(e.dir)},[G(`span`,Cb,O(e.dir===`up`?`↑`:e.dir===`down`?`↓`:`●`),1),G(`span`,wb,O(e.who),1),G(`code`,Tb,O(e.label),1),G(`span`,Eb,O(e.desc),1)],2))),128))])]))),128))]),G(`p`,{class:`point`,innerHTML:F(hd)(e.anatomy.point)},null,8,Db),n.value?(H(),W(Hd,{key:0,path:F(Lu)(n.value),code:F(Iu)(n.value),onClose:i},null,8,[`path`,`code`])):J(``,!0)]))}},[[`__scopeId`,`data-v-6080f9f4`]]),kb={class:`check-layout`},Ab={class:`checklist-card`},jb={class:`checklist-head`},Mb={class:`track`},Nb=[`onUpdate:modelValue`],Pb={class:`side`},Fb={class:`side-card`},Ib={class:`side-card`},Lb={class:`grade-head`},Rb=Q({__name:`SubmissionChecklist`,setup(e){let t=P(Qo.map(e=>({...e,done:!1}))),n=X(()=>t.value.filter(e=>e.done).length),r=X(()=>Math.round(n.value/t.value.length*100));return(e,i)=>(H(),U(`div`,kb,[G(`section`,Ab,[G(`div`,jb,[i[0]||=G(`div`,null,[G(`h2`,null,`최종 제출 체크리스트`),G(`p`,null,`완료한 항목을 체크하면 진행률에 반영됩니다.`)],-1),G(`strong`,null,O(n.value)+` / `+O(t.value.length),1)]),G(`div`,Mb,[G(`i`,{style:E({width:`${r.value}%`})},null,4)]),(H(!0),U(V,null,B(t.value,e=>(H(),U(`label`,{key:e.title,class:D([`check-item`,{done:e.done}])},[R(G(`input`,{"onUpdate:modelValue":t=>e.done=t,type:`checkbox`},null,8,Nb),[[ko,e.done]]),G(`span`,null,[G(`b`,null,O(e.title),1),G(`small`,null,O(e.detail),1)])],2))),128))]),G(`aside`,Pb,[G(`section`,Fb,[i[1]||=G(`p`,{class:`side-label`},`제출 조건 · 교안 5쪽`,-1),G(`ul`,null,[(H(!0),U(V,null,B(F(Xo),e=>(H(),U(`li`,{key:e},O(e),1))),128))])]),G(`section`,Ib,[i[2]||=G(`p`,{class:`side-label`},`평가 기준 · 교안 6쪽`,-1),(H(!0),U(V,null,B(F(Zo),e=>(H(),U(`div`,{key:e.grade,class:`grade-row`},[G(`div`,Lb,[G(`b`,null,O(e.grade),1),G(`span`,null,O(e.score),1)]),G(`p`,null,O(e.criteria),1)]))),128))])])]))}},[[`__scopeId`,`data-v-8f40fe26`]]),zb={class:`hero`},Bb={class:`hero-meter`,"aria-hidden":`true`},Vb={class:`meter-count`},Hb={class:`meter-total`},Ub={class:`meter-track`},Wb={class:`stage-tabs`,role:`tablist`},Gb=[`aria-selected`,`onClick`],Kb={class:`tab-no`},qb={class:`tab-title`},Jb={class:`stage-head`},Yb={class:`eyebrow`},Xb={class:`stage-goal`},Zb={class:`stage-frame`},Qb={class:`frame-bar`},$b={class:`frame-title`},ex={class:`stage-body`},tx={key:0,class:`stage-note`},nx={key:1,class:`anatomy-fold`},rx={class:`anatomy-body`},ix={key:1,class:`empty-state`},ax={key:2,class:`roadmap`},ox={class:`roadmap-grid`},sx={class:`number`},cx={class:`submission`},lx={class:`submission-body`},ux=Q({__name:`ProjectView`,setup(e){let t=X(()=>Yo.filter(e=>ju(e.result)).map(e=>({...e,component:ju(e.result)}))),n=X(()=>Yo.filter(e=>!ju(e.result)&&e.status!==`done`)),r=P(null),i=X(()=>{let e=t.value;return e.length?e.find(e=>e.id===r.value)??e[e.length-1]:null});return(e,a)=>(H(),U(V,null,[G(`section`,zb,[a[1]||=G(`div`,{class:`hero-text`},[G(`p`,{class:`eyebrow`},`FINAL PROJECT`),G(`h1`,null,[q(`Weather`),G(`br`),G(`span`,null,`Dashboard`)]),G(`p`,{class:`hero-copy`},[q(` 제출 과제가 한 겹씩 쌓여 완성되는 결과물입니다. 아래에서 단계를 골라 `),G(`strong`,null,`지금까지 만든 앱을 그대로 실행`),q(`해 볼 수 있습니다. `)])],-1),G(`div`,Bb,[G(`span`,Vb,O(t.value.length),1),G(`span`,Hb,`/ `+O(F(Yo).length)+` 단계`,1),G(`span`,Ub,[G(`i`,{style:E({width:`${t.value.length/F(Yo).length*100}%`})},null,4)]),a[0]||=G(`span`,{class:`meter-label`},`완성한 단계`,-1)])]),i.value?(H(),U(V,{key:0},[G(`div`,Wb,[(H(!0),U(V,null,B(t.value,e=>(H(),U(`button`,{key:e.id,type:`button`,role:`tab`,class:D([`stage-tab`,{active:e.id===i.value.id}]),"aria-selected":e.id===i.value.id,onClick:t=>r.value=e.id},[G(`span`,Kb,O(String(e.id).padStart(2,`0`)),1),G(`span`,qb,O(e.title),1)],10,Gb))),128))]),G(`div`,Jb,[G(`div`,null,[G(`p`,Yb,`ASSIGNMENT `+O(String(i.value.id).padStart(2,`0`)),1),G(`h2`,null,O(i.value.title),1),G(`p`,Xb,O(i.value.goal),1)]),a[2]||=G(`a`,{class:`to-assignment`,href:`#/assignments`},`요구사항 보기 →`,-1)]),G(`div`,Zb,[G(`div`,Qb,[a[3]||=G(`span`,{class:`dots`,"aria-hidden":`true`},[G(`i`),G(`i`),G(`i`)],-1),G(`span`,$b,`실행 중 · `+O(i.value.title),1)]),G(`div`,ex,[(H(),W(Er(i.value.component),{key:i.value.id}))])]),i.value.resultNote?(H(),U(`p`,tx,O(i.value.resultNote),1)):J(``,!0),i.value.anatomy?(H(),U(`details`,nx,[a[4]||=G(`summary`,null,[G(`span`,{class:`fold-mark`,"aria-hidden":`true`},`▶`),G(`span`,{class:`fold-title`},`컴포넌트 구조와 이벤트 흐름`),G(`span`,{class:`fold-hint`},`파일이 어떻게 연결되고 이벤트가 어디로 오가는지`)],-1),G(`div`,rx,[K(Ob,{anatomy:i.value.anatomy},null,8,[`anatomy`])])])):J(``,!0)],64)):(H(),U(`p`,ix,[...a[5]||=[q(` 아직 실행할 수 있는 결과물이 없습니다. 과제를 완성한 뒤 `,-1),G(`code`,null,`src/components/assignments/`,-1),q(` 에 컴포넌트를 넣고 `,-1),G(`code`,null,`curriculum.js`,-1),q(` 의 `,-1),G(`code`,null,`result`,-1),q(` 에 이름을 적어 주세요. `,-1)]])),n.value.length?(H(),U(`section`,ax,[a[6]||=G(`p`,{class:`section-label`},`앞으로 이어 붙일 단계`,-1),G(`div`,ox,[(H(!0),U(V,null,B(n.value,e=>(H(),U(`article`,{key:e.id},[G(`span`,sx,O(String(e.id).padStart(2,`0`)),1),G(`h3`,null,O(e.title),1),G(`p`,null,O(e.goal),1)]))),128))])])):J(``,!0),G(`details`,cx,[a[7]||=G(`summary`,null,[G(`span`,{class:`sum-title`},`제출 전 점검`),G(`span`,{class:`sum-hint`},`체크리스트 · 제출 조건 · 평가 기준`)],-1),G(`div`,lx,[K(Rb)])])],64))}},[[`__scopeId`,`data-v-9a4a8adc`]]),dx=[{id:`editorial`,name:`Editorial`,tagline:`기술 문서`,description:`따뜻한 종이 위에 근접 블랙으로 찍은 인쇄물. 색을 아끼고 여백으로 읽힙니다.`,swatches:[`#f6f4ef`,`#fffefb`,`#0f7a4e`,`#16191c`]},{id:`terminal`,name:`Terminal`,tagline:`다크 IDE`,description:`코드를 오래 보는 화면. 저조도 배경에 형광 민트로 눌러야 할 곳만 밝힙니다.`,swatches:[`#14181f`,`#1b212b`,`#3ddc97`,`#e8edf4`]},{id:`blueprint`,name:`Blueprint`,tagline:`설계도`,description:`모눈종이 위의 도면. 차가운 청색과 각진 모서리로 구조를 드러냅니다.`,swatches:[`#eef1f6`,`#ffffff`,`#1d4ed8`,`#12213a`]}],fx=`inwoo-vue-theme`,px=`editorial`,mx=e=>dx.some(t=>t.id===e),hx=P(px),gx=e=>{if(mx(e)){hx.value=e,document.documentElement.dataset.theme=e;try{localStorage.setItem(fx,e)}catch{}}},_x=()=>{let e=null;try{e=localStorage.getItem(fx)}catch{e=null}gx(mx(e)?e:px)},vx={class:`block`},yx={class:`theme-grid`},bx=[`aria-pressed`,`onClick`],xx={class:`meta`},Sx={class:`name-row`},Cx={key:0,class:`badge`},wx={class:`desc`},Tx=Q({__name:`SettingsView`,setup(e){return(e,t)=>(H(),U(V,null,[t[1]||=G(`section`,{class:`page-intro`},[G(`p`,{class:`eyebrow`},`SETTINGS`),G(`h1`,null,`환경 설정`),G(`p`,null,[q(` 화면 테마를 고를 수 있습니다. 고른 테마는 `),G(`strong`,null,`이 브라우저에 저장`),q(`되어 다음에 열어도 그대로 유지됩니다. `)])],-1),G(`section`,vx,[t[0]||=G(`div`,{class:`block-head`},[G(`p`,{class:`eyebrow`},`APPEARANCE`),G(`h2`,null,`테마`),G(`p`,{class:`block-desc`},`누르면 바로 적용됩니다. 실습 화면의 색은 각 실습 코드가 정한 대로 유지됩니다.`)],-1),G(`div`,yx,[(H(!0),U(V,null,B(F(dx),e=>(H(),U(`button`,{key:e.id,type:`button`,class:D([`theme-card`,{active:F(hx)===e.id}]),"aria-pressed":F(hx)===e.id,onClick:t=>F(gx)(e.id)},[G(`span`,{class:`preview`,style:E({background:e.swatches[0],borderColor:e.swatches[3]+`22`})},[G(`i`,{class:`bar`,style:E({background:e.swatches[1]})},[G(`em`,{style:E({background:e.swatches[2]})},null,4)],4),G(`i`,{class:`line long`,style:E({background:e.swatches[3],opacity:.85})},null,4),G(`i`,{class:`line`,style:E({background:e.swatches[3],opacity:.35})},null,4),G(`i`,{class:`line mid`,style:E({background:e.swatches[3],opacity:.35})},null,4),G(`i`,{class:`chip`,style:E({background:e.swatches[2]})},null,4)],4),G(`span`,xx,[G(`span`,Sx,[G(`b`,null,O(e.name),1),G(`small`,null,O(e.tagline),1),F(hx)===e.id?(H(),U(`span`,Cx,`사용 중`)):J(``,!0)]),G(`span`,wx,O(e.description),1)])],10,bx))),128))])]),t[2]||=oa(`<section class="block" data-v-cc84f2a9><div class="block-head" data-v-cc84f2a9><p class="eyebrow" data-v-cc84f2a9>ABOUT</p><h2 data-v-cc84f2a9>이 사이트</h2></div><dl class="facts" data-v-cc84f2a9><dt data-v-cc84f2a9>구성</dt><dd data-v-cc84f2a9>학습 &amp; 코드 챌린지 · 제출 과제 · 최종 결과물</dd><dt data-v-cc84f2a9>내용 출처</dt><dd data-v-cc84f2a9>Full-stack Engineering · Frontend Framework (Vue.js) 교안 276쪽</dd><dt data-v-cc84f2a9>내용 추가</dt><dd data-v-cc84f2a9><code data-v-cc84f2a9>src/data/curriculum.js</code> 한 파일만 고치면 모든 화면에 반영됩니다</dd><dt data-v-cc84f2a9>가이드</dt><dd data-v-cc84f2a9><code data-v-cc84f2a9>docs/CONTENT_GUIDE.md</code></dd></dl></section>`,1)],64))}},[[`__scopeId`,`data-v-cc84f2a9`]]),Ex={class:`app-shell`},Dx={class:`app-header`},Ox={class:`main-nav`,"aria-label":`주요 메뉴`},kx={class:`page-container`},Ax={__name:`App`,setup(e){let t=P(window.location.hash.slice(1)||`/`),n=()=>{t.value=window.location.hash.slice(1)||`/`};mr(()=>window.addEventListener(`hashchange`,n)),vr(()=>window.removeEventListener(`hashchange`,n));let r=X(()=>t.value===`/learning`?Ky:t.value===`/assignments`?td:t.value===`/project`?ux:t.value===`/settings`?Tx:dd),i=e=>t.value===e;return(e,t)=>(H(),U(`div`,Ex,[G(`header`,Dx,[t[0]||=G(`a`,{class:`brand`,href:`#/`},[G(`span`,{class:`brand-mark`},`V`),G(`span`,null,`Vue Learning Lab`)],-1),G(`nav`,Ox,[G(`a`,{href:`#/`,class:D({active:i(`/`)})},`홈`,2),G(`a`,{href:`#/learning`,class:D({active:i(`/learning`)})},` 학습 & 챌린지 `,2),G(`a`,{href:`#/assignments`,class:D({active:i(`/assignments`)})},` 제출 과제 `,2),G(`a`,{href:`#/project`,class:D({active:i(`/project`)})},` 최종 결과물 `,2),G(`a`,{href:`#/settings`,class:D({active:i(`/settings`)})},` 환경 설정 `,2)])]),G(`main`,kx,[(H(),W(Er(r.value)))])]))}},jx={class:`global-badge`},Mx=Q({__name:`GlobalBadge`,props:{text:{type:String,default:`전역 등록됨`}},setup(e){return(t,n)=>(H(),U(`span`,jx,[n[0]||=G(`i`,{"aria-hidden":`true`},null,-1),q(` `+O(e.text),1)]))}},[[`__scopeId`,`data-v-4c3191a7`]]);_x();var Nx=Wo(Ax);Nx.component(`GlobalBadge`,Mx),Nx.mount(`#app`);